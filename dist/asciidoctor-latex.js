...
Opal.modules["asciidoctor/latex/version"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      Opal.cdecl($scope, 'VERSION', "1.5.0.17.dev")
    })($scope.base)
  })($scope.base)
};
...
Opal.modules["asciidoctor/latex/css_doc_info"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$process', TMP_1 = function ːprocess(doc) {
      var $a, self = this, extdir = nil, stylesheet_name = nil, stylesheet_href = nil, content = nil;

      extdir = $scope.get('File').$expand_path("../../../../data", "asciidoctor/latex/css_doc_info");
    ...
    return (Opal.defn(self, '$handle_stylesheet', TMP_3 = function ːhandle_stylesheet(doc, extdir, stylesheet_name) {
      var $a, $b, $c, TMP_2, self = this, outdir = nil, stylesoutdir = nil, destination = nil, content = nil;
      ...
      if ((($a = ($b = ($c = stylesoutdir['$!='](extdir), $c !== false && $c !== nil && $c != null ?$rb_lt(doc.$safe(), (($scope.get('SafeMode')).$$scope.get('SECURE'))) : $c), $b !== false && $b !== nil && $b != null ?(doc['$attr?']("copycss")) : $b)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        ...
        content = doc.$read_asset("" + (extdir) + "/" + (stylesheet_name));
        ($a = ($b = Opal.get('File')).$open, $a.$$p = (TMP_2 = function(f){var self = TMP_2.$$s || this;
if (f == null) f = nil;
        return f.$write(content)}, TMP_2.$$s = self, TMP_2.$$arity = 1, TMP_2), $a).call($b, destination, "w");
        return destination;
        } else {
        return "./" + (stylesheet_name)
      };
    }, TMP_3.$$arity = 3), nil) && 'handle_stylesheet';
  })($scope.base, (((($scope.get('Asciidoctor')).$$scope.get('Extensions'))).$$scope.get('DocinfoProcessor')));
};
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        Opal.defn(self, '$parse_content', TMP_10 = function ːparse_content(parent, content, attributes) {
          ...
          reader = (function() {if ((($a = (content['$is_a?']($scope.get('Reader')))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
            return content
            } else {
...
if (method_name == null) method_name = nil;if (delegate_method_name == null) delegate_method_name = nil;if (context == null) context = nil;
      ...
      (function($base) {
        ...
        Opal.defn(self, '$named', TMP_26 = function ːnamed(value) {
          ...
          if ((($a = self['$is_a?']($scope.get('Processor'))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        ...
        Opal.defn(self, '$docinfo_processors?', TMP_62 = function(location) {
          ...
          if ((($a = self.docinfo_processor_extensions) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
            if (location !== false && location !== nil && location != null) {
              return ($a = ($b = self.docinfo_processor_extensions).$find, $a.$$p = (TMP_61 = function(ext){var self = TMP_61.$$s || this;
if (ext == null) ext = nil;
...
if (word == null) word = nil;
          ...
          extension = (function() {if ((block !== nil)) {
            ...
            if ((($a = ((($d = (processor['$is_a?'](Opal.get('Class')))) !== false && $d !== nil && $d != null) ? $d : (($e = (processor['$is_a?'](Opal.get('String'))), $e !== false && $e !== nil && $e != null ?(processor = $scope.get('Extensions').$class_for_name(processor)) : $e)))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
            ...
            } else if ((($a = ((($d = (processor['$is_a?'](kind_class))) !== false && $d !== nil && $d != null) ? $d : ((($e = kind_java_class !== false && kind_java_class !== nil && kind_java_class != null) ? (processor['$is_a?'](kind_java_class)) : kind_java_class)))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
...
if (word == null) word = nil;
        ...
        Opal.defn(self, '$resolve_args', TMP_82 = function ːresolve_args(args, expect) {
          ...
          opts = (function() {if ((($a = (args['$[]'](-1)['$is_a?'](Opal.get('Hash')))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
            return args.$pop()
            } else {
            return $hash2([], {})
          }; return nil; })();
        ...
        return (Opal.defn(self, '$as_symbol', TMP_83 = function ːas_symbol(name) {
          ...
          if (name !== false && name !== nil && name != null) {
            return ((function() {if ((($a = (name['$is_a?'](Opal.get('Symbol')))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
              return name
              } else {
              return name.$to_sym()
            }; return nil; })())
      ...
      (function(self) {
        ...
        Opal.defn(self, '$resolve_class', TMP_90 = function ːresolve_class(object) {
          ...
          if ((($a = (object['$is_a?'](Opal.get('Class')))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
            return object
            } else {
...
Opal.modules["asciidoctor/latex/core_ext/colored_string"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$blue', TMP_1 = function ːblue() {
      var self = this;

      return "\e[1;34m" + (self) + "\e[0m";
    }, TMP_1.$$arity = 0);

    Opal.defn(self, '$green', TMP_2 = function ːgreen() {
      var self = this;

      return "\e[1;32m" + (self) + "\e[0m";
    }, TMP_2.$$arity = 0);

    Opal.defn(self, '$red', TMP_3 = function ːred() {
      var self = this;

      return "\e[1;31m" + (self) + "\e[0m";
    }, TMP_3.$$arity = 0);

    Opal.defn(self, '$yellow', TMP_4 = function ːyellow() {
      var self = this;

      return "\e[1;33m" + (self) + "\e[0m";
    }, TMP_4.$$arity = 0);

    Opal.defn(self, '$magenta', TMP_5 = function ːmagenta() {
      var self = this;

      return "\e[1;35m" + (self) + "\e[0m";
    }, TMP_5.$$arity = 0);

    Opal.defn(self, '$cyan', TMP_6 = function ːcyan() {
      var self = this;

      return "\e[1;36m" + (self) + "\e[0m";
    }, TMP_6.$$arity = 0);

    Opal.defn(self, '$white', TMP_7 = function ːwhite() {
      var self = this;

      return "\e[1;37m" + (self) + "\e[0m";
    }, TMP_7.$$arity = 0);

    return (Opal.defn(self, '$black', TMP_8 = function ːblack() {
      var self = this;

      return "\e[1;30m" + (self) + "\e[0m";
    }, TMP_8.$$arity = 0), nil) && 'black';
  })($scope.base, null)
};
...
Opal.modules["asciidoctor/latex/inline_macros"] = function(Opal) {
  ...
  return (function($base) {
    ...
    })($scope.base, (((($scope.get('Asciidoctor')).$$scope.get('Extensions'))).$$scope.get('InlineMacroProcessor')));
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$glossterm', TMP_2 = function ːglossterm(term) {
      ...
      return (Opal.defn(self, '$process', TMP_3 = function ːprocess(parent, target, attributes) {
        var self = this, term = nil;

        term = attributes.$values()['$[]'](0);
        return self.$glossterm(term);
      }, TMP_3.$$arity = 3), nil) && 'process';
    })($scope.base, (((($scope.get('Asciidoctor')).$$scope.get('Extensions'))).$$scope.get('InlineMacroProcessor')));
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$process', TMP_4 = function ːprocess(parent, target, attributes) {
        ...
        ((($a = reference) !== false && $a !== nil && $a != null) ? $a : reference = "");
        if (css['$==']("invisible")) {
      ...
      }, TMP_4.$$arity = 3), nil) && 'process';
    })($scope.base, (((($scope.get('Asciidoctor')).$$scope.get('Extensions'))).$$scope.get('InlineMacroProcessor')));
  })($scope.get('Asciidoctor'));
};
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$process', TMP_1 = function ːprocess(parent, target, attrs) {
        ...
        file_contents = $scope.get('IO').$read(target);
        if (file_contents['$=='](nil)) {
          file_contents = $scope.get('IO').$read("public/macros.tex")};
        if ((($a = parent.$document()['$basebackend?']("html")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          content = ((($a = "\n\\(\n" + (file_contents) + "\n\\)\n") !== false && $a !== nil && $a != null) ? $a : "")
          } else {
          content = ((($a = "\n" + (file_contents) + "\n") !== false && $a !== nil && $a != null) ? $a : "")
        };
        return self.$create_pass_block(parent, content, attrs, $hash2(["subs"], {"subs": nil}));
      }, TMP_1.$$arity = 3), nil) && 'process';
    })($scope.base, (((($scope.get('Asciidoctor')).$$scope.get('Extensions'))).$$scope.get('BlockMacroProcessor')));
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$process', TMP_2 = function ːprocess(parent, reader, attrs) {
        var $a, $b, self = this, original_title = nil, original_role = nil, role = nil, numbered = nil, env_name = nil, title = nil, block = nil;
        ...
        numbered = false;
        if ((($a = ($b = attrs['$[]']("options"), $b !== false && $b !== nil && $b != null ?attrs['$[]']("options")['$include?']("number") : $b)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          numbered = true};
        if (numbered !== false && numbered !== nil && numbered != null) {
          env_name = role;
          if ($gvars.counter['$[]'](env_name)['$=='](nil)) {
            $gvars.counter['$[]='](env_name, 1)
            } else {
            ($a = env_name, $b = $gvars.counter, $b['$[]=']($a, $rb_plus($b['$[]']($a), 1)))
          };};
        if (role['$==']("code")) {
          title = "Listing"
          } else {
        ...
        if ((($a = attrs['$[]']("title")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          if (numbered !== false && numbered !== nil && numbered != null) {
        ...
        if ((($a = role['$!=']("equation")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          attrs['$[]=']("title", title)
        } else if (numbered !== false && numbered !== nil && numbered != null) {
          attrs['$[]=']("equation_number", $gvars.counter['$[]'](env_name).$to_s())};
        attrs['$[]=']("title", title);
        if (attrs['$[]']("role")['$==']("code")) {
          role = "listing"
          } else {
    ...
    })($scope.base, (((($scope.get('Asciidoctor')).$$scope.get('Extensions'))).$$scope.get('BlockProcessor')));
  })($scope.get('Asciidoctor'));
};
...
Opal.modules["asciidoctor/latex/inject_html"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$process', TMP_1 = function ːprocess(document, output) {
        var self = this;
        if ($gvars.click_insertion == null) $gvars.click_insertion = nil;

        return output.$sub("</head>", $gvars.click_insertion);
      }, TMP_1.$$arity = 2), nil) && 'process'
    })($scope.base, (((($scope.get('Asciidoctor')).$$scope.get('Extensions'))).$$scope.get('Postprocessor')));
...
Opal.modules["htmlentities/flavors"] = function(Opal) {
  ...
  (function($base, $super) {
    ...
    Opal.cdecl($scope, 'FLAVORS', ["html4", "xhtml1", "expanded"]);

    if ((($a = ($scope.MAPPINGS != null)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
      } else {
      Opal.cdecl($scope, 'MAPPINGS', $hash2([], {}))
    };

    if ((($a = ($scope.SKIP_DUP_ENCODINGS != null)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
      return nil
      } else {
      return Opal.cdecl($scope, 'SKIP_DUP_ENCODINGS', $hash2([], {}))
    };
  })($scope.base, null);
  return ($a = ($b = (($scope.get('HTMLEntities')).$$scope.get('FLAVORS'))).$each, $a.$$p = (TMP_1 = function(flavor){var self = TMP_1.$$s || this;
if (flavor == null) flavor = nil;
  return self.$require("htmlentities/mappings/" + (flavor))}, TMP_1.$$s = self, TMP_1.$$arity = 1, TMP_1), $a).call($b);
};
...
Opal.modules["htmlentities/encoder"] = function(Opal) {
  ...
  Opal.add_stubs(['$new', '$empty?', '$validate_instructions', '$build_basic_entity_encoder', '$build_extended_entity_encoder', '$minimize_encoding', '$replace_extended', '$replace_basic', '$prepare', '$private', '$encode', '$to_s', '$!=', '$encoding', '$contains_only_ascii?', '$match', '$==', '$<<', '$gsub', '$encode_basic', '$basic_entity_regexp', '$encode_extended', '$extended_entity_regexp', '$-', '$any?', '$raise', '$inspect', '$include?', '$instance_eval', '$&', '$join', '$map', '$[]', '$unpack', '$reverse_map', '$reject', '$invert']);
  return (function($base, $super) {
    function $HTMLEntities(){};
    var self = $HTMLEntities = $klass($base, $super, 'HTMLEntities', $HTMLEntities);
    ...
    Opal.cdecl($scope, 'InstructionError', $scope.get('Class').$new($scope.get('RuntimeError')));

    return (function($base, $super) {
      function $Encoder(){};
      var self = $Encoder = $klass($base, $super, 'Encoder', $Encoder);

      var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_7, TMP_9, TMP_11, TMP_12, TMP_13, TMP_15, TMP_16, TMP_17, TMP_18, TMP_20;

      def.basic_entity_regexp = def.flavor = def.extended_entity_regexp = def.reverse_map = nil;
      Opal.cdecl($scope, 'INSTRUCTIONS', ["basic", "named", "decimal", "hexadecimal"]);

      Opal.defn(self, '$initialize', TMP_1 = function ːinitialize(flavor, instructions) {
        var $a, self = this;

        self.flavor = flavor;
        if ((($a = instructions['$empty?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          instructions = ["basic"]};
      ...
      Opal.defn(self, '$encode', TMP_2 = function ːencode(source) {
        var self = this;
      ...
      Opal.defn(self, '$prepare', TMP_3 = function ːprepare(string) {
        var self = this;

        return string.$to_s().$encode((($scope.get('Encoding')).$$scope.get('UTF_8')));
      }, TMP_3.$$arity = 1);

      Opal.defn(self, '$minimize_encoding', TMP_4 = function ːminimize_encoding(string) {
        var $a, $b, self = this;

        if ((($a = ($b = string.$encoding()['$!=']((($scope.get('Encoding')).$$scope.get('ASCII'))), $b !== false && $b !== nil && $b != null ?self['$contains_only_ascii?'](string) : $b)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return string.$encode((($scope.get('Encoding')).$$scope.get('ASCII')))
          } else {
          return string
        };
      }, TMP_4.$$arity = 1);

      Opal.defn(self, '$contains_only_ascii?', TMP_5 = function(string) {
        var self = this;

        return string.$match(/\A[\x01-\x7F]*\z/);
      }, TMP_5.$$arity = 1);

      Opal.defn(self, '$basic_entity_regexp', TMP_6 = function ːbasic_entity_regexp() {
        var $a, $b, self = this;

        return ((($a = self.basic_entity_regexp) !== false && $a !== nil && $a != null) ? $a : self.basic_entity_regexp = (function() {if ((($b = self.flavor.$match(/^html/)) !== nil && $b != null && (!$b.$$is_boolean || $b == true))) {
          return /[<>"&]/
          } else {
          return /[<>'"&]/
        }; return nil; })());
      ...
      Opal.defn(self, '$extended_entity_regexp', TMP_7 = function ːextended_entity_regexp() {
        var $a, self = this, pattern = nil;

        return ((($a = self.extended_entity_regexp) !== false && $a !== nil && $a != null) ? $a : self.extended_entity_regexp = (pattern = "[^\\u{20}-\\u{7E}]", (function() {if (self.flavor['$==']("html4")) {
          return pattern['$<<']("|'")
          } else {
          return nil
        }; return nil; })(), $scope.get('Regexp').$new(pattern)));
      }, TMP_7.$$arity = 0);

      Opal.defn(self, '$replace_basic', TMP_9 = function ːreplace_basic(string) {
        var $a, $b, TMP_8, self = this;

        return ($a = ($b = string).$gsub, $a.$$p = (TMP_8 = function(match){var self = TMP_8.$$s || this;
if (match == null) match = nil;
        return self.$encode_basic(match)}, TMP_8.$$s = self, TMP_8.$$arity = 1, TMP_8), $a).call($b, self.$basic_entity_regexp());
      }, TMP_9.$$arity = 1);

      Opal.defn(self, '$replace_extended', TMP_11 = function ːreplace_extended(string) {
        var $a, $b, TMP_10, self = this;

        return ($a = ($b = string).$gsub, $a.$$p = (TMP_10 = function(match){var self = TMP_10.$$s || this;
if (match == null) match = nil;
        return self.$encode_extended(match)}, TMP_10.$$s = self, TMP_10.$$arity = 1, TMP_10), $a).call($b, self.$extended_entity_regexp());
      }, TMP_11.$$arity = 1);

      Opal.defn(self, '$validate_instructions', TMP_12 = function ːvalidate_instructions(instructions) {
        var $a, $b, self = this, unknown_instructions = nil;

        unknown_instructions = $rb_minus(instructions, $scope.get('INSTRUCTIONS'));
        if ((($a = unknown_instructions['$any?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          self.$raise($scope.get('InstructionError'), "unknown encode_entities command(s): " + (unknown_instructions.$inspect()))};
        if ((($a = ($b = instructions['$include?']("decimal"), $b !== false && $b !== nil && $b != null ?instructions['$include?']("hexadecimal") : $b)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return self.$raise($scope.get('InstructionError'), "hexadecimal and decimal encoding are mutually exclusive")
          } else {
          return nil
        };
      }, TMP_12.$$arity = 1);

      Opal.defn(self, '$build_basic_entity_encoder', TMP_13 = function ːbuild_basic_entity_encoder(instructions) {
        var $a, $b, self = this, method = nil;

        if ((($a = ((($b = instructions['$include?']("basic")) !== false && $b !== nil && $b != null) ? $b : instructions['$include?']("named"))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          method = "encode_named"
        } else if ((($a = instructions['$include?']("decimal")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          method = "encode_decimal"
        } else if ((($a = instructions['$include?']("hexadecimal")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          method = "encode_hexadecimal"};
        return self.$instance_eval("        def encode_basic(char)\n          " + (method) + "(char)\n        end\n");
      }, TMP_13.$$arity = 1);

      Opal.defn(self, '$build_extended_entity_encoder', TMP_15 = function ːbuild_extended_entity_encoder(instructions) {
        var $a, $b, TMP_14, self = this, operations = nil;

        operations = ["named", "decimal", "hexadecimal"]['$&'](instructions);
        return self.$instance_eval("        def encode_extended(char)\n          " + (($a = ($b = operations).$map, $a.$$p = (TMP_14 = function(encoder){var self = TMP_14.$$s || this;
if (encoder == null) encoder = nil;
        return "\n            encoded = encode_" + (encoder) + "(char)\n            return encoded if encoded\n          "}, TMP_14.$$s = self, TMP_14.$$arity = 1, TMP_14), $a).call($b).$join("\n")) + "\n          char\n        end\n");
      }, TMP_15.$$arity = 1);

      Opal.defn(self, '$encode_named', TMP_16 = function ːencode_named(char$) {
        var $a, self = this, cp = nil, e = nil;

        cp = char$.$unpack("U")['$[]'](0);
        return ($a = (e = self.$reverse_map()['$[]'](cp)), $a !== false && $a !== nil && $a != null ?"&" + (e) + ";" : $a);
      }, TMP_16.$$arity = 1);

      Opal.defn(self, '$encode_decimal', TMP_17 = function ːencode_decimal(char$) {
        var self = this;

        return "&#" + (char$.$unpack("U")['$[]'](0)) + ";";
      }, TMP_17.$$arity = 1);

      Opal.defn(self, '$encode_hexadecimal', TMP_18 = function ːencode_hexadecimal(char$) {
        var self = this;

        return "&#x" + (char$.$unpack("U")['$[]'](0).$to_s(16)) + ";";
      }, TMP_18.$$arity = 1);

      return (Opal.defn(self, '$reverse_map', TMP_20 = function ːreverse_map() {
        var $a, $b, $c, TMP_19, self = this, skips = nil, map = nil, uniqmap = nil;

        return ((($a = self.reverse_map) !== false && $a !== nil && $a != null) ? $a : self.reverse_map = (skips = (($scope.get('HTMLEntities')).$$scope.get('SKIP_DUP_ENCODINGS'))['$[]'](self.flavor), map = (($scope.get('HTMLEntities')).$$scope.get('MAPPINGS'))['$[]'](self.flavor), uniqmap = (function() {if (skips !== false && skips !== nil && skips != null) {
          return ($b = ($c = map).$reject, $b.$$p = (TMP_19 = function(ent, hx){var self = TMP_19.$$s || this;
if (ent == null) ent = nil;if (hx == null) hx = nil;
          return skips['$include?'](ent)}, TMP_19.$$s = self, TMP_19.$$arity = 2, TMP_19), $b).call($c)
          } else {
          return map
        }; return nil; })(), uniqmap.$invert()));
      }, TMP_20.$$arity = 0), nil) && 'reverse_map';
    })($scope.base, null);
  })($scope.base, null)
};
...
Opal.modules["htmlentities/decoder"] = function(Opal) {
  ...
  Opal.add_stubs(['$[]', '$entity_regexp', '$gsub', '$pack', '$to_i', '$prepare', '$private', '$encode', '$to_s', '$map', '$length', '$keys', '$==', '$-', '$min', '$max']);
  return (function($base, $super) {
    function $HTMLEntities(){};
    var self = $HTMLEntities = $klass($base, $super, 'HTMLEntities', $HTMLEntities);
    ...
    return (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_3, TMP_4, TMP_6;

      def.flavor = def.entity_regexp = def.map = nil;
      Opal.defn(self, '$initialize', TMP_1 = function ːinitialize(flavor) {
        var self = this;

        self.flavor = flavor;
        self.map = (($scope.get('HTMLEntities')).$$scope.get('MAPPINGS'))['$[]'](self.flavor);
        return self.entity_regexp = self.$entity_regexp();
      }, TMP_1.$$arity = 1);

      Opal.defn(self, '$decode', TMP_3 = function ːdecode(source) {
        var $a, $b, TMP_2, self = this;

        return ($a = ($b = self.$prepare(source)).$gsub, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $c, $d, $e, codepoint = nil;
          if (self.map == null) self.map = nil;

        if ((($c = ($d = (($e = $gvars['~']) === nil ? nil : $e['$[]'](1)), $d !== false && $d !== nil && $d != null ?codepoint = self.map['$[]']((($e = $gvars['~']) === nil ? nil : $e['$[]'](1))) : $d)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            return [codepoint].$pack("U")
          } else if ((($c = (($d = $gvars['~']) === nil ? nil : $d['$[]'](2))) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            return [(($c = $gvars['~']) === nil ? nil : $c['$[]'](2)).$to_i(10)].$pack("U")
          } else if ((($c = (($d = $gvars['~']) === nil ? nil : $d['$[]'](3))) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            return [(($c = $gvars['~']) === nil ? nil : $c['$[]'](3)).$to_i(16)].$pack("U")
            } else {
            return (($c = $gvars['~']) === nil ? nil : $c['$[]'](0))
          }}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $a).call($b, self.entity_regexp);
      }, TMP_3.$$arity = 1);

      self.$private();

      Opal.defn(self, '$prepare', TMP_4 = function ːprepare(string) {
        var self = this;

        return string.$to_s().$encode((($scope.get('Encoding')).$$scope.get('UTF_8')));
      }, TMP_4.$$arity = 1);

      return (Opal.defn(self, '$entity_regexp', TMP_6 = function ːentity_regexp() {
        var $a, $b, TMP_5, self = this, key_lengths = nil, entity_name_pattern = nil;

        key_lengths = ($a = ($b = self.map.$keys()).$map, $a.$$p = (TMP_5 = function(k){var self = TMP_5.$$s || this;
if (k == null) k = nil;
        return k.$length()}, TMP_5.$$s = self, TMP_5.$$arity = 1, TMP_5), $a).call($b);
        if (self.flavor['$==']("expanded")) {
          entity_name_pattern = "(?:b\\.)?[a-z][a-z0-9]"
          } else {
          entity_name_pattern = "[a-z][a-z0-9]"
        };
        return (new RegExp("&(?:(" + entity_name_pattern + "{" + $rb_minus(key_lengths.$min(), 1) + "," + $rb_minus(key_lengths.$max(), 1) + "})|#([0-9]{1,7})|#x([0-9a-f]{1,6}));"));
      }, TMP_6.$$arity = 0), nil) && 'entity_regexp';
    })($scope.base, null)
  })($scope.base, null)
};
...
Opal.modules["htmlentities/version"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    return (function($base) {
      ...
      Opal.cdecl($scope, 'MAJOR', 4);

      Opal.cdecl($scope, 'MINOR', 3);

      Opal.cdecl($scope, 'TINY', 3);

      Opal.cdecl($scope, 'STRING', [$scope.get('MAJOR'), $scope.get('MINOR'), $scope.get('TINY')].$join("."));
    })($scope.base)
  })($scope.base, null)
};
...
Opal.modules["htmlentities"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.cdecl($scope, 'UnknownFlavor', $scope.get('Class').$new($scope.get('RuntimeError')));
    ...
    Opal.defn(self, '$initialize', TMP_1 = function ːinitialize(flavor) {
      ...
      if ((($a = $scope.get('FLAVORS')['$include?'](self.flavor)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return nil
        } else {
        return self.$raise($scope.get('UnknownFlavor'), "Unknown flavor " + (flavor))
      };
    }, TMP_1.$$arity = -1);

    Opal.defn(self, '$decode', TMP_2 = function ːdecode(source) {
      var $a, self = this;

      return (((($a = self.decoder) !== false && $a !== nil && $a != null) ? $a : self.decoder = $scope.get('Decoder').$new(self.flavor))).$decode(source);
    }, TMP_2.$$arity = 1);

    return (Opal.defn(self, '$encode', TMP_3 = function ːencode(source, $a_rest) {
      ...
      return $scope.get('Encoder').$new(self.flavor, instructions).$encode(source);
    }, TMP_3.$$arity = -2), nil) && 'encode';
  })($scope.base, null);
};
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$process', TMP_1 = function ːprocess(document, output) {
        ...
        coder = $scope.get('HTMLEntities').$new();
...
Opal.modules["asciidoctor/latex/environment_block"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$use_dsl', '$named', '$on_context', '$[]', '$[]=', '$==', '$=~', '$gsub', '$!', '$include?', '$capitalize', '$warn', '$cyan', '$create_block', '$lines', '$counter_increment', '$document', '$assign_caption', '$title=']);
  self.$require("asciidoctor");
  self.$require("asciidoctor/extensions");
  self.$require("asciidoctor/latex/core_ext/colored_string");
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$process', TMP_1 = function ːprocess(parent, reader, attrs) {
        var $a, $b, self = this, original_title = nil, role = nil, env_name = nil, env_title = nil, block = nil, env_ref_prefix = nil, caption_num = nil, caption = nil;
        ...
        if ((($a = attrs['$[]']("role")['$=~'](/\\/)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          attrs['$[]=']("role", attrs['$[]']("role").$gsub(/\\/, ""))};
        if ((($a = (attrs['$[]']("options")['$=~'](/no_number|numbered/))['$!']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          if ((($a = ["capsule", "box", "equation", "equationalign"]['$include?'](role)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
            attrs['$[]=']("options", "no_number")
            } else {
            attrs['$[]=']("options", "numbered")
          }};
        if ((($a = attrs['$[]']("id")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          attrs['$[]=']("options", "numbered")};
        env_name = role;
        if ((($a = ["equation", "equationalign", "chem"]['$include?'](role)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          attrs['$[]=']("title", env_name)
        } else if (role['$==']("code")) {
          if ((($a = ((($b = attrs['$[]']("id")) !== false && $b !== nil && $b != null) ? $b : attrs['$[]']("title"))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
            attrs['$[]=']("title", "Listing")
            } else {
            attrs['$[]=']("title", "");
            attrs['$[]=']("options", "no_number");
        ...
        } else if ((($a = ((($b = role['$==']("box")) !== false && $b !== nil && $b != null) ? $b : role['$==']("capsule"))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          attrs['$[]=']("title", "")
          } else {
        ...
        if ((($a = attrs['$[]']("options")['$=~'](/numbered/)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          ...
          caption = "" + (caption_num);
          if (original_title !== false && original_title !== nil && original_title != null) {
            attrs['$[]=']("title", "" + (env_title) + " " + (caption_num) + ": " + (original_title))
            } else {
            attrs['$[]=']("title", "" + (env_title) + " " + (caption_num) + ".")
          };
        } else if (original_title !== false && original_title !== nil && original_title != null) {
          if ((($a = ["box"]['$include?'](role)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        ...
        if ((($a = ["equation", "equationalign", "chem"]['$include?'](role)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          (($a = ["" + (caption_num)]), $b = block, $b['$title='].apply($b, $a), $a[$a.length-1])
          } else {
          (($a = [attrs['$[]']("title")]), $b = block, $b['$title='].apply($b, $a), $a[$a.length-1])
        };
        return block;
      }, TMP_1.$$arity = 3), nil) && 'process';
    })($scope.base, (((($scope.get('Asciidoctor')).$$scope.get('Extensions'))).$$scope.get('BlockProcessor')));
...
Opal.modules["asciidoctor/latex/core_ext/utility"] = function(Opal) {
  ...
  Opal.add_stubs(['$each', '$macro', '$reverse', '$gsub', '$==', '$[]', '$+']);
  return (function($base, $super) {
    function $String(){};
    var self = $String = $klass($base, $super, 'String', $String);
    ...
    Opal.defn(self, '$macro', TMP_1 = function ːmacro(macro) {
      var self = this;

      return "\\" + (macro) + "{" + (self) + "}";
    }, TMP_1.$$arity = 1);

    Opal.defn(self, '$apply_macros', TMP_3 = function ːapply_macros(macro_list) {
      var $a, $b, TMP_2, self = this, val = nil;

      val = self;
      ($a = ($b = macro_list.$reverse()).$each, $a.$$p = (TMP_2 = function(macro_name){var self = TMP_2.$$s || this;
if (macro_name == null) macro_name = nil;
      return val = val.$macro(macro_name)}, TMP_2.$$s = self, TMP_2.$$arity = 1, TMP_2), $a).call($b);
      return val;
    }, TMP_3.$$arity = 1);

    return (Opal.defn(self, '$tex_normalize', TMP_4 = function ːtex_normalize() {
    ...
    }, TMP_4.$$arity = 0), nil) && 'tex_normalize';
  })($scope.base, null)
};
...
Opal.modules["asciidoctor/latex/node_processors"] = function(Opal) {
  ...
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $gvars = Opal.gvars, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$require', '$count', '$===', '$[]', '$each', '$macro', '$reverse', '$begin', '$strip', '$end', '$tex_normalize', '$include', '$embedded?', '$==', '$attributes', '$document', '$<<', '$exist?', '$read', '$open', '$join', '$doctype', '$doctitle', '$author', '$revdate', '$process_environments', '$content', '$capitalize', '$uniq', '$write', '$level', '$numbered', '$gsub', '$downcase', '$title', '$hypertarget', '$node_name', '$dlist_process', '$ulist_process', '$olist_process', '$text', '$text?', '$blocks?', '$items', '$blockname', '$paragraph_process', '$stem_process', '$admonition_process', '$page_break_process', '$literal_process', '$pass_process', '$quote_process', '$open_process', '$environment_process', '$click_process', '$listing_process', '$example_process', '$floating_title_process', '$image_process', '$preamble_process', '$sidebar_process', '$verse_process', '$toc_process', '$+', '$region', '$make_substitutions', '$role', '$include?', '$environment_type', '$stem_substitutions', '$style', '$id', '$env', '$attr?', '$attr', '$label', '$options', '$env_title', '$!', '$handle_listing', '$handle_eqalign', '$handle_equation', '$handle_chem', '$handle_box', '$handle_texmacro', '$handle_include_latex', '$handle_plain', '$puts', '$nil?', '$warn', '$magenta', '$cyan', '$yellow', '$green', '$red', '$split', '$/', '$to_f', '$match', '$!=', '$references', '$parent', '$rstrip', '$inline_quoted_process', '$inline_anchor_process', '$inline_break_process', '$inline_footnote_process', '$inline_callout_process', '$type', '$convert', '$target', '$body', '$rows', '$columns', '$*', '$each_with_index', '$scan', '$make_substitutions1', '$match_inline', '$>', '$make_substitutions_in_matches', '$match_block', '$tr']);
  self.$require("asciidoctor");
  self.$require("asciidoctor/latex/core_ext/colored_string");
  ...
  (function($base) {
    ...
    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_5, TMP_6, TMP_7, TMP_8, TMP_9;

    Opal.defs(self, '$macro', TMP_1 = function ːmacro(name, $a_rest) {
      var self = this, args, $case = nil;
      ...
      return (function() {$case = args.$count();if ((1)['$===']($case)) {return "\\" + (name) + "{" + (args['$[]'](0)) + "}"}else if ((2)['$===']($case)) {return "\\" + (name) + "{" + (args['$[]'](0)) + "}{" + (args['$[]'](1)) + "}"}else if ((3)['$===']($case)) {return "\\" + (name) + "{" + (args['$[]'](0)) + "}{" + (args['$[]'](1)) + "}{" + (args['$[]'](2)) + "}"}else {return ""}})();
    }, TMP_1.$$arity = -2);

    Opal.defs(self, '$region', TMP_2 = function ːregion(name, arg) {
      var self = this;

      return "{\\" + (name) + " " + (arg) + "}";
    }, TMP_2.$$arity = 2);

    Opal.defs(self, '$macro_opt', TMP_3 = function ːmacro_opt(name, opt, args) {
      var self = this, $case = nil;

      return (function() {$case = args.$count();if ((1)['$===']($case)) {return "\\" + (name) + "[" + (opt) + "]{" + (args['$[]'](0)) + "}"}else if ((2)['$===']($case)) {return "\\" + (name) + "[" + (opt) + "]{" + (args['$[]'](0)) + "}{" + (args['$[]'](1)) + "}"}else if ((3)['$===']($case)) {return "\\" + (name) + "[" + (opt) + "]{" + (args['$[]'](0)) + "}{" + (args['$[]'](1)) + "}{" + (args['$[]'](2)) + "}"}else {return ""}})();
    }, TMP_3.$$arity = 3);

    Opal.defs(self, '$apply_macros', TMP_5 = function ːapply_macros(macro_list, arg) {
      var $a, $b, TMP_4, self = this, val = nil;

      val = arg;
      ($a = ($b = macro_list.$reverse()).$each, $a.$$p = (TMP_4 = function(macro_name){var self = TMP_4.$$s || this;
if (macro_name == null) macro_name = nil;
      return val = self.$macro(macro_name, val)}, TMP_4.$$s = self, TMP_4.$$arity = 1, TMP_4), $a).call($b);
      return val;
    }, TMP_5.$$arity = 2);

    Opal.defs(self, '$begin', TMP_6 = function ːbegin(arg) {
      var self = this;

      return self.$macro("begin", arg);
    }, TMP_6.$$arity = 1);

    Opal.defs(self, '$end', TMP_7 = function ːend(arg) {
      var self = this;

      return self.$macro("end", arg);
    }, TMP_7.$$arity = 1);

    Opal.defs(self, '$env', TMP_8 = function ːenv(env, $a_rest) {
      var self = this, args, $case = nil;
      ...
      return (function() {$case = args.$count();if ((1)['$===']($case)) {return "" + (self.$begin(env)) + "\n" + (args['$[]'](0).$strip()) + "\n" + (self.$end(env)) + "\n"}else if ((2)['$===']($case)) {return "" + (self.$begin(env)) + "{" + (args['$[]'](0)) + "}\n" + (args['$[]'](1)) + "\n" + (self.$end(env)) + "\n"}else if ((3)['$===']($case)) {return "" + (self.$begin(env)) + "{" + (args['$[]'](0)) + "}{" + (args['$[]'](1)) + "}\n" + (args['$[]'](2)) + "\n" + (self.$end(env)) + "\n"}else {return ""}})();
    }, TMP_8.$$arity = -2);

    Opal.defs(self, '$hypertarget', TMP_9 = function ːhypertarget(name, text) {
      var self = this;

      if (text !== false && text !== nil && text != null) {};
      if (name !== false && name !== nil && name != null) {
  ...
  return (function($base) {
    ...
    self.$include($scope.get('TexUtilities'));

    $gvars.tex = $scope.get('TexUtilities');
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$tex_process', TMP_14 = function ːtex_process() {
        var $a, $b, TMP_10, $c, TMP_11, $d, TMP_12, $e, TMP_13, self = this, doc = nil, preamble = nil, macros = nil, processed_content = nil, definitions = nil;
        if ($gvars.latex_environment_names == null) $gvars.latex_environment_names = nil;

        doc = "";
        if ((($a = ((($b = self['$embedded?']()) !== false && $b !== nil && $b != null) ? $b : self.$document().$attributes()['$[]']("header")['$==']("no"))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          } else {
          doc['$<<']("%% Preamble %%\n");
          if ((($a = $scope.get('File')['$exist?']("preamble.tex")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
            preamble = $scope.get('IO').$read("preamble.tex");
            doc['$<<'](preamble)['$<<']("\n ");
            } else {
            doc['$<<'](($a = ($b = $scope.get('File')).$open, $a.$$p = (TMP_10 = function(f){var self = TMP_10.$$s || this;
if (f == null) f = nil;
            return f.$read()}, TMP_10.$$s = self, TMP_10.$$arity = 1, TMP_10), $a).call($b, $scope.get('File').$join((($scope.get('LaTeX')).$$scope.get('DATA_DIR')), "preamble_" + (self.$document().$doctype()) + ".tex"), "r"))
          };
          doc['$<<']("%% Asciidoc TeX Macros %%\n");
          doc['$<<'](($a = ($c = $scope.get('File')).$open, $a.$$p = (TMP_11 = function(f){var self = TMP_11.$$s || this;
if (f == null) f = nil;
          return f.$read()}, TMP_11.$$s = self, TMP_11.$$arity = 1, TMP_11), $a).call($c, $scope.get('File').$join((($scope.get('LaTeX')).$$scope.get('DATA_DIR')), "asciidoc_tex_macros.tex"), "r"));
          doc['$<<']("%% User Macros %%\n");
          if ((($a = $scope.get('File')['$exist?']("macros.tex")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
            macros = $scope.get('IO').$read("macros.tex");
            doc['$<<'](macros);};
          if ((($a = $scope.get('File')['$exist?']("myEnvironments.tex")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          ...
          doc['$<<']("\n\n\\begin{document}\n");
          doc['$<<']("\\maketitle\n");
          if ((($a = self.$attributes()['$[]']("toc")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
            doc['$<<']("\\tableofcontents\n")};
        };
        processed_content = (($scope.get('LaTeX')).$$scope.get('TeXBlock')).$process_environments(self.$content());
        doc['$<<'](processed_content);
        if ((($a = self['$embedded?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          } else {
          definitions = "";
          ($a = ($d = $gvars.latex_environment_names.$uniq()).$each, $a.$$p = (TMP_12 = function(name){var self = TMP_12.$$s || this;
if (name == null) name = nil;
          return definitions['$<<']("\\newtheorem{" + (name) + "}{" + (name.$capitalize()) + "}")['$<<']("\n")}, TMP_12.$$s = self, TMP_12.$$arity = 1, TMP_12), $a).call($d);
          ($a = ($e = $scope.get('File')).$open, $a.$$p = (TMP_13 = function(f){var self = TMP_13.$$s || this;
if (f == null) f = nil;
          return f.$write(definitions)}, TMP_13.$$s = self, TMP_13.$$arity = 1, TMP_13), $a).call($e, "newEnvironments.tex", "w");
        ...
        return doc['$<<']("\n");
      }, TMP_14.$$arity = 0), nil) && 'tex_process'
    })($scope.base, null);
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$tex_process', TMP_15 = function ːtex_process() {
        var $a, self = this, doctype = nil, tags = nil, tagname = nil, tagsuffix = nil, id = nil, heading = nil, value = nil;
        ...
        tagsuffix = (function() {if ((($a = self.$numbered()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return ""
          } else {
          return "*"
        }; return nil; })();
        ...
        value = "" + (heading) + "\n" + (self.$content());
        return value;
      }, TMP_15.$$arity = 0), nil) && 'tex_process'
    })($scope.base, null);
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_16, TMP_19, TMP_21, TMP_23;

      Opal.defn(self, '$tex_process', TMP_16 = function ːtex_process() {
        var self = this, $case = nil;

        return (function() {$case = self.$node_name();if ("dlist"['$===']($case)) {return self.$dlist_process()}else if ("ulist"['$===']($case)) {return self.$ulist_process()}else if ("olist"['$===']($case)) {return self.$olist_process()}else { return nil }})();
      }, TMP_16.$$arity = 0);

      Opal.defn(self, '$dlist_process', TMP_19 = function ːdlist_process() {
        var $a, $b, TMP_17, self = this, list = nil;

        list = "\\begin{description}\n\n";
        ($a = ($b = self.$items()).$each, $a.$$p = (TMP_17 = function(terms, dd){var self = TMP_17.$$s || this, $c, $d, TMP_18;
if (terms == null) terms = nil;if (dd == null) dd = nil;
        list['$<<']("\\item[");
          ($c = ($d = [].concat(Opal.to_a(terms))).$each, $c.$$p = (TMP_18 = function(dt){var self = TMP_18.$$s || this;
if (dt == null) dt = nil;
          return list['$<<'](dt.$text())}, TMP_18.$$s = self, TMP_18.$$arity = 1, TMP_18), $c).call($d);
          list['$<<']("]");
          if (dd !== false && dd !== nil && dd != null) {
            if ((($c = dd['$text?']()) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
              list['$<<'](dd.$text())['$<<']("\n\n")};
      ...
      Opal.defn(self, '$ulist_process', TMP_21 = function ːulist_process() {
        var $a, $b, TMP_20, self = this, list = nil;

        list = "\\begin{itemize}\n\n";
        ($a = ($b = self.$content()).$each, $a.$$p = (TMP_20 = function(item){var self = TMP_20.$$s || this;
if (item == null) item = nil;
        list['$<<']("\\item " + (item.$text()) + "\n\n");
          return list['$<<'](item.$content());}, TMP_20.$$s = self, TMP_20.$$arity = 1, TMP_20), $a).call($b);
        return list['$<<']("\\end{itemize}\n\n");
      }, TMP_21.$$arity = 0);

      return (Opal.defn(self, '$olist_process', TMP_23 = function ːolist_process() {
        var $a, $b, TMP_22, self = this, list = nil;

        list = "\\begin{enumerate}\n\n";
        ($a = ($b = self.$content()).$each, $a.$$p = (TMP_22 = function(item){var self = TMP_22.$$s || this;
if (item == null) item = nil;
        list['$<<'](item.$text().$macro("item"))['$<<']("\n\n");
          return list['$<<'](item.$content());}, TMP_22.$$s = self, TMP_22.$$arity = 1, TMP_22), $a).call($b);
        return list['$<<']("\\end{enumerate}\n\n");
      }, TMP_23.$$arity = 0), nil) && 'olist_process';
    })($scope.base, null);
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_24, TMP_25, TMP_26, TMP_27, TMP_28, TMP_29, TMP_30, TMP_31, TMP_32, TMP_33, TMP_34, TMP_35, TMP_36, TMP_37, TMP_38, TMP_39, TMP_40, TMP_41, TMP_42, TMP_43, TMP_44, TMP_45, TMP_46, TMP_47, TMP_48, TMP_49, TMP_50, TMP_51, TMP_52, TMP_53, TMP_54;

      Opal.cdecl($scope, 'STANDARD_ENVIRONMENT_NAMES', ["equation"]);

      Opal.defn(self, '$tex_process', TMP_24 = function ːtex_process() {
        var self = this, $case = nil;

        return (function() {$case = self.$blockname();if ("paragraph"['$===']($case)) {return self.$paragraph_process()}else if ("stem"['$===']($case)) {return self.$stem_process()}else if ("admonition"['$===']($case)) {return self.$admonition_process()}else if ("page_break"['$===']($case)) {return self.$page_break_process()}else if ("literal"['$===']($case)) {return self.$literal_process()}else if ("pass"['$===']($case)) {return self.$pass_process()}else if ("quote"['$===']($case)) {return self.$quote_process()}else if ("open"['$===']($case)) {return self.$open_process()}else if ("environment"['$===']($case)) {return self.$environment_process()}else if ("click"['$===']($case)) {return self.$click_process()}else if ("listing"['$===']($case)) {return self.$listing_process()}else if ("example"['$===']($case)) {return self.$example_process()}else if ("floating_title"['$===']($case)) {return self.$floating_title_process()}else if ("image"['$===']($case)) {return self.$image_process()}else if ("preamble"['$===']($case)) {return self.$preamble_process()}else if ("sidebar"['$===']($case)) {return self.$sidebar_process()}else if ("verse"['$===']($case)) {return self.$verse_process()}else if ("toc"['$===']($case)) {return self.$toc_process()}else {return ""}})();
      }, TMP_24.$$arity = 0);

      Opal.defn(self, '$paragraph_process', TMP_25 = function ːparagraph_process() {
        var $a, $b, self = this, options = nil, out = nil, title = nil, content = nil;
        if ($gvars.tex == null) $gvars.tex = nil;

        options = self.$attributes()['$[]']("options");
        out = "";
        if ((($a = self.$attributes()['$[]']("title")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          title = "" + (self.$attributes()['$[]']("title")) + ".";
          out['$<<']($rb_plus($gvars.tex.$region("bf", title), " "));};
        content = (($scope.get('LaTeX')).$$scope.get('TeXPostProcess')).$make_substitutions(self.$content());
        if (self.$role()['$==']("red")) {
          content = content.$macro("rolered")
        } else if (self.$role()['$==']("blue")) {
          content = content.$macro("roleblue")};
        if ((($a = (($b = options !== false && options !== nil && options != null) ? options['$include?']("hardbreaks") : options)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {};
        return out['$<<'](content)['$<<']("\n\n");
      }, TMP_25.$$arity = 0);

      Opal.defn(self, '$stem_process', TMP_26 = function ːstem_process() {
        var $a, self = this, environment = nil;

        environment = (($scope.get('LaTeX')).$$scope.get('TeXBlock')).$environment_type(self.$content());
        if ((($a = (((($scope.get('LaTeX')).$$scope.get('TeXBlock'))).$$scope.get('INNER_TYPES'))['$include?'](environment)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return "\\[\n" + ((($scope.get('LaTeX')).$$scope.get('TeXPostProcess')).$stem_substitutions(self.$content())) + "\n\\]\n"
          } else {
          return self.$content()
        };
      }, TMP_26.$$arity = 0);

      Opal.defn(self, '$admonition_process', TMP_27 = function ːadmonition_process() {
        var self = this;
        if ($gvars.tex == null) $gvars.tex = nil;
      ...
      Opal.defn(self, '$page_break_process', TMP_28 = function ːpage_break_process() {
        var self = this;

        return "\n\\vfill\\eject\n";
      }, TMP_28.$$arity = 0);

      Opal.defn(self, '$literal_process', TMP_29 = function ːliteral_process() {
        var $a, $b, self = this, heading = nil, output = nil;
        if ($gvars.tex == null) $gvars.tex = nil;

        heading = "";
        if ((($a = ($b = self.$id(), $b !== false && $b !== nil && $b != null ?self.$title() : $b)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
      ...
      Opal.defn(self, '$pass_process', TMP_30 = function ːpass_process() {
        var self = this;

        return self.$content();
      }, TMP_30.$$arity = 0);

      Opal.defn(self, '$quote_process', TMP_31 = function ːquote_process() {
        var $a, self = this, attribution = nil, citetitle = nil;
        if ($gvars.tex == null) $gvars.tex = nil;

        if ((($a = self['$attr?']("attribution")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          attribution = self.$attr("attribution");
          citetitle = (function() {if ((($a = (self['$attr?']("citetitle"))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
            return (self.$attr("citetitle"))
            } else {
            return nil
          }; return nil; })();
          citetitle = (function() {if (citetitle !== false && citetitle !== nil && citetitle != null) {
      ...
      Opal.defn(self, '$label', TMP_32 = function ːlabel() {
        var $a, self = this, label = nil;
        if ($gvars.tex == null) $gvars.tex = nil;
      ...
      Opal.defn(self, '$options', TMP_33 = function ːoptions() {
        var self = this;

        return self.$attributes()['$[]']("options");
      }, TMP_33.$$arity = 0);

      Opal.defn(self, '$env_title', TMP_34 = function ːenv_title() {
        var $a, self = this;

        if ((($a = self.$attributes()['$[]']("original_title")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
      ...
      Opal.defn(self, '$handle_listing', TMP_35 = function ːhandle_listing() {
        var self = this, content = nil;
        if ($gvars.tex == null) $gvars.tex = nil;
      ...
      Opal.defn(self, '$handle_eqalign', TMP_36 = function ːhandle_eqalign() {
        var $a, self = this, content = nil;
        if ($gvars.tex == null) $gvars.tex = nil;

        if ((($a = self.$options()['$include?']("numbered")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          content = $gvars.tex.$env("split", $rb_plus($rb_plus(self.$label(), "\n"), self.$content().$strip()));
          return $gvars.tex.$env("equation", content);
          } else {
          content = $gvars.tex.$env("split", $rb_plus($rb_plus(self.$label(), "\n"), self.$content().$strip()));
          return $gvars.tex.$env("equation*", content);
        };
      ...
      Opal.defn(self, '$handle_equation', TMP_37 = function ːhandle_equation() {
        var $a, self = this, content = nil;
        if ($gvars.tex == null) $gvars.tex = nil;

        if ((($a = self.$options()['$include?']("numbered")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          content = $gvars.tex.$hypertarget(self.$id(), self.$content().$strip());
          return $gvars.tex.$env("equation", "" + (self.$label()) + (content));
          } else {
          return $gvars.tex.$env("equation*", "" + (self.$label()) + (self.$content().$strip()))
        };
      }, TMP_37.$$arity = 0);

      Opal.defn(self, '$handle_chem', TMP_38 = function ːhandle_chem() {
        var self = this;
        if ($gvars.tex == null) $gvars.tex = nil;

        return $gvars.tex.$env("equation", "" + (self.$label()) + "\n\\ce{" + (self.$content().$strip()) + "}\n");
      }, TMP_38.$$arity = 0);

      Opal.defn(self, '$handle_plain', TMP_39 = function ːhandle_plain(env) {
        var $a, $b, self = this, _title = nil, content = nil;
        if ($gvars.tex == null) $gvars.tex = nil;
        ...
        if ((($a = self.$attributes()['$[]']("plain-option")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          content = $gvars.tex.$region("rm", self.$content())
          } else {
          content = self.$content()
        };
        return $gvars.tex.$env(env, "" + (_title) + (self.$label()) + (content) + "\n");
      }, TMP_39.$$arity = 1);

      Opal.defn(self, '$environment_process', TMP_40 = function ːenvironment_process() {
        var $a, $b, self = this, env = nil, $case = nil;
        if ($gvars.latex_environment_names == null) $gvars.latex_environment_names = nil;

        env = self.$attributes()['$[]']("role");
        if ((($a = ($b = $scope.get('STANDARD_ENVIRONMENT_NAMES')['$include?'](env)['$!'](), $b !== false && $b !== nil && $b != null ?$gvars.latex_environment_names['$include?'](env)['$!']() : $b)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          $gvars.latex_environment_names['$<<'](env)};
        return (function() {$case = env;if ("listing"['$===']($case)) {return self.$handle_listing()}else if ("equationalign"['$===']($case)) {return self.$handle_eqalign()}else if ("equation"['$===']($case)) {return self.$handle_equation()}else if ("chem"['$===']($case)) {return self.$handle_chem()}else if ("box"['$===']($case)) {return self.$handle_box()}else if ("texmacro"['$===']($case)) {return self.$handle_texmacro()}else if ("include_latex"['$===']($case)) {return self.$handle_include_latex()}else {return self.$handle_plain(env)}})();
      }, TMP_40.$$arity = 0);

      Opal.defn(self, '$handle_texmacro', TMP_41 = function ːhandle_texmacro() {
        var self = this;

        return "%% User tex macros:\n" + (self.$content()) + "\n%% end of user macros\n";
      }, TMP_41.$$arity = 0);

      Opal.defn(self, '$handle_include_latex', TMP_42 = function ːhandle_include_latex() {
        var self = this;
      ...
      Opal.defn(self, '$handle_box', TMP_43 = function ːhandle_box() {
        var $a, $b, self = this;
        if ($gvars.tex == null) $gvars.tex = nil;

        if ((($a = ((($b = self.$title()['$nil?']()) !== false && $b !== nil && $b != null) ? $b : self.$title()['$=='](""))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
      ...
      Opal.defn(self, '$click_process', TMP_44 = function ːclick_process() {
        var $a, $b, self = this, attr = nil, click = nil, title = nil, content = nil, env = nil, label = nil;
        if ($gvars.latex_environment_names == null) $gvars.latex_environment_names = nil;
        if ($gvars.tex == null) $gvars.tex = nil;

        attr = self.$attributes();
        click = self.$attributes()['$[]']("role");
        if ((($a = $scope.get('STANDARD_ENVIRONMENT_NAMES')['$include?'](click)['$!']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          $gvars.latex_environment_names['$<<'](click)};
        if ((($a = self.$title()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          title = self.$title().$downcase()};
        if ((($a = attr['$[]']("plain-option")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          content = $gvars.tex.$region("rm", self.$content())
          } else {
          content = $gvars.tex.$region("it", self.$content())
        };
        if ((($a = attr['$[]']("original_title")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          if ((($a = ($b = attr['$[]']("options"), $b !== false && $b !== nil && $b != null ?attr['$[]']("options")['$include?']("numbered") : $b)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
      ...
      Opal.defn(self, '$toc_process', TMP_45 = function ːtoc_process() {
        var self = this;

        return nil;
      }, TMP_45.$$arity = 0);

      Opal.defn(self, '$report', TMP_46 = function ːreport() {
        var $a, self = this;
      ...
      Opal.defn(self, '$open_process', TMP_47 = function ːopen_process() {
      ...
      Opal.defn(self, '$listing_process', TMP_48 = function ːlisting_process() {
        var self = this;

        return "\\begin{verbatim}\n" + (self.$content()) + "\n\\end{verbatim}\n";
      }, TMP_48.$$arity = 0);

      Opal.defn(self, '$example_process', TMP_49 = function ːexample_process() {
        var $a, self = this, id = nil, heading = nil, content = nil, hypertarget = nil;
        if ($gvars.tex == null) $gvars.tex = nil;
      ...
      Opal.defn(self, '$floating_title_process', TMP_50 = function ːfloating_title_process() {
      ...
      Opal.defn(self, '$image_process', TMP_51 = function ːimage_process() {
        var $a, $b, self = this, width = nil, raw_image = nil, image_rx = nil, match_data = nil, image = nil, caption = nil, refs = nil, align = nil, float$ = nil, figure_type = nil, ftext_width = nil, text_width = nil, $case = nil, position = nil;

        if ((($a = self.$attributes()['$[]']("width")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        ...
        if (self.$document().$attributes()['$[]']("noteshare")['$==']("yes")) {
          ...
          if (match_data !== false && match_data !== nil && match_data != null) {
            image = match_data['$[]'](1)
            } else {
            image = "undefined"
          };
        ...
        if ((($a = ($b = self.$title(), $b !== false && $b !== nil && $b != null ?self.$title()['$!=']("") : $b)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        ...
        if (float$ !== false && float$ !== nil && float$ != null) {
        ...
        $case = float$;if ("left"['$===']($case)) {position = "{l}"}else if ("right"['$===']($case)) {position = "{r}"}else {position = "[h]"};
        return "\\begin{" + (figure_type) + "}" + (position) + "{" + (ftext_width) + "}\n\\centering\\includegraphics[width=" + (width) + "]{" + (image) + "}\n" + (caption) + "\n" + (align) + "\n\\end{" + (figure_type) + "}\n";
      }, TMP_51.$$arity = 0);

      Opal.defn(self, '$preamble_process', TMP_52 = function ːpreamble_process() {
        var self = this;

        return self.$content();
      }, TMP_52.$$arity = 0);

      Opal.defn(self, '$sidebar_process', TMP_53 = function ːsidebar_process() {
        ...
        if (title !== false && title !== nil && title != null) {
          ...
          return $gvars.tex.$env("sidebar", "" + (title) + "\\\\" + (content));
          } else {
          return $gvars.tex.$env("sidebar", content)
        };
      }, TMP_53.$$arity = 0);

      return (Opal.defn(self, '$verse_process', TMP_54 = function ːverse_process() {
        var self = this;
        if ($gvars.tex == null) $gvars.tex = nil;

        return $gvars.tex.$env("verse", self.$content());
      }, TMP_54.$$arity = 0), nil) && 'verse_process';
    })($scope.base, null);
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_55, TMP_56, TMP_57, TMP_58, TMP_59, TMP_60;

      Opal.defn(self, '$tex_process', TMP_55 = function ːtex_process() {
        var self = this, $case = nil;

        return (function() {$case = self.$node_name();if ("inline_quoted"['$===']($case)) {return self.$inline_quoted_process()}else if ("inline_anchor"['$===']($case)) {return self.$inline_anchor_process()}else if ("inline_break"['$===']($case)) {return self.$inline_break_process()}else if ("inline_footnote"['$===']($case)) {return self.$inline_footnote_process()}else if ("inline_callout"['$===']($case)) {return self.$inline_callout_process()}else {return ""}})();
      }, TMP_55.$$arity = 0);

      Opal.defn(self, '$inline_quoted_process', TMP_56 = function ːinline_quoted_process() {
        var self = this, $case = nil, output = nil, role = nil;

        return (function() {$case = self.$type();if ("strong"['$===']($case)) {return "\\textbf{" + (self.$text()) + "}"}else if ("emphasis"['$===']($case)) {return "\\emph{" + (self.$text()) + "}"}else if ("asciimath"['$===']($case)) {output = $scope.get('Asciidoctor').$convert(self.$text(), $hash2(["backend"], {"backend": "html"}));
        return output;}else if ("monospaced"['$===']($case)) {return "\\texttt{" + (self.$text()) + "}"}else if ("superscript"['$===']($case)) {return "${}^{" + (self.$text()) + "}$"}else if ("subscript"['$===']($case)) {return "${}_{" + (self.$text()) + "}$"}else if ("mark"['$===']($case)) {return "\\colorbox{yellow}{ " + (self.$text()) + "}"}else if ("double"['$===']($case)) {return "``" + (self.$text()) + "''"}else if ("single"['$===']($case)) {return "`" + (self.$text()) + "'"}else if ("latexmath"['$===']($case)) {"\\(" + ((($scope.get('LaTeX')).$$scope.get('TeXPostProcess')).$stem_substitutions(self.$text())) + "\\)";
        return self.$text();}else if ("unquoted"['$===']($case)) {role = self.$attributes()['$[]']("role");
        if (role['$==']("red")) {
          ...
          return nil
        };}else if ("literal"['$===']($case)) {return "\\texttt{" + (self.$text()) + "}"}else if ("verse"['$===']($case)) {return "\\texttt{" + (self.$text()) + "}"}else {return "\\unknown:" + (self.$type()) + "\\{" + (self.$text()) + "\\}"}})();
      }, TMP_56.$$arity = 0);

      Opal.defn(self, '$inline_anchor_process', TMP_57 = function ːinline_anchor_process() {
        ...
        if ((($a = refs['$[]'](refid)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        ...
        return (function() {$case = self.$type();if ("link"['$===']($case)) {return $gvars.tex.$macro("href", self.$target(), self.$text())}else if ("ref"['$===']($case)) {return $gvars.tex.$macro("label", self.$text().$gsub(/\[(.*?)\]/, "\\1"))}else if ("xref"['$===']($case)) {return $gvars.tex.$macro("hyperlink", refid.$tex_normalize(), reftext)}else { return nil }})();
      }, TMP_57.$$arity = 0);

      Opal.defn(self, '$inline_break_process', TMP_58 = function ːinline_break_process() {
        var self = this;

        return "" + (self.$text()) + " \\\\";
      }, TMP_58.$$arity = 0);

      Opal.defn(self, '$inline_footnote_process', TMP_59 = function ːinline_footnote_process() {
        var self = this;
        if ($gvars.tex == null) $gvars.tex = nil;
      ...
      return (Opal.defn(self, '$inline_callout_process', TMP_60 = function ːinline_callout_process() {
        var self = this;

        return nil;
      }, TMP_60.$$arity = 0), nil) && 'inline_callout_process';
    })($scope.base, null);
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_63;

      return (Opal.defn(self, '$tex_process', TMP_63 = function ːtex_process() {
        var $a, $b, TMP_61, self = this, n_rows = nil, n_columns = nil, alignment = nil, output = nil;
        ...
        output['$<<']("\\hline\n");
        ($a = ($b = self.$rows().$body()).$each_with_index, $a.$$p = (TMP_61 = function(row, index){var self = TMP_61.$$s || this, $c, $d, TMP_62, row_array = nil;
if (row == null) row = nil;if (index == null) index = nil;
        row_array = [];
          ($c = ($d = row).$each, $c.$$p = (TMP_62 = function(cell){var self = TMP_62.$$s || this;
if (cell == null) cell = nil;
          return row_array['$<<'](cell.$content()['$[]'](0))}, TMP_62.$$s = self, TMP_62.$$arity = 1, TMP_62), $c).call($d);
          output['$<<'](row_array.$join(" & "));
          return output['$<<'](" \\\\ \n");}, TMP_61.$$s = self, TMP_61.$$arity = 2, TMP_61), $a).call($b);
        output['$<<']("\\hline\n");
        output['$<<']("\\end{tabular}\n");
        output['$<<']("\\end{center}\n");
        return "" + (output);
      }, TMP_63.$$arity = 0), nil) && 'tex_process'
    })($scope.base, null);
    ...
    (function($base) {
      ...
      (function($base) {
        ...
        var def = self.$$proto, $scope = self.$$scope, TMP_64, TMP_65, TMP_66, TMP_68, TMP_69, TMP_70;

        Opal.defs(self, '$match_inline', TMP_64 = function ːmatch_inline(str) {
        ...
        Opal.defs(self, '$match_block', TMP_65 = function ːmatch_block(str) {
        ...
        Opal.defs(self, '$make_substitutions1', TMP_66 = function ːmake_substitutions1(str) {
          var self = this;
        ...
        Opal.defs(self, '$make_substitutions_in_matches', TMP_68 = function ːmake_substitutions_in_matches(matches, str) {
          var $a, $b, TMP_67, self = this;

          ($a = ($b = matches).$each, $a.$$p = (TMP_67 = function(m){var self = TMP_67.$$s || this, m_str = nil, m_transformed = nil;
if (m == null) m = nil;
          m_str = m['$[]'](0);
            m_transformed = self.$make_substitutions1(m_str);
            return str = str.$gsub(m_str, m_transformed);}, TMP_67.$$s = self, TMP_67.$$arity = 1, TMP_67), $a).call($b);
          return str;
        }, TMP_68.$$arity = 2);

        Opal.defs(self, '$make_substitutions', TMP_69 = function ːmake_substitutions(str) {
          var $a, self = this, matches = nil;

          str = str.$gsub("\\\\", "@@");
          matches = self.$match_inline(str);
          if ((($a = $rb_gt(matches.$count(), 0)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        ...
        Opal.defs(self, '$stem_substitutions', TMP_70 = function ːstem_substitutions(str) {
          var self = this;
...
Opal.modules["asciidoctor/latex/prepend_processor"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$putline', TMP_1 = function ːputline(line) {
        var $a, self = this;

        return (Opal.cvars['@@line_array'] = $rb_plus((($a = Opal.cvars['@@line_array']) == null ? nil : $a), [line, ""]));
      }, TMP_1.$$arity = 1);

      return (Opal.defn(self, '$process', TMP_2 = function ːprocess(document, reader) {
        var $a, self = this;
        if ($gvars["VERBOSE"] == null) $gvars["VERBOSE"] = nil;

        if ((($a = $gvars["VERBOSE"]) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          self.$warn("Entering ClickStyleInsert".$magenta())};
        (Opal.cvars['@@line_array'] = []);
        if ((($a = reader['$eof?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return reader};
        self.$putline("++++");
        self.$putline("<style>");
        ...
        self.$putline("</style>");
        self.$putline("++++");
        reader.$unshift_lines((($a = Opal.cvars['@@line_array']) == null ? nil : $a));
        return reader;
      }, TMP_2.$$arity = 2), nil) && 'process';
    })($scope.base, (((($scope.get('Asciidoctor')).$$scope.get('Extensions'))).$$scope.get('Preprocessor')))
  })($scope.get('Asciidoctor'));
};
...
Opal.modules["asciidoctor/latex/macro_insert"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$process', TMP_3 = function ːprocess(document, reader) {
        var $a, $b, TMP_2, self = this, file_contents = nil, lines = nil;
        if ($gvars["VERBOSE"] == null) $gvars["VERBOSE"] = nil;

        file_contents = $scope.get('IO').$read("macros.tex");
        if (file_contents['$=='](nil)) {
          file_contents = $scope.get('IO').$read("public/macros.tex")};
        if (file_contents !== false && file_contents !== nil && file_contents != null) {
          if ((($a = $gvars["VERBOSE"]) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
            self.$warn(((("In MacroInsert, file_contents: ") + (file_contents.$length())) + " chars read").$yellow())}
        } else if ((($a = $gvars["VERBOSE"]) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        ...
        ($a = ($b = lines).$each, $a.$$p = (TMP_2 = function(line){var self = TMP_2.$$s || this;
if (line == null) line = nil;
        return self.$putline(line)}, TMP_2.$$s = self, TMP_2.$$arity = 1, TMP_2), $a).call($b);
        self.$putline("\\)");
        self.$putline("</div>");
        self.$putline("++++");
        reader.$unshift_lines((($a = Opal.cvars['@@line_array']) == null ? nil : $a));
        return reader;
      }, TMP_3.$$arity = 2), nil) && 'process';
    })($scope.base, (((($scope.get('Asciidoctor')).$$scope.get('Extensions'))).$$scope.get('Preprocessor')))
  })($scope.get('Asciidoctor'));
};
...
Opal.modules["asciidoctor/latex/tex_block"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      Opal.defs(self, '$get_tex_blocks', TMP_1 = function ːget_tex_blocks(str) {
        var self = this, rx_tex_block = nil;
      ...
      Opal.defs(self, '$environment_type', TMP_2 = function ːenvironment_type(str) {
        var self = this, rx_env_block = nil, m = nil, env_type = nil;

        rx_env_block = /\\begin\{(.*?)\}/;
        m = str.$match(rx_env_block);
        if (m !== false && m !== nil && m != null) {
          env_type = m['$[]'](1)
          } else {
          env_type = "none"
        };
      ...
      Opal.defs(self, '$environmemt_type_of_match', TMP_3 = function ːenvironmemt_type_of_match(m) {
        var self = this;

        return self.$environment_type(m['$[]'](1));
      }, TMP_3.$$arity = 1);

      Opal.defs(self, '$restore_match_data', TMP_4 = function ːrestore_match_data(m) {
        var self = this;

        return m.$join();
      }, TMP_4.$$arity = 1);

      Opal.defs(self, '$strip_match_data', TMP_5 = function ːstrip_match_data(m) {
        var self = this;

        return m['$[]'](1);
      }, TMP_5.$$arity = 1);

      Opal.defs(self, '$process_tex_block', TMP_6 = function ːprocess_tex_block(m, str) {
        var $a, self = this, block_type = nil, output = nil;

        block_type = self.$environmemt_type_of_match(m);
        if ((($a = $scope.get('INNER_TYPES')['$include?'](block_type)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          output = str
          } else {
      ...
      Opal.defs(self, '$process_environments', TMP_8 = function ːprocess_environments(str) {
        var $a, $b, TMP_7, self = this, tbs = nil;

        tbs = self.$get_tex_blocks(str);
        ($a = ($b = tbs).$each, $a.$$p = (TMP_7 = function(tb){var self = TMP_7.$$s || this;
if (tb == null) tb = nil;
        return str = self.$process_tex_block(tb, str)}, TMP_7.$$s = self, TMP_7.$$arity = 1, TMP_7), $a).call($b);
        return str;
      }, TMP_8.$$arity = 1);

      Opal.cdecl($scope, 'INNER_TYPES', ["array", "matrix", "none"]);
    })($scope.base)
  })($scope.get('Asciidoctor'))
};
...
Opal.modules["asciidoctor/latex/tex_preprocessor"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$eof?', '$map', '$include?', '$basebackend?', '$gsub', '$=~', '$read_lines', '$unshift_lines']);
  self.$require("asciidoctor");
  self.$require("asciidoctor/extensions");
  return (function($base) {
    var $LaTeX, self = $LaTeX = $module($base, 'LaTeX');
    ...
    (function($base, $super) {
      ...
      Opal.cdecl($scope, 'TEX_DOLLAR_RX', /\$(.*?)\$/);

      Opal.cdecl($scope, 'TEX_DOLLAR_SUB', "pass:[\\\\(\\1\\\\)]");

      return (Opal.defn(self, '$process', TMP_2 = function ːprocess(document, reader) {
        var $a, $b, TMP_1, self = this, replacement_lines = nil;

        if ((($a = reader['$eof?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return reader};
        replacement_lines = ($a = ($b = reader.$read_lines()).$map, $a.$$p = (TMP_1 = function(line){var self = TMP_1.$$s || this, $c, $d;
if (line == null) line = nil;
        if ((($c = ($d = line['$include?']("<-->"), $d !== false && $d !== nil && $d != null ?document['$basebackend?']("tex") : $d)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            line = line.$gsub("<-->", "CHEMLEFTRIGHTARROW")};
          if ((($c = ($d = line['$include?']("->"), $d !== false && $d !== nil && $d != null ?document['$basebackend?']("tex") : $d)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            line = line.$gsub("->", "CHEMRIGHTARROW")};
          if ((($c = ($d = line['$include?']("<-"), $d !== false && $d !== nil && $d != null ?document['$basebackend?']("tex") : $d)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            line = line.$gsub("<-", "CHEMLEFTARROW")};
          if ((($c = ($d = line['$include?']("\\&"), $d !== false && $d !== nil && $d != null ?document['$basebackend?']("html") : $d)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            line = line.$gsub("\\&", "ESCAMPERSAND")};
          if ((($c = ($d = line['$include?']("\\_"), $d !== false && $d !== nil && $d != null ?document['$basebackend?']("html") : $d)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            line = line.$gsub("\\_", "ESCUNDERSCORE")};
          if ((($c = ($d = line['$include?']("\\"), $d !== false && $d !== nil && $d != null ?document['$basebackend?']("html") : $d)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            line = line.$gsub("\\$", "ESCDOLLAR")};
          if ((($c = line['$include?']("$")) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            line = line.$gsub($scope.get('TEX_DOLLAR_RX'), $scope.get('TEX_DOLLAR_SUB'))};
          if ((($c = line['$=~'](/^\\\[/)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            line = line.$gsub("\\[", "+++\n\\[")};
          if ((($c = line['$=~'](/^\\\]/)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            line = line.$gsub("\\]", "\\]\n+++\n")};
          return line;}, TMP_1.$$s = self, TMP_1.$$arity = 1, TMP_1), $a).call($b);
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$process', TMP_4 = function ːprocess(document, reader) {
        var $a, $b, TMP_3, self = this, replacement_lines = nil;

        if ((($a = reader['$eof?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return reader};
        replacement_lines = ($a = ($b = reader.$read_lines()).$map, $a.$$p = (TMP_3 = function(line){var self = TMP_3.$$s || this, $c, $d;
if (line == null) line = nil;
        if ((($c = ($d = line['$include?']("$"), $d !== false && $d !== nil && $d != null ?document['$basebackend?']("tex") : $d)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            line = line.$gsub("$", "\\$")};
          return line;}, TMP_3.$$s = self, TMP_3.$$arity = 1, TMP_3), $a).call($b);
        reader.$unshift_lines(replacement_lines);
        return reader;
      }, TMP_4.$$arity = 2), nil) && 'process'
    })($scope.base, (((($scope.get('Asciidoctor')).$$scope.get('Extensions'))).$$scope.get('Preprocessor')));
  })($scope.get('Asciidoctor'));
};
...
Opal.modules["asciidoctor/latex/macro_preprocessor"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$eof?', '$map', '$include?', '$scan', '$each', '$[]', '$puts', '$red', '$gsub', '$read_lines', '$unshift_lines']);
  self.$require("asciidoctor");
  self.$require("asciidoctor/extensions");
  return (function($base) {
    var $LaTeX, self = $LaTeX = $module($base, 'LaTeX');
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$process', TMP_3 = function ːprocess(document, reader) {
        var $a, $b, TMP_1, self = this, regex = nil, replacement_lines = nil;

        regex = /{{(.*?)}}/;
        if ((($a = reader['$eof?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return reader};
        replacement_lines = ($a = ($b = reader.$read_lines()).$map, $a.$$p = (TMP_1 = function(line){var self = TMP_1.$$s || this, $c, $d, TMP_2, scan = nil;
if (line == null) line = nil;
        if ((($c = line['$include?']("{{")) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            scan = line.$scan(regex);
            ($c = ($d = scan).$each, $c.$$p = (TMP_2 = function(match){var self = TMP_2.$$s || this, target = nil;
if (match == null) match = nil;
            target = match['$[]'](0);
              self.$puts((("target: ") + (target)).$red());
              return line = line.$gsub("{{" + (target) + "}}", "glossterm::[" + (target) + "]");}, TMP_2.$$s = self, TMP_2.$$arity = 1, TMP_2), $c).call($d);};
          return line;}, TMP_1.$$s = self, TMP_1.$$arity = 1, TMP_1), $a).call($b);
        reader.$unshift_lines(replacement_lines);
        return reader;
      }, TMP_3.$$arity = 2), nil) && 'process'
...
Opal.modules["asciidoctor/latex/tex_postprocessor"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$process', TMP_2 = function ːprocess(document, output) {
        var self = this;
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$process', TMP_1 = function ːprocess(document, output) {
        ...
        return output.$gsub($scope.get('TEX_SNIPPET'), $scope.get('CHEM_SNIPPET'));
      }, TMP_1.$$arity = 2), nil) && 'process'
    })($scope.base, (((($scope.get('Asciidoctor')).$$scope.get('Extensions'))).$$scope.get('Postprocessor')));

    Opal.cdecl($scope, 'TEX_SNIPPET', "TeX: { equationNumbers: { autoNumber: \"none\" } }");

    Opal.cdecl($scope, 'CHEM_SNIPPET', "TeX: { extensions: [\"mhchem.js\"] }");
  })($scope.get('Asciidoctor'));
};
...
Opal.modules["asciidoctor/latex/sectnumoffset-treeprocessor"] = function(Opal) {
  ...
  Opal.add_stubs(['$==', '$include', '$register', '$treeprocessor', '$process', '$attr?', '$>', '$to_i', '$attr', '$warn', '$red', '$cyan', '$each', '$<=', '$level', '$+', '$number=', '$number', '$find_by']);
  if ($scope.get('RUBY_ENGINE')['$==']("opal")) {};
  self.$include(Opal.get('Asciidoctor'));
  return ($a = ($b = $scope.get('Extensions')).$register, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, $c, $d, TMP_2;

  return ($c = ($d = self).$treeprocessor, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $e, $f, TMP_3;

    return ($e = ($f = self).$process, $e.$$p = (TMP_3 = function(document){var self = TMP_3.$$s || this, $g, $h, TMP_4, $i, sectnumoffset = nil, subsectnumoffset = nil, section_count = nil;
        if ($gvars["VERBOSE"] == null) $gvars["VERBOSE"] = nil;
if (document == null) document = nil;
      if ((($g = ($h = (document['$attr?']("sectnums")), $h !== false && $h !== nil && $h != null ?$rb_gt((sectnumoffset = (document.$attr("sectnumoffset", 0)).$to_i()), 0) : $h)) !== nil && $g != null && (!$g.$$is_boolean || $g == true))) {
          subsectnumoffset = (document.$attr("subsectnumoffset", 0)).$to_i();
          if ((($g = $gvars["VERBOSE"]) !== nil && $g != null && (!$g.$$is_boolean || $g == true))) {
            self.$warn((("subsectnumoffset: ") + (subsectnumoffset)).$red())};
          section_count = 0;
          if ((($g = $rb_gt(subsectnumoffset, 0)) !== nil && $g != null && (!$g.$$is_boolean || $g == true))) {
            if ((($g = $gvars["VERBOSE"]) !== nil && $g != null && (!$g.$$is_boolean || $g == true))) {
              self.$warn((("Insert parent section at 'head' of document with offset ") + (sectnumoffset)).$cyan())}};
          ($g = ($h = (((($i = (document.$find_by($hash2(["context"], {"context": "section"})))) !== false && $i !== nil && $i != null) ? $i : []))).$each, $g.$$p = (TMP_4 = function(sect){var self = TMP_4.$$s || this, $i, $j;
if (sect == null) sect = nil;
          if ((($i = $rb_le(sect.$level(), 2)) !== nil && $i != null && (!$i.$$is_boolean || $i == true))) {
              } else {
              return nil;
            };
            if (sect.$level()['$=='](1)) {
              section_count = $rb_plus(section_count, 1);
              return ($i = sect, $i['$number=']($rb_plus($i.$number(), sectnumoffset)));
            } else if ((($i = (($j = sect.$level()['$=='](2)) ? section_count['$=='](1) : sect.$level()['$=='](2))) !== nil && $i != null && (!$i.$$is_boolean || $i == true))) {
              return ($i = sect, $i['$number=']($rb_plus($i.$number(), subsectnumoffset)))
              } else {
              return nil
            };}, TMP_4.$$s = self, TMP_4.$$arity = 1, TMP_4), $g).call($h);};
        return nil;}, TMP_3.$$s = self, TMP_3.$$arity = 1, TMP_3), $e).call($f)}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d)}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b);
};
...
Opal.modules["asciidoctor/latex/converter"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$==', '$warn', '$red', '$node_name', '$attributes', '$blue', '$[]', '$===', '$handle_null', '$handle_code', '$handle_equation', '$handle_equation_align', '$handle_cd', '$handle_chem', '$handle_jsxgraph', '$handle_texmacro', '$handle_include_latex', '$handle_default', '$[]=', '$*', '$+', '$roles', '$open', '$handle_equation_literal', '$title=', '$lines=', '$lines', '$target', '$type', '$text', '$references', '$document', '$id', '$<<', '$role', '$attr?', '$attr', '$join', '$inspect', '$to_s', '$gsub', '$parent', '$=~', '$old_inline_anchor', '$caption', '$include?', '$nil?', '$caption=', '$include', '$register_for', '$register', '$options', '$basebackend?', '$preprocessor', '$block', '$inline_macro', '$postprocessor', '$docinfo_processor', '$exist?', '$block_macro', '$basebackend', '$outfilesuffix', '$tex_process', '$magenta', '$class', '$respond_to?', '$prepend']);
  self.$require("asciidoctor");
  if ($scope.get('RUBY_ENGINE')['$==']("opal")) {};
  self.$require("asciidoctor/converter/html5");
  ...
  (function($base) {
    ...
    (function($base) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_7, TMP_8, TMP_9, TMP_10, TMP_11, TMP_12, TMP_13, TMP_14, TMP_15, TMP_16, TMP_17;

      Opal.cdecl($scope, 'ENV_CSS_OBLIQUE', "+++<div class='click_oblique'>+++");

      Opal.cdecl($scope, 'ENV_CSS_PLAIN', "+++<div class='click_plain'>+++");

      Opal.cdecl($scope, 'DIV_END', "+++</div>+++");

      Opal.cdecl($scope, 'TABLE_ROW_END', "+++</tr></table>+++");

      Opal.defn(self, '$info', TMP_1 = function ːinfo(node) {
        var $a, self = this;
        if ($gvars["VERBOSE"] == null) $gvars["VERBOSE"] = nil;
      ...
      Opal.defn(self, '$environment', TMP_2 = function ːenvironment(node) {
        var $a, self = this, attrs = nil, $case = nil;
        if ($gvars["VERBOSE"] == null) $gvars["VERBOSE"] = nil;
        ...
        $case = attrs['$[]']("role");if ("box"['$===']($case) || "capsule"['$===']($case)) {self.$handle_null(node)}else if ("code"['$===']($case)) {self.$handle_code(node)}else if ("equation"['$===']($case)) {self.$handle_equation(node)}else if ("equationalign"['$===']($case)) {self.$handle_equation_align(node)}else if ("cd"['$===']($case)) {self.$handle_cd(node)}else if ("chem"['$===']($case)) {self.$handle_chem(node)}else if ("jsxgraph"['$===']($case)) {self.$handle_jsxgraph(node)}else if ("texmacro"['$===']($case)) {self.$handle_texmacro(node)}else if ("include_latex"['$===']($case)) {self.$handle_include_latex(node)}else {self.$handle_default(node)};
        node.$attributes()['$[]=']("roles", $rb_times(($rb_plus(node.$roles(), ["environment"])), " "));
        return self.$open(node);
      }, TMP_2.$$arity = 1);

      Opal.defn(self, '$environment_literal', TMP_3 = function ːenvironment_literal(node) {
        var $a, self = this, attrs = nil, $case = nil;
        if ($gvars["VERBOSE"] == null) $gvars["VERBOSE"] = nil;
        ...
        if ((($a = $gvars["VERBOSE"]) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          self.$warn((("attrs['role'] = ") + (attrs['$[]']("role"))).$blue())};
        $case = attrs['$[]']("role");if ("box"['$===']($case) || "capsule"['$===']($case)) {self.$handle_null(node)}else if ("code"['$===']($case)) {self.$handle_code(node)}else if ("equation"['$===']($case)) {self.$handle_equation_literal(node)}else if ("equationalign"['$===']($case)) {self.$handle_equation_align(node)}else if ("cd"['$===']($case)) {self.$handle_cd(node)}else if ("chem"['$===']($case)) {self.$handle_chem(node)}else if ("jsxgraph"['$===']($case)) {self.$handle_jsxgraph(node)}else if ("texmacro"['$===']($case)) {self.$handle_texmacro(node)}else {self.$handle_default(node)};
        node.$attributes()['$[]=']("roles", $rb_times(($rb_plus(node.$roles(), ["environment"])), " "));
        return self.$open(node);
      }, TMP_3.$$arity = 1);

      Opal.defn(self, '$handle_texmacro', TMP_4 = function ːhandle_texmacro(node) {
        var $a, $b, self = this;

        (($a = [nil]), $b = node, $b['$title='].apply($b, $a), $a[$a.length-1]);
        return (($a = [$rb_plus($rb_plus(["+++\n\\("], node.$lines()), ["\\)\n+++"])]), $b = node, $b['$lines='].apply($b, $a), $a[$a.length-1]);
      }, TMP_4.$$arity = 1);

      Opal.defn(self, '$handle_include_latex', TMP_5 = function ːhandle_include_latex(node) {
        var $a, $b, self = this;

        (($a = [nil]), $b = node, $b['$title='].apply($b, $a), $a[$a.length-1]);
        (($a = [[]]), $b = node, $b['$lines='].apply($b, $a), $a[$a.length-1]);
        return self.$open(node);
      }, TMP_5.$$arity = 1);

      Opal.defn(self, '$click', TMP_6 = function ːclick(node) {
        var $a, $b, self = this;

        if ((($a = node.$attributes()['$[]']("plain-option")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          (($a = [$rb_plus($rb_plus([$scope.get('ENV_CSS_PLAIN')], node.$lines()), [$scope.get('DIV_END')])]), $b = node, $b['$lines='].apply($b, $a), $a[$a.length-1])
          } else {
          (($a = [$rb_plus($rb_plus([$scope.get('ENV_CSS_OBLIQUE')], node.$lines()), [$scope.get('DIV_END')])]), $b = node, $b['$lines='].apply($b, $a), $a[$a.length-1])
        };
        node.$attributes()['$[]=']("roles", $rb_times(($rb_plus(node.$roles(), ["click"])), " "));
        return self.$open(node);
      }, TMP_6.$$arity = 1);

      Opal.defn(self, '$old_inline_anchor', TMP_7 = function ːold_inline_anchor(node) {
        var $a, $b, self = this, target = nil, $case = nil, refid = nil, text = nil, attrs = nil, role = nil;
      ...
      Opal.defn(self, '$inline_anchor', TMP_8 = function ːinline_anchor(node) {
        var $a, $b, self = this, $case = nil, refid = nil, output = nil, refs = nil, reftext = nil;

        $case = node.$type().$to_s();if ("xref"['$===']($case)) {refid = node.$attributes()['$[]']("refid");
        if ((($a = (($b = refid !== false && refid !== nil && refid != null) ? refid['$[]'](0)['$==']("_") : refid)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          ...
          if ((($a = refs['$[]'](refid)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
            ...
            if ((($a = refid['$=~'](/\Aeq-/)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
              output = "<span class='xref'><a href=#" + (refid) + ">equation " + (reftext) + "</a></span>"
            } else if ((($a = refid['$=~'](/\Aformula-/)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
              output = "<span class='xref'><a href=#" + (refid) + ">formula " + (reftext) + "</a></span>"
            } else if ((($a = refid['$=~'](/\Areaction-/)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
              output = "<span class='xref'><a href=#" + (refid) + ">reaction " + (reftext) + "</a></span>"
              } else {
              output = "<span class='xref'><a href=#" + (refid) + ">" + (reftext) + "</a></span>"
            };
            } else {
            output = self.$old_inline_anchor(node)
          };
        };}else if ("link"['$===']($case)) {output = "<a href=" + (node.$target()) + ">" + (node.$text()) + "</a>"}else {output = self.$old_inline_anchor(node)};
        return output;
      }, TMP_8.$$arity = 1);

      Opal.defn(self, '$handle_equation', TMP_9 = function ːhandle_equation(node) {
        var $a, $b, self = this, attrs = nil, options = nil, number_part = nil, equation_part = nil, table_style = nil, row_style = nil;
        ...
        if ((($a = options['$include?']("numbered")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return (($a = [$rb_plus($rb_plus($rb_plus(["+++<table " + (table_style) + "><tr " + (row_style) + ">+++"], equation_part), number_part), [$scope.get('TABLE_ROW_END')])]), $b = node, $b['$lines='].apply($b, $a), $a[$a.length-1])
          } else {
          return (($a = [$rb_plus($rb_plus(["+++<table " + (table_style) + "><tr " + (row_style) + ">+++"], equation_part), [$scope.get('TABLE_ROW_END')])]), $b = node, $b['$lines='].apply($b, $a), $a[$a.length-1])
        };
      }, TMP_9.$$arity = 1);

      Opal.defn(self, '$handle_equation_literal', TMP_10 = function ːhandle_equation_literal(node) {
        var $a, $b, self = this, attrs = nil, options = nil, number_part = nil, equation_part = nil, table_style = nil, row_style = nil;
        ...
        row_style = "class=\"equation_row_style\"";
        if ((($a = options['$include?']("numbered")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return (($a = [$rb_plus($rb_plus($rb_plus(["<table " + (table_style) + "><tr " + (row_style) + ">"], equation_part), number_part), ["</tr></table>"])]), $b = node, $b['$lines='].apply($b, $a), $a[$a.length-1])
          } else {
          return (($a = [$rb_plus($rb_plus(["<table " + (table_style) + "><tr " + (row_style) + ">"], equation_part), ["</tr></table>"])]), $b = node, $b['$lines='].apply($b, $a), $a[$a.length-1])
        };
      }, TMP_10.$$arity = 1);

      Opal.defn(self, '$handle_equation_align', TMP_11 = function ːhandle_equation_align(node) {
        var $a, $b, self = this, attrs = nil, options = nil, number_part = nil, equation_part = nil, table_style = nil, row_style = nil;
      ...
      Opal.defn(self, '$handle_cd', TMP_12 = function ːhandle_cd(node) {
        var $a, $b, self = this;

        (($a = [nil]), $b = node, $b['$title='].apply($b, $a), $a[$a.length-1]);
        return (($a = [["\\[", "\\require{AMScd}", "\\begin{CD}", node.$lines(), "\\end{CD}", "\\]"]]), $b = node, $b['$lines='].apply($b, $a), $a[$a.length-1]);
      }, TMP_12.$$arity = 1);

      Opal.defn(self, '$handle_chem', TMP_13 = function ːhandle_chem(node) {
        var $a, $b, self = this, number_part = nil, equation_part = nil, table_style = nil, row_style = nil;
      ...
      Opal.defn(self, '$handle_jsxgraph', TMP_14 = function ːhandle_jsxgraph(node) {
        var $a, $b, self = this, attrs = nil, line_array = nil;
        ...
        return (($a = [line_array]), $b = node, $b['$lines='].apply($b, $a), $a[$a.length-1]);
      }, TMP_14.$$arity = 1);

      Opal.defn(self, '$handle_null', TMP_15 = function ːhandle_null(node) {
        var self = this;

        return nil;
      }, TMP_15.$$arity = 1);

      Opal.defn(self, '$handle_code', TMP_16 = function ːhandle_code(node) {
        var $a, $b, self = this;
        if ($gvars["VERBOSE"] == null) $gvars["VERBOSE"] = nil;

        if ((($a = $gvars["VERBOSE"]) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          self.$warn("handle code".$red())};
        if ((($a = node.$attributes()['$[]']("id")['$nil?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          (($a = ["FOO"]), $b = node, $b['$title='].apply($b, $a), $a[$a.length-1]);
          return (($a = ["666"]), $b = node, $b['$caption='].apply($b, $a), $a[$a.length-1]);
          } else {
          return nil
        };
      }, TMP_16.$$arity = 1);

      Opal.defn(self, '$handle_default', TMP_17 = function ːhandle_default(node) {
        var $a, $b, self = this;

        if ((($a = node.$attributes()['$[]']("plain-option")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return (($a = [$rb_plus($rb_plus([$scope.get('ENV_CSS_PLAIN')], node.$lines()), [$scope.get('DIV_END')])]), $b = node, $b['$lines='].apply($b, $a), $a[$a.length-1])
          } else {
          return (($a = [$rb_plus($rb_plus([$scope.get('ENV_CSS_OBLIQUE')], node.$lines()), [$scope.get('DIV_END')])]), $b = node, $b['$lines='].apply($b, $a), $a[$a.length-1])
        };
      }, TMP_17.$$arity = 1);
    })($scope.base);
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, $a, $b, TMP_18, $c, TMP_19, TMP_20, TMP_21;

      self.$include((($scope.get('Asciidoctor')).$$scope.get('Converter')));

      self.$register_for("latex");

      ($a = ($b = (($scope.get('Asciidoctor')).$$scope.get('Extensions'))).$register, $a.$$p = (TMP_18 = function(){var self = TMP_18.$$s || this, $c, $d, dialect = nil;

      dialect = ((($c = ((($d = self.$document().$options()['$[]']("dialect")) !== false && $d !== nil && $d != null) ? $d : self.$document().$attributes()['$[]']("dialect"))) !== false && $c !== nil && $c != null) ? $c : "latex");
        if ((($c = ["asciidoc", "manuscript"]['$include?'](dialect)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
          if ((($c = self.$document()['$basebackend?']("tex")) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            self.$preprocessor($scope.get('DollarPreprocessor'))}};
        if ((($c = ["latex", "manuscript"]['$include?'](dialect)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
          if (self.$document().$attributes()['$[]']("css_extras")['$==']("include")) {
            self.$preprocessor($scope.get('ClickStyleInsert'))};
          self.$preprocessor($scope.get('MacroPreprocessor'));
          self.$block($scope.get('EnvironmentBlock'));
          self.$block($scope.get('EnvironmentBlock2'));
          self.$block($scope.get('ClickBlock'));
          self.$inline_macro($scope.get('GlossInlineMacro'));
          self.$inline_macro($scope.get('IndexTermInlineMacro'));
          if (self.$document().$attributes()['$[]']("inject_javascript")['$==']("no")) {
            } else {
            self.$postprocessor($scope.get('InjectHTML'))
          };
          if (self.$document().$attributes()['$[]']("unicode")['$==']("no")) {
          } else if ((($c = self.$document()['$basebackend?']("tex")) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            self.$postprocessor($scope.get('EntToUni'))};
          self.$docinfo_processor($scope.get('CSSDocinfoProcessor'));};
        if ((($c = ["latex"]['$include?'](dialect)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
          if (self.$document().$attributes()['$[]']("preprocess")['$==']("no")) {
            } else {
            self.$preprocessor($scope.get('TeXPreprocessor'))
          };
          if ((($c = ($scope.get('File')['$exist?']("macros.tex"))) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            self.$preprocessor($scope.get('MacroInsert'))};
          self.$inline_macro($scope.get('ChemInlineMacro'));
          self.$block_macro($scope.get('IncludeLatexBlockMacro'));
          if ((($c = self.$document()['$basebackend?']("html")) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            self.$postprocessor($scope.get('Chem'))};
          if ((($c = self.$document()['$basebackend?']("html")) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            self.$postprocessor($scope.get('HTMLPostprocessor'))};
          if ((($c = self.$document()['$basebackend?']("tex")) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            return self.$postprocessor($scope.get('TexPostprocessor'))
            } else {
            return nil
          };
          } else {
          return nil
        };}, TMP_18.$$s = self, TMP_18.$$arity = 0, TMP_18), $a).call($b);

      ($a = ($c = (($scope.get('Asciidoctor')).$$scope.get('Extensions'))).$register, $a.$$p = (TMP_19 = function(){var self = TMP_19.$$s || this;

      return nil}, TMP_19.$$s = self, TMP_19.$$arity = 0, TMP_19), $a).call($c, "latex");

      Opal.cdecl($scope, 'TOP_TYPES', ["document", "section"]);

      Opal.cdecl($scope, 'LIST_TYPES', ["dlist", "olist", "ulist"]);

      Opal.cdecl($scope, 'INLINE_TYPES', ["inline_anchor", "inline_break", "inline_footnote", "inline_quoted", "inline_callout"]);

      Opal.cdecl($scope, 'BLOCK_TYPES', ["admonition", "listing", "literal", "page_break", "paragraph", "stem", "pass", "open", "quote", "\n", "example", "floating_title", "image", "click", "preamble", "sidebar", "verse", "toc"]);

      Opal.cdecl($scope, 'OTHER_TYPES', ["environment", "table"]);

      Opal.cdecl($scope, 'NODE_TYPES', $rb_plus($rb_plus($rb_plus($rb_plus($scope.get('TOP_TYPES'), $scope.get('LIST_TYPES')), $scope.get('INLINE_TYPES')), $scope.get('BLOCK_TYPES')), $scope.get('OTHER_TYPES')));

      Opal.defn(self, '$initialize', TMP_20 = function ːinitialize(backend, opts) {
      ...
      return (Opal.defn(self, '$convert', TMP_21 = function ːconvert(node, transform) {
        var $a, self = this;

        if (transform == null) {
          transform = nil;
        }
        if ((($a = $scope.get('NODE_TYPES')['$include?'](node.$node_name())) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return node.$tex_process()
          } else {
          return self.$warn((((("Node to implement: ") + (node.$node_name())) + ", class = ") + (node.$class())).$magenta())
        };
      }, TMP_21.$$arity = -2), nil) && 'convert';
    })($scope.base, null);
  })($scope.get('Asciidoctor'));
  return (function($base, $super) {
    function $Html5Converter(){};
    ...
    if ((($a = self['$respond_to?']("prepend")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
      return self.$prepend((((($scope.get('Asciidoctor')).$$scope.get('LaTeX'))).$$scope.get('Html5ConverterExtensions')))
      } else {
      return self.$include((((($scope.get('Asciidoctor')).$$scope.get('LaTeX'))).$$scope.get('Html5ConverterExtensions')))
    }
  })((($scope.get('Asciidoctor')).$$scope.get('Converter')), null);
};
...
Opal.modules["asciidoctor/latex"] = function(Opal) {
  ...
  (function($base) {
    ...
    (function($base) {
      ...
      Opal.cdecl($scope, 'DATA_DIR', $rb_plus((Opal.get('File').$dirname(Opal.get('File').$dirname(Opal.get('File').$dirname(Opal.get('File').$expand_path("asciidoctor/latex"))))), "/data"))
    })($scope.base)
  })($scope.base);
