  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$section = function(node) {
        ...
        } else if ((($a = (($b = doctype['$==']("book")) ? $rb_le(node.$level(), 1) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (item == null) item = nil;
      ...
      (($a = [$scope.get('DLIST_TAGS')['$[]']("labeled")]), $b = $scope.get('DLIST_TAGS'), $b['$default='].apply($b, $a), $a[$a.length-1]);
...
if (terms == null) terms = nil;if (dd == null) dd = nil;
          result['$<<']("<row>\n<entry>");
            ($a = ($b = [].concat(terms)).$each, $a.$$p = (TMP_3 = function(dt){var self = TMP_3.$$s || this;
if (dt == null) dt = nil;
...
if (terms == null) terms = nil;if (dd == null) dd = nil;
          result['$<<']("<" + (entry_tag) + ">");
            if (label_tag !== false && label_tag !== nil) {
              result['$<<']("<" + (label_tag) + ">")};
            ($a = ($b = [].concat(terms)).$each, $a.$$p = (TMP_5 = function(dt){var self = TMP_5.$$s || this;
if (dt == null) dt = nil;
      ...
      def.$listing = function(node) {
        ...
        if ((($a = (($b = node.$style()['$==']("source")) ? (node['$attr?']("language")) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (item == null) item = nil;
      ...
      def.$open = function(node) {
        ...
        return (function() {$case = node.$style();if ("abstract"['$===']($case)) {if ((($a = (($b = node.$parent()['$=='](node.$document())) ? node.$document()['$attr?']("doctype", "book") : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          return "<abstract>\n" + (self.$title_tag(node)) + (self.$resolve_content(node)) + "\n</abstract>"
        }}else if ("partintro"['$===']($case)) {if ((($a = ($b = (($c = node.$level()['$=='](0)) ? node.$parent().$context()['$==']("section") : $c), $b !== false && $b !== nil ?node.$document().$doctype()['$==']("book") : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (item == null) item = nil;
          text_marker = (function() {if ((($a = (($b = checklist !== false && checklist !== nil) ? (item['$attr?']("checkbox")) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
      ...
      def.$inline_anchor = function(node) {
        ...
        return (function() {$case = node.$type();if ("ref"['$===']($case)) {return "<anchor" + (self.$common_attributes(node.$target(), nil, node.$text())) + "/>"}else if ("xref"['$===']($case)) {if ((($a = node['$attr?']("path", nil)) !== nil && (!$a.$$is_boolean || $a == true))) {
      ...
      def.$inline_kbd = function(node) {
        ...
        if (((keys = node.$attr("keys"))).$size()['$=='](1)) {
          ...
          key_combo = ($a = ($b = keys).$map, $a.$$p = (TMP_17 = function(key){var self = TMP_17.$$s || this;
if (key == null) key = nil;
          return "<keycap>" + (key) + "</keycap>"}, TMP_17.$$s = self, TMP_17), $a).call($b).$join();
...
if (submenu == null) submenu = nil;
      ...
      (($a = [[nil, nil, true]]), $b = $scope.get('QUOTE_TAGS'), $b['$default='].apply($b, $a), $a[$a.length-1]);
...
if (index == null) index = nil;
          ...
          if ((($a = ($c = (doc['$attr?']("revdate")), $c !== false && $c !== nil ?(((($d = (doc['$attr?']("revnumber"))) !== false && $d !== nil) ? $d : (doc['$attr?']("revremark")))) : $c)) !== nil && (!$a.$$is_boolean || $a == true))) {
            ...
            result['$<<']("</revision>\n</revhistory>");};
          if ((($a = ((header_docinfo = doc.$docinfo("header")))['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            } else {
...
/* Generated by Opal 0.8.0 */
Opal.modules["asciidoctor/converter/docbook45"] = function(Opal) {
  Opal.dynamic_require_severity = "ignore";
  function $rb_times(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs * rhs : lhs['$*'](rhs);
  }
...
if (item == null) item = nil;if (idx == null) idx = nil;
      ...
      def.$inline_anchor = function(node) {
        ...
        target = node.$target();
        return (function() {$case = node.$type();if ("ref"['$===']($case)) {return "<anchor" + (self.$common_attributes(target, nil, node.$text())) + "/>"}else if ("xref"['$===']($case)) {if ((($a = node['$attr?']("path", nil)) !== nil && (!$a.$$is_boolean || $a == true))) {
