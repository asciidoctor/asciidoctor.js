  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        var def = $Processor._proto, $scope = $Processor._scope, $a, $b, TMP_1;
        def.config = nil;
        (function(self) {
          ...
          self._proto.$use_dsl = function() {
            var $a, self = this;
            if (($a = self.$name()['$nil_or_empty?']()) !== false && $a !== nil) {
              if (($a = self.$constants().$grep("DSL")) !== false && $a !== nil) {
                return self.$include(self.$const_get("DSL"))
                } else {
                return nil
              }
            } else if (($a = self.$constants().$grep("DSL")) !== false && $a !== nil) {
        ...
        def.$parse_content = function(parent, content, attributes) {
          ...
          reader = (function() {if (($a = (content['$is_a?']($scope.Reader))) !== false && $a !== nil) {
            return reader
            } else {
        ...
        return ($a = ($b = [["create_paragraph", "create_block", "paragraph"], ["create_open_block", "create_block", "open"], ["create_example_block", "create_block", "example"], ["create_pass_block", "create_block", "pass"], ["create_listing_block", "create_block", "listing"], ["create_literal_block", "create_block", "literal"], ["create_anchor", "create_inline", "anchor"]]).$each, $a._p = (TMP_1 = function(method_name, delegate_method_name, context){var self = TMP_1._s || this, $a, $b, TMP_2;if (method_name == null) method_name = nil;if (delegate_method_name == null) delegate_method_name = nil;if (context == null) context = nil;
        return ($a = ($b = self).$define_method, $a._p = (TMP_2 = function(args){var self = TMP_2._s || this, $a;args = $slice.call(arguments, 0);
      ...
      (function($base) {
        ...
        def.$process = TMP_3 = function(args) {
          ...
          } else if (($a = self.process_block) !== false && $a !== nil) {
      ...
      (function($base, $super) {
        ...
        var def = $Preprocessor._proto, $scope = $Preprocessor._scope;
      ...
      (function($base, $super) {
        ...
        var def = $Treeprocessor._proto, $scope = $Treeprocessor._scope;
      ...
      (function($base, $super) {
        ...
        var def = $Postprocessor._proto, $scope = $Postprocessor._scope;
      ...
      (function($base, $super) {
        ...
        var def = $IncludeProcessor._proto, $scope = $IncludeProcessor._scope;
      ...
      (function($base, $super) {
        ...
        var def = $BlockProcessor._proto, $scope = $BlockProcessor._scope, TMP_4;
        def.config = nil;
      ...
      (function($base) {
        ...
        def.$named = function(value) {
          var $a, self = this;
          if (($a = self['$is_a?']($scope.Processor)) !== false && $a !== nil) {
      ...
      (function($base, $super) {
        ...
        var def = $MacroProcessor._proto, $scope = $MacroProcessor._scope, TMP_5;
        def.config = nil;
        self.$attr_accessor("name");
      ...
      (function($base, $super) {
        ...
        var def = $BlockMacroProcessor._proto, $scope = $BlockMacroProcessor._scope;
        return nil;
      ...
      (function($base, $super) {
        ...
        var def = $InlineMacroProcessor._proto, $scope = $InlineMacroProcessor._scope, TMP_6;
      ...
      (function($base, $super) {
        ...
        var def = $Extension._proto, $scope = $Extension._scope;
        self.$attr("kind");
      ...
      (function($base, $super) {
        ...
        var def = $ProcessorExtension._proto, $scope = $ProcessorExtension._scope, TMP_7;
      ...
      (function($base, $super) {
        ...
        var def = $Group._proto, $scope = $Group._scope;
        (function(self) {
          var $scope = self._scope, def = self._proto;
      ...
      (function($base, $super) {
        ...
        var def = $Registry._proto, $scope = $Registry._scope, TMP_9, TMP_10, TMP_11, TMP_12, TMP_13, TMP_14, TMP_15, TMP_16, TMP_18;
        ...
        def.$activate = function(document) {
          ...
          ($a = ($b = ($scope.Extensions.$groups().$values()['$+'](self.groups.$values()))).$each, $a._p = (TMP_8 = function(group){var self = TMP_8._s || this, $a, $b, $case = nil;if (group == null) group = nil;
        ...
        def['$preprocessors?'] = function() {
          var $a, $b, self = this;
          return ($a = ($b = self.preprocessor_extensions, ($b === nil || $b === false)), ($a === nil || $a === false));
        };
        ...
        def['$treeprocessors?'] = function() {
          var $a, $b, self = this;
          return ($a = ($b = self.treeprocessor_extensions, ($b === nil || $b === false)), ($a === nil || $a === false));
        };
        ...
        def['$postprocessors?'] = function() {
          var $a, $b, self = this;
          return ($a = ($b = self.postprocessor_extensions, ($b === nil || $b === false)), ($a === nil || $a === false));
        };
        ...
        def['$include_processors?'] = function() {
          var $a, $b, self = this;
          return ($a = ($b = self.include_processor_extensions, ($b === nil || $b === false)), ($a === nil || $a === false));
        };
        ...
        def['$blocks?'] = function() {
          var $a, $b, self = this;
          return ($a = ($b = self.block_extensions, ($b === nil || $b === false)), ($a === nil || $a === false));
        };

        def['$registered_for_block?'] = function(name, context) {
          var $a, self = this, ext = nil;
          if (($a = (ext = self.block_extensions['$[]'](name.$to_sym()))) !== false && $a !== nil) {
            if (($a = (ext.$config()['$[]']("contexts")['$include?'](context))) !== false && $a !== nil) {
              return ext
              } else {
              return false
            }
        ...
        def['$block_macros?'] = function() {
          var $a, $b, self = this;
          return ($a = ($b = self.block_macro_extensions, ($b === nil || $b === false)), ($a === nil || $a === false));
        };

        def['$registered_for_block_macro?'] = function(name) {
          var $a, self = this, ext = nil;
          if (($a = (ext = self.block_macro_extensions['$[]'](name.$to_sym()))) !== false && $a !== nil) {
            return ext
            } else {
            return false
          };
        ...
        def['$inline_macros?'] = function() {
          var $a, $b, self = this;
          return ($a = ($b = self.inline_macro_extensions, ($b === nil || $b === false)), ($a === nil || $a === false));
        };

        def['$registered_for_inline_macro?'] = function(name) {
          var $a, self = this, ext = nil;
          if (($a = (ext = self.inline_macro_extensions['$[]'](name.$to_sym()))) !== false && $a !== nil) {
            return ext
            } else {
            return false
          };
        ...
        def.$add_document_processor = TMP_16 = function(kind, args) {
          ...
          kind_class_symbol = ($a = ($b = kind_name.$split(" ")).$map, $a._p = (TMP_17 = function(word){var self = TMP_17._s || this;if (word == null) word = nil;
          ...
          kind_java_class = (function() {if (($a = (($opal.Object._scope.AsciidoctorJ == null ? nil : 'constant'))) !== false && $a !== nil) {
          ...
          extension = (function() {if ((block !== nil)) {
            ...
            processor.$freeze();
            if (($a = processor['$process_block_given?']()) === false || $a === nil) {
            ...
            if (($a = ((($d = (processor['$is_a?']((($e = $opal.Object._scope.Class) == null ? $opal.cm('Class') : $e)))) !== false && $d !== nil) ? $d : (($e = (processor['$is_a?']((($f = $opal.Object._scope.String) == null ? $opal.cm('String') : $f))), $e !== false && $e !== nil ?(processor = $scope.Extensions.$class_for_name(processor)) : $e)))) !== false && $a !== nil) {
              if (($a = ((($d = processor['$<'](kind_class)) !== false && $d !== nil) ? $d : ((($e = kind_java_class !== false && kind_java_class !== nil) ? processor['$<'](kind_java_class) : $e)))) === false || $a === nil) {
            ...
            } else if (($a = ((($d = (processor['$is_a?'](kind_class))) !== false && $d !== nil) ? $d : ((($e = kind_java_class !== false && kind_java_class !== nil) ? (processor['$is_a?'](kind_java_class)) : $e)))) !== false && $a !== nil) {
        ...
        def.$add_syntax_processor = TMP_18 = function(kind, args) {
          ...
          TMP_18._p = null;
          kind_name = kind.$to_s().$tr("_", " ");
          kind_class_basename = ($a = ($b = kind_name.$split(" ")).$map, $a._p = (TMP_19 = function(word){var self = TMP_19._s || this;if (word == null) word = nil;
          ...
          if ((block !== nil)) {
            ...
            if (($a = (name = self.$as_symbol(processor.$name()))) === false || $a === nil) {
            ...
            if (($a = ((($d = (processor['$is_a?']((($e = $opal.Object._scope.Class) == null ? $opal.cm('Class') : $e)))) !== false && $d !== nil) ? $d : (($e = (processor['$is_a?']((($f = $opal.Object._scope.String) == null ? $opal.cm('String') : $f))), $e !== false && $e !== nil ?(processor = $scope.Extensions.$class_for_name(processor)) : $e)))) !== false && $a !== nil) {
              ...
              if (($a = (name = self.$as_symbol(processor_instance.$name()))) === false || $a === nil) {
        ...
        def.$resolve_args = function(args, expect) {
          ...
          opts = (function() {if (($a = (args['$[]'](-1)['$is_a?']((($b = $opal.Object._scope.Hash) == null ? $opal.cm('Hash') : $b)))) !== false && $a !== nil) {
            return args.$pop()
            } else {
            return $hash2([], {})
          }; return nil; })();
        ...
        return (def.$as_symbol = function(name) {
          ...
          if (name !== false && name !== nil) {
            return ((function() {if (($a = (name['$is_a?']((($b = $opal.Object._scope.Symbol) == null ? $opal.cm('Symbol') : $b)))) !== false && $a !== nil) {
              return name
              } else {
              return name.$to_sym()
            }; return nil; })())
      ...
      (function(self) {
        ...
        self._proto.$register = TMP_21 = function(args) {
          var $a, $b, self = this, $iter = TMP_21._p, block = $iter || nil, argc = nil, resolved_group = nil, group = nil, $case = nil, name = nil;
          args = $slice.call(arguments, 0);
          TMP_21._p = null;
          argc = args.$length();
          resolved_group = (function() {if ((block !== nil)) {
            return block
          } else if (($a = ($b = (group = args.$pop()), ($b === nil || $b === false))) !== false && $a !== nil) {
        ...
        self._proto.$resolve_class = function(object) {
          var $a, $b, self = this;
          if (($a = (object['$is_a?']((($b = $opal.Object._scope.Class) == null ? $opal.cm('Class') : $b)))) !== false && $a !== nil) {
            return object
            } else {
        ...
        return (self._proto.$class_for_name = function(qualified_name) {
          ...
          ($a = ($b = qualified_name.$split("::")).$each, $a._p = (TMP_22 = function(name){var self = TMP_22._s || this, $a;if (name == null) name = nil;
          if (($a = name['$empty?']()) !== false && $a !== nil) {
              return nil
            } else if (($a = resolved_class['$const_defined?'](name)) !== false && $a !== nil) {
