...
(function($opal) {
  ...
  (function($base, $super) {
    ...
    var def = $Kernel._proto, $scope = $Kernel._scope, TMP_1;
  ...
  return (function($base, $super) {
    ...
    var def = $File._proto, $scope = $File._scope, TMP_2;
    ...
    $opal.defs(self, '$basename', function(path) {
      ...
      if (($a = (offset = path.$rindex($scope.SEPARATOR))) !== false && $a !== nil) {
    ...
    $opal.defs(self, '$extname', function(path) {
      ...
      if (($a = path['$nil_or_empty?']()) !== false && $a !== nil) {
        return ""};
...
(function($opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      var def = $Timings._proto, $scope = $Timings._scope;
...
(function($opal) {
  ...
  (function($base, $super) {
    ...
    var def = $NilClass._proto, $scope = $NilClass._scope, $a;
    if (($a = self['$respond_to?']("nil_or_empty?")) !== false && $a !== nil) {
      return nil
      } else {
  ...
  (function($base, $super) {
    ...
    var def = $String._proto, $scope = $String._scope, $a;
    if (($a = self['$respond_to?']("nil_or_empty?")) !== false && $a !== nil) {
      return nil
      } else {
  ...
  (function($base, $super) {
    ...
    var def = $Array._proto, $scope = $Array._scope, $a;
    if (($a = self['$respond_to?']("nil_or_empty?")) !== false && $a !== nil) {
      return nil
      } else {
      return $opal.defn(self, '$nil_or_empty?', def['$empty?'])
  ...
  (function($base, $super) {
    ...
    var def = $Hash._proto, $scope = $Hash._scope, $a;
    if (($a = self['$respond_to?']("nil_or_empty?")) !== false && $a !== nil) {
      return nil
      } else {
      return $opal.defn(self, '$nil_or_empty?', def['$empty?'])
  ...
  return (function($base, $super) {
    ...
    var def = $Numeric._proto, $scope = $Numeric._scope, $a;
    if (($a = self['$respond_to?']("nil_or_empty?")) !== false && $a !== nil) {
      return nil
      } else {
      return $opal.defn(self, '$nil_or_empty?', def['$nil?'])
...
(function($opal) {
  ...
  return (function($base, $super) {
    ...
    var def = $String._proto, $scope = $String._scope, $a;
    if (($a = self['$respond_to?']("chr")) !== false && $a !== nil) {
      return nil
      } else {
      return (def.$chr = function() {
        var self = this;
        return self['$[]']($range(0, 0, false));
      }, nil)
    }
  })(self, null)
})(Opal);
...
(function($opal) {
  ...
  ;
  if ((($a = $opal.Object._scope.RUBY_VERSION) == null ? $opal.cm('RUBY_VERSION') : $a)['$>=']("1.9")) {
    return nil
    } else {
    ;
    return true;
  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      $opal.defs(self, '$require_library', function(name, gem) {
        ...
        try {
        return true
        } catch ($err) {if ((($a = $opal.Object._scope.LoadError) == null ? $opal.cm('LoadError') : $a)['$===']($err)) {e = $err;
      ...
      $opal.defs(self, '$normalize_lines_from_string', function(data) {
        ...
        if (($a = data['$nil_or_empty?']()) !== false && $a !== nil) {
          return []};
        if (($a = $scope.COERCE_ENCODING) !== false && $a !== nil) {
          utf8 = ((($a = $opal.Object._scope.Encoding) == null ? $opal.cm('Encoding') : $a))._scope.UTF_8;
      ...
      $opal.defs(self, '$rootname', function(file_name) {
        ...
        if (($a = ((ext = (($b = $opal.Object._scope.File) == null ? $opal.cm('File') : $b).$extname(file_name)))['$empty?']()) !== false && $a !== nil) {
          return file_name
          } else {
      ...
      $opal.defs(self, '$mkdir_p', function(dir) {
        var $a, $b, $c, $d, self = this, parent_dir = nil;
        if (($a = (($b = $opal.Object._scope.File) == null ? $opal.cm('File') : $b)['$directory?'](dir)) !== false && $a !== nil) {
          return nil
          } else {
          parent_dir = (($a = $opal.Object._scope.File) == null ? $opal.cm('File') : $a).$dirname(dir);
          if (($a = ($b = ($c = (($d = $opal.Object._scope.File) == null ? $opal.cm('File') : $d)['$directory?'](parent_dir = (($d = $opal.Object._scope.File) == null ? $opal.cm('File') : $d).$dirname(dir)), ($c === nil || $c === false)), $b !== false && $b !== nil ?($c = parent_dir['$==']("."), ($c === nil || $c === false)) : $b)) !== false && $a !== nil) {
...
(function($opal) {
  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      $opal.cdecl($scope, 'PASS_START', (function() {if ((($a = $opal.Object._scope.RUBY_ENGINE) == null ? $opal.cm('RUBY_ENGINE') : $a)['$==']("opal")) {
        return (150).$chr()
        } else {
        return "u0096"
      }; return nil; })());

      $opal.cdecl($scope, 'PASS_END', (function() {if ((($a = $opal.Object._scope.RUBY_ENGINE) == null ? $opal.cm('RUBY_ENGINE') : $a)['$==']("opal")) {
        return (151).$chr()
        } else {
        return "u0097"
      }; return nil; })());
      ...
      def.$apply_subs = function(source, subs, expand) {
        ...
        if (($a = ($b = subs, ($b === nil || $b === false))) !== false && $a !== nil) {
          return source
        } else if (subs['$==']("normal")) {
          subs = $scope.SUBS['$[]']("normal")
        } else if (expand !== false && expand !== nil) {
          if (($a = subs['$is_a?']((($b = $opal.Object._scope.Symbol) == null ? $opal.cm('Symbol') : $b))) !== false && $a !== nil) {
        ...
        if (($a = subs['$empty?']()) !== false && $a !== nil) {
          return source};
        text = (function() {if (($a = (multiline = source['$is_a?']((($c = $opal.Object._scope.Array) == null ? $opal.cm('Array') : $c)))) !== false && $a !== nil) {
        ...
        return (function() {$case = type;if ("specialcharacters"['$===']($case)) {return text = self.$sub_specialcharacters(text)}else if ("quotes"['$===']($case)) {return text = self.$sub_quotes(text)}else if ("attributes"['$===']($case)) {return text = self.$sub_attributes(text.$split($scope.EOL))['$*']($scope.EOL)}else if ("replacements"['$===']($case)) {return text = self.$sub_replacements(text)}else if ("macros"['$===']($case)) {return text = self.$sub_macros(text)}else if ("highlight"['$===']($case)) {return text = self.$highlight_source(text, (subs['$include?']("callouts")))}else if ("callouts"['$===']($case)) {if (($a = subs['$include?']("highlight")) !== false && $a !== nil) {
            return nil
            } else {
      ...
      def.$extract_passthroughs = function(text) {
        ...
        if (($a = ((($b = ((($c = (text['$include?']("++"))) !== false && $c !== nil) ? $c : (text['$include?']("$$")))) !== false && $b !== nil) ? $b : (text['$include?']("ss:")))) !== false && $a !== nil) {
        ...
        if (($a = (text['$include?']("`"))) !== false && $a !== nil) {
          ...
          m = $gvars["~"];
            ...
            } else if (($a = (($b = m['$[]'](1)['$==']("\\")) ? m['$[]'](2) : $b)) !== false && $a !== nil) {
              unescaped_attrs = "[" + (m['$[]'](2)) + "]"};
            if (($a = ($b = ($c = unescaped_attrs, ($c === nil || $c === false)), $b !== false && $b !== nil ?m['$[]'](2) : $b)) !== false && $a !== nil) {
        ...
        if (($a = (text['$include?']("math:"))) !== false && $a !== nil) {
          ...
          m = $gvars["~"];
            ...
            type = m['$[]'](1).$to_sym();
            if (type['$==']("math")) {
              type = ((function() {if (($a = ((default_type = self.$document().$attributes()['$[]']("math")))['$nil_or_empty?']()) !== false && $a !== nil) {
                return "asciimath"
                } else {
                return default_type
              }; return nil; })()).$to_sym()};
            text = self.$unescape_brackets(m['$[]'](3));
            if (($a = m['$[]'](2)['$nil_or_empty?']()) !== false && $a !== nil) {
      ...
      def.$restore_passthroughs = function(text) {
        ...
        if (($a = ((($b = self.passthroughs['$nil_or_empty?']()) !== false && $b !== nil) ? $b : ($c = text['$include?']($scope.PASS_START), ($c === nil || $c === false)))) !== false && $a !== nil) {
          return text};
        ...
        pass = self.passthroughs['$[]']($gvars["~"]['$[]'](1).$to_i());
          subbed_text = (function() {if (($a = (subs = pass['$[]']("subs"))) !== false && $a !== nil) {
            return (self.$apply_subs(pass['$[]']("text"), subs))
            } else {
            return pass['$[]']("text")
          }; return nil; })();
          if (($a = (type = pass['$[]']("type"))) !== false && $a !== nil) {
      ...
      def.$sub_specialcharacters = function(text) {
        ...
        if (($a = $scope.SUPPORTS_GSUB_RESULT_HASH) !== false && $a !== nil) {
          ...
          if (($a = line['$include?']("{")) !== false && $a !== nil) {
            ...
            m = $gvars["~"];
              if (($a = ((($b = m['$[]'](1)['$==']("\\")) !== false && $b !== nil) ? $b : m['$[]'](4)['$==']("\\"))) !== false && $a !== nil) {
                return "{" + (m['$[]'](2)) + "}"
              } else if (($a = ($b = m['$[]'](3)['$nil_or_empty?'](), ($b === nil || $b === false))) !== false && $a !== nil) {
              ...
              } else if (($a = $scope.INTRINSIC_ATTRIBUTES['$has_key?'](key)) !== false && $a !== nil) {
      ...
      def.$sub_macros = function(source) {
        ...
        if (($a = source['$nil_or_empty?']()) !== false && $a !== nil) {
          return source};
        found = $hash2([], {});
        ...
        if (experimental !== false && experimental !== nil) {
            ...
            m = $gvars["~"];
              ...
              if (($a = captured['$start_with?']("kbd")) !== false && $a !== nil) {
                ...
                if (keys['$==']("+")) {
                  ...
                  keys = ($a = ($b = keys.$split($scope.KbdDelimiterRx)).$inject, $a._p = (TMP_21 = function(c, key){var self = TMP_21._s || this, $a;if (c == null) c = nil;if (key == null) key = nil;
          ...
          if (($a = ($c = found['$[]']("macroish"), $c !== false && $c !== nil ?result['$include?']("menu:") : $c)) !== false && $a !== nil) {
            ...
            m = $gvars["~"];
              ...
              menu = m['$[]'](1);
              items = m['$[]'](2);
              if (($a = ($b = items, ($b === nil || $b === false))) !== false && $a !== nil) {
                submenus = [];
                menuitem = nil;
                ...
                submenus = ($a = ($b = items.$split(delim)).$map, $a._p = (TMP_23 = function(it){var self = TMP_23._s || this;if (it == null) it = nil;
          ...
          if (($a = ($d = result['$include?']("\""), $d !== false && $d !== nil ?result['$include?']("&gt;") : $d)) !== false && $a !== nil) {
            ...
            m = $gvars["~"];
              if (($a = ((captured = m['$[]'](0)))['$start_with?']("\\")) !== false && $a !== nil) {
                return captured['$[]']($range(1, -1, false));};
              input = m['$[]'](1);
              $a = $opal.to_ary(($b = ($c = input.$split("&gt;")).$map, $b._p = (TMP_25 = function(it){var self = TMP_25._s || this;if (it == null) it = nil;
        ...
        if (($a = ($e = (extensions = self.document.$extensions()), $e !== false && $e !== nil ?extensions['$inline_macros?']() : $e)) !== false && $a !== nil) {
          ($a = ($e = extensions.$inline_macros()).$each, $a._p = (TMP_26 = function(extension){var self = TMP_26._s || this, $a, $b, TMP_27;if (extension == null) extension = nil;
        ...
        if (($a = ((($g = found['$[]']("macroish_short_form")) !== false && $g !== nil) ? $g : found['$[]']("round_bracket"))) !== false && $a !== nil) {
          ...
          m = $gvars["~"];
            ...
            if (($a = ((($b = macro_name['$==']("indexterm")) !== false && $b !== nil) ? $b : num_brackets['$=='](3))) !== false && $a !== nil) {
              if (($a = ($b = macro_name, ($b === nil || $b === false))) !== false && $a !== nil) {
        ...
        if (($a = (($h = found_colon !== false && found_colon !== nil) ? (result['$include?']("://")) : $h)) !== false && $a !== nil) {
          ...
          m = $gvars["~"];
            ...
            target = m['$[]'](2);
            suffix = "";
            if (($a = ((($b = m['$[]'](3)) !== false && $b !== nil) ? $b : ($c = target['$=~']($scope.UriTerminator), ($c === nil || $c === false)))) === false || $a === nil) {
              $case = $gvars["~"]['$[]'](0);if (")"['$===']($case)) {target = target['$[]']($range(0, -2, false));
              suffix = ")";}else if (";"['$===']($case)) {if (($a = ($b = prefix['$start_with?']("&lt;"), $b !== false && $b !== nil ?target['$end_with?']("&gt;") : $b)) !== false && $a !== nil) {
                ...
                suffix = ";";
              }}else if (":"['$===']($case)) {if (($a = target['$end_with?']("):")) !== false && $a !== nil) {
                target = target['$[]']($range(0, -3, false));
                suffix = "):";
                } else {
                target = target['$[]']($range(0, -2, false));
          ...
          m = $gvars["~"];
            ...
            if (m['$[]'](1)['$==']("footnote")) {
              ...
              if (text !== false && text !== nil) {
                ...
                if (($a = (footnote = ($b = ($c = self.document.$references()['$[]']("footnotes")).$find, $b._p = (TMP_34 = function(fn){var self = TMP_34._s || this;if (fn == null) fn = nil;
                return fn.$id()['$=='](id)}, TMP_34._s = self, TMP_34), $b).call($c))) !== false && $a !== nil) {
      ...
      def.$sub_inline_anchors = function(text, found) {
        var $a, $b, $c, $d, TMP_35, $e, $f, TMP_36, self = this;
        if (found == null) {
          found = nil
        }
        if (($a = ($b = (((($c = ($d = found, ($d === nil || $d === false))) !== false && $c !== nil) ? $c : found['$[]']("square_bracket"))), $b !== false && $b !== nil ?text['$include?']("[[[") : $b)) !== false && $a !== nil) {
        ...
        if (($a = ((($c = (($d = (((($e = ($f = found, ($f === nil || $f === false))) !== false && $e !== nil) ? $e : found['$[]']("square_bracket"))), $d !== false && $d !== nil ?text['$include?']("[[") : $d))) !== false && $c !== nil) ? $c : (($d = (((($e = ($f = found, ($f === nil || $f === false))) !== false && $e !== nil) ? $e : found['$[]']("macroish"))), $d !== false && $d !== nil ?text['$include?']("anchor:") : $d)))) !== false && $a !== nil) {
          ...
          m = $gvars["~"];
            ...
            if (($a = m['$[]'](1)) !== false && $a !== nil) {
              ...
              if (reftext !== false && reftext !== nil) {
                reftext = reftext.$sub($scope.DoubleQuotedMultiRx, (function() {if (($a = (($b = $opal.Object._scope.RUBY_ENGINE_OPAL) == null ? $opal.cm('RUBY_ENGINE_OPAL') : $b)) !== false && $a !== nil) {
                  return "$2"
                  } else {
                  return "2"
                }; return nil; })())};
            ...
            if (($a = ($b = path, ($b === nil || $b === false))) !== false && $a !== nil) {
              refid = fragment;
              target = "#" + (fragment);
              } else {
      ...
      def.$sub_post_replacements = function(text) {
        ...
        if (($a = ((($b = (self.document.$attributes()['$has_key?']("hardbreaks"))) !== false && $b !== nil) ? $b : (self.attributes['$has_key?']("hardbreaks-option")))) !== false && $a !== nil) {
          ...
          if (lines.$size()['$=='](1)) {
            return text};
          last = lines.$pop();
          return ($a = ($b = lines).$map, $a._p = (TMP_41 = function(line){var self = TMP_41._s || this;if (line == null) line = nil;
        ...
        } else if (($a = text['$include?']("+")) !== false && $a !== nil) {
      ...
      def.$parse_attributes = function(attrline, posattrs, opts) {
        ...
        if (($a = opts.$fetch("sub_result", true)) !== false && $a !== nil) {
          block = self};
        if (($a = (into = opts['$[]']("into"))) !== false && $a !== nil) {
      ...
      def.$split_simple_csv = function(str) {
        ...
        if (($a = str['$empty?']()) !== false && $a !== nil) {
          ...
          current = [];
          quote_open = false;
          ($a = ($b = str).$each_char, $a._p = (TMP_43 = function(c){var self = TMP_43._s || this, $a, $case = nil;if (c == null) c = nil;
          return (function() {$case = c;if (","['$===']($case)) {if (quote_open !== false && quote_open !== nil) {
              return current.$push(c)
              } else {
              values['$<<'](current.$join().$strip());
              return current = [];
            }}else if ("\""['$===']($case)) {return quote_open = ($a = quote_open, ($a === nil || $a === false))}else {return current.$push(c)}})()}, TMP_43._s = self, TMP_43), $a).call($b);
          values['$<<'](current.$join().$strip());
          } else {
          values = ($a = ($c = str.$split(",")).$map, $a._p = (TMP_44 = function(it){var self = TMP_44._s || this;if (it == null) it = nil;
      ...
      def.$resolve_subs = function(subs, type, defaults, subject) {
        ...
        if (($a = subs['$nil_or_empty?']()) !== false && $a !== nil) {
          return []};
        candidates = [];
        ...
        ($a = ($b = subs.$split(",")).$each, $a._p = (TMP_45 = function(val){var self = TMP_45._s || this, $a, $b, $c, key = nil, first = nil, operation = nil, resolved_keys = nil, resolved_key = nil, candidate = nil, $case = nil;if (val == null) val = nil;
        key = val.$strip();
          ...
          } else if (($a = ($b = (($c = type['$==']("inline")) ? key.$length()['$=='](1) : $c), $b !== false && $b !== nil ?($scope.SUB_SYMBOLS['$has_key?'](key)) : $b)) !== false && $a !== nil) {
            resolved_key = $scope.SUB_SYMBOLS['$[]'](key);
            if (($a = (candidate = $scope.COMPOSITE_SUBS['$[]'](resolved_key))) !== false && $a !== nil) {
        ...
        if (($a = (candidates['$-'](resolved))['$empty?']()) === false || $a === nil) {
      ...
      def.$highlight_source = function(source, sub_callouts, highlighter) {
        var $a, $b, TMP_46, $c, $d, TMP_48, self = this, callout_marks = nil, lineno = nil, callout_on_last = nil, last = nil, linenums_mode = nil, $case = nil, result = nil, lexer = nil, opts = nil, reached_code = nil;
        if (self.document == null) self.document = nil;
        if (self.passthroughs == null) self.passthroughs = nil;
        ...
        if (sub_callouts !== false && sub_callouts !== nil) {
          last = -1;
          source = ($a = ($b = source.$split($scope.EOL)).$map, $a._p = (TMP_46 = function(line){var self = TMP_46._s || this, $a, $b, TMP_47;if (line == null) line = nil;
          lineno = lineno['$+'](1);
        ...
        $case = highlighter;if ("coderay"['$===']($case)) {result = ((($a = $opal.Object._scope.CodeRay) == null ? $opal.cm('CodeRay') : $a))._scope.Duo['$[]'](self.$attr("language", "text").$to_sym(), "html", $hash2(["css", "line_numbers", "line_number_anchors"], {"css": (((($a = self.document.$attributes()['$[]']("coderay-css")) !== false && $a !== nil) ? $a : "class")).$to_sym(), "line_numbers": (linenums_mode = ((function() {if (($a = (self['$attr?']("linenums"))) !== false && $a !== nil) {
          ...
          return nil
        }; return nil; })())), "line_number_anchors": false})).$highlight(source)}else if ("pygments"['$===']($case)) {if (($a = (lexer = ((($c = $opal.Object._scope.Pygments) == null ? $opal.cm('Pygments') : $c))._scope.Lexer['$[]'](self.$attr("language")))) !== false && $a !== nil) {
          opts = $hash2(["cssclass", "classprefix", "nobackground"], {"cssclass": "pyhl", "classprefix": "tok-", "nobackground": true});
          if (($a = (((($c = self.document.$attributes()['$[]']("pygments-css")) !== false && $c !== nil) ? $c : "class"))['$==']("class")) === false || $a === nil) {
            opts['$[]=']("noclasses", true);
...
if (conum == null) conum = nil;
      ...
      def.$lock_in_subs = function() {
        ...
        if (($a = self.default_subs) !== false && $a !== nil) {
          default_subs = self.default_subs
          } else {
          $case = self.content_model;if ("simple"['$===']($case)) {default_subs = $scope.SUBS['$[]']("normal")}else if ("verbatim"['$===']($case)) {default_subs = (function() {if (($a = ((($b = self.context['$==']("listing")) !== false && $b !== nil) ? $b : ((($c = self.context['$==']("literal")) ? ($d = (self['$option?']("listparagraph")), ($d === nil || $d === false)) : $c)))) !== false && $a !== nil) {
        ...
        if (($a = ($b = ($c = ($d = (($e = self.context['$==']("listing")) ? self.style['$==']("source") : $e), $d !== false && $d !== nil ?(self.document['$basebackend?']("html")) : $d), $c !== false && $c !== nil ?(((($d = ((highlighter = self.document.$attributes()['$[]']("source-highlighter")))['$==']("coderay")) !== false && $d !== nil) ? $d : highlighter['$==']("pygments"))) : $c), $b !== false && $b !== nil ?(self['$attr?']("language")) : $b)) !== false && $a !== nil) {
          return self.subs = ($a = ($b = self.subs).$map, $a._p = (TMP_50 = function(sub){var self = TMP_50._s || this;if (sub == null) sub = nil;
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$initialize = function(parent, context) {
        ...
        } else if (($a = (self.parent = parent)) !== false && $a !== nil) {
      ...
      def.$attr = function(name, default_value, inherit) {
        ...
        if (($a = name['$is_a?']((($b = $opal.Object._scope.Symbol) == null ? $opal.cm('Symbol') : $b))) !== false && $a !== nil) {
          name = name.$to_s()};
      ...
      def.$set_attr = function(name, value, overwrite) {
        ...
        if (($a = overwrite['$nil?']()) !== false && $a !== nil) {
          ...
          return true;
        } else if (($a = ((($b = overwrite) !== false && $b !== nil) ? $b : ($c = (self.attributes['$key?'](name)), ($c === nil || $c === false)))) !== false && $a !== nil) {
          self.attributes['$[]='](name, value);
          return true;
          } else {
          return false
      ...
      def.$media_uri = function(target, asset_dir_key) {
        ...
        if (($a = ($b = target['$include?'](":"), $b !== false && $b !== nil ?$scope.UriSniffRx['$=~'](target) : $b)) !== false && $a !== nil) {
          return target
      ...
      def.$image_uri = function(target_image, asset_dir_key) {
        ...
        if (($a = ($b = target_image['$include?'](":"), $b !== false && $b !== nil ?$scope.UriSniffRx['$=~'](target_image) : $b)) !== false && $a !== nil) {
          return target_image
        } else if (($a = (($b = self.document.$safe()['$<'](($scope.SafeMode)._scope.SECURE)) ? self.document['$attr?']("data-uri") : $b)) !== false && $a !== nil) {
    ...
    (function($base, $super) {
      ...
      def.$initialize = TMP_1 = function(parent, context) {var $zuper = $slice.call(arguments, 0);
        ...
        self.level = (function() {if (context['$==']("document")) {
          return 0
        } else if (($a = (($b = parent !== false && parent !== nil) ? ($c = context['$==']("section"), ($c === nil || $c === false)) : $b)) !== false && $a !== nil) {
          return parent.$level()
          } else {
          return nil
        }; return nil; })();
      ...
      def['$title?'] = function() {
        var $a, self = this;
        return ($a = self.title['$nil_or_empty?'](), ($a === nil || $a === false));
      };
      ...
      def.$sections = function() {
        var $a, $b, TMP_3, self = this;
        return ($a = ($b = self.blocks).$select, $a._p = (TMP_3 = function(block){var self = TMP_3._s || this;if (block == null) block = nil;
      ...
      def.$assign_caption = function(caption, key) {
        var $a, $b, $c, self = this, value = nil, caption_key = nil, caption_title = nil, caption_num = nil;
        if (caption == null) {
          caption = nil
        }
        if (key == null) {
        ...
        if (($a = ((($b = self['$title?']()) !== false && $b !== nil) ? $b : ($c = self.caption, ($c === nil || $c === false)))) === false || $a === nil) {
          return nil};
        if (caption !== false && caption !== nil) {
          self.caption = caption
        } else if (($a = (value = self.document.$attributes()['$[]']("caption"))) !== false && $a !== nil) {
          self.caption = value
        } else if (($a = self['$title?']()) !== false && $a !== nil) {
          ((($a = key) !== false && $a !== nil) ? $a : key = self.context.$to_s());
          caption_key = "" + (key) + "-caption";
          if (($a = (caption_title = self.document.$attributes()['$[]'](caption_key))) !== false && $a !== nil) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$parse = function(posattrs) {
        ...
        if (($a = self.attributes) !== false && $a !== nil) {
      ...
      $opal.defs(self, '$rekey', function(attributes, pos_attrs) {
        ...
        if (($a = key) === false || $a === nil) {
            return nil;};
          pos = index['$+'](1);
          if (($a = (val = attributes['$[]'](pos))) !== false && $a !== nil) {
      ...
      def.$parse_attribute = function(index, pos_attrs) {
        var $a, $b, $c, TMP_2, self = this, single_quoted_value = nil, first = nil, name = nil, value = nil, skipped = nil, c = nil, resolved_value = nil, $case = nil, resolved_name = nil, pos_name = nil;
        if (index == null) {
          index = 0
        }
        if (pos_attrs == null) {
        ...
        if (((first = self.scanner.$peek(1)))['$==']("\"")) {
          ...
          if (($a = self.scanner['$eos?']()) !== false && $a !== nil) {
            if (($a = name) === false || $a === nil) {
              return false}
            } else {
            skipped = ((($a = self.$skip_blank()) !== false && $a !== nil) ? $a : 0);
            c = self.scanner.$get_byte();
          };
          if (($a = ((($b = ($c = c, ($c === nil || $c === false))) !== false && $b !== nil) ? $b : c['$=='](self.delimiter))) !== false && $a !== nil) {
            value = nil
          } else if (($a = ((($b = ($c = c['$==']("="), ($c === nil || $c === false))) !== false && $b !== nil) ? $b : ($c = name, ($c === nil || $c === false)))) !== false && $a !== nil) {
            name = "" + (name) + (" "['$*'](skipped)) + (c) + (self.$scan_to_delimiter());
            value = nil;
            } else {
            self.$skip_blank();
            if (($a = self.scanner.$peek(1)) !== false && $a !== nil) {
...
if (o == null) o = nil;
          ...
          return value;}else if ("title"['$===']($case)) {return value}else {if (($a = (($c = single_quoted_value !== false && single_quoted_value !== nil) ? self.block : $c)) !== false && $a !== nil) {
          ...
          resolved_name = (function() {if (($a = (($c = single_quoted_value !== false && single_quoted_value !== nil) ? self.block : $c)) !== false && $a !== nil) {
            return (self.block.$apply_normal_subs(name))
            } else {
            return name
          }; return nil; })();
          if (($a = (pos_name = pos_attrs['$[]'](index))) !== false && $a !== nil) {
      ...
      def.$parse_attribute_value = function(quote) {
        ...
        if (self.scanner.$peek(1)['$=='](quote)) {
          ...
          return "";};
        if (($a = (value = self.$scan_to_quote(quote))) !== false && $a !== nil) {
          self.scanner.$get_byte();
...
(function($opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      var def = $Block._proto, $scope = $Block._scope, $a, TMP_1, TMP_2;
      ...
      def.$initialize = TMP_1 = function(parent, context, opts) {
        ...
        if (($a = ((attrs = opts['$[]']("attributes")))['$nil_or_empty?']()) !== false && $a !== nil) {
          self.attributes = $hash2([], {})
          } else {
          self.attributes = attrs.$dup()
        };
        if (($a = opts['$has_key?']("subs")) !== false && $a !== nil) {
          if (($a = ((($b = ($c = (subs = opts['$[]']("subs")), ($c === nil || $c === false))) !== false && $b !== nil) ? $b : (subs['$is_a?']((($c = $opal.Object._scope.Array) == null ? $opal.cm('Array') : $c))))) !== false && $a !== nil) {
        ...
        if (($a = ($b = (raw_source = opts['$[]']("source")), ($b === nil || $b === false))) !== false && $a !== nil) {
          return self.lines = []
        } else if (($a = raw_source['$is_a?']((($b = $opal.Object._scope.String) == null ? $opal.cm('String') : $b))) !== false && $a !== nil) {
      ...
      def.$content = TMP_2 = function() {var $zuper = $slice.call(arguments, 0);
        ...
        if (result.$size()['$<'](2)) {
          ...
          while (($b = ($c = (first = result['$[]'](0)), $c !== false && $c !== nil ?first.$rstrip()['$empty?']() : $c)) !== false && $b !== nil) {
          result.$shift()};
          while (($b = ($c = (last = result['$[]'](-1)), $c !== false && $c !== nil ?last.$rstrip()['$empty?']() : $c)) !== false && $b !== nil) {
          result.$pop()};
          return result['$*']($scope.EOL);
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$callout_ids = function(li_ordinal) {
        var $a, $b, TMP_1, self = this;
        return ($a = ($b = self.$current_list()).$map, $a._p = (TMP_1 = function(element){var self = TMP_1._s || this;if (element == null) element = nil;
...
(function($opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      var def = $BuiltIn._proto, $scope = $BuiltIn._scope;
  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        var def = $Factory._proto, $scope = $Factory._scope;
...
if (backend == null) backend = nil;
        ...
        return (def.$create = function(backend, opts) {
          ...
          if (($a = (converter = self.$resolve(backend))) !== false && $a !== nil) {
            if (($a = converter['$is_a?']((($b = $opal.Object._scope.Class) == null ? $opal.cm('Class') : $b))) !== false && $a !== nil) {
              return converter.$new(backend, opts)
              } else {
              return converter
            }};
          base_converter = (function() {$case = backend;if ("html5"['$===']($case)) {if (($a = (function(){ try { return (((((($b = $opal.Object._scope.Asciidoctor) == null ? $opal.cm('Asciidoctor') : $b))._scope.Converter)._scope.Html5Converter) != null ? 'constant' : nil); } catch (err) { if (err._klass === Opal.NameError) { return nil; } else { throw(err); }}; })()) === false || $a === nil) {
            };
          return $scope.Html5Converter.$new(backend, opts);}else if ("docbook5"['$===']($case)) {if (($a = (function(){ try { return (((((($b = $opal.Object._scope.Asciidoctor) == null ? $opal.cm('Asciidoctor') : $b))._scope.Converter)._scope.DocBook5Converter) != null ? 'constant' : nil); } catch (err) { if (err._klass === Opal.NameError) { return nil; } else { throw(err); }}; })()) === false || $a === nil) {
            };
          return $scope.DocBook5Converter.$new(backend, opts);}else if ("docbook45"['$===']($case)) {if (($a = (function(){ try { return (((((($b = $opal.Object._scope.Asciidoctor) == null ? $opal.cm('Asciidoctor') : $b))._scope.Converter)._scope.DocBook45Converter) != null ? 'constant' : nil); } catch (err) { if (err._klass === Opal.NameError) { return nil; } else { throw(err); }}; })()) === false || $a === nil) {
            };
          return $scope.DocBook45Converter.$new(backend, opts);}else { return nil }})();
          if (($a = opts['$key?']("template_dirs")) === false || $a === nil) {
            return base_converter};
          if (($a = (function(){ try { return (((((($b = $opal.Object._scope.Asciidoctor) == null ? $opal.cm('Asciidoctor') : $b))._scope.Converter)._scope.TemplateConverter) != null ? 'constant' : nil); } catch (err) { if (err._klass === Opal.NameError) { return nil; } else { throw(err); }}; })()) === false || $a === nil) {
            };
          if (($a = (function(){ try { return (((((($b = $opal.Object._scope.Asciidoctor) == null ? $opal.cm('Asciidoctor') : $b))._scope.Converter)._scope.CompositeConverter) != null ? 'constant' : nil); } catch (err) { if (err._klass === Opal.NameError) { return nil; } else { throw(err); }}; })()) === false || $a === nil) {
            };
  ...
  (function($base) {
    ...
    (function($base) {
      ...
      (function($base) {
        ...
        def.$register_for = function(backends) {
          ...
          if (backends['$=='](["*"])) {
            ($a = ($b = metaclass).$send, $a._p = (TMP_1 = function(name){var self = TMP_1._s || this;if (name == null) name = nil;
            return true}, TMP_1._s = self, TMP_1), $a).call($b, "define_method", "converts?")
            } else {
            ($a = ($c = metaclass).$send, $a._p = (TMP_2 = function(name){var self = TMP_2._s || this;if (name == null) name = nil;
      ...
      (function($base) {
        ...
        def.$setup_backend_info = function() {
          ...
          if (($a = (ext = $scope.DEFAULT_EXTENSIONS['$[]'](base))) !== false && $a !== nil) {
    ...
    (function($base) {
      ...
      def.$write = function(output, target) {
        ...
        if (($a = target['$respond_to?']("write")) !== false && $a !== nil) {
          target.$write(output.$chomp());
          target.$write($scope.EOL);
          } else {
          ($a = ($b = (($c = $opal.Object._scope.File) == null ? $opal.cm('File') : $c)).$open, $a._p = (TMP_3 = function(f){var self = TMP_3._s || this;if (f == null) f = nil;
...
(function($opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      var def = $Html5Converter._proto, $scope = $Html5Converter._scope;
      ...
      def.$initialize = function(backend, opts) {
        ...
        self.void_element_slash = (function() {if (($a = self.xml_mode) !== false && $a !== nil) {
          return "/"
          } else {
          return nil
        }; return nil; })();
      ...
      def.$document = function(node) {
        var $a, $b, $c, TMP_1, $d, TMP_2, self = this, result = nil, slash = nil, br = nil, linkcss = nil, lang_attribute = nil, iconfont_stylesheet = nil, $case = nil, pygments_style = nil, docinfo_content = nil, body_attrs = nil, authorcount = nil;
        result = [];
        slash = self.void_element_slash;
        br = "<br" + (slash) + ">";
        linkcss = ((($a = node.$safe()['$>='](($scope.SafeMode)._scope.SECURE)) !== false && $a !== nil) ? $a : (node['$attr?']("linkcss")));
        result['$<<']("<!DOCTYPE html>");
        lang_attribute = (function() {if (($a = (node['$attr?']("nolang"))) !== false && $a !== nil) {
          return nil
          } else {
          return " lang=\"" + (node.$attr("lang", "en")) + "\""
        }; return nil; })();
        result['$<<']("<html" + ((function() {if (($a = self.xml_mode) !== false && $a !== nil) {
        ...
        if (($a = $scope.DEFAULT_STYLESHEET_KEYS['$include?'](node.$attr("stylesheet"))) !== false && $a !== nil) {
        ...
        } else if (($a = node['$attr?']("stylesheet")) !== false && $a !== nil) {
          if (linkcss !== false && linkcss !== nil) {
            result['$<<']("<link rel=\"stylesheet\" href=\"" + (node.$normalize_web_path((node.$attr("stylesheet")), (node.$attr("stylesdir", "")))) + "\"" + (slash) + ">")
            } else {
            result['$<<']("<style>\n" + (node.$read_asset(node.$normalize_system_path((node.$attr("stylesheet")), (node.$attr("stylesdir", ""))), true)) + "\n</style>")
          }};
        if (($a = node['$attr?']("icons", "font")) !== false && $a !== nil) {
          if (($a = ($b = (node.$attr("iconfont-remote", ""))['$nil?'](), ($b === nil || $b === false))) !== false && $a !== nil) {
        ...
        if (($a = node['$attr?']("math")) !== false && $a !== nil) {
        ...
        if (($a = ((docinfo_content = node.$docinfo()))['$empty?']()) === false || $a === nil) {
          result['$<<'](docinfo_content)};
        result['$<<']("</head>");
        body_attrs = [];
        if (($a = node.$id()) !== false && $a !== nil) {
          body_attrs['$<<']("id=\"" + (node.$id()) + "\"")};
        if (($a = ($b = ($c = (node['$attr?']("toc-class")), $c !== false && $c !== nil ?(node['$attr?']("toc")) : $c), $b !== false && $b !== nil ?(node['$attr?']("toc-placement", "auto")) : $b)) !== false && $a !== nil) {
          body_attrs['$<<']("class=\"" + (node.$doctype()) + " " + (node.$attr("toc-class")) + " toc-" + (node.$attr("toc-position", "left")) + "\"")
          } else {
          body_attrs['$<<']("class=\"" + (node.$doctype()) + "\"")
        };
        if (($a = node['$attr?']("max-width")) !== false && $a !== nil) {
          body_attrs['$<<']("style=\"max-width: " + (node.$attr("max-width")) + ";\"")};
        result['$<<']("<body " + (body_attrs['$*'](" ")) + ">");
        if (($a = node.$noheader()) === false || $a === nil) {
          result['$<<']("<div id=\"header\">");
          if (node.$doctype()['$==']("manpage")) {
            result['$<<']("<h1>" + (node.$doctitle()) + " Manual Page</h1>");
            if (($a = ($b = (node['$attr?']("toc")), $b !== false && $b !== nil ?(node['$attr?']("toc-placement", "auto")) : $b)) !== false && $a !== nil) {
              result['$<<']("<div id=\"toc\" class=\"" + (node.$attr("toc-class", "toc")) + "\">\n<div id=\"toctitle\">" + (node.$attr("toc-title")) + "</div>\n" + (self.$outline(node)) + "\n</div>")};
            result['$<<']("<h2>" + (node.$attr("manname-title")) + "</h2>\n<div class=\"sectionbody\">\n<p>" + (node.$attr("manname")) + " - " + (node.$attr("manpurpose")) + "</p>\n</div>");
            } else {
            if (($a = node['$has_header?']()) !== false && $a !== nil) {
              if (($a = node.$notitle()) === false || $a === nil) {
                result['$<<']("<h1>" + (node.$header().$title()) + "</h1>")};
              if (($a = node['$attr?']("author")) !== false && $a !== nil) {
                result['$<<']("<span id=\"author\" class=\"author\">" + (node.$attr("author")) + "</span>" + (br));
                if (($a = node['$attr?']("email")) !== false && $a !== nil) {
                  result['$<<']("<span id=\"email\" class=\"email\">" + (node.$sub_macros(node.$attr("email"))) + "</span>" + (br))};
                if (((authorcount = (node.$attr("authorcount")).$to_i()))['$>'](1)) {
                  ($a = ($b = ($range(2, authorcount, false))).$each, $a._p = (TMP_1 = function(idx){var self = TMP_1._s || this, $a;if (idx == null) idx = nil;
                  result['$<<']("<span id=\"author" + (idx) + "\" class=\"author\">" + (node.$attr("author_" + (idx))) + "</span>" + (br));
                    if (($a = node['$attr?']("email_" + (idx))) !== false && $a !== nil) {
                      return result['$<<']("<span id=\"email" + (idx) + "\" class=\"email\">" + (node.$sub_macros(node.$attr("email_" + (idx)))) + "</span>" + (br))
                      } else {
                      return nil
                    };}, TMP_1._s = self, TMP_1), $a).call($b)};};
              if (($a = node['$attr?']("revnumber")) !== false && $a !== nil) {
                result['$<<']("<span id=\"revnumber\">" + ((((($a = (node.$attr("version-label"))) !== false && $a !== nil) ? $a : "")).$downcase()) + " " + (node.$attr("revnumber")) + ((function() {if (($a = (node['$attr?']("revdate"))) !== false && $a !== nil) {
                  return ","
                  } else {
                  return ""
                }; return nil; })()) + "</span>")};
              if (($a = node['$attr?']("revdate")) !== false && $a !== nil) {
                result['$<<']("<span id=\"revdate\">" + (node.$attr("revdate")) + "</span>")};
              if (($a = node['$attr?']("revremark")) !== false && $a !== nil) {
                result['$<<']("" + (br) + "<span id=\"revremark\">" + (node.$attr("revremark")) + "</span>")};};
            if (($a = ($c = (node['$attr?']("toc")), $c !== false && $c !== nil ?(node['$attr?']("toc-placement", "auto")) : $c)) !== false && $a !== nil) {
              result['$<<']("<div id=\"toc\" class=\"" + (node.$attr("toc-class", "toc")) + "\">\n<div id=\"toctitle\">" + (node.$attr("toc-title")) + "</div>\n" + (self.$outline(node)) + "\n</div>")};
          };
          result['$<<']("</div>");};
        result['$<<']("<div id=\"content\">\n" + (node.$content()) + "\n</div>");
        if (($a = ($c = node['$footnotes?'](), $c !== false && $c !== nil ?($d = (node['$attr?']("nofootnotes")), ($d === nil || $d === false)) : $c)) !== false && $a !== nil) {
          result['$<<']("<div id=\"footnotes\">\n<hr" + (slash) + ">");
          ($a = ($c = node.$footnotes()).$each, $a._p = (TMP_2 = function(footnote){var self = TMP_2._s || this;if (footnote == null) footnote = nil;
          return result['$<<']("<div class=\"footnote\" id=\"_footnote_" + (footnote.$index()) + "\">\n<a href=\"#_footnoteref_" + (footnote.$index()) + "\">" + (footnote.$index()) + "</a>. " + (footnote.$text()) + "\n</div>")}, TMP_2._s = self, TMP_2), $a).call($c);
          result['$<<']("</div>");};
        if (($a = node.$nofooter()) === false || $a === nil) {
          result['$<<']("<div id=\"footer\">");
          result['$<<']("<div id=\"footer-text\">");
          if (($a = node['$attr?']("revnumber")) !== false && $a !== nil) {
            result['$<<']("" + (node.$attr("version-label")) + " " + (node.$attr("revnumber")) + (br))};
          if (($a = node['$attr?']("last-update-label")) !== false && $a !== nil) {
            result['$<<']("" + (node.$attr("last-update-label")) + " " + (node.$attr("docdatetime")))};
          result['$<<']("</div>");
          if (($a = ((docinfo_content = node.$docinfo("footer")))['$empty?']()) === false || $a === nil) {
            result['$<<'](docinfo_content)};
          result['$<<']("</div>");};
        result['$<<']("</body>");
        result['$<<']("</html>");
      ...
      def.$embedded = function(node) {
        var $a, $b, $c, TMP_3, self = this, result = nil, id_attr = nil;
        result = [];
        if (($a = ($b = ($c = node.$notitle(), ($c === nil || $c === false)), $b !== false && $b !== nil ?node['$has_header?']() : $b)) !== false && $a !== nil) {
          id_attr = (function() {if (($a = node.$id()) !== false && $a !== nil) {
            return " id=\"" + (node.$id()) + "\""
            } else {
            return nil
          }; return nil; })();
        ...
        result['$<<'](node.$content());
        if (($a = ($b = node['$footnotes?'](), $b !== false && $b !== nil ?($c = (node['$attr?']("nofootnotes")), ($c === nil || $c === false)) : $b)) !== false && $a !== nil) {
          result['$<<']("<div id=\"footnotes\">\n<hr" + (self.void_element_slash) + ">");
          ($a = ($b = node.$footnotes()).$each, $a._p = (TMP_3 = function(footnote){var self = TMP_3._s || this;if (footnote == null) footnote = nil;
      ...
      def.$outline = function(node, opts) {
        ...
        if (($a = ((sections = node.$sections()))['$empty?']()) !== false && $a !== nil) {
          return nil};
        ...
        if (($a = (($b = slevel['$=='](0)) ? first_section.$special() : $b)) !== false && $a !== nil) {
          slevel = 1};
        result['$<<']("<ul class=\"sectlevel" + (slevel) + "\">");
        ($a = ($b = sections).$each, $a._p = (TMP_4 = function(section){var self = TMP_4._s || this, $a, $b, $c, $d, section_num = nil, child_toc_level = nil;if (section == null) section = nil;
        section_num = (function() {if (($a = (($b = ($c = section.$numbered(), $c !== false && $c !== nil ?($d = section.$caption(), ($d === nil || $d === false)) : $c), $b !== false && $b !== nil ?section.$level()['$<='](sectnumlevels) : $b))) !== false && $a !== nil) {
            return "" + (section.$sectnum()) + " "
            } else {
            return nil
          }; return nil; })();
          result['$<<']("<li><a href=\"#" + (section.$id()) + "\">" + (section_num) + (section.$captioned_title()) + "</a></li>");
          if (($a = (($b = section.$level()['$<'](toclevels)) ? (child_toc_level = self.$outline(section, $hash2(["toclevels", "secnumlevels"], {"toclevels": toclevels, "secnumlevels": sectnumlevels}))) : $b)) !== false && $a !== nil) {
            result['$<<']("<li>");
      ...
      def.$section = function(node) {
        var $a, $b, $c, $d, self = this, slevel = nil, htag = nil, id_attr = nil, anchor = nil, link_start = nil, link_end = nil, class_attr = nil, role = nil, sectnum = nil;
        slevel = node.$level();
        if (($a = (($b = slevel['$=='](0)) ? node.$special() : $b)) !== false && $a !== nil) {
          slevel = 1};
        htag = "h" + (slevel['$+'](1));
        id_attr = anchor = link_start = link_end = nil;
        if (($a = node.$id()) !== false && $a !== nil) {
          id_attr = " id=\"" + (node.$id()) + "\"";
          if (($a = node.$document()['$attr?']("sectanchors")) !== false && $a !== nil) {
            anchor = "<a class=\"anchor\" href=\"#" + (node.$id()) + "\"></a>"
          } else if (($a = node.$document()['$attr?']("sectlinks")) !== false && $a !== nil) {
            link_start = "<a class=\"link\" href=\"#" + (node.$id()) + "\">";
            link_end = "</a>";};};
        if (slevel['$=='](0)) {
          return "<h1" + (id_attr) + " class=\"sect0\">" + (anchor) + (link_start) + (node.$title()) + (link_end) + "</h1>\n" + (node.$content())
          } else {
          class_attr = (function() {if (($a = (role = node.$role())) !== false && $a !== nil) {
            return " class=\"sect" + (slevel) + " " + (role) + "\""
            } else {
            return " class=\"sect" + (slevel) + "\""
          }; return nil; })();
          sectnum = (function() {if (($a = ($b = ($c = node.$numbered(), $c !== false && $c !== nil ?($d = node.$caption(), ($d === nil || $d === false)) : $c), $b !== false && $b !== nil ?slevel['$<=']((node.$document().$attr("sectnumlevels", 3)).$to_i()) : $b)) !== false && $a !== nil) {
            return "" + (node.$sectnum()) + " "
            } else {
            return nil
          }; return nil; })();
      ...
      def.$admonition = function(node) {
        ...
        name = node.$attr("name");
        title_element = (function() {if (($a = node['$title?']()) !== false && $a !== nil) {
          return "<div class=\"title\">" + (node.$title()) + "</div>\n"
          } else {
          return nil
        }; return nil; })();
        caption = (function() {if (($a = node.$document()['$attr?']("icons")) !== false && $a !== nil) {
          if (($a = node.$document()['$attr?']("icons", "font")) !== false && $a !== nil) {
      ...
      def.$audio = function(node) {
        ...
        id_attribute = (function() {if (($a = node.$id()) !== false && $a !== nil) {
          return " id=\"" + (node.$id()) + "\""
          } else {
          return nil
        }; return nil; })();
        ...
        return "<div" + (id_attribute) + (class_attribute) + ">\n" + (title_element) + "<div class=\"content\">\n<audio src=\"" + (node.$media_uri(node.$attr("target"))) + "\"" + ((function() {if (($a = (node['$option?']("autoplay"))) !== false && $a !== nil) {
          return (self.$append_boolean_attribute("autoplay", xml))
          } else {
          return nil
        }; return nil; })()) + ((function() {if (($a = (node['$option?']("nocontrols"))) !== false && $a !== nil) {
          return nil
          } else {
          return (self.$append_boolean_attribute("controls", xml))
        }; return nil; })()) + ((function() {if (($a = (node['$option?']("loop"))) !== false && $a !== nil) {
      ...
      def.$colist = function(node) {
        ...
        if (($a = node['$title?']()) !== false && $a !== nil) {
          result['$<<']("<div class=\"title\">" + (node.$title()) + "</div>")};
        if (($a = node.$document()['$attr?']("icons")) !== false && $a !== nil) {
          result['$<<']("<table>");
...
if (item == null) item = nil;if (i == null) i = nil;
          ...
          result['$<<']("<ol>");
          ($a = ($c = node.$items()).$each, $a._p = (TMP_6 = function(item){var self = TMP_6._s || this;if (item == null) item = nil;
      ...
      def.$dlist = function(node) {
        ...
        ($a = ($b = node.$items()).$each, $a._p = (TMP_7 = function(terms, dd){var self = TMP_7._s || this, $a, $b, TMP_8;if (terms == null) terms = nil;if (dd == null) dd = nil;
        result['$<<']("<li>");
          ($a = ($b = [].concat(terms)).$each, $a._p = (TMP_8 = function(dt){var self = TMP_8._s || this;if (dt == null) dt = nil;
        ...
        result['$<<']("<table>");
        if (($a = ((($c = (node['$attr?']("labelwidth"))) !== false && $c !== nil) ? $c : (node['$attr?']("itemwidth")))) !== false && $a !== nil) {
          result['$<<']("<colgroup>");
          col_style_attribute = (function() {if (($a = (node['$attr?']("labelwidth"))) !== false && $a !== nil) {
            return " style=\"width: " + ((node.$attr("labelwidth")).$chomp("%")) + "%;\""
            } else {
            return nil
          }; return nil; })();
          result['$<<']("<col" + (col_style_attribute) + (slash) + ">");
          col_style_attribute = (function() {if (($a = (node['$attr?']("itemwidth"))) !== false && $a !== nil) {
          ...
          result['$<<']("<col" + (col_style_attribute) + (slash) + ">");
          result['$<<']("</colgroup>");};
        ($a = ($c = node.$items()).$each, $a._p = (TMP_9 = function(terms, dd){var self = TMP_9._s || this, $a, $b, TMP_10, terms_array = nil, last_term = nil;if (terms == null) terms = nil;if (dd == null) dd = nil;
        result['$<<']("<tr>");
          result['$<<']("<td class=\"hdlist1" + ((function() {if (($a = (node['$option?']("strong"))) !== false && $a !== nil) {
            return " strong"
            } else {
            return nil
          }; return nil; })()) + "\">");
          ...
          ($a = ($b = terms_array).$each, $a._p = (TMP_10 = function(dt){var self = TMP_10._s || this, $a, $b;if (dt == null) dt = nil;
          result['$<<'](dt.$text());
        ...
        dt_style_attribute = (function() {if (($a = node.$style()) !== false && $a !== nil) {
          return nil
          } else {
          return " class=\"hdlist1\""
        }; return nil; })();
        ($a = ($d = node.$items()).$each, $a._p = (TMP_11 = function(terms, dd){var self = TMP_11._s || this, $a, $b, TMP_12;if (terms == null) terms = nil;if (dd == null) dd = nil;
        ($a = ($b = [].concat(terms)).$each, $a._p = (TMP_12 = function(dt){var self = TMP_12._s || this;if (dt == null) dt = nil;
      ...
      def.$example = function(node) {
        ...
        return "<div" + (id_attribute) + " class=\"" + ((function() {if (($a = (role = node.$role())) !== false && $a !== nil) {
      ...
      def.$image = function(node) {
        ...
        align = (function() {if (($a = (node['$attr?']("align"))) !== false && $a !== nil) {
          return (node.$attr("align"))
          } else {
          return nil
        }; return nil; })();
        float = (function() {if (($a = (node['$attr?']("float"))) !== false && $a !== nil) {
          return (node.$attr("float"))
          } else {
          return nil
        }; return nil; })();
        style_attribute = (function() {if (($a = ((($b = align) !== false && $b !== nil) ? $b : float)) !== false && $a !== nil) {
        ...
        width_attribute = (function() {if (($a = (node['$attr?']("width"))) !== false && $a !== nil) {
          return " width=\"" + (node.$attr("width")) + "\""
          } else {
          return nil
        }; return nil; })();
        height_attribute = (function() {if (($a = (node['$attr?']("height"))) !== false && $a !== nil) {
        ...
        if (($a = (link = node.$attr("link"))) !== false && $a !== nil) {
      ...
      def.$listing = function(node) {
        var $a, $b, self = this, nowrap = nil, language = nil, language_classes = nil, $case = nil, pre_class = nil, code_class = nil, pre_start = nil, pre_end = nil, id_attribute = nil, title_element = nil, role = nil;
        nowrap = ((($a = ($b = (node.$document()['$attr?']("prewrap")), ($b === nil || $b === false))) !== false && $a !== nil) ? $a : (node['$option?']("nowrap")));
        if (node.$style()['$==']("source")) {
          ...
          code_class = (function() {if (language !== false && language !== nil) {
            ...
            return nil
          }; return nil; })()) + ((function() {if (($a = (node['$attr?']("linenums"))) !== false && $a !== nil) {
            return " linenums"
            } else {
            return nil
          }; return nil; })()) + "\"";
      ...
      def.$literal = function(node) {
        var $a, $b, self = this, id_attribute = nil, title_element = nil, nowrap = nil, role = nil;
        id_attribute = (function() {if (($a = node.$id()) !== false && $a !== nil) {
          return " id=\"" + (node.$id()) + "\""
          } else {
          return nil
      ...
      def.$math = function(node) {
        var $a, $b, $c, self = this, id_attribute = nil, title_element = nil, open = nil, close = nil, equation = nil, role = nil;
        id_attribute = (function() {if (($a = node.$id()) !== false && $a !== nil) {
          return " id=\"" + (node.$id()) + "\""
          } else {
          return nil
        ...
        if (($a = ($b = node.$subs()['$nil_or_empty?'](), $b !== false && $b !== nil ?($c = (node['$attr?']("subs")), ($c === nil || $c === false)) : $b)) !== false && $a !== nil) {
          equation = node.$sub_specialcharacters(equation)};
        if (($a = ($b = (equation['$start_with?'](open)), $b !== false && $b !== nil ?(equation['$end_with?'](close)) : $b)) === false || $a === nil) {
      ...
      def.$olist = function(node) {
        ...
        if (($a = node['$title?']()) !== false && $a !== nil) {
          result['$<<']("<div class=\"title\">" + (node.$title()) + "</div>")};
        type_attribute = (function() {if (($a = (keyword = node.$list_marker_keyword())) !== false && $a !== nil) {
          return " type=\"" + (keyword) + "\""
          } else {
          return nil
        }; return nil; })();
        start_attribute = (function() {if (($a = (node['$attr?']("start"))) !== false && $a !== nil) {
          return " start=\"" + (node.$attr("start")) + "\""
          } else {
          return nil
        }; return nil; })();
        result['$<<']("<ol class=\"" + (node.$style()) + "\"" + (type_attribute) + (start_attribute) + ">");
        ($a = ($b = node.$items()).$each, $a._p = (TMP_13 = function(item){var self = TMP_13._s || this, $a;if (item == null) item = nil;
        result['$<<']("<li>");
      ...
      def.$open = function(node) {
        var $a, $b, $c, $d, $e, self = this, style = nil, id_attr = nil, title_el = nil, role = nil;
        if (((style = node.$style()))['$==']("abstract")) {
          if (($a = (($b = node.$parent()['$=='](node.$document())) ? node.$document().$doctype()['$==']("book") : $b)) !== false && $a !== nil) {
            ...
            title_el = (function() {if (($a = node['$title?']()) !== false && $a !== nil) {
              return "<div class=\"title\">" + (node.$title()) + "</div>"
              } else {
              return nil
            }; return nil; })();
        ...
        } else if (($a = (($b = style['$==']("partintro")) ? (((($c = ((($d = ($e = node.$level()['$=='](0), ($e === nil || $e === false))) !== false && $d !== nil) ? $d : ($e = node.$parent().$context()['$==']("section"), ($e === nil || $e === false)))) !== false && $c !== nil) ? $c : ($d = node.$document().$doctype()['$==']("book"), ($d === nil || $d === false)))) : $b)) !== false && $a !== nil) {
          ...
          return "<div" + (id_attr) + " class=\"openblock" + ((function() {if (($a = (($b = style !== false && style !== nil) ? ($c = style['$==']("open"), ($c === nil || $c === false)) : $b)) !== false && $a !== nil) {
            return " " + (style)
            } else {
            return ""
      ...
      def.$paragraph = function(node) {
        ...
        attributes = (function() {if (($a = node.$id()) !== false && $a !== nil) {
          if (($a = node.$role()) !== false && $a !== nil) {
            return " id=\"" + (node.$id()) + "\" class=\"paragraph " + (node.$role()) + "\""
            } else {
            return " id=\"" + (node.$id()) + "\" class=\"paragraph\""
          }
        } else if (($a = node.$role()) !== false && $a !== nil) {
      ...
      def.$preamble = function(node) {
        ...
        toc = (function() {if (($a = ($b = (node['$attr?']("toc")), $b !== false && $b !== nil ?(node['$attr?']("toc-placement", "preamble")) : $b)) !== false && $a !== nil) {
      ...
      def.$quote = function(node) {
        ...
        attribution = (function() {if (($a = (node['$attr?']("attribution"))) !== false && $a !== nil) {
          return (node.$attr("attribution"))
          } else {
          return nil
        }; return nil; })();
        citetitle = (function() {if (($a = (node['$attr?']("citetitle"))) !== false && $a !== nil) {
          return (node.$attr("citetitle"))
          } else {
          return nil
        }; return nil; })();
        if (($a = ((($b = attribution) !== false && $b !== nil) ? $b : citetitle)) !== false && $a !== nil) {
      ...
      def.$table = function(node) {
        ...
        if (($a = (role_class = node.$role())) !== false && $a !== nil) {
          classes['$<<'](role_class)};
        class_attribute = " class=\"" + (classes['$*'](" ")) + "\"";
        styles = [(function() {if (($a = (node['$option?']("autowidth"))) !== false && $a !== nil) {
          return nil
          } else {
          return "width: " + (node.$attr("tablepcwidth")) + "%;"
        }; return nil; })(), (function() {if (($a = (node['$attr?']("float"))) !== false && $a !== nil) {
        ...
        if ((node.$attr("rowcount"))['$>'](0)) {
          slash = self.void_element_slash;
          result['$<<']("<colgroup>");
          if (($a = node['$option?']("autowidth")) !== false && $a !== nil) {
            tag = "<col" + (slash) + ">";
            ($a = ($b = node.$columns().$size()).$times, $a._p = (TMP_14 = function(){var self = TMP_14._s || this;
            return result['$<<'](tag)}, TMP_14._s = self, TMP_14), $a).call($b);
            } else {
            ($a = ($c = node.$columns()).$each, $a._p = (TMP_15 = function(col){var self = TMP_15._s || this;if (col == null) col = nil;
            return result['$<<']("<col style=\"width: " + (col.$attr("colpcwidth")) + "%;\"" + (slash) + ">")}, TMP_15._s = self, TMP_15), $a).call($c)
          };
          result['$<<']("</colgroup>");
          ($a = ($d = ($e = ($f = ["head", "foot", "body"]).$select, $e._p = (TMP_20 = function(tsec){var self = TMP_20._s || this, $a;if (tsec == null) tsec = nil;
          return ($a = node.$rows()['$[]'](tsec)['$empty?'](), ($a === nil || $a === false))}, TMP_20._s = self, TMP_20), $e).call($f)).$each, $a._p = (TMP_16 = function(tsec){var self = TMP_16._s || this, $a, $b, TMP_17;if (tsec == null) tsec = nil;
          result['$<<']("<t" + (tsec) + ">");
            ($a = ($b = node.$rows()['$[]'](tsec)).$each, $a._p = (TMP_17 = function(row){var self = TMP_17._s || this, $a, $b, TMP_18;if (row == null) row = nil;
            result['$<<']("<tr>");
              ($a = ($b = row).$each, $a._p = (TMP_18 = function(cell){var self = TMP_18._s || this, $a, $b, TMP_19, $c, cell_content = nil, $case = nil, cell_tag_name = nil, cell_class_attribute = nil, cell_colspan_attribute = nil, cell_rowspan_attribute = nil, cell_style_attribute = nil;if (cell == null) cell = nil;
              if (tsec['$==']("head")) {
                  ...
                  ($a = ($b = cell.$content()).$each, $a._p = (TMP_19 = function(text){var self = TMP_19._s || this;if (text == null) text = nil;
                  return cell_content = "" + (cell_content) + "<p class=\"tableblock\">" + (text) + "</p>"}, TMP_19._s = self, TMP_19), $a).call($b);}
                };
                cell_tag_name = ((function() {if (($a = ((($c = tsec['$==']("head")) !== false && $c !== nil) ? $c : cell.$style()['$==']("header"))) !== false && $a !== nil) {
                  return "th"
                  } else {
                  return "td"
                }; return nil; })());
                cell_class_attribute = " class=\"tableblock halign-" + (cell.$attr("halign")) + " valign-" + (cell.$attr("valign")) + "\"";
                cell_colspan_attribute = (function() {if (($a = cell.$colspan()) !== false && $a !== nil) {
                  return " colspan=\"" + (cell.$colspan()) + "\""
                  } else {
                  return nil
                }; return nil; })();
                cell_rowspan_attribute = (function() {if (($a = cell.$rowspan()) !== false && $a !== nil) {
                  return " rowspan=\"" + (cell.$rowspan()) + "\""
                  } else {
                  return nil
                }; return nil; })();
                cell_style_attribute = (function() {if (($a = (node.$document()['$attr?']("cellbgcolor"))) !== false && $a !== nil) {
      ...
      def.$toc = function(node) {
        ...
        if (($a = ((doc = node.$document()))['$attr?']("toc")) === false || $a === nil) {
          return "<!-- toc disabled -->"};
        if (($a = node.$id()) !== false && $a !== nil) {
          id_attr = " id=\"" + (node.$id()) + "\"";
          title_id_attr = "";
        } else if (($a = ((($b = doc['$embedded?']()) !== false && $b !== nil) ? $b : ($c = (doc['$attr?']("toc-placement")), ($c === nil || $c === false)))) !== false && $a !== nil) {
          id_attr = " id=\"toc\"";
        ...
        title = (function() {if (($a = node['$title?']()) !== false && $a !== nil) {
          return node.$title()
          } else {
          return (doc.$attr("toc-title"))
        }; return nil; })();
        levels = (function() {if (($a = (node['$attr?']("levels"))) !== false && $a !== nil) {
          return (node.$attr("levels")).$to_i()
          } else {
          return nil
        }; return nil; })();
        role = (function() {if (($a = node['$role?']()) !== false && $a !== nil) {
          return node.$role()
          } else {
      ...
      def.$ulist = function(node) {
        ...
        if (($a = (checklist = node['$option?']("checklist"))) !== false && $a !== nil) {
          div_classes.$insert(1, "checklist");
          ul_class_attribute = " class=\"checklist\"";
          if (($a = node['$option?']("interactive")) !== false && $a !== nil) {
            if (($a = node.$document()['$attr?']("htmlsyntax", "xml")) !== false && $a !== nil) {
          ...
          } else if (($a = node.$document()['$attr?']("icons", "font")) !== false && $a !== nil) {
          ...
          ul_class_attribute = (function() {if (($a = node.$style()) !== false && $a !== nil) {
        ...
        ($a = ($b = node.$items()).$each, $a._p = (TMP_21 = function(item){var self = TMP_21._s || this, $a, $b;if (item == null) item = nil;
        result['$<<']("<li>");
          if (($a = (($b = checklist !== false && checklist !== nil) ? (item['$attr?']("checkbox")) : $b)) !== false && $a !== nil) {
            result['$<<']("<p>" + ((function() {if (($a = (item['$attr?']("checked"))) !== false && $a !== nil) {
      ...
      def.$video = function(node) {
        ...
        return (function() {$case = node.$attr("poster");if ("vimeo"['$===']($case)) {start_anchor = (function() {if (($a = (node['$attr?']("start"))) !== false && $a !== nil) {
          return "#at=" + (node.$attr("start"))
          } else {
          return nil
        }; return nil; })();
        delimiter = "?";
        autoplay_param = (function() {if (($a = (node['$option?']("autoplay"))) !== false && $a !== nil) {
        ...
        controls_param = (function() {if (($a = (node['$option?']("nocontrols"))) !== false && $a !== nil) {
          return "&amp;controls=0"
          } else {
          return nil
        }; return nil; })();
        return "<div" + (id_attribute) + (class_attribute) + ">" + (title_element) + "\n<div class=\"content\">\n<iframe" + (width_attribute) + (height_attribute) + " src=\"//www.youtube.com/embed/" + (node.$attr("target")) + "?rel=0" + (start_param) + (end_param) + (autoplay_param) + (loop_param) + (controls_param) + "\" frameborder=\"0\"" + ((function() {if (($a = (node['$option?']("nofullscreen"))) !== false && $a !== nil) {
          return nil
          } else {
          return (self.$append_boolean_attribute("allowfullscreen", xml))
        }; return nil; })()) + "></iframe>\n</div>\n</div>";}else {poster_attribute = (function() {if (($a = (("") + (poster = node.$attr("poster")))['$empty?']()) !== false && $a !== nil) {
          return nil
          } else {
          return " poster=\"" + (node.$media_uri(poster)) + "\""
        }; return nil; })();
        time_anchor = (function() {if (($a = (((($b = (node['$attr?']("start"))) !== false && $b !== nil) ? $b : (node['$attr?']("end"))))) !== false && $a !== nil) {
          return "#t=" + (node.$attr("start")) + ((function() {if (($a = (node['$attr?']("end"))) !== false && $a !== nil) {
            return ","
            } else {
            return nil
        ...
        return "<div" + (id_attribute) + (class_attribute) + ">" + (title_element) + "\n<div class=\"content\">\n<video src=\"" + (node.$media_uri(node.$attr("target"))) + (time_anchor) + "\"" + (width_attribute) + (height_attribute) + (poster_attribute) + ((function() {if (($a = (node['$option?']("autoplay"))) !== false && $a !== nil) {
          return (self.$append_boolean_attribute("autoplay", xml))
          } else {
          return nil
        }; return nil; })()) + ((function() {if (($a = (node['$option?']("nocontrols"))) !== false && $a !== nil) {
      ...
      def.$inline_anchor = function(node) {
        ...
        return "<a href=\"" + (target) + "\">" + (text) + "</a>";}else if ("ref"['$===']($case)) {return "<a id=\"" + (target) + "\"></a>"}else if ("link"['$===']($case)) {class_attr = (function() {if (($a = (role = node.$role())) !== false && $a !== nil) {
          return " class=\"" + (role) + "\""
          } else {
          return nil
        }; return nil; })();
        window_attr = (function() {if (($a = (node['$attr?']("window"))) !== false && $a !== nil) {
      ...
      def.$inline_callout = function(node) {
        ...
        } else if (($a = node.$document()['$attr?']("icons")) !== false && $a !== nil) {
      ...
      def.$inline_footnote = function(node) {
        ...
        if (($a = (index = node.$attr("index"))) !== false && $a !== nil) {
          if (node.$type()['$==']("xref")) {
      ...
      def.$inline_image = function(node) {
        var $a, $b, $c, TMP_22, self = this, type = nil, style_class = nil, title_attribute = nil, img = nil, resolved_target = nil, attrs = nil, window_attr = nil, style_classes = nil, role = nil, style_attr = nil;
        if (($a = (($b = ((type = node.$type()))['$==']("icon")) ? (node.$document()['$attr?']("icons", "font")) : $b)) !== false && $a !== nil) {
          style_class = "icon-" + (node.$target());
          if (($a = node['$attr?']("size")) !== false && $a !== nil) {
            style_class = "" + (style_class) + " icon-" + (node.$attr("size"))};
          if (($a = node['$attr?']("rotate")) !== false && $a !== nil) {
            style_class = "" + (style_class) + " icon-rotate-" + (node.$attr("rotate"))};
          if (($a = node['$attr?']("flip")) !== false && $a !== nil) {
            style_class = "" + (style_class) + " icon-flip-" + (node.$attr("flip"))};
          title_attribute = (function() {if (($a = (node['$attr?']("title"))) !== false && $a !== nil) {
            return " title=\"" + (node.$attr("title")) + "\""
            } else {
            return nil
          }; return nil; })();
          img = "<i class=\"" + (style_class) + "\"" + (title_attribute) + "></i>";
        } else if (($a = (($b = type['$==']("icon")) ? ($c = (node.$document()['$attr?']("icons")), ($c === nil || $c === false)) : $b)) !== false && $a !== nil) {
          img = "[" + (node.$attr("alt")) + "]"
          } else {
          resolved_target = (function() {if (($a = (type['$==']("icon"))) !== false && $a !== nil) {
            return (node.$icon_uri(node.$target()))
            } else {
            return (node.$image_uri(node.$target()))
          }; return nil; })();
          attrs = ($a = ($b = ["alt", "width", "height", "title"]).$map, $a._p = (TMP_22 = function(name){var self = TMP_22._s || this, $a;if (name == null) name = nil;
          if (($a = (node['$attr?'](name))) !== false && $a !== nil) {
        ...
        if (($a = node['$attr?']("link")) !== false && $a !== nil) {
          window_attr = (function() {if (($a = (node['$attr?']("window"))) !== false && $a !== nil) {
            return " target=\"" + (node.$attr("window")) + "\""
            } else {
            return nil
        ...
        style_classes = (function() {if (($a = (role = node.$role())) !== false && $a !== nil) {
          return "" + (type) + " " + (role)
          } else {
          return type
        }; return nil; })();
        style_attr = (function() {if (($a = (node['$attr?']("float"))) !== false && $a !== nil) {
      ...
      def.$inline_kbd = function(node) {
        ...
        if (((keys = node.$attr("keys"))).$size()['$=='](1)) {
          ...
          key_combo = ($a = ($b = keys).$map, $a._p = (TMP_23 = function(key){var self = TMP_23._s || this;if (key == null) key = nil;
      ...
      def.$inline_menu = function(node) {
        ...
        menu = node.$attr("menu");
        if (($a = ($b = ((submenus = node.$attr("submenus")))['$empty?'](), ($b === nil || $b === false))) !== false && $a !== nil) {
          submenu_path = ($a = ($b = submenus).$map, $a._p = (TMP_24 = function(submenu){var self = TMP_24._s || this;if (submenu == null) submenu = nil;
        ...
        } else if (($a = (menuitem = node.$attr("menuitem"))) !== false && $a !== nil) {
      ...
      def.$inline_quoted = function(node) {
        ...
        quoted_text = (function() {if (($a = (role = node.$role())) !== false && $a !== nil) {
...
(function($opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      var def = $Document._proto, $scope = $Document._scope, $a, TMP_1, TMP_9, TMP_15;
      ...
      def.$initialize = TMP_1 = function(data, options) {
        ...
        if (($a = (parent_doc = options.$delete("parent"))) !== false && $a !== nil) {
          self.parent_document = parent_doc;
          ($a = "base_dir", $b = options, ((($c = $b['$[]']($a)) !== false && $c !== nil) ? $c : $b['$[]=']($a, parent_doc.$base_dir())));
          self.references = ($a = ($b = parent_doc.$references()).$inject, $a._p = (TMP_2 = function(accum, $d){var self = TMP_2._s || this;if (accum == null) accum = nil;key = $d[0];ref = $d[1];
          if (key['$==']("footnotes")) {
              accum['$[]=']("footnotes", [])
              } else {
              accum['$[]='](key, ref)
          ...
          ($a = ($c = (((($e = options['$[]']("attributes")) !== false && $e !== nil) ? $e : $hash2([], {})))).$each, $a._p = (TMP_3 = function(key, value){var self = TMP_3._s || this, $a;if (key == null) key = nil;if (value == null) value = nil;
        ...
        if (($a = parent_doc) === false || $a === nil) {
          if (($a = ($e = (safe_mode = options['$[]']("safe")), ($e === nil || $e === false))) !== false && $a !== nil) {
            self.safe = ($scope.SafeMode)._scope.SECURE
          } else if (($a = safe_mode['$is_a?']((($e = $opal.Object._scope.Fixnum) == null ? $opal.cm('Fixnum') : $e))) !== false && $a !== nil) {
            self.safe = safe_mode
            } else {
        ...
        attrs['$[]=']("sectids", "");
        if (($a = header_footer) === false || $a === nil) {
          attrs['$[]=']("notitle", "")};
...
if (l == null) l = nil;
        ...
        if (($a = (backend_val = options['$[]']("backend"))) !== false && $a !== nil) {
          attr_overrides['$[]=']("backend", "" + (backend_val))};
        if (($a = (doctype_val = options['$[]']("doctype"))) !== false && $a !== nil) {
        ...
        if (self.safe['$>='](($scope.SafeMode)._scope.SERVER)) {
          ...
          if (($a = ($f = ($g = parent_doc, ($g === nil || $g === false)), $f !== false && $f !== nil ?attr_overrides['$key?']("docfile") : $f)) !== false && $a !== nil) {
          ...
          if (self.safe['$>='](($scope.SafeMode)._scope.SECURE)) {
            if (($a = attr_overrides.$fetch("linkcss", "")['$nil?']()) === false || $a === nil) {
              attr_overrides['$[]=']("linkcss", "")};
            ($a = "icons", $f = attr_overrides, ((($g = $f['$[]']($a)) !== false && $g !== nil) ? $g : $f['$[]=']($a, nil)));};};
        ($a = ($f = attr_overrides).$delete_if, $a._p = (TMP_5 = function(key, val){var self = TMP_5._s || this, $a, $b, $c, verdict = nil;if (key == null) key = nil;if (val == null) val = nil;
        verdict = false;
          if (($a = val['$nil?']()) !== false && $a !== nil) {
            attrs.$delete(key)
            } else {
            if (($a = ($b = (val['$is_a?']((($c = $opal.Object._scope.String) == null ? $opal.cm('String') : $c))), $b !== false && $b !== nil ?(val['$end_with?']("@")) : $b)) !== false && $a !== nil) {
              val = val.$chop();
              verdict = true;};
            attrs['$[]='](key, val);
          };
        ...
        if (parent_doc !== false && parent_doc !== nil) {
          ...
          self.extensions = (function() {if (initialize_extensions !== false && initialize_extensions !== nil) {
            registry = (function() {if (($a = (ext_registry = options['$[]']("extensions_registry"))) !== false && $a !== nil) {
              if (($a = ((($g = (ext_registry['$is_a?'](($scope.Extensions)._scope.Registry))) !== false && $g !== nil) ? $g : (($h = (($i = $opal.Object._scope.RUBY_ENGINE_JRUBY) == null ? $opal.cm('RUBY_ENGINE_JRUBY') : $i), $h !== false && $h !== nil ?(ext_registry['$is_a?']((((($i = $opal.Object._scope.AsciidoctorJ) == null ? $opal.cm('AsciidoctorJ') : $i))._scope.Extensions)._scope.ExtensionRegistry)) : $h)))) !== false && $a !== nil) {
                return ext_registry
                } else {
                return nil
              }
            } else if (($a = ((ext_block = options['$[]']("extensions")))['$is_a?']((($g = $opal.Object._scope.Proc) == null ? $opal.cm('Proc') : $g))) !== false && $a !== nil) {
          ...
          if (($a = (($h = data !== false && data !== nil) ? options['$[]']("parse") : $h)) !== false && $a !== nil) {
            return self.$parse()
            } else {
            return nil
          };
      ...
      def.$parse = function(data) {
        ...
        if (($a = self.parsed) === false || $a === nil) {
          ...
          if (($a = ($b = (exts = (function() {if (($c = self.parent_document) !== false && $c !== nil) {
            return nil
            } else {
            return self.extensions
          }; return nil; })()), $b !== false && $b !== nil ?exts['$preprocessors?']() : $b)) !== false && $a !== nil) {
...
if (ext == null) ext = nil;
          ...
          $scope.Parser.$parse(self.reader, self, $hash2(["header_only"], {"header_only": ($a = ($c = self.options['$[]']("parse_header_only"), ($c === nil || $c === false)), ($a === nil || $a === false))}));
          self.callouts.$rewind();
          if (($a = (($c = exts !== false && exts !== nil) ? exts['$treeprocessors?']() : $c)) !== false && $a !== nil) {
            ($a = ($c = exts.$treeprocessors()).$each, $a._p = (TMP_7 = function(ext){var self = TMP_7._s || this;if (ext == null) ext = nil;
      ...
      def.$counter = function(name, seed) {
        var $a, $b, $c, self = this, attr_is_seed = nil, attr_val = nil;
        if (seed == null) {
          seed = nil
        }
        if (($a = ($b = (attr_is_seed = ($c = ((attr_val = self.attributes['$[]'](name)))['$nil_or_empty?'](), ($c === nil || $c === false))), $b !== false && $b !== nil ?self.counters['$key?'](name) : $b)) !== false && $a !== nil) {
      ...
      def.$nextval = function(current) {
        ...
        if (($a = current['$is_a?']((($b = $opal.Object._scope.Integer) == null ? $opal.cm('Integer') : $b))) !== false && $a !== nil) {
          return current['$+'](1)
          } else {
          intval = current.$to_i();
      ...
      def.$register = function(type, value) {
        ...
        return (function() {$case = type;if ("ids"['$===']($case)) {if (($a = value['$is_a?']((($b = $opal.Object._scope.Array) == null ? $opal.cm('Array') : $b))) !== false && $a !== nil) {
      ...
      def['$nested?'] = function() {
        var $a, $b, self = this;
        return ($a = ($b = self.parent_document, ($b === nil || $b === false)), ($a === nil || $a === false));
      };
      ...
      def['$extensions?'] = function() {
        var $a, $b, self = this;
        return ($a = ($b = self.extensions, ($b === nil || $b === false)), ($a === nil || $a === false));
      };
      ...
      def.$doctitle = function(opts) {
        ...
        if (($a = ($b = ((val = self.attributes.$fetch("title", "")))['$empty?'](), ($b === nil || $b === false))) !== false && $a !== nil) {
          val = self.$title()
        } else if (($a = ($b = (sect = self.$first_section()), $b !== false && $b !== nil ?sect['$title?']() : $b)) !== false && $a !== nil) {
          val = sect.$title()
          } else {
          return nil
        };
      ...
      def.$notitle = function() {
        var $a, $b, self = this;
        return ($a = ($b = self.attributes['$key?']("showtitle"), ($b === nil || $b === false)), $a !== false && $a !== nil ?self.attributes['$key?']("notitle") : $a);
      };
      ...
      def.$save_attributes = function() {
        ...
        if (($a = ((($b = self.attributes['$key?']("doctitle")) !== false && $b !== nil) ? $b : ($c = (val = self.$doctitle()), ($c === nil || $c === false)))) === false || $a === nil) {
        ...
        if (($a = ((($b = ((($c = toc_val !== false && toc_val !== nil) ? (((($d = ($e = toc_val['$=='](""), ($e === nil || $e === false))) !== false && $d !== nil) ? $d : ($e = toc_position_val['$nil_or_empty?'](), ($e === nil || $e === false)))) : $c))) !== false && $b !== nil) ? $b : toc2_val)) !== false && $a !== nil) {
          ...
          return ($a = pos['$nil_or_empty?'](), ($a === nil || $a === false))}, TMP_10._s = self, TMP_10), $a).call($b);
          if (($a = ($c = ($d = position, ($d === nil || $d === false)), $c !== false && $c !== nil ?toc2_val : $c)) !== false && $a !== nil) {
...
if (name == null) name = nil;
          if (($a = ($b = self.attribute_overrides['$key?'](name), $b !== false && $b !== nil ?($c = self.attribute_overrides['$[]'](name)['$nil?'](), ($c === nil || $c === false)) : $b)) !== false && $a !== nil) {
      ...
      def.$playback_attributes = function(block_attributes) {
        ...
        if (($a = block_attributes['$key?']("attribute_entries")) !== false && $a !== nil) {
...
if (entry == null) entry = nil;
      ...
      def.$apply_attribute_value_subs = function(value) {
        ...
        if (($a = (m = $scope.AttributeEntryPassMacroRx.$match(value))) !== false && $a !== nil) {
      ...
      def.$update_backend_attributes = function(new_backend, force) {
        var $a, $b, $c, $d, self = this, attrs = nil, current_backend = nil, current_basebackend = nil, current_doctype = nil, resolved_name = nil, new_basebackend = nil, new_filetype = nil, new_outfilesuffix = nil, current_filetype = nil, page_width = nil;
        if (force == null) {
          force = false
        }
        if (($a = ((($b = force) !== false && $b !== nil) ? $b : ((($c = new_backend !== false && new_backend !== nil) ? ($d = new_backend['$=='](self.attributes['$[]']("backend")), ($d === nil || $d === false)) : $c)))) !== false && $a !== nil) {
          attrs = self.attributes;
          current_backend = attrs['$[]']("backend");
          current_basebackend = attrs['$[]']("basebackend");
          current_doctype = attrs['$[]']("doctype");
          if (($a = new_backend['$start_with?']("xhtml")) !== false && $a !== nil) {
            attrs['$[]=']("htmlsyntax", "xml");
            new_backend = new_backend['$[]']($range(1, -1, false));
          } else if (($a = new_backend['$start_with?']("html")) !== false && $a !== nil) {
            attrs['$[]=']("htmlsyntax", "html")};
          if (($a = (resolved_name = $scope.BACKEND_ALIASES['$[]'](new_backend))) !== false && $a !== nil) {
          ...
          attrs['$[]=']("backend-" + (new_backend), "");
          if (($a = (self.converter = self.$create_converter())['$is_a?'](($scope.Converter)._scope.BackendInfo)) !== false && $a !== nil) {
            ...
            if (($a = self['$attribute_locked?']("outfilesuffix")) === false || $a === nil) {
              attrs['$[]=']("outfilesuffix", new_outfilesuffix)};
          };
          if (($a = (current_filetype = attrs['$[]']("filetype"))) !== false && $a !== nil) {
            attrs.$delete("filetype-" + (current_filetype))};
          attrs['$[]=']("filetype", new_filetype);
          attrs['$[]=']("filetype-" + (new_filetype), "");
          if (($a = (page_width = $scope.DEFAULT_PAGE_WIDTHS['$[]'](new_basebackend))) !== false && $a !== nil) {
            attrs['$[]=']("pagewidth", page_width)
            } else {
            attrs.$delete("pagewidth")
          };
          if (($a = ($b = new_basebackend['$=='](current_basebackend), ($b === nil || $b === false))) !== false && $a !== nil) {
      ...
      def.$update_doctype_attributes = function(new_doctype) {
        var $a, $b, $c, self = this, attrs = nil, current_doctype = nil, current_backend = nil, current_basebackend = nil;
        if (($a = (($b = new_doctype !== false && new_doctype !== nil) ? ($c = new_doctype['$=='](self.attributes['$[]']("doctype")), ($c === nil || $c === false)) : $b)) !== false && $a !== nil) {
          attrs = self.attributes;
          current_doctype = attrs['$[]']("doctype");
          current_backend = attrs['$[]']("backend");
          current_basebackend = attrs['$[]']("basebackend");
      ...
      def.$create_converter = function() {
        ...
        template_dirs = (function() {if (($a = (template_dir = self.options['$[]']("template_dir"))) !== false && $a !== nil) {
          return converter_opts['$[]=']("template_dirs", [template_dir])
        } else if (($a = (template_dirs = self.options['$[]']("template_dirs"))) !== false && $a !== nil) {
        ...
        converter_factory = (function() {if (($a = (converter = self.options['$[]']("converter"))) !== false && $a !== nil) {
      ...
      def.$convert = function(opts) {
        var $a, $b, $c, TMP_13, self = this, block = nil, output = nil, transform = nil, exts = nil;
        if (opts == null) {
          opts = $hash2([], {})
        }
        if (($a = self.parsed) === false || $a === nil) {
        ...
        if (self.$doctype()['$==']("inline")) {
          if (($a = ($b = (block = self.blocks['$[]'](0)), $b !== false && $b !== nil ?($c = block.$content_model()['$==']("compound"), ($c === nil || $c === false)) : $b)) !== false && $a !== nil) {
            output = block.$content()
            } else {
            output = ""
          }
          } else {
          transform = (function() {if (($a = ((function() {if (($b = (opts['$key?']("header_footer"))) !== false && $b !== nil) {
        ...
        if (($a = self.parent_document) === false || $a === nil) {
          if (($a = ($b = (exts = self.extensions), $b !== false && $b !== nil ?exts['$postprocessors?']() : $b)) !== false && $a !== nil) {
            ($a = ($b = exts.$postprocessors()).$each, $a._p = (TMP_13 = function(ext){var self = TMP_13._s || this;if (ext == null) ext = nil;
      ...
      def.$write = function(output, target) {
        ...
        if (($a = self.converter['$is_a?']($scope.Writer)) !== false && $a !== nil) {
          ...
          if (($a = target['$respond_to?']("write")) !== false && $a !== nil) {
            ...
            ($a = ($b = (($c = $opal.Object._scope.File) == null ? $opal.cm('File') : $c)).$open, $a._p = (TMP_14 = function(f){var self = TMP_14._s || this;if (f == null) f = nil;
      ...
      def.$docinfo = function(pos, ext) {
        ...
        if (self.$safe()['$>='](($scope.SafeMode)._scope.SECURE)) {
          ...
          if (($a = ($b = (((($c = docinfo) !== false && $c !== nil) ? $c : docinfo2)), $b !== false && $b !== nil ?self.attributes['$key?']("docname") : $b)) !== false && $a !== nil) {
      ...
      return (def.$to_s = function() {
        var $a, $b, self = this;
        return "#<" + (self.$class()) + "@" + (self.$object_id()) + " {doctype: " + (self.$doctype().$inspect()) + ", doctitle: " + (((function() {if (($a = ($b = self.header['$=='](nil), ($b === nil || $b === false))) !== false && $a !== nil) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$initialize = TMP_1 = function(parent, context, text, opts) {
        ...
        if (($a = ((more_attributes = opts['$[]']("attributes")))['$nil_or_empty?']()) !== false && $a !== nil) {
          return nil
          } else {
...
(function($opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def['$text?'] = function() {
        var $a, self = this;
        return ($a = self.text['$nil_or_empty?'](), ($a === nil || $a === false));
      };
      ...
      def.$fold_first = function(continuation_connects_first_block, content_adjacent) {
        ...
        if (($a = ($b = ($c = (first_block = self.blocks['$[]'](0)), $c !== false && $c !== nil ?first_block['$is_a?']($scope.Block) : $c), $b !== false && $b !== nil ?(((($c = ((($d = first_block.$context()['$==']("paragraph")) ? ($e = continuation_connects_first_block, ($e === nil || $e === false)) : $d))) !== false && $c !== nil) ? $c : (($d = ($e = (((($f = content_adjacent) !== false && $f !== nil) ? $f : ($g = continuation_connects_first_block, ($g === nil || $g === false)))), $e !== false && $e !== nil ?first_block.$context()['$==']("literal") : $e), $d !== false && $d !== nil ?first_block['$option?']("listparagraph") : $d)))) : $b)) !== false && $a !== nil) {
          ...
          if (($a = self.text['$nil_or_empty?']()) === false || $a === nil) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      $opal.defs(self, '$parse_document_header', function(reader, document) {
        ...
        if (($a = ((val = document.$attributes()['$[]']("doctitle")))['$nil_or_empty?']()) === false || $a === nil) {
          document['$title='](val);
        ...
        if (($a = self['$is_next_line_document_title?'](reader, block_attributes)) !== false && $a !== nil) {
          ...
          if (($a = document.$id()) === false || $a === nil) {
            document['$id='](block_attributes.$delete("id"))};
          self.$parse_header_metadata(reader, document);};
        if (($a = ($b = ($c = ((val = document.$attributes()['$[]']("doctitle")))['$nil_or_empty?'](), ($c === nil || $c === false)), $b !== false && $b !== nil ?($c = val['$=='](section_title), ($c === nil || $c === false)) : $b)) !== false && $a !== nil) {
          document['$title='](val);
          assigned_doctitle = val;};
      ...
      $opal.defs(self, '$parse_manpage_header', function(reader, document) {
        ...
        if (($a = (m = $scope.ManpageTitleVolnumRx.$match(document.$attributes()['$[]']("doctitle")))) !== false && $a !== nil) {
        ...
        if (($a = self['$is_next_line_section?'](reader, $hash2([], {}))) !== false && $a !== nil) {
          ...
          if (name_section.$level()['$=='](1)) {
            ...
            if (($a = (m = $scope.ManpageNamePurposeRx.$match(name_section_buffer))) !== false && $a !== nil) {
      ...
      $opal.defs(self, '$next_section', function(reader, parent, attributes) {
        ...
        part = false;
        intro = false;
        if (($a = ($b = (($c = parent.$context()['$==']("document")) ? parent.$blocks()['$empty?']() : $c), $b !== false && $b !== nil ?(((($c = ((($d = (has_header = parent['$has_header?']())) !== false && $d !== nil) ? $d : attributes.$delete("invalid-header"))) !== false && $c !== nil) ? $c : ($d = self['$is_next_line_section?'](reader, attributes), ($d === nil || $d === false)))) : $b)) !== false && $a !== nil) {
          ...
          attributes = (function() {if (($a = (title = attributes['$[]']("title"))) !== false && $a !== nil) {
            return $hash2(["title"], {"title": title})
            } else {
            return $hash2([], {})
          }; return nil; })();
          current_level = section.$level();
          if (($a = (($b = current_level['$=='](0)) ? doctype['$==']("book") : $b)) !== false && $a !== nil) {
            part = ($a = section.$special(), ($a === nil || $a === false));
            if (($a = ($b = section.$special(), $b !== false && $b !== nil ?(["preface", "appendix"]['$include?'](section.$sectname())) : $b)) !== false && $a !== nil) {
        ...
        if (($b = (next_level = self['$is_next_line_section?'](reader, attributes))) !== false && $b !== nil) {
          next_level = next_level['$+'](section.$document().$attr("leveloffset", 0).$to_i());
          if (($b = ((($c = next_level['$>'](current_level)) !== false && $c !== nil) ? $c : ((($d = section.$context()['$==']("document")) ? next_level['$=='](0) : $d)))) !== false && $b !== nil) {
            if (($b = (($c = next_level['$=='](0)) ? ($d = doctype['$==']("book"), ($d === nil || $d === false)) : $c)) !== false && $b !== nil) {
              self.$warn("asciidoctor: ERROR: " + (reader.$line_info()) + ": only book doctypes can contain level 0 sections")
            } else if (($b = (($c = expected_next_levels !== false && expected_next_levels !== nil) ? ($d = expected_next_levels['$include?'](next_level), ($d === nil || $d === false)) : $c)) !== false && $b !== nil) {
          ...
          if (($b = (new_block = self.$next_block(reader, (((($c = intro) !== false && $c !== nil) ? $c : section)), attributes, $hash2(["parse_metadata"], {"parse_metadata": false})))) !== false && $b !== nil) {
            if (part !== false && part !== nil) {
              if (($b = ($c = section['$blocks?'](), ($c === nil || $c === false))) !== false && $b !== nil) {
                if (($b = ($c = new_block.$style()['$==']("partintro"), ($c === nil || $c === false))) !== false && $b !== nil) {
                ...
                if (($b = ($c = ($d = intro, ($d === nil || $d === false)), $c !== false && $c !== nil ?first_block.$content_model()['$==']("compound") : $c)) !== false && $b !== nil) {
                  self.$warn("asciidoctor: ERROR: " + (block_line_info) + ": illegal block content outside of partintro block")
                } else if (($b = ($c = first_block.$content_model()['$==']("compound"), ($c === nil || $c === false))) !== false && $b !== nil) {
                  intro = $scope.Block.$new(section, "open", $hash2(["content_model"], {"content_model": "compound"}));
                  intro['$style=']("partintro");
        ...
        reader.$skip_blank_lines();};
        if (part !== false && part !== nil) {
          if (($a = ($b = section['$blocks?'](), $b !== false && $b !== nil ?section.$blocks()['$[]'](-1).$context()['$==']("section") : $b)) === false || $a === nil) {
          ...
          if (($a = preamble['$blocks?']()) !== false && $a !== nil) {
            if (($a = ($b = ($c = $scope.Compliance.$unwrap_standalone_preamble(), $c !== false && $c !== nil ?document.$blocks().$size()['$=='](1) : $c), $b !== false && $b !== nil ?(((($c = ($d = doctype['$==']("book"), ($d === nil || $d === false))) !== false && $c !== nil) ? $c : ($d = preamble.$blocks()['$[]'](0).$style()['$==']("abstract"), ($d === nil || $d === false)))) : $b)) !== false && $a !== nil) {
              document.$blocks().$shift();
              while (($b = (child_block = preamble.$blocks().$shift())) !== false && $b !== nil) {
              child_block['$parent='](document);
              document['$<<'](child_block);};}
            } else {
            document.$blocks().$shift()
          };};
        return [(function() {if (($a = ($b = section['$=='](parent), ($b === nil || $b === false))) !== false && $a !== nil) {
          return section
          } else {
          return nil
      ...
      $opal.defs(self, '$next_block', function(reader, parent, attributes, options) {
        ...
        if (($a = reader['$has_more_lines?']()) === false || $a === nil) {
          return nil};
        if (($a = ($b = (text_only = options['$[]']("text")), $b !== false && $b !== nil ?skipped['$>'](0) : $b)) !== false && $a !== nil) {
          options.$delete("text");
          text_only = false;};
        ...
        style = nil;
        explicit_style = nil;
        while (($b = ($c = ($d = block, ($d === nil || $d === false)), $c !== false && $c !== nil ?reader['$has_more_lines?']() : $c)) !== false && $b !== nil) {
        ...
        if (($b = (delimited_blk_match = self['$is_delimited_block?'](this_line, true))) !== false && $b !== nil) {
          ...
          if (($b = ($c = style, ($c === nil || $c === false))) !== false && $b !== nil) {
            ...
            } else if (($b = (($c = block_extensions !== false && block_extensions !== nil) ? extensions['$registered_for_block?'](style, block_context) : $c)) !== false && $b !== nil) {
              block_context = style.$to_sym()
              } else {
              self.$warn("asciidoctor: WARNING: " + (reader.$prev_line_info()) + ": invalid style for " + (block_context) + " block: " + (style));
              style = block_context.$to_s();
            }};};
        if (($b = delimited_block) === false || $b === nil) {
          while (($c = true) !== false && $c !== nil) {
          if (($c = ($d = (($e = style !== false && style !== nil) ? $scope.Compliance.$strict_verbatim_paragraphs() : $e), $d !== false && $d !== nil ?$scope.VERBATIM_STYLES['$include?'](style) : $d)) !== false && $c !== nil) {
            block_context = style.$to_sym();
          ...
          if (($c = text_only) === false || $c === nil) {
            ...
            if (($c = ($d = ($e = ($scope.LAYOUT_BREAK_LINES['$has_key?'](first_char)), $e !== false && $e !== nil ?this_line.$length()['$>='](3) : $e), $d !== false && $d !== nil ?((function() {if (($e = $scope.Compliance.$markdown_syntax()) !== false && $e !== nil) {
              return $scope.LayoutBreakLinePlusRx
              } else {
              return $scope.LayoutBreakLineRx
            }; return nil; })())['$=~'](this_line) : $d)) !== false && $c !== nil) {
              block = $scope.Block.$new(parent, $scope.LAYOUT_BREAK_LINES['$[]'](first_char), $hash2(["content_model"], {"content_model": "empty"}));
              break;;
            } else if (($c = ($d = this_line['$end_with?']("]"), $d !== false && $d !== nil ?(match = $scope.MediaBlockMacroRx.$match(this_line)) : $d)) !== false && $c !== nil) {
              ...
              if (($c = ((($d = ($e = style, ($e === nil || $e === false))) !== false && $d !== nil) ? $d : explicit_style)) === false || $c === nil) {
                if (blk_ctx['$==']("image")) {
              ...
              break;;
            } else if (($c = (($d = first_char['$==']("t")) ? (match = $scope.TocBlockMacroRx.$match(this_line)) : $d)) !== false && $c !== nil) {
              ...
              break;;
            } else if (($c = ($d = (($e = block_macro_extensions !== false && block_macro_extensions !== nil) ? (match = $scope.GenericBlockMacroRx.$match(this_line)) : $e), $d !== false && $d !== nil ?(extension = extensions['$registered_for_block_macro?'](match['$[]'](1))) : $d)) !== false && $c !== nil) {
              target = match['$[]'](2);
              ...
              if (($c = (default_attrs = extension.$config()['$[]']("default_attrs"))) !== false && $c !== nil) {
                ($c = ($d = default_attrs).$each, $c._p = (TMP_1 = function(k, v){var self = TMP_1._s || this, $a, $b, $c;if (k == null) k = nil;if (v == null) v = nil;
                return ($a = k, $b = attributes, ((($c = $b['$[]']($a)) !== false && $c !== nil) ? $c : $b['$[]=']($a, v)))}, TMP_1._s = self, TMP_1), $c).call($d)};
              if (($c = (block = extension.$process_method()['$[]'](parent, target, attributes.$dup()))) !== false && $c !== nil) {
              ...
              break;;};};
          if (($c = (match = $scope.CalloutListRx.$match(this_line))) !== false && $c !== nil) {
            block = $scope.List.$new(parent, "colist");
            attributes['$[]=']("style", "arabic");
            reader.$unshift_line(this_line);
            expected_index = 1;
            while (($e = ($f = reader['$has_more_lines?'](), $f !== false && $f !== nil ?(match = $scope.CalloutListRx.$match(reader.$peek_line())) : $f)) !== false && $e !== nil) {
            ...
            break;;
          } else if (($c = $scope.UnorderedListRx['$=~'](this_line)) !== false && $c !== nil) {
            reader.$unshift_line(this_line);
            block = self.$next_outline_list(reader, "ulist", parent);
            break;;
          } else if (($c = (match = $scope.OrderedListRx.$match(this_line))) !== false && $c !== nil) {
            reader.$unshift_line(this_line);
            ...
            if (($c = ($e = ($f = attributes['$[]']("style"), ($f === nil || $f === false)), $e !== false && $e !== nil ?($f = block.$attributes()['$[]']("style"), ($f === nil || $f === false)) : $e)) !== false && $c !== nil) {
              ...
              if (($c = marker['$start_with?'](".")) !== false && $c !== nil) {
                ...
                style = ($c = ($e = $scope.ORDERED_LIST_STYLES).$detect, $c._p = (TMP_2 = function(s){var self = TMP_2._s || this;if (s == null) s = nil;
            ...
            break;;
          } else if (($c = (match = $scope.DefinitionListRx.$match(this_line))) !== false && $c !== nil) {
            reader.$unshift_line(this_line);
            ...
            if (($c = float_id['$nil_or_empty?']()) !== false && $c !== nil) {
            ...
            break;;
          } else if (($c = (($f = style !== false && style !== nil) ? ($g = style['$==']("normal"), ($g === nil || $g === false)) : $f)) !== false && $c !== nil) {
            if (($c = $scope.PARAGRAPH_STYLES['$include?'](style)) !== false && $c !== nil) {
              ...
              reader.$unshift_line(this_line);
              break;;
            } else if (($c = (($f = block_extensions !== false && block_extensions !== nil) ? extensions['$registered_for_block?'](style, "paragraph") : $f)) !== false && $c !== nil) {
              block_context = style.$to_sym();
              cloaked_context = "paragraph";
              reader.$unshift_line(this_line);
              break;;
          ...
          if (($c = ($f = ($g = style['$==']("normal"), ($g === nil || $g === false)), $f !== false && $f !== nil ?$scope.LiteralParagraphRx['$=~'](this_line) : $f)) !== false && $c !== nil) {
            reader.$unshift_line(this_line);
            lines = ($c = ($f = reader).$read_lines_until, $c._p = (TMP_3 = function(line){var self = TMP_3._s || this, $a, $b, $c;if (line == null) line = nil;
            ...
            reader.$unshift_line(this_line);
            lines = ($c = ($g = reader).$read_lines_until, $c._p = (TMP_4 = function(line){var self = TMP_4._s || this, $a, $b, $c;if (line == null) line = nil;
            ...
            first_line = lines['$[]'](0);
            if (($c = ($h = ($i = text_only, ($i === nil || $i === false)), $h !== false && $h !== nil ?(admonition_match = $scope.AdmonitionParagraphRx.$match(first_line)) : $h)) !== false && $c !== nil) {
              ...
              ($c = ($h = lines)['$map!'], $c._p = (TMP_5 = function(line){var self = TMP_5._s || this, $a;if (line == null) line = nil;
              if (line['$=='](">")) {
            ...
            } else if (($c = ($i = ($j = ($k = ($l = ($m = text_only, ($m === nil || $m === false)), $l !== false && $l !== nil ?lines.$size()['$>'](1) : $l), $k !== false && $k !== nil ?first_line['$start_with?']("\"") : $k), $j !== false && $j !== nil ?lines['$[]'](-1)['$start_with?']("-- ") : $j), $i !== false && $i !== nil ?lines['$[]'](-2)['$end_with?']("\"") : $i)) !== false && $c !== nil) {
              ...
              if (($c = (($i = style['$==']("normal")) ? (((($j = ((first_char = lines['$[]'](0).$chr()))['$=='](" ")) !== false && $j !== nil) ? $j : first_char['$==']($scope.TAB))) : $i)) !== false && $c !== nil) {
                first_line = lines['$[]'](0);
                ...
                ($c = ($i = lines.$size()).$times, $c._p = (TMP_6 = function(i){var self = TMP_6._s || this;if (i == null) i = nil;
                if (i['$>'](0)) {
          ...
          break;;}};
        if (($b = ($c = ($j = block, ($j === nil || $j === false)), $c !== false && $c !== nil ?block_context : $c)) !== false && $b !== nil) {
          ...
          block = self.$build_block("listing", "verbatim", terminator, parent, reader, attributes);}else if ("literal"['$===']($case)) {block = self.$build_block(block_context, "verbatim", terminator, parent, reader, attributes)}else if ("pass"['$===']($case)) {block = self.$build_block(block_context, "raw", terminator, parent, reader, attributes)}else if ("math"['$===']($case) || "latexmath"['$===']($case) || "asciimath"['$===']($case)) {if (block_context['$==']("math")) {
            attributes['$[]=']("style", (function() {if (($b = ((default_math_syntax = document.$attributes()['$[]']("math")))['$nil_or_empty?']()) !== false && $b !== nil) {
              return "asciimath"
              } else {
          ...
          block = self.$build_block(block_context, ((function() {if (block_context['$==']("verse")) {
            ...
            return "compound"
          }; return nil; })()), terminator, parent, reader, attributes);}else {if (($b = (($c = block_extensions !== false && block_extensions !== nil) ? (extension = extensions['$registered_for_block?'](block_context, cloaked_context)) : $c)) !== false && $b !== nil) {
            if (($b = ($c = ((content_model = extension.$config()['$[]']("content_model")))['$==']("skip"), ($c === nil || $c === false))) !== false && $b !== nil) {
              if (($b = ($c = ((pos_attrs = ((($j = extension.$config()['$[]']("pos_attrs")) !== false && $j !== nil) ? $j : [])))['$empty?'](), ($c === nil || $c === false))) !== false && $b !== nil) {
                $scope.AttributeList.$rekey(attributes, [nil].$concat(pos_attrs))};
              if (($b = (default_attrs = extension.$config()['$[]']("default_attrs"))) !== false && $b !== nil) {
                ($b = ($c = default_attrs).$each, $b._p = (TMP_7 = function(k, v){var self = TMP_7._s || this, $a, $b, $c;if (k == null) k = nil;if (v == null) v = nil;
            ...
            if (($b = (($j = block !== false && block !== nil) ? ($k = content_model['$==']("skip"), ($k === nil || $k === false)) : $j)) === false || $b === nil) {
              attributes.$clear();
              return nil;};
            } else {
        ...
        if (block !== false && block !== nil) {
          ...
          if (block.$context()['$==']("image")) {
            ...
            if (($a = (scaledwidth = attributes['$[]']("scaledwidth"))) !== false && $a !== nil) {
              if (($a = ($range(48, 57, false))['$include?']((((($b = scaledwidth['$[]'](-1)) !== false && $b !== nil) ? $b : 0)).$ord())) !== false && $a !== nil) {
                attributes['$[]=']("scaledwidth", "" + (scaledwidth) + "%")}};
            } else {
            ($a = block, ((($b = $a.$caption()) !== false && $b !== nil) ? $b : $a['$caption='](attributes.$delete("caption"))))
          };
          block['$style='](attributes['$[]']("style"));
          if (($a = (block_id = (($b = block, ((($j = $b.$id()) !== false && $j !== nil) ? $j : $b['$id='](attributes['$[]']("id"))))))) !== false && $a !== nil) {
            document.$register("ids", [block_id, (((($a = attributes['$[]']("reftext")) !== false && $a !== nil) ? $a : ((function() {if (($b = block['$title?']()) !== false && $b !== nil) {
              return block.$title()
              } else {
              return nil
            }; return nil; })())))])};
          ...
          if (($a = block['$sub?']("callouts")) !== false && $a !== nil) {
            if (($a = (self.$catalog_callouts(block.$source(), document))) === false || $a === nil) {
      ...
      $opal.defs(self, '$build_block', function(block_context, content_model, terminator, parent, reader, attributes, options) {
        var $a, $b, TMP_8, $c, $d, self = this, skip_processing = nil, parse_as_content_model = nil, lines = nil, block_reader = nil, cursor = nil, indent = nil, extension = nil, block = nil;
        if (options == null) {
          options = $hash2([], {})
        }
        ...
        if (($a = terminator['$nil?']()) !== false && $a !== nil) {
          if (parse_as_content_model['$==']("verbatim")) {
            ...
            lines = ($a = ($b = reader).$read_lines_until, $a._p = (TMP_8 = function(line){var self = TMP_8._s || this, $a, $b;if (line == null) line = nil;
        ...
        if (content_model['$==']("skip")) {
          attributes.$clear();
          return lines;};
        if (($a = (($c = content_model['$==']("verbatim")) ? (indent = attributes['$[]']("indent")) : $c)) !== false && $a !== nil) {
          self['$reset_block_indent!'](lines, indent.$to_i())};
        if (($a = (extension = options['$[]']("extension"))) !== false && $a !== nil) {
          attributes.$delete("style");
          if (($a = (block = extension.$process_method()['$[]'](parent, ((($c = block_reader) !== false && $c !== nil) ? $c : ($scope.Reader.$new(lines))), attributes.$dup()))) !== false && $a !== nil) {
            attributes.$replace(block.$attributes());
            if (($a = (($c = block.$content_model()['$==']("compound")) ? ($d = ((lines = block.$lines()))['$nil_or_empty?'](), ($d === nil || $d === false)) : $c)) !== false && $a !== nil) {
        ...
        if (($a = ($c = (attributes['$has_key?']("title")), $c !== false && $c !== nil ?(block.$document()['$attr?']("" + (block.$context()) + "-caption")) : $c)) !== false && $a !== nil) {
      ...
      $opal.defs(self, '$next_outline_list', function(reader, list_type, parent) {
        ...
        while (($b = ($c = reader['$has_more_lines?'](), $c !== false && $c !== nil ?(match = $scope.ListRxMap['$[]'](list_type).$match(reader.$peek_line())) : $c)) !== false && $b !== nil) {
        marker = self.$resolve_list_marker(list_type, match['$[]'](1));
        if (($b = ($c = list_block['$items?'](), $c !== false && $c !== nil ?($d = marker['$=='](list_block.$items()['$[]'](0).$marker()), ($d === nil || $d === false)) : $c)) !== false && $b !== nil) {
      ...
      $opal.defs(self, '$catalog_callouts', function(text, document) {
        ...
        found = false;
        if (($a = text['$include?']("<")) !== false && $a !== nil) {
          ($a = ($b = text).$scan, $a._p = (TMP_9 = function(){var self = TMP_9._s || this, $a, $b, m = nil;
          m = $gvars["~"];
            if (($a = ($b = m['$[]'](0).$chr()['$==']("\\"), ($b === nil || $b === false))) !== false && $a !== nil) {
      ...
      $opal.defs(self, '$next_labeled_list', function(reader, match, parent) {
        ...
        while (($b = ($c = reader['$has_more_lines?'](), $c !== false && $c !== nil ?(match = sibling_pattern.$match(reader.$peek_line())) : $c)) !== false && $b !== nil) {
        $b = $opal.to_ary(self.$next_list_item(reader, list_block, match, sibling_pattern)), term = ($b[0] == null ? nil : $b[0]), item = ($b[1] == null ? nil : $b[1]);
        if (($b = (($c = previous_pair !== false && previous_pair !== nil) ? ($d = previous_pair['$[]'](-1), ($d === nil || $d === false)) : $c)) !== false && $b !== nil) {
          previous_pair.$pop();
      ...
      $opal.defs(self, '$next_list_item', function(reader, list_block, match, sibling_trait) {
        ...
        if (((list_type = list_block.$context()))['$==']("dlist")) {
          ...
          has_text = ($a = match['$[]'](3)['$nil_or_empty?'](), ($a === nil || $a === false));
          } else {
          text = match['$[]'](2);
          checkbox = false;
      ...
      $opal.defs(self, '$read_lines_for_list_item', function(reader, list_type, sibling_trait, has_text) {
        var $a, $b, $c, $d, $e, TMP_11, TMP_12, $f, TMP_13, TMP_14, $g, $h, TMP_15, $i, self = this, buffer = nil, continuation = nil, within_nested_list = nil, detached_continuation = nil, this_line = nil, prev_line = nil, match = nil, nested_list_type = nil;
        if (sibling_trait == null) {
          sibling_trait = nil
        }
        if (has_text == null) {
        ...
        if (($b = (match = self['$is_delimited_block?'](this_line, true))) !== false && $b !== nil) {
        ...
        } else if (($b = ($c = (($d = list_type['$==']("dlist")) ? ($e = continuation['$==']("active"), ($e === nil || $e === false)) : $d), $c !== false && $c !== nil ?$scope.BlockAttributeLineRx['$=~'](this_line) : $c)) !== false && $b !== nil) {
          break;
        } else if (($b = (($c = continuation['$==']("active")) ? ($d = this_line['$empty?'](), ($d === nil || $d === false)) : $c)) !== false && $b !== nil) {
          if (($b = $scope.LiteralParagraphRx['$=~'](this_line)) !== false && $b !== nil) {
            reader.$unshift_line(this_line);
            buffer.$concat(($b = ($c = reader).$read_lines_until, $b._p = (TMP_11 = function(line){var self = TMP_11._s || this, $a;if (line == null) line = nil;
            ...
            continuation = "inactive";
          } else if (($b = ((($d = ((($e = $scope.BlockTitleRx['$=~'](this_line)) !== false && $e !== nil) ? $e : $scope.BlockAttributeLineRx['$=~'](this_line))) !== false && $d !== nil) ? $d : $scope.AttributeEntryRx['$=~'](this_line))) !== false && $b !== nil) {
            buffer['$<<'](this_line)
            } else {
            ...
            }; return nil; })())).$detect, $d._p = (TMP_12 = function(ctx){var self = TMP_12._s || this;if (ctx == null) ctx = nil;
            return $scope.ListRxMap['$[]'](ctx)['$=~'](this_line)}, TMP_12._s = self, TMP_12), $d).call($e)) !== false && $b !== nil) {
              within_nested_list = true;
              if (($b = (($d = nested_list_type['$==']("dlist")) ? $gvars["~"]['$[]'](3)['$nil_or_empty?']() : $d)) !== false && $b !== nil) {
                has_text = false};};
            buffer['$<<'](this_line);
            continuation = "inactive";
          }
          ...
          if (this_line['$==']($scope.LIST_CONTINUATION)) {
            ...
            if (($b = self['$is_sibling_list_item?'](this_line, list_type, sibling_trait)) !== false && $b !== nil) {
              break;
            } else if (($b = nested_list_type = ($d = ($f = $scope.NESTABLE_LIST_CONTEXTS).$detect, $d._p = (TMP_13 = function(ctx){var self = TMP_13._s || this;if (ctx == null) ctx = nil;
            return $scope.ListRxMap['$[]'](ctx)['$=~'](this_line)}, TMP_13._s = self, TMP_13), $d).call($f)) !== false && $b !== nil) {
              buffer['$<<'](this_line);
              within_nested_list = true;
              if (($b = (($d = nested_list_type['$==']("dlist")) ? $gvars["~"]['$[]'](3)['$nil_or_empty?']() : $d)) !== false && $b !== nil) {
                has_text = false};
            } else if (($b = $scope.LiteralParagraphRx['$=~'](this_line)) !== false && $b !== nil) {
              reader.$unshift_line(this_line);
              buffer.$concat(($b = ($d = reader).$read_lines_until, $b._p = (TMP_14 = function(line){var self = TMP_14._s || this, $a;if (line == null) line = nil;
          ...
          if (($b = nested_list_type = ($g = ($h = ((function() {if (within_nested_list !== false && within_nested_list !== nil) {
            ...
            return $scope.NESTABLE_LIST_CONTEXTS
          }; return nil; })())).$detect, $g._p = (TMP_15 = function(ctx){var self = TMP_15._s || this;if (ctx == null) ctx = nil;
          return $scope.ListRxMap['$[]'](ctx)['$=~'](this_line)}, TMP_15._s = self, TMP_15), $g).call($h)) !== false && $b !== nil) {
            within_nested_list = true;
            if (($b = (($g = nested_list_type['$==']("dlist")) ? $gvars["~"]['$[]'](3)['$nil_or_empty?']() : $g)) !== false && $b !== nil) {
              has_text = false};};
          buffer['$<<'](this_line);
        };
        this_line = nil;};
        ...
        while (($b = ($g = ($i = buffer['$empty?'](), ($i === nil || $i === false)), $g !== false && $g !== nil ?buffer['$[]'](-1)['$empty?']() : $g)) !== false && $b !== nil) {
        buffer.$pop()};
        if (($a = ($b = ($g = buffer['$empty?'](), ($g === nil || $g === false)), $b !== false && $b !== nil ?buffer['$[]'](-1)['$==']($scope.LIST_CONTINUATION) : $b)) !== false && $a !== nil) {
          buffer.$pop()};
        return buffer;
      });

      $opal.defs(self, '$initialize_section', function(reader, parent, attributes) {
        var $a, $b, $c, self = this, document = nil, sect_id = nil, sect_reftext = nil, sect_title = nil, sect_level = nil, _ = nil, section = nil, style = nil, id = nil;
        if (attributes == null) {
          attributes = $hash2([], {})
        }
        document = parent.$document();
        ...
        if (($a = ($b = ($c = section.$id(), ($c === nil || $c === false)), $b !== false && $b !== nil ?(id = attributes['$[]']("id")) : $b)) !== false && $a !== nil) {
          section['$id='](id)
          } else {
      ...
      $opal.defs(self, '$is_next_line_section?', function(reader, attributes) {
        ...
        if (($a = ($b = ($c = ($d = ((val = attributes['$[]'](1)))['$nil?'](), ($d === nil || $d === false)), $c !== false && $c !== nil ?(((($d = ((ord_0 = val['$[]'](0).$ord()))['$=='](100)) !== false && $d !== nil) ? $d : ord_0['$=='](102))) : $c), $b !== false && $b !== nil ?val['$=~']($scope.FloatingTitleStyleRx) : $b)) !== false && $a !== nil) {
          return false};
        if (($a = reader['$has_more_lines?']()) === false || $a === nil) {
          return false};
      ...
      $opal.defs(self, '$is_single_line_section_title?', function(line1) {
        ...
        if (($a = ($b = (((($c = first_char['$==']("=")) !== false && $c !== nil) ? $c : (($d = $scope.Compliance.$markdown_syntax(), $d !== false && $d !== nil ?first_char['$==']("#") : $d)))), $b !== false && $b !== nil ?(match = $scope.AtxSectionRx.$match(line1)) : $b)) !== false && $a !== nil) {
      ...
      $opal.defs(self, '$is_two_line_section_title?', function(line1, line2) {
        ...
        if (($a = ($b = ($c = ($d = ($e = (($f = line1 !== false && line1 !== nil) ? line2 : $f), $e !== false && $e !== nil ?$scope.SECTION_LEVELS['$has_key?'](line2.$chr()) : $e), $d !== false && $d !== nil ?line2['$=~']($scope.SetextSectionLineRx) : $d), $c !== false && $c !== nil ?line1['$=~']($scope.SetextSectionTitleRx) : $c), $b !== false && $b !== nil ?(self.$line_length(line1)['$-'](self.$line_length(line2))).$abs()['$<='](1) : $b)) !== false && $a !== nil) {
      ...
      $opal.defs(self, '$parse_section_title', function(reader, document) {
        ...
        if (($a = ($b = (((($c = first_char['$==']("=")) !== false && $c !== nil) ? $c : (($d = $scope.Compliance.$markdown_syntax(), $d !== false && $d !== nil ?first_char['$==']("#") : $d)))), $b !== false && $b !== nil ?(match = $scope.AtxSectionRx.$match(line1)) : $b)) !== false && $a !== nil) {
          ...
          sect_title = match['$[]'](2);
          if (($a = ($b = sect_title['$end_with?']("]]"), $b !== false && $b !== nil ?(anchor_match = $scope.InlineSectionAnchorRx.$match(sect_title)) : $b)) !== false && $a !== nil) {
          ...
          if (($a = ($b = ($c = ($d = ($e = (line2 = reader.$peek_line(true)), $e !== false && $e !== nil ?$scope.SECTION_LEVELS['$has_key?'](line2.$chr()) : $e), $d !== false && $d !== nil ?line2['$=~']($scope.SetextSectionLineRx) : $d), $c !== false && $c !== nil ?(name_match = $scope.SetextSectionTitleRx.$match(line1)) : $c), $b !== false && $b !== nil ?(self.$line_length(line1)['$-'](self.$line_length(line2))).$abs()['$<='](1) : $b)) !== false && $a !== nil) {
      ...
      $opal.defs(self, '$parse_header_metadata', function(reader, document) {
        var $a, $b, $c, TMP_16, $d, TMP_17, $e, self = this, metadata = nil, implicit_author = nil, implicit_authors = nil, author_metadata = nil, rev_metadata = nil, rev_line = nil, match = nil, author_line = nil, authors = nil, author_key = nil;
        if (document == null) {
          document = nil
        }
        ...
        if (($a = ($b = reader['$has_more_lines?'](), $b !== false && $b !== nil ?($c = reader['$next_line_empty?'](), ($c === nil || $c === false)) : $b)) !== false && $a !== nil) {
          ...
          if (($a = author_metadata['$empty?']()) === false || $a === nil) {
            if (document !== false && document !== nil) {
              ($a = ($b = author_metadata).$each, $a._p = (TMP_16 = function(key, val){var self = TMP_16._s || this, $a, $b;if (key == null) key = nil;if (val == null) val = nil;
              if (($a = document.$attributes()['$has_key?'](key)) !== false && $a !== nil) {
                  return nil
                  } else {
                  return document.$attributes()['$[]='](key, ((function() {if (($a = (val['$is_a?']((($b = $opal.Object._scope.String) == null ? $opal.cm('String') : $b)))) !== false && $a !== nil) {
          ...
          if (($a = ($c = reader['$has_more_lines?'](), $c !== false && $c !== nil ?($d = reader['$next_line_empty?'](), ($d === nil || $d === false)) : $c)) !== false && $a !== nil) {
            ...
            if (($a = (match = $scope.RevisionInfoLineRx.$match(rev_line))) !== false && $a !== nil) {
          ...
          if (($a = rev_metadata['$empty?']()) === false || $a === nil) {
            if (document !== false && document !== nil) {
              ($a = ($c = rev_metadata).$each, $a._p = (TMP_17 = function(key, val){var self = TMP_17._s || this, $a;if (key == null) key = nil;if (val == null) val = nil;
              if (($a = document.$attributes()['$has_key?'](key)) !== false && $a !== nil) {
                  return nil
                  } else {
      ...
      $opal.defs(self, '$process_authors', function(author_line, names_only, multiple) {
        ...
        author_entries = (function() {if (multiple !== false && multiple !== nil) {
          return ($a = ($b = (author_line.$split(";"))).$map, $a._p = (TMP_18 = function(line){var self = TMP_18._s || this;if (line == null) line = nil;
        ...
        if (($a = author_entry['$empty?']()) !== false && $a !== nil) {
          ...
          } else if (($a = (match = $scope.AuthorInfoLineRx.$match(author_entry))) !== false && $a !== nil) {
            segments = match.$to_a();
            segments.$shift();};
      ...
      $opal.defs(self, '$parse_block_metadata_line', function(reader, parent, attributes, options) {
        var $a, $b, $c, $d, self = this, next_line = nil, commentish = nil, match = nil, terminator = nil, in_square_brackets = nil;
        if (options == null) {
          options = $hash2([], {})
        }
        if (($a = reader['$has_more_lines?']()) === false || $a === nil) {
        ...
        if (($a = ($b = (commentish = next_line['$start_with?']("//")), $b !== false && $b !== nil ?(match = $scope.CommentBlockRx.$match(next_line)) : $b)) !== false && $a !== nil) {
          terminator = match['$[]'](0);
        ...
        } else if (($a = (($b = commentish !== false && commentish !== nil) ? $scope.CommentLineRx['$=~'](next_line) : $b)) === false || $a === nil) {
          if (($a = ($b = ($c = ($d = options['$[]']("text"), ($d === nil || $d === false)), $c !== false && $c !== nil ?next_line['$start_with?'](":") : $c), $b !== false && $b !== nil ?(match = $scope.AttributeEntryRx.$match(next_line)) : $b)) !== false && $a !== nil) {
            self.$process_attribute_entry(reader, parent, attributes, match)
          } else if (($a = ($b = (in_square_brackets = ($c = next_line['$start_with?']("["), $c !== false && $c !== nil ?next_line['$end_with?']("]") : $c)), $b !== false && $b !== nil ?(match = $scope.BlockAnchorRx.$match(next_line)) : $b)) !== false && $a !== nil) {
            if (($a = match['$[]'](1)['$nil_or_empty?']()) === false || $a === nil) {
              attributes['$[]=']("id", match['$[]'](1));
              if (($a = match['$[]'](2)['$nil?']()) === false || $a === nil) {
                attributes['$[]=']("reftext", match['$[]'](2))};}
          } else if (($a = (($b = in_square_brackets !== false && in_square_brackets !== nil) ? (match = $scope.BlockAttributeListRx.$match(next_line)) : $b)) !== false && $a !== nil) {
            parent.$document().$parse_attributes(match['$[]'](1), [], $hash2(["sub_input", "into"], {"sub_input": true, "into": attributes}))
          } else if (($a = ($b = ($c = options['$[]']("text"), ($c === nil || $c === false)), $b !== false && $b !== nil ?(match = $scope.BlockTitleRx.$match(next_line)) : $b)) !== false && $a !== nil) {
      ...
      $opal.defs(self, '$is_sibling_list_item?', function(line, list_type, sibling_trait) {
        ...
        if (($a = sibling_trait['$is_a?']((($b = $opal.Object._scope.Regexp) == null ? $opal.cm('Regexp') : $b))) !== false && $a !== nil) {
        ...
        if (($a = (m = matcher.$match(line))) !== false && $a !== nil) {
      ...
      $opal.defs(self, '$parse_col_specs', function(records) {
        ...
        if (($a = $scope.DigitsRx['$=~'](records)) !== false && $a !== nil) {
        ...
        specs = [];
        ($a = ($c = records.$split(",")).$each, $a._p = (TMP_26 = function(record){var self = TMP_26._s || this, $a, $b, $c, TMP_27, m = nil, spec = nil, colspec = nil, rowspec = nil, repeat = nil;if (record == null) record = nil;
        if (($a = (m = $scope.ColumnSpecRx.$match(record))) !== false && $a !== nil) {
            spec = $hash2([], {});
            if (($a = m['$[]'](2)) !== false && $a !== nil) {
              $a = $opal.to_ary(m['$[]'](2).$split(".")), colspec = ($a[0] == null ? nil : $a[0]), rowspec = ($a[1] == null ? nil : $a[1]);
              if (($a = ($b = ($c = colspec['$nil_or_empty?'](), ($c === nil || $c === false)), $b !== false && $b !== nil ?($scope.Table)._scope.ALIGNMENTS['$[]']("h")['$has_key?'](colspec) : $b)) !== false && $a !== nil) {
                spec['$[]=']("halign", ($scope.Table)._scope.ALIGNMENTS['$[]']("h")['$[]'](colspec))};
              if (($a = ($b = ($c = rowspec['$nil_or_empty?'](), ($c === nil || $c === false)), $b !== false && $b !== nil ?($scope.Table)._scope.ALIGNMENTS['$[]']("v")['$has_key?'](rowspec) : $b)) !== false && $a !== nil) {
      ...
      $opal.defs(self, '$parse_cell_spec', function(line, pos) {
        ...
        if (($a = (m = ((function() {if (pos['$==']("start")) {
        ...
        }; return nil; })()).$match(line))) !== false && $a !== nil) {
          spec = $hash2([], {});
          ...
          if (($a = m['$[]'](1)) !== false && $a !== nil) {
            ...
            colspec = (function() {if (($a = colspec['$nil_or_empty?']()) !== false && $a !== nil) {
              return 1
              } else {
              return colspec.$to_i()
            }; return nil; })();
            rowspec = (function() {if (($a = rowspec['$nil_or_empty?']()) !== false && $a !== nil) {
              return 1
              } else {
              return rowspec.$to_i()
            }; return nil; })();
      ...
      $opal.defs(self, '$reset_block_indent!', function(lines, indent) {
        var $a, $b, $c, TMP_31, TMP_32, $d, TMP_33, self = this, tab_detected = nil, tab_expansion = nil, offsets = nil, offset = nil, padding = nil;
        if (indent == null) {
          indent = 0
        }
        if (($a = ((($b = ($c = indent, ($c === nil || $c === false))) !== false && $b !== nil) ? $b : lines['$empty?']())) !== false && $a !== nil) {
          return nil};
        tab_detected = false;
        tab_expansion = "    ";
        ...
        if (($a = line.$chr().$lstrip()['$empty?']()) === false || $a === nil) {
            return ($breaker.$v = [], $breaker)};
          if (($a = line['$include?']($scope.TAB)) !== false && $a !== nil) {
            tab_detected = true;
    ...
    (function($base, $super) {
      ...
      def.$initialize = function(file_separator, working_dir) {
        ...
        if (working_dir !== false && working_dir !== nil) {
          self.working_dir = (function() {if (($a = (self['$is_root?'](working_dir))) !== false && $a !== nil) {
            return working_dir
            } else {
      ...
      def['$is_root?'] = function(path) {
        var $a, $b, self = this;
        if (($a = path['$start_with?']($scope.SLASH)) !== false && $a !== nil) {
          return true
        } else if (($a = (($b = self.file_separator['$==']($scope.BACKSLASH)) ? $scope.WindowsRootRx['$=~'](path) : $b)) !== false && $a !== nil) {
          return true
          } else {
          return false
        };
      ...
      def.$posixfy = function(path) {
        ...
        if (($a = path['$nil_or_empty?']()) !== false && $a !== nil) {
          return ""
        } else if (($a = path['$include?']($scope.BACKSLASH)) !== false && $a !== nil) {
      ...
      def.$partition_path = function(path, web_path) {
        ...
        root = (function() {if (web_path !== false && web_path !== nil) {
          if (($a = self['$is_web_root?'](posix_path)) !== false && $a !== nil) {
            return $scope.SLASH
          } else if (($a = posix_path['$start_with?']($scope.DOT_SLASH)) !== false && $a !== nil) {
            return $scope.DOT_SLASH
            } else {
            return nil
          }
        } else if (($a = self['$is_root?'](posix_path)) !== false && $a !== nil) {
          if (($a = self['$is_unc?'](posix_path)) !== false && $a !== nil) {
            return $scope.DOUBLE_SLASH
          } else if (($a = posix_path['$start_with?']($scope.SLASH)) !== false && $a !== nil) {
            return $scope.SLASH
            } else {
      ...
      def.$system_path = function(target, start, jail, opts) {
        ...
        if (($a = target['$nil_or_empty?']()) !== false && $a !== nil) {
          target_segments = []
          } else {
        ...
        if (($a = target_segments['$empty?']()) !== false && $a !== nil) {
          if (($a = start['$nil_or_empty?']()) !== false && $a !== nil) {
            ...
            if (($a = jail) === false || $a === nil) {
              return self.$expand_path(start)}
            } else {
            return self.$system_path(start, jail, jail)
          }};
        if (($a = (($b = target_root !== false && target_root !== nil) ? ($c = target_root['$==']($scope.DOT_SLASH), ($c === nil || $c === false)) : $b)) !== false && $a !== nil) {
          resolved_target = self.$join_path(target_segments, target_root);
          if (($a = ((($b = ($c = jail, ($c === nil || $c === false))) !== false && $b !== nil) ? $b : (resolved_target['$start_with?'](jail)))) !== false && $a !== nil) {
        ...
        if (jail['$=='](start)) {
          ...
          if (($a = start['$start_with?'](jail)) === false || $a === nil) {
      ...
      def.$web_path = function(target, start) {
        ...
        start = self.$posixfy(start);
        uri_prefix = nil;
        if (($a = ((($b = start['$nil_or_empty?']()) !== false && $b !== nil) ? $b : (self['$is_web_root?'](target)))) === false || $a === nil) {
        ...
        resolved_segments = [];
        ($a = ($b = target_segments).$each, $a._p = (TMP_2 = function(segment){var self = TMP_2._s || this, $a, $b, $c;if (segment == null) segment = nil;
        if (segment['$==']($scope.DOT_DOT)) {
            if (($a = resolved_segments['$empty?']()) !== false && $a !== nil) {
              if (($a = (($b = target_root !== false && target_root !== nil) ? ($c = target_root['$==']($scope.DOT_SLASH), ($c === nil || $c === false)) : $b)) !== false && $a !== nil) {
                return nil
                } else {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$initialize = function(data, cursor, opts) {
        ...
        if (($a = ($b = cursor, ($b === nil || $b === false))) !== false && $a !== nil) {
          self.file = self.dir = nil;
          self.path = "<stdin>";
          self.lineno = 1;
        } else if (($a = cursor['$is_a?']((($b = $opal.Object._scope.String) == null ? $opal.cm('String') : $b))) !== false && $a !== nil) {
          self.file = cursor;
          ...
          if (($a = self.file) !== false && $a !== nil) {
            if (($a = self.dir) === false || $a === nil) {
              self.dir = (($a = $opal.Object._scope.File) == null ? $opal.cm('File') : $a).$dirname(self.file);
              if (self.dir['$=='](".")) {
                self.dir = nil};};
            if (($a = cursor.$path()) === false || $a === nil) {
              self.path = (($a = $opal.Object._scope.File) == null ? $opal.cm('File') : $a).$basename(self.file)};};
      ...
      def.$peek_line = function(direct) {
        ...
        if (($a = ((($b = direct) !== false && $b !== nil) ? $b : self.look_ahead['$>'](0))) !== false && $a !== nil) {
          ...
          self.look_ahead = 0;
          return nil;
        } else if (($a = ($b = (line = self.$process_line(self.lines['$[]'](0))), ($b === nil || $b === false))) !== false && $a !== nil) {
      ...
      def.$advance = function(direct) {
        ...
        return ($a = ($b = self.$read_line(direct), ($b === nil || $b === false)), ($a === nil || $a === false));
      };
      ...
      def.$skip_comment_lines = function(opts) {
        ...
        } else if (($b = ($c = (commentish = next_line['$start_with?']("//")), $c !== false && $c !== nil ?(match = $scope.CommentBlockRx.$match(next_line)) : $c)) !== false && $b !== nil) {
          comment_lines['$<<'](self.$shift());
        ...
        } else if (($c = (($d = commentish !== false && commentish !== nil) ? $scope.CommentLineRx['$=~'](next_line) : $d)) !== false && $c !== nil) {
          comment_lines['$<<'](self.$shift())
          } else {
          break;
        }};
      ...
      def.$skip_line_comments = function() {
        ...
        comment_lines = [];
        while (($b = (next_line = self.$peek_line())) !== false && $b !== nil) {
        if (($b = $scope.CommentLineRx['$=~'](next_line)) !== false && $b !== nil) {
          comment_lines['$<<'](self.$shift())
          } else {
          break;
        }};
      ...
      def.$read_lines_until = TMP_4 = function(options) {
        ...
        if (($c = ($d = (($e = break_on_list_continuation !== false && break_on_list_continuation !== nil) ? line_read : $e), $d !== false && $d !== nil ?line['$==']($scope.LIST_CONTINUATION) : $d)) !== false && $c !== nil) {
          ...
          return true;};
        if (($c = (($d = ($yield !== nil)) ? (((($e = $opal.$yield1($yield, line)) === $breaker) ? $breaker.$v : $e)) : $d)) !== false && $c !== nil) {
          return true};
        ...
        if (complete !== false && complete !== nil) {
          ...
          if (($b = options['$[]']("preserve_last_line")) !== false && $b !== nil) {
            ...
            line_restored = true;};
        } else if (($b = ($c = (($d = skip_line_comments !== false && skip_line_comments !== nil) ? line['$start_with?']("//") : $d), $c !== false && $c !== nil ?$scope.CommentLineRx['$=~'](line) : $c)) === false || $b === nil) {
          result['$<<'](line);
          line_read = true;};};
        if (restore_process_lines !== false && restore_process_lines !== nil) {
          self.process_lines = true;
          if (($a = (($b = line_restored !== false && line_restored !== nil) ? ($c = terminator, ($c === nil || $c === false)) : $b)) !== false && $a !== nil) {
            self.look_ahead = self.look_ahead['$-'](1)};};
        return result;
      };
    ...
    (function($base, $super) {
      ...
      def.$prepare_lines = TMP_6 = function(data, opts) {var $zuper = $slice.call(arguments, 0);
        ...
        if (($a = ($b = self.document, $b !== false && $b !== nil ?(self.document.$attributes()['$has_key?']("skip-front-matter")) : $b)) !== false && $a !== nil) {
        ...
        if (($a = opts.$fetch("condense", true)) !== false && $a !== nil) {
          while (($b = ($c = (first = result['$[]'](0)), $c !== false && $c !== nil ?first['$empty?']() : $c)) !== false && $b !== nil) {
          ($b = result.$shift(), $b !== false && $b !== nil ?self.lineno = self.lineno['$+'](1) : $b)};
          while (($b = ($c = (last = result['$[]'](-1)), $c !== false && $c !== nil ?last['$empty?']() : $c)) !== false && $b !== nil) {
          result.$pop()};};
      ...
      def.$process_line = function(line) {
        ...
        if (($a = line['$empty?']()) !== false && $a !== nil) {
          self.look_ahead = self.look_ahead['$+'](1);
          return "";};
        if (($a = ($b = ($c = line['$end_with?']("]"), $c !== false && $c !== nil ?($d = line['$start_with?']("["), ($d === nil || $d === false)) : $c), $b !== false && $b !== nil ?line['$include?']("::") : $b)) !== false && $a !== nil) {
          if (($a = ($b = line['$include?']("if"), $b !== false && $b !== nil ?(match = $scope.ConditionalDirectiveRx.$match(line)) : $b)) !== false && $a !== nil) {
            ...
            self.$advance();
            return nil;
          } else if (($a = ($c = (((($d = (escaped = line['$start_with?']("\\include::"))) !== false && $d !== nil) ? $d : line['$start_with?']("include::"))), $c !== false && $c !== nil ?(match = $scope.IncludeDirectiveRx.$match(line)) : $c)) !== false && $a !== nil) {
      ...
      def.$preprocess_conditional_inclusion = function(directive, target, delimiter, text) {
        ...
        if (($a = ((($b = (($c = (((($d = directive['$==']("ifdef")) !== false && $d !== nil) ? $d : directive['$==']("ifndef"))), $c !== false && $c !== nil ?target['$empty?']() : $c))) !== false && $b !== nil) ? $b : ((($c = directive['$==']("endif")) ? text : $c)))) !== false && $a !== nil) {
          return false};
...
if (name == null) name = nil;
          return ($a = self.document.$attributes()['$has_key?'](name), ($a === nil || $a === false))}, TMP_10._s = self, TMP_10), $d).call($e), ($a === nil || $a === false))}else if ("+"['$===']($case)) {skip = ($a = ($d = target.$split("+")).$detect, $a._p = (TMP_11 = function(name){var self = TMP_11._s || this;
            if (self.document == null) self.document = nil;
if (name == null) name = nil;
          return self.document.$attributes()['$has_key?'](name)}, TMP_11._s = self, TMP_11), $a).call($d)}}else if ("ifeval"['$===']($case)) {if (($a = ((($f = ($g = target['$empty?'](), ($g === nil || $g === false))) !== false && $f !== nil) ? $f : ($g = (expr_match = $scope.EvalExpressionRx.$match(text.$strip())), ($g === nil || $g === false)))) !== false && $a !== nil) {
            return false};
          lhs = self.$resolve_expr_val(expr_match['$[]'](1));
          op = expr_match['$[]'](2);
          rhs = self.$resolve_expr_val(expr_match['$[]'](3));
          skip = ($a = (lhs.$send(op.$to_sym(), rhs)), ($a === nil || $a === false));}};
        if (($a = ((($f = directive['$==']("ifeval")) !== false && $f !== nil) ? $f : ($g = text, ($g === nil || $g === false)))) !== false && $a !== nil) {
      ...
      def.$preprocess_include = function(raw_target, raw_attributes) {
        ...
        if (($a = ((target = self.document.$sub_attributes(raw_target, $hash2(["attribute_missing"], {"attribute_missing": "drop-line"}))))['$empty?']()) !== false && $a !== nil) {
        ...
        } else if (($a = ($b = self['$include_processors?'](), $b !== false && $b !== nil ?(extension = ($c = ($d = self.include_processor_extensions).$find, $c._p = (TMP_12 = function(candidate){var self = TMP_12._s || this;if (candidate == null) candidate = nil;
        return candidate.$instance()['$handles?'](target)}, TMP_12._s = self, TMP_12), $c).call($d)) : $b)) !== false && $a !== nil) {
          self.$advance();
          ...
          if (($a = (($b = $opal.Object._scope.RUBY_ENGINE_OPAL) == null ? $opal.cm('RUBY_ENGINE_OPAL') : $b)) !== false && $a !== nil) {
            target_type = "file";
            include_file = path = ((function() {if (($a = self.include_stack['$empty?']()) !== false && $a !== nil) {
              return target
              } else {
              return ($scope.File.$join(self.dir, target))
            }; return nil; })());
          } else if (($a = ($b = target['$include?'](":"), $b !== false && $b !== nil ?$scope.UriSniffRx['$=~'](target) : $b)) !== false && $a !== nil) {
            ...
            } else if (($a = ($b = (($c = $opal.Object._scope.RUBY_ENGINE_OPAL) == null ? $opal.cm('RUBY_ENGINE_OPAL') : $c), ($b === nil || $b === false))) !== false && $a !== nil) {
            ...
            if (($a = (($b = $opal.Object._scope.File) == null ? $opal.cm('File') : $b)['$file?'](include_file)) === false || $a === nil) {
          ...
          if (($a = ($b = raw_attributes['$empty?'](), ($b === nil || $b === false))) !== false && $a !== nil) {
            ...
            if (($a = attributes['$has_key?']("lines")) !== false && $a !== nil) {
              inc_lines = [];
              ($a = ($b = attributes['$[]']("lines").$split($scope.DataDelimiterRx)).$each, $a._p = (TMP_13 = function(linedef){var self = TMP_13._s || this, $a, $b, $c, from = nil, to = nil;if (linedef == null) linedef = nil;
          ...
          if (($a = ($c = inc_lines['$nil?'](), ($c === nil || $c === false))) !== false && $a !== nil) {
            if (($a = ($c = inc_lines['$empty?'](), ($c === nil || $c === false))) !== false && $a !== nil) {
              ...
              ($a = ($c = self).$open, $a._p = (TMP_14 = function(f){var self = TMP_14._s || this, $a, $b, TMP_15;if (f == null) f = nil;
                return ($a = ($b = f).$each_line, $a._p = (TMP_15 = function(l){var self = TMP_15._s || this, $a, $b, $c, take = nil;if (l == null) l = nil;
                  inc_lineno = inc_lineno['$+'](1);
                    take = inc_lines['$[]'](0);
                    if (($a = ($b = take['$is_a?']((($c = $opal.Object._scope.Float) == null ? $opal.cm('Float') : $c)), $b !== false && $b !== nil ?take['$infinite?']() : $b)) !== false && $a !== nil) {
                      selected.$push(l);
            ...
            if (($a = ($e = tags['$empty?'](), ($e === nil || $e === false))) !== false && $a !== nil) {
              ...
              if (($a = ((missing_tags = tags.$to_a()['$-'](tags_found.$to_a())))['$empty?']()) === false || $a === nil) {
      ...
      def['$skip_front_matter!'] = function(data, increment_linenos) {
        ...
        if (data['$[]'](0)['$==']("---")) {
          ...
          if (increment_linenos !== false && increment_linenos !== nil) {
            self.lineno = self.lineno['$+'](1)};
          while (($b = ($c = ($d = data['$empty?'](), ($d === nil || $d === false)), $c !== false && $c !== nil ?($d = data['$[]'](0)['$==']("---"), ($d === nil || $d === false)) : $c)) !== false && $b !== nil) {
      ...
      def['$include_processors?'] = function() {
        var $a, $b, self = this;
        if (($a = ($b = self.include_processor_extensions, ($b === nil || $b === false))) !== false && $a !== nil) {
          ...
          return ($a = self.include_processor_extensions['$=='](false), ($a === nil || $a === false))
        };
      };

      return (def.$to_s = function() {
        var $a, $b, TMP_21, self = this;
        return "#<" + (self.$class()) + "@" + (self.$object_id()) + " {path: " + (self.path.$inspect()) + ", line #: " + (self.lineno) + ", include depth: " + (self.include_stack.$size()) + ", include stack: [" + (($a = ($b = self.include_stack).$map, $a._p = (TMP_21 = function(inc){var self = TMP_21._s || this;if (inc == null) inc = nil;
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$sectnum = function(delimiter, append) {
        ...
        if (($a = ($b = ($c = ($d = self.level, $d !== false && $d !== nil ?self.level['$>'](1) : $d), $c !== false && $c !== nil ?self.parent : $c), $b !== false && $b !== nil ?self.parent.$context()['$==']("section") : $b)) !== false && $a !== nil) {
      ...
      return (def.$to_s = TMP_3 = function() {var $zuper = $slice.call(arguments, 0);
        var $a, $b, self = this, $iter = TMP_3._p, $yield = $iter || nil, qualified_title = nil;
        TMP_3._p = null;
        if (($a = ($b = self.title['$=='](nil), ($b === nil || $b === false))) !== false && $a !== nil) {
          qualified_title = (function() {if (($a = self.numbered) !== false && $a !== nil) {
...
(function($opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      var def = $Stylesheets._proto, $scope = $Stylesheets._scope, $a;
      ...
      def.$write_primary_stylesheet = function(target_dir) {
        ...
        return ($a = ($b = (($c = $opal.Object._scope.File) == null ? $opal.cm('File') : $c)).$open, $a._p = (TMP_1 = function(f){var self = TMP_1._s || this;if (f == null) f = nil;
      ...
      def.$write_coderay_stylesheet = function(target_dir) {
        ...
        return ($a = ($b = (($c = $opal.Object._scope.File) == null ? $opal.cm('File') : $c)).$open, $a._p = (TMP_2 = function(f){var self = TMP_2._s || this;if (f == null) f = nil;
      ...
      def.$write_pygments_stylesheet = function(target_dir, style) {
        ...
        return ($a = ($b = (($c = $opal.Object._scope.File) == null ? $opal.cm('File') : $c)).$open, $a._p = (TMP_3 = function(f){var self = TMP_3._s || this;if (f == null) f = nil;
      ...
      return (def.$load_pygments = function() {
        var $a, self = this;
        if (($a = ($opal.Object._scope.Pygments == null ? nil : 'constant')) === false || $a === nil) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$create_columns = function(col_specs) {
        ...
        total_width = 0;
        cols = [];
        ($a = ($b = col_specs).$each, $a._p = (TMP_2 = function(col_spec){var self = TMP_2._s || this;if (col_spec == null) col_spec = nil;
        total_width = total_width['$+'](col_spec['$[]']("width"));
          return cols['$<<']($scope.Column.$new(self, cols.$size(), col_spec));}, TMP_2._s = self, TMP_2), $a).call($b);
        if (($a = cols['$empty?']()) === false || $a === nil) {
          self.attributes['$[]=']("colcount", cols.$size());
          even_width = ((100.0)['$/'](cols.$size())).$floor();
          ($a = ($c = cols).$each, $a._p = (TMP_3 = function(c){var self = TMP_3._s || this;if (c == null) c = nil;
      ...
      return (def.$partition_header_footer = function(attributes) {
        ...
        if (($a = (($b = num_body_rows['$>'](0)) ? self.has_header_option : $b)) !== false && $a !== nil) {
          ...
          self.rows['$head=']([head]);};
        if (($a = (($c = num_body_rows['$>'](0)) ? attributes['$has_key?']("footer-option") : $c)) !== false && $a !== nil) {
    ...
    (function($base, $super) {
      ...
      def.$initialize = TMP_6 = function(column, text, attributes, cursor) {
        ...
        if (($a = (($b = self.style['$==']("asciidoc")) ? ($c = column.$table()['$header_row?'](), ($c === nil || $c === false)) : $b)) !== false && $a !== nil) {
          ...
          if (($a = ((($b = inner_document_lines['$empty?']()) !== false && $b !== nil) ? $b : ($c = inner_document_lines['$[]'](0)['$include?']("::"), ($c === nil || $c === false)))) === false || $a === nil) {
      ...
      def.$content = function() {
        ...
        if (self.style['$==']("asciidoc")) {
          ...
          return ($a = ($b = self.$text().$split($scope.BlankLineRx)).$map, $a._p = (TMP_7 = function(p){var self = TMP_7._s || this, $a, $b, $c;
            if (self.style == null) self.style = nil;
if (p == null) p = nil;
    ...
    (function($base, $super) {
      ...
      def.$initialize = function(reader, table, attributes) {
        ...
        if (($a = (self.format = attributes['$[]']("format"))) !== false && $a !== nil) {
          if (($a = ($scope.Table)._scope.DATA_FORMATS['$include?'](self.format)) === false || $a === nil) {
...
if (i == null) i = nil;
        if (self.col_count['$=='](-1)) {
          ...
          if (($a = ((($b = ($c = cell.$rowspan(), ($c === nil || $c === false))) !== false && $b !== nil) ? $b : cell.$rowspan()['$=='](1))) === false || $a === nil) {
...
(function($opal) {
  ...
  (function($base) {
    ...
    var def = self._proto, $scope = self._scope, $a, $b, $c, TMP_1;
    if (($a = (($b = $opal.Object._scope.RUBY_ENGINE_OPAL) == null ? $opal.cm('RUBY_ENGINE_OPAL') : $b)) === false || $a === nil) {
      ;
    ...
    (function($base) {
      ...
      $opal.defs(self, '$define', function(key, value) {
        ...
        if (($a = ((($b = key['$==']("keys")) !== false && $b !== nil) ? $b : (self['$respond_to?'](key)))) !== false && $a !== nil) {
    ...
    $opal.cdecl($scope, 'COERCE_ENCODING', ($a = ($b = (($c = $opal.Object._scope.RUBY_ENGINE_OPAL) == null ? $opal.cm('RUBY_ENGINE_OPAL') : $c), ($b === nil || $b === false)), $a !== false && $a !== nil ?(($b = $opal.Object._scope.RUBY_MIN_VERSION_1_9) == null ? $opal.cm('RUBY_MIN_VERSION_1_9') : $b) : $a));
    ...
    $opal.cdecl($scope, 'FORCE_UNICODE_LINE_LENGTH', ($a = (($b = $opal.Object._scope.RUBY_MIN_VERSION_1_9) == null ? $opal.cm('RUBY_MIN_VERSION_1_9') : $b), ($a === nil || $a === false)));

    $opal.cdecl($scope, 'SUPPORTS_GSUB_RESULT_HASH', ($a = (($b = $opal.Object._scope.RUBY_MIN_VERSION_1_9) == null ? $opal.cm('RUBY_MIN_VERSION_1_9') : $b), $a !== false && $a !== nil ?($b = (($c = $opal.Object._scope.RUBY_ENGINE_OPAL) == null ? $opal.cm('RUBY_ENGINE_OPAL') : $c), ($b === nil || $b === false)) : $a));

    $opal.cdecl($scope, 'EOL', "\n");

    $opal.cdecl($scope, 'NULL', (function() {if (($a = (($b = $opal.Object._scope.RUBY_ENGINE_OPAL) == null ? $opal.cm('RUBY_ENGINE_OPAL') : $b)) !== false && $a !== nil) {
      return (0).$chr()
      } else {
      return "0"
    }; return nil; })());
    ...
    $opal.cdecl($scope, 'AuthorInfoLineRx', /^(\w[\w\-'.]*)(?: +(\w[\w\-'.]*))?(?: +(\w[\w\-'.]*))?(?: +<([^>]+)>)?$/);

    $opal.cdecl($scope, 'RevisionInfoLineRx', /^(?:\D*(.*?),)?(?:\s*(?!:)(.*?))(?:\s*(?!^):\s*(.*))?$/);

    $opal.cdecl($scope, 'ManpageTitleVolnumRx', /^(.*)\((.*)\)$/);

    $opal.cdecl($scope, 'ManpageNamePurposeRx', (new RegExp("^(.*?)" + $scope.CC_BLANK + "+-" + $scope.CC_BLANK + "+(.*)$")));

    $opal.cdecl($scope, 'ConditionalDirectiveRx', /^\\?(ifdef|ifndef|ifeval|endif)::(\S*?(?:([,\+])\S+?)?)\[(.+)?\]$/);

    $opal.cdecl($scope, 'EvalExpressionRx', (new RegExp("^(\\S.*?)" + $scope.CC_BLANK + "*(==|!=|<=|>=|<|>)" + $scope.CC_BLANK + "*(\\S.*)$")));

    $opal.cdecl($scope, 'IncludeDirectiveRx', /^\\?include::([^\[]+)\[(.*?)\]$/);

    $opal.cdecl($scope, 'AttributeEntryRx', (new RegExp("^:(!?\\w.*?):(?:" + $scope.CC_BLANK + "+(.*))?$")));
    ...
    $opal.cdecl($scope, 'BlockAnchorRx', (new RegExp("^\\[\\[(?:|([" + $scope.CC_ALPHA + ":_][\\w:.-]*)(?:," + $scope.CC_BLANK + "*(\\S.*))?)\\]\\]$")));

    $opal.cdecl($scope, 'BlockAttributeListRx', (new RegExp("^\\[(|" + $scope.CC_BLANK + "*[\\w\\{,.#\"'%].*)\\]$")));

    $opal.cdecl($scope, 'BlockAttributeLineRx', (new RegExp("^\\[(|" + $scope.CC_BLANK + "*[\\w\\{,.#\"'%].*|\\[(?:|[" + $scope.CC_ALPHA + ":_][\\w:.-]*(?:," + $scope.CC_BLANK + "*\\S.*)?)\\])\\]$")));

    $opal.cdecl($scope, 'BlockTitleRx', /^\.([^\s.].*)$/);

    $opal.cdecl($scope, 'AdmonitionParagraphRx', (new RegExp("^(" + $scope.ADMONITION_STYLES.$to_a()['$*']("|") + "):" + $scope.CC_BLANK)));

    $opal.cdecl($scope, 'LiteralParagraphRx', (new RegExp("^(" + $scope.CC_BLANK + "+.*)$")));

    $opal.cdecl($scope, 'CommentBlockRx', /^\/{4,}$/);

    $opal.cdecl($scope, 'CommentLineRx', /^\/\/(?:[^\/]|$)/);

    $opal.cdecl($scope, 'AtxSectionRx', (new RegExp("^((?:=|#){1,6})" + $scope.CC_BLANK + "+(\\S.*?)(?:" + $scope.CC_BLANK + "+\\1)?$")));

    $opal.cdecl($scope, 'SetextSectionTitleRx', /^((?=.*\w+.*)[^.].*?)$/);

    $opal.cdecl($scope, 'SetextSectionLineRx', /^(?:=|-|~|\^|\+)+$/);

    $opal.cdecl($scope, 'InlineSectionAnchorRx', (new RegExp("^(.*?)" + $scope.CC_BLANK + "+(\\\\)?\\[\\[([" + $scope.CC_ALPHA + ":_][\\w:.-]*)(?:," + $scope.CC_BLANK + "*(\\S.*?))?\\]\\]$")));

    $opal.cdecl($scope, 'InvalidSectionIdCharsRx', /&(?:[a-zA-Z]{2,}|#\d{2,5}|#x[a-fA-F0-9]{2,4});|\W+?/);

    $opal.cdecl($scope, 'FloatingTitleStyleRx', /^(?:float|discrete)\b/);

    $opal.cdecl($scope, 'AnyListRx', (new RegExp("^(?:<?\\d+>" + $scope.CC_BLANK + "+" + $scope.CC_GRAPH + "|" + $scope.CC_BLANK + "*(?:-|(?:\\*|\\.){1,5}|\\d+\\.|[a-zA-Z]\\.|[IVXivx]+\\))" + $scope.CC_BLANK + "+" + $scope.CC_GRAPH + "|" + $scope.CC_BLANK + "*.*?(?::{2,4}|;;)(?:" + $scope.CC_BLANK + "+" + $scope.CC_GRAPH + "|$))")));

    $opal.cdecl($scope, 'UnorderedListRx', (new RegExp("^" + $scope.CC_BLANK + "*(-|\\*{1,5})" + $scope.CC_BLANK + "+(.*)$")));

    $opal.cdecl($scope, 'OrderedListRx', (new RegExp("^" + $scope.CC_BLANK + "*(\\.{1,5}|\\d+\\.|[a-zA-Z]\\.|[IVXivx]+\\))" + $scope.CC_BLANK + "+(.*)$")));
    ...
    $opal.cdecl($scope, 'DefinitionListRx', (new RegExp("^(?!\\/\\/)" + $scope.CC_BLANK + "*(.*?)(:{2,4}|;;)(?:" + $scope.CC_BLANK + "+(.*))?$")));

    $opal.cdecl($scope, 'DefinitionListSiblingRx', $hash2(["::", ":::", "::::", ";;"], {"::": (new RegExp("^(?!\\/\\/)" + $scope.CC_BLANK + "*((?:.*[^:])?)(::)(?:" + $scope.CC_BLANK + "+(.*))?$")), ":::": (new RegExp("^(?!\\/\\/)" + $scope.CC_BLANK + "*((?:.*[^:])?)(:::)(?:" + $scope.CC_BLANK + "+(.*))?$")), "::::": (new RegExp("^(?!\\/\\/)" + $scope.CC_BLANK + "*((?:.*[^:])?)(::::)(?:" + $scope.CC_BLANK + "+(.*))?$")), ";;": (new RegExp("^(?!\\/\\/)" + $scope.CC_BLANK + "*(.*)(;;)(?:" + $scope.CC_BLANK + "+(.*))?$"))}));

    $opal.cdecl($scope, 'CalloutListRx', (new RegExp("^<?(\\d+)>" + $scope.CC_BLANK + "+(.*)")));
    ...
    $opal.cdecl($scope, 'CellSpecStartRx', (new RegExp("^" + $scope.CC_BLANK + "*(?:(\\d+(?:\\.\\d*)?|(?:\\d*\\.)?\\d+)([*+]))?([<^>](?:\\.[<^>]?)?|(?:[<^>]?\\.)?[<^>])?([a-z])?\\|")));

    $opal.cdecl($scope, 'CellSpecEndRx', (new RegExp("" + $scope.CC_BLANK + "+(?:(\\d+(?:\\.\\d*)?|(?:\\d*\\.)?\\d+)([*+]))?([<^>](?:\\.[<^>]?)?|(?:[<^>]?\\.)?[<^>])?([a-z])?$")));

    $opal.cdecl($scope, 'GenericBlockMacroRx', /^(\w[\w\-]*)::(\S*?)\[((?:\\\]|[^\]])*?)\]$/);

    $opal.cdecl($scope, 'MediaBlockMacroRx', /^(image|video|audio)::(\S+?)\[((?:\\\]|[^\]])*?)\]$/);

    $opal.cdecl($scope, 'TocBlockMacroRx', /^toc::\[(.*?)\]$/);

    $opal.cdecl($scope, 'InlineAnchorRx', (new RegExp("\\\\?(?:\\[\\[([" + $scope.CC_ALPHA + ":_][\\w:.-]*)(?:," + $scope.CC_BLANK + "*(\\S.*?))?\\]\\]|anchor:(\\S+)\\[(.*?[^\\\\])?\\])")));

    $opal.cdecl($scope, 'InlineBiblioAnchorRx', /\\?\[\[\[([\w:][\w:.-]*?)\]\]\]/);

    $opal.cdecl($scope, 'EmailInlineMacroRx', (new RegExp("([\\\\>:\\/])?\\w[\\w.%+-]*@[" + $scope.CC_ALNUM + "][" + $scope.CC_ALNUM + ".-]*\\.[" + $scope.CC_ALPHA + "]{2,4}\\b")));

    $opal.cdecl($scope, 'FootnoteInlineMacroRx', /\\?(footnote(?:ref)?):\[(.*?[^\\])\]/i);

    $opal.cdecl($scope, 'ImageInlineMacroRx', /\\?(?:image|icon):([^:\[][^\[]*)\[((?:\\\]|[^\]])*?)\]/);

    $opal.cdecl($scope, 'IndextermInlineMacroRx', /\\?(?:(indexterm2?):\[(.*?[^\\])\]|\(\((.+?)\)\)(?!\)))/i);

    $opal.cdecl($scope, 'KbdBtnInlineMacroRx', /\\?(?:kbd|btn):\[((?:\\\]|[^\]])+?)\]/);

    $opal.cdecl($scope, 'KbdDelimiterRx', (new RegExp("(?:\\+|,)(?=" + $scope.CC_BLANK + "*[^\\1])")));

    $opal.cdecl($scope, 'LinkInlineRx', /(^|link:|&lt;|[\s>\(\)\[\];])(\\?(?:https?|file|ftp|irc):\/\/[^\s\[\]<]*[^\s.,\[\]<])(?:\[((?:\\\]|[^\]])*?)\])?/);

    $opal.cdecl($scope, 'LinkInlineMacroRx', /\\?(?:link|mailto):([^\s\[]+)(?:\[((?:\\\]|[^\]])*?)\])/);

    $opal.cdecl($scope, 'MathInlineMacroRx', /\\?((?:latex|ascii)?math):([a-z,]*)\[(.*?[^\\])\]/i);

    $opal.cdecl($scope, 'MenuInlineMacroRx', (new RegExp("\\\\?menu:(\\w|\\w.*?\\S)\\[" + $scope.CC_BLANK + "*(.+?)?\\]")));

    $opal.cdecl($scope, 'MenuInlineRx', (new RegExp("\\\\?\"(\\w[^\"]*?" + $scope.CC_BLANK + "*&gt;" + $scope.CC_BLANK + "*[^\" \\t][^\"]*)\"")));

    $opal.cdecl($scope, 'PassInlineLiteralRx', /(^|[^`\w])(?:\[([^\]]+?)\])?(\\?`([^`\s]|[^`\s].*?\S)`)(?![`\w])/i);

    $opal.cdecl($scope, 'PassInlineMacroRx', /\\?(?:(\+{3}|\${2})(.*?)\1|pass:([a-z,]*)\[(.*?[^\\])\])/i);

    $opal.cdecl($scope, 'XrefInlineMacroRx', /\\?(?:&lt;&lt;([\w":].*?)&gt;&gt;|xref:([\w":].*?)\[(.*?)\])/i);

    $opal.cdecl($scope, 'LineBreakRx', (function() {if (($a = (($c = $opal.Object._scope.RUBY_ENGINE_OPAL) == null ? $opal.cm('RUBY_ENGINE_OPAL') : $c)) !== false && $a !== nil) {
      return /^(.*?)[ \t]\+$/m;
      } else {
      return /^(.*)[[:blank:]]\+$/
    }; return nil; })());
    ...
    $opal.cdecl($scope, 'BlankLineRx', (new RegExp("^" + $scope.CC_BLANK + "*\\n")));
    ...
    $opal.cdecl($scope, 'DoubleQuotedMultiRx', /^("|)(.*)\1$/i);

    $opal.cdecl($scope, 'TrailingDigitsRx', /\d+$/);

    $opal.cdecl($scope, 'EscapedSpaceRx', (new RegExp("\\\\(" + $scope.CC_BLANK + ")")));

    $opal.cdecl($scope, 'SpaceDelimiterRx', (new RegExp("([^\\\\])" + $scope.CC_BLANK + "+")));

    $opal.cdecl($scope, 'UriSniffRx', (new RegExp("^[" + $scope.CC_ALPHA + "][" + $scope.CC_ALNUM + ".+-]*:/{0,2}")));
    ...
    $opal.cdecl($scope, 'REPLACEMENTS', [[/\\?\(C\)/, "&#169;", "none"], [/\\?\(R\)/, "&#174;", "none"], [/\\?\(TM\)/, "&#8482;", "none"], [/(^|\n| |\\)--( |\n|$)/, "&#8201;&#8212;&#8201;", "none"], [/(\w)\\?--(?=\w)/, "&#8212;", "leading"], [/\\?\.\.\./, "&#8230;", "leading"], [(new RegExp("([" + $scope.CC_ALPHA + "])\\\\?'(?!')")), "&#8217;", "leading"], [/\\?-&gt;/, "&#8594;", "none"], [/\\?=&gt;/, "&#8658;", "none"], [/\\?&lt;-/, "&#8592;", "none"], [/\\?&lt;=/, "&#8656;", "none"], [/\\?(&)amp;((?:[a-zA-Z]+|#\d{2,5}|#x[a-fA-F0-9]{2,4});)/, "", "bounding"]]);
    ...
    (function(self) {
      ...
      self._proto.$load = function(input, options) {
        ...
        options = options.$dup();
        if (($a = (timings = options['$[]']("timings"))) !== false && $a !== nil) {
          timings.$start("read")};
        attributes = options['$[]=']("attributes", (function() {if (($a = ($b = (attrs = options['$[]']("attributes")), ($b === nil || $b === false))) !== false && $a !== nil) {
          return $hash2([], {})
        } else if (($a = ((($b = (attrs['$is_a?']((($c = $opal.Object._scope.Hash) == null ? $opal.cm('Hash') : $c)))) !== false && $b !== nil) ? $b : (($c = (($d = $opal.Object._scope.RUBY_ENGINE_JRUBY) == null ? $opal.cm('RUBY_ENGINE_JRUBY') : $d), $c !== false && $c !== nil ?(attrs['$is_a?']((((($d = $opal.Object._scope.Java) == null ? $opal.cm('Java') : $d))._scope.JavaUtil)._scope.Map)) : $c)))) !== false && $a !== nil) {
          return attrs.$dup()
        } else if (($a = attrs['$is_a?']((($b = $opal.Object._scope.Array) == null ? $opal.cm('Array') : $b))) !== false && $a !== nil) {
          return ($a = ($b = attrs).$inject, $a._p = (TMP_2 = function(accum, entry){var self = TMP_2._s || this, $a, k = nil, v = nil;if (accum == null) accum = nil;if (entry == null) entry = nil;
          ...
          capture_1 = (function() {if (($a = (($c = $opal.Object._scope.RUBY_ENGINE_OPAL) == null ? $opal.cm('RUBY_ENGINE_OPAL') : $c)) !== false && $a !== nil) {
            return "$1"
            } else {
            return "1"
          }; return nil; })();
          attrs = attrs.$gsub($scope.SpaceDelimiterRx, "" + (capture_1) + ($scope.NULL)).$gsub($scope.EscapedSpaceRx, capture_1);
          return ($a = ($c = attrs.$split($scope.NULL)).$inject, $a._p = (TMP_3 = function(accum, entry){var self = TMP_3._s || this, $a, k = nil, v = nil;if (accum == null) accum = nil;if (entry == null) entry = nil;
          $a = $opal.to_ary(entry.$split("=", 2)), k = ($a[0] == null ? nil : $a[0]), v = ($a[1] == null ? nil : $a[1]);
            accum['$[]='](k, ((($a = v) !== false && $a !== nil) ? $a : ""));
          ...
          attrs = $hash2([], {});
          ($a = ($d = original_attrs.$keys()).$each, $a._p = (TMP_4 = function(key){var self = TMP_4._s || this;if (key == null) key = nil;
        ...
        if (timings !== false && timings !== nil) {
          timings.$record("read");
          timings.$start("parse");};
        if (($a = options['$key?']("parse")) === false || $a === nil) {
          options['$[]=']("parse", true)};
      ...
      self._proto.$convert = function(input, options) {
        ...
        $case = to_file;if (true['$===']($case) || nil['$===']($case)) {write_to_same_dir = ($a = ($b = to_dir, ($b === nil || $b === false)), $a !== false && $a !== nil ?(input['$is_a?']((($b = $opal.Object._scope.File) == null ? $opal.cm('File') : $b))) : $a);
        stream_output = false;
        ...
        if (($a = ($b = ($c = options['$key?']("header_footer"), ($c === nil || $c === false)), $b !== false && $b !== nil ?(((($c = write_to_same_dir) !== false && $c !== nil) ? $c : write_to_target)) : $b)) !== false && $a !== nil) {
        ...
        if (to_file['$==']("/dev/null")) {
          ...
          if (to_dir !== false && to_dir !== nil) {
            ...
            outdir = (($a = $opal.Object._scope.File) == null ? $opal.cm('File') : $a).$dirname(outfile);};
          if (($a = (($b = $opal.Object._scope.File) == null ? $opal.cm('File') : $b)['$directory?'](outdir)) === false || $a === nil) {
        ...
        if (outfile !== false && outfile !== nil) {
          if (timings !== false && timings !== nil) {
            timings.$start("write")};
          if (($a = stream_output) === false || $a === nil) {
            doc.$attributes()['$[]=']("outfile", outfile);
            doc.$attributes()['$[]=']("outdir", outdir);};
          doc.$write(output, outfile);
          if (timings !== false && timings !== nil) {
            timings.$record("write")};
          if (($a = ($b = ($c = ($d = ($e = ($f = stream_output, ($f === nil || $f === false)), $e !== false && $e !== nil ?doc.$safe()['$<'](($scope.SafeMode)._scope.SECURE) : $e), $d !== false && $d !== nil ?(doc['$attr?']("basebackend-html")) : $d), $c !== false && $c !== nil ?(doc['$attr?']("linkcss")) : $c), $b !== false && $b !== nil ?(doc['$attr?']("copycss")) : $b)) !== false && $a !== nil) {
            copy_asciidoctor_stylesheet = $scope.DEFAULT_STYLESHEET_KEYS['$include?'](stylesheet = (doc.$attr("stylesheet")));
            copy_user_stylesheet = ($a = ($b = copy_asciidoctor_stylesheet, ($b === nil || $b === false)), $a !== false && $a !== nil ?($b = stylesheet['$nil_or_empty?'](), ($b === nil || $b === false)) : $a);
            ...
            if (($a = ((($b = ((($c = ((($d = copy_asciidoctor_stylesheet) !== false && $d !== nil) ? $d : copy_user_stylesheet)) !== false && $c !== nil) ? $c : copy_coderay_stylesheet)) !== false && $b !== nil) ? $b : copy_pygments_stylesheet)) !== false && $a !== nil) {
              ...
              if (copy_asciidoctor_stylesheet !== false && copy_asciidoctor_stylesheet !== nil) {
                ...
                if (($a = ((($b = stylesheet_src['$=='](stylesheet_dst)) !== false && $b !== nil) ? $b : ((stylesheet_content = doc.$read_asset(stylesheet_src)))['$nil?']())) === false || $a === nil) {
                  ($a = ($b = (($c = $opal.Object._scope.File) == null ? $opal.cm('File') : $c)).$open, $a._p = (TMP_5 = function(f){var self = TMP_5._s || this;if (f == null) f = nil;
