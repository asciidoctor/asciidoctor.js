...
Opal.modules["asciidoctor/core_ext/match_data"] = function(Opal) {
...
Opal.modules["asciidoctor/opal_ext"] = function(Opal) {
  ...
  return self.$require("asciidoctor/opal_ext/file");
};
/* Generated by Opal 0.8.0 */
    ...
    (function($base) {
      ...
      Opal.defn(self, '$apply_subs', function(source, subs, expand) {
        ...
        if ((($a = subs['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          if ((($a = subs['$is_a?'](Opal.get('Symbol'))) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (key == null) key = nil;
        ...
        if ((($a = subs['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          return source};
        text = (function() {if ((($a = (multiline = source['$is_a?'](Opal.get('Array')))) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (type == null) type = nil;
        return (function() {$case = type;if ("specialcharacters"['$===']($case)) {return text = self.$sub_specialcharacters(text)}else if ("quotes"['$===']($case)) {return text = self.$sub_quotes(text)}else if ("attributes"['$===']($case)) {return text = $rb_times(self.$sub_attributes(text.$split($scope.get('EOL'))), $scope.get('EOL'))}else if ("replacements"['$===']($case)) {return text = self.$sub_replacements(text)}else if ("macros"['$===']($case)) {return text = self.$sub_macros(text)}else if ("highlight"['$===']($case)) {return text = self.$highlight_source(text, (subs['$include?']("callouts")))}else if ("callouts"['$===']($case)) {if ((($a = subs['$include?']("highlight")) !== nil && (!$a.$$is_boolean || $a == true))) {
            return nil
            } else {
      ...
      Opal.defn(self, '$apply_normal_subs', function(lines) {
        ...
        return self.$apply_subs((function() {if ((($a = lines['$is_a?'](Opal.get('Array'))) !== nil && (!$a.$$is_boolean || $a == true))) {
      ...
      Opal.defn(self, '$sub_specialcharacters', function(text) {
...
if (pattern == null) pattern = nil;if (replacement == null) replacement = nil;if (restore == null) restore = nil;
      ...
      Opal.defn(self, '$sub_attributes', function(data, opts) {
        ...
        if ((($a = data['$nil_or_empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          return data};
        if ((($a = (string_data = $scope.get('String')['$==='](data))) !== nil && (!$a.$$is_boolean || $a == true))) {
          data = [data]};
...
if (extension == null) extension = nil;
          return result = ($a = ($b = result).$gsub, $a.$$p = (TMP_25 = function(){var self = TMP_25.$$s || this, $a, m = nil, target = nil, attributes = nil;
            ...
            m = $gvars["~"];
              ...
              return extension.$process_method()['$[]'](self, target, attributes);}, TMP_25.$$s = self, TMP_25), $a).call($b, extension.$config()['$[]']("regexp"))}, TMP_24.$$s = self, TMP_24), $a).call($e)};
        if ((($a = ($f = found['$[]']("macroish"), $f !== false && $f !== nil ?(((($g = result['$include?']("image:")) !== false && $g !== nil) ? $g : result['$include?']("icon:"))) : $f)) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          m = $gvars["~"];
            ...
            ($a = "alt", $b = attrs, ((($c = $b['$[]']($a)) !== false && $c !== nil) ? $c : $b['$[]=']($a, $scope.get('File').$basename(target, $scope.get('File').$extname(target)))));
        ...
        if ((($a = (($h = found_colon !== false && found_colon !== nil) ? (result['$include?']("://")) : $h)) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          m = $gvars["~"];
            ...
            if ((($a = text['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
              text = (function() {if ((($a = self.document['$attr?']("hide-uri-scheme")) !== nil && (!$a.$$is_boolean || $a == true))) {
                return target.$sub($scope.get('UriSniffRx'), "")
                } else {
                return target
              }; return nil; })();
              if (attrs !== false && attrs !== nil) {
...
if (it == null) it = nil;
      ...
      Opal.defn(self, '$resolve_subs', function(subs, type, defaults, subject) {
        ...
        ($a = ($b = subs.$split(",")).$each, $a.$$p = (TMP_42 = function(val){var self = TMP_42.$$s || this, $a, $b, $c, key = nil, modifier_operation = nil, first = nil, resolved_keys = nil, resolved_key = nil, candidate = nil, $case = nil;
if (val == null) val = nil;
        key = val.$strip();
      ...
      Opal.defn(self, '$highlight_source', function(source, process_callouts, highlighter) {
        ...
        $scope.get('Helpers').$require_library(highlighter, ((function() {if (highlighter['$==']("pygments")) {
          return "pygments.rb"
          } else {
          return highlighter
        }; return nil; })()));
...
if (line == null) line = nil;
        ...
        linenums_mode = nil;
        $case = highlighter;if ("coderay"['$===']($case)) {result = ((Opal.get('CodeRay')).$$scope.get('Duo'))['$[]'](self.$attr("language", "text", false).$to_sym(), "html", $hash2(["css", "line_numbers", "line_number_anchors"], {"css": (((($a = self.document.$attributes()['$[]']("coderay-css")) !== false && $a !== nil) ? $a : "class")).$to_sym(), "line_numbers": (linenums_mode = ((function() {if ((($a = (self['$attr?']("linenums"))) !== nil && (!$a.$$is_boolean || $a == true))) {
          return (((($a = self.document.$attributes()['$[]']("coderay-linenums-mode")) !== false && $a !== nil) ? $a : "table")).$to_sym()
          } else {
          return nil
        }; return nil; })())), "line_number_anchors": false})).$highlight(source)}else if ("pygments"['$===']($case)) {lexer = ((($a = ((Opal.get('Pygments')).$$scope.get('Lexer'))['$[]'](self.$attr("language", nil, false))) !== false && $a !== nil) ? $a : ((Opal.get('Pygments')).$$scope.get('Lexer'))['$[]']("text"));
...
if (conum == null) conum = nil;
      ...
      Opal.defn(self, '$lock_in_subs', function() {
        ...
        if ((($a = ($b = ($c = ($d = (($e = self.context['$==']("listing")) ? self.style['$==']("source") : $e), $d !== false && $d !== nil ?self.attributes['$[]']("language") : $d), $c !== false && $c !== nil ?self.document['$basebackend?']("html") : $c), $b !== false && $b !== nil ?$scope.get('SUB_HIGHLIGHT')['$include?'](self.document.$attributes()['$[]']("source-highlighter")) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return self.subs = ($a = ($b = self.subs).$map, $a.$$p = (TMP_47 = function(sub){var self = TMP_47.$$s || this;
if (sub == null) sub = nil;
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$attr = function(name, default_value, inherit) {
        ...
        if ((($a = name['$is_a?'](Opal.get('Symbol'))) !== nil && (!$a.$$is_boolean || $a == true))) {
          name = name.$to_s()};
      ...
      def.$set_attr = function(name, value, overwrite) {
        ...
        if ((($a = overwrite['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.attributes['$[]='](name, value);
          return true;
        } else if ((($a = ((($b = overwrite) !== false && $b !== nil) ? $b : (self.attributes['$key?'](name))['$!']())) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.attributes['$[]='](name, value);
          return true;
          } else {
          return false
      ...
      def.$image_uri = function(target_image, asset_dir_key) {
        ...
        if ((($a = (($b = $rb_lt(((doc = self.document)).$safe(), (($scope.get('SafeMode')).$$scope.get('SECURE')))) ? doc['$attr?']("data-uri") : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          if ((($a = ((($b = self['$is_uri?'](target_image)) !== false && $b !== nil) ? $b : (($c = ($d = (($e = asset_dir_key !== false && asset_dir_key !== nil) ? (images_base = doc.$attr(asset_dir_key)) : $e), $d !== false && $d !== nil ?self['$is_uri?'](images_base) : $d), $c !== false && $c !== nil ?(target_image = self.$normalize_web_path(target_image, images_base, false)) : $c)))) !== nil && (!$a.$$is_boolean || $a == true))) {
      ...
      def.$generate_data_uri = function(target_image, asset_dir_key) {
        ...
        ext = Opal.get('File').$extname(target_image)['$[]']($range(1, -1, false));
...
if (file == null) file = nil;
      ...
      def.$generate_data_uri_from_uri = function(image_uri, cache_uri) {
        ...
        $scope.get('Helpers').$require_library("base64");
...
if (file == null) file = nil;
          ...
          return "data:" + (mimetype) + ";base64," + ($scope.get('Base64').$encode64(bindata).$delete($scope.get('EOL')));
        } catch ($err) {if (true) {
      ...
      def.$normalize_web_path = function(target, start, preserve_uri_target) {
        ...
        if ((($a = (($b = preserve_uri_target !== false && preserve_uri_target !== nil) ? self['$is_uri?'](target) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return target
          } else {
      ...
      def['$is_uri?'] = function(str) {
        ...
        return ($a = str['$include?'](":"), $a !== false && $a !== nil ?$scope.get('UriSniffRx')['$=~'](str) : $a);
      };
      ...
      def.$find_by = TMP_4 = function(selector) {
        ...
        if ((($a = ($b = ($c = ($d = (((($e = (any_context = ((context_selector = selector['$[]']("context")))['$!']())) !== false && $e !== nil) ? $e : context_selector['$=='](self.context))), $d !== false && $d !== nil ?(((($e = ((style_selector = selector['$[]']("style")))['$!']()) !== false && $e !== nil) ? $e : style_selector['$=='](self.style))) : $d), $c !== false && $c !== nil ?(((($d = ((role_selector = selector['$[]']("role")))['$!']()) !== false && $d !== nil) ? $d : self['$has_role?'](role_selector))) : $c), $b !== false && $b !== nil ?(((($c = ((id_selector = selector['$[]']("id")))['$!']()) !== false && $c !== nil) ? $c : id_selector['$=='](self.id))) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          if (id_selector !== false && id_selector !== nil) {
            return [((function() {if ((($a = (($b = (block !== nil)) ? ((($c = Opal.yield1(block, self)) === $breaker) ? $breaker.$v : $c) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
              return self
              } else {
              return self
            }; return nil; })())]
            } else {
            result['$<<'](((function() {if ((($a = (($b = (block !== nil)) ? ((($c = Opal.yield1(block, self)) === $breaker) ? $breaker.$v : $c) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
              return self
              } else {
              return self
            }; return nil; })()))
        ...
        if ((($a = ($b = (($c = self.context['$==']("document")) ? (((($d = any_context) !== false && $d !== nil) ? $d : context_selector['$==']("section"))) : $c), $b !== false && $b !== nil ?self['$header?']() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          result.$concat(((($a = ($b = ($c = self.header).$find_by, $b.$$p = block.$to_proc(), $b).call($c, selector)) !== false && $a !== nil) ? $a : []))};
        if (context_selector['$==']("document")) {
        } else if (self.context['$==']("dlist")) {
          if ((($a = ((($b = any_context) !== false && $b !== nil) ? $b : context_selector['$==']("section")['$!']())) !== nil && (!$a.$$is_boolean || $a == true))) {
            ($a = ($b = self.blocks.$flatten()).$each, $a.$$p = (TMP_5 = function(li){var self = TMP_5.$$s || this, $a, $b, $c;
if (li == null) li = nil;
            return result.$concat(((($a = ($b = ($c = li).$find_by, $b.$$p = block.$to_proc(), $b).call($c, selector)) !== false && $a !== nil) ? $a : []))}, TMP_5.$$s = self, TMP_5), $a).call($b)}
        } else if ((($a = ($d = ($e = self.blocks).$each, $d.$$p = (TMP_6 = function(b){var self = TMP_6.$$s || this, $a, $b, $c;
if (b == null) b = nil;
        if ((($a = ((($b = context_selector['$==']("section")) ? b.$context()['$==']("section")['$!']() : $b))) !== nil && (!$a.$$is_boolean || $a == true))) {
            return nil;};
          return result.$concat(((($a = ($b = ($c = b).$find_by, $b.$$p = block.$to_proc(), $b).call($c, selector)) !== false && $a !== nil) ? $a : []));}, TMP_6.$$s = self, TMP_6), $d).call($e)) !== nil && (!$a.$$is_boolean || $a == true))) {};
...
if (key == null) key = nil;if (index == null) index = nil;
      ...
      def.$parse_attribute = function(index, pos_attrs) {
        ...
        if (value !== false && value !== nil) {
          ...
          ($a = ($b = value.$split(",")).$each, $a.$$p = (TMP_2 = function(o){var self = TMP_2.$$s || this;
            if (self.attributes == null) self.attributes = nil;
if (o == null) o = nil;
          return self.attributes['$[]=']("" + (o.$strip()) + "-option", "")}, TMP_2.$$s = self, TMP_2), $a).call($b);
...
Opal.modules["asciidoctor/block"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      (($a = ["simple"]), $b = $scope.get('DEFAULT_CONTENT_MODEL'), $b['$default='].apply($b, $a), $a[$a.length-1]);
...
if (backend == null) backend = nil;
        ...
        return (def.$create = function(backend, opts) {
          ...
          return $scope.get('DocBook45Converter').$new(backend, opts);}else { return nil }})();
...
Opal.modules["asciidoctor/converter/html5"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      (($a = [[nil, nil, nil]]), $b = $scope.get('QUOTE_TAGS'), $b['$default='].apply($b, $a), $a[$a.length-1]);
      ...
      def.$document = function(node) {
        ...
        if ((($a = asset_uri_scheme['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          } else {
        ...
        if ((($a = node['$attr?']("stem")) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          result['$<<']("<script type=\"text/x-mathjax-config\">\nMathJax.Hub.Config({\n  tex2jax: {\n    inlineMath: [" + ($scope.get('INLINE_MATH_DELIMITERS')['$[]']("latexmath").$to_s()) + "],\n    displayMath: [" + ($scope.get('BLOCK_MATH_DELIMITERS')['$[]']("latexmath").$to_s()) + "],\n    ignoreClass: \"nostem|nolatexmath\"\n  },\n  asciimath2jax: {\n    delimiters: [" + ($scope.get('BLOCK_MATH_DELIMITERS')['$[]']("asciimath").$to_s()) + "],\n    ignoreClass: \"nostem|noasciimath\"\n  },\n  TeX: {" + (eqnums_opt) + "}\n});\n</script>\n<script src=\"" + (cdn_base) + "/mathjax/2.4.0/MathJax.js?config=TeX-MML-AM_HTMLorMML\"></script>");};
...
if (footnote == null) footnote = nil;
      ...
      def.$embedded = function(node) {
        ...
        result = [];
        if ((($a = ($b = node.$notitle()['$!'](), $b !== false && $b !== nil ?node['$has_header?']() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (dt == null) dt = nil;
      ...
      def.$image = function(node) {
        ...
        align = (function() {if ((($a = (node['$attr?']("align"))) !== nil && (!$a.$$is_boolean || $a == true))) {
          return (node.$attr("align"))
          } else {
          return nil
        }; return nil; })();
        float$ = (function() {if ((($a = (node['$attr?']("float"))) !== nil && (!$a.$$is_boolean || $a == true))) {
          return (node.$attr("float"))
          } else {
          return nil
        }; return nil; })();
        style_attribute = (function() {if ((($a = ((($b = align) !== false && $b !== nil) ? $b : float$)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (item == null) item = nil;
      ...
      def.$paragraph = function(node) {
        ...
        attributes = (function() {if ((($a = node.$id()) !== nil && (!$a.$$is_boolean || $a == true))) {
          if ((($a = node.$role()) !== nil && (!$a.$$is_boolean || $a == true))) {
            return " id=\"" + (node.$id()) + "\" class=\"paragraph " + (node.$role()) + "\""
            } else {
            return " id=\"" + (node.$id()) + "\" class=\"paragraph\""
          }
        } else if ((($a = node.$role()) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (item == null) item = nil;
      ...
      def.$video = function(node) {
        ...
        return (function() {$case = node.$attr("poster");if ("vimeo"['$===']($case)) {start_anchor = (function() {if ((($a = (node['$attr?']("start", nil, false))) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        return "<div" + (id_attribute) + (class_attribute) + ">" + (title_element) + "\n<div class=\"content\">\n<iframe" + (width_attribute) + (height_attribute) + " src=\"//player.vimeo.com/video/" + (node.$attr("target")) + (start_anchor) + (autoplay_param) + (loop_param) + "\" frameborder=\"0\"" + ((function() {if ((($a = (node['$option?']("nofullscreen"))) !== nil && (!$a.$$is_boolean || $a == true))) {
          return nil
          } else {
          return (self.$append_boolean_attribute("allowfullscreen", xml))
        }; return nil; })()) + "></iframe>\n</div>\n</div>";}else if ("youtube"['$===']($case)) {rel_param_val = (function() {if ((($a = (node['$option?']("related"))) !== nil && (!$a.$$is_boolean || $a == true))) {
          return 1
          } else {
          return 0
        }; return nil; })();
      ...
      def.$inline_anchor = function(node) {
        ...
        if ((($a = (role = node.$role())) !== nil && (!$a.$$is_boolean || $a == true))) {
          attrs['$<<'](" class=\"" + (role) + "\"")};
        if ((($a = node['$attr?']("title")) !== nil && (!$a.$$is_boolean || $a == true))) {
          attrs['$<<'](" title=\"" + (node.$attr("title")) + "\"")};
        if ((($a = node['$attr?']("window")) !== nil && (!$a.$$is_boolean || $a == true))) {
      ...
      def.$inline_image = function(node) {
        ...
        if ((($a = (($b = ((type = node.$type()))['$==']("icon")) ? (node.$document()['$attr?']("icons", "font")) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          if ((($a = node['$attr?']("size")) !== nil && (!$a.$$is_boolean || $a == true))) {
            style_class = "" + (style_class) + " fa-" + (node.$attr("size"))};
          if ((($a = node['$attr?']("rotate")) !== nil && (!$a.$$is_boolean || $a == true))) {
            style_class = "" + (style_class) + " fa-rotate-" + (node.$attr("rotate"))};
          if ((($a = node['$attr?']("flip")) !== nil && (!$a.$$is_boolean || $a == true))) {
            style_class = "" + (style_class) + " fa-flip-" + (node.$attr("flip"))};
          title_attribute = (function() {if ((($a = (node['$attr?']("title"))) !== nil && (!$a.$$is_boolean || $a == true))) {
            return " title=\"" + (node.$attr("title")) + "\""
            } else {
            return nil
          }; return nil; })();
          img = "<i class=\"" + (style_class) + "\"" + (title_attribute) + "></i>";
        } else if ((($a = (($b = type['$==']("icon")) ? (node.$document()['$attr?']("icons"))['$!']() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          img = "[" + (node.$attr("alt")) + "]"
          } else {
          resolved_target = (function() {if ((($a = (type['$==']("icon"))) !== nil && (!$a.$$is_boolean || $a == true))) {
            return (node.$icon_uri(node.$target()))
            } else {
            return (node.$image_uri(node.$target()))
          }; return nil; })();
          attrs = ($a = ($b = ["alt", "width", "height", "title"]).$map, $a.$$p = (TMP_22 = function(name){var self = TMP_22.$$s || this, $a;
if (name == null) name = nil;
          if ((($a = (node['$attr?'](name))) !== nil && (!$a.$$is_boolean || $a == true))) {
              return " " + (name) + "=\"" + (node.$attr(name)) + "\""
              } else {
              return nil
            }}, TMP_22.$$s = self, TMP_22), $a).call($b).$join();
        ...
        style_classes = (function() {if ((($a = (role = node.$role())) !== nil && (!$a.$$is_boolean || $a == true))) {
          return "" + (type) + " " + (role)
          } else {
          return type
        }; return nil; })();
      ...
      def.$inline_kbd = function(node) {
        ...
        if (((keys = node.$attr("keys"))).$size()['$=='](1)) {
          ...
          key_combo = ($a = ($b = keys).$map, $a.$$p = (TMP_23 = function(key){var self = TMP_23.$$s || this;
if (key == null) key = nil;
          return "<kbd>" + (key) + "</kbd>+"}, TMP_23.$$s = self, TMP_23), $a).call($b).$join().$chop();
      ...
      def.$inline_menu = function(node) {
        ...
        if ((($a = ((submenus = node.$attr("submenus")))['$empty?']()['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          submenu_path = ($a = ($b = submenus).$map, $a.$$p = (TMP_24 = function(submenu){var self = TMP_24.$$s || this;
if (submenu == null) submenu = nil;
          return "<span class=\"submenu\">" + (submenu) + "</span>&#160;&#9656; "}, TMP_24.$$s = self, TMP_24), $a).call($b).$join().$chop();
    ...
    (function($base, $super) {
      ...
      (function($base, $super) {
        ...
        def.$initialize = function(val, opts) {
          ...
          if ((($a = (self.combined = val)['$include?'](": ")) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (key == null) key = nil;if (val == null) val = nil;
        ...
        if (parent_doc !== false && parent_doc !== nil) {
          ...
          ($a = "backend", $g = attrs, ((($h = $g['$[]']($a)) !== false && $h !== nil) ? $h : $g['$[]=']($a, $scope.get('DEFAULT_BACKEND'))));
          ($a = "doctype", $g = attrs, ((($h = $g['$[]']($a)) !== false && $h !== nil) ? $h : $g['$[]=']($a, $scope.get('DEFAULT_DOCTYPE'))));
...
if (ext == null) ext = nil;
      ...
      def.$register = function(type, value) {
        ...
        return (function() {$case = type;if ("ids"['$===']($case)) {if ((($a = Opal.get('Array')['$==='](value)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return self.references['$[]']("ids")['$[]='](value['$[]'](0), (((($a = value['$[]'](1)) !== false && $a !== nil) ? $a : $rb_plus($rb_plus("[", value['$[]'](0)), "]"))))
          } else {
          return self.references['$[]']("ids")['$[]='](value, $rb_plus($rb_plus("[", value), "]"))
      ...
      def.$doctitle = function(opts) {
        ...
        if ((($a = opts['$[]']("partition")) !== nil && (!$a.$$is_boolean || $a == true))) {
          return $scope.get('Title').$new(val, opts)
...
if (f == null) f = nil;
      ...
      def.$docinfo = function(location, ext) {
        ...
        if ($rb_ge(self.$safe(), (($scope.get('SafeMode')).$$scope.get('SECURE')))) {
          ...
          if ((($a = ((($b = docinfo1) !== false && $b !== nil) ? $b : docinfo2)) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          if ((($a = ($b = (((($c = docinfo) !== false && $c !== nil) ? $c : docinfo2)), $b !== false && $b !== nil ?self.attributes['$key?']("docname") : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          if ((($a = ($b = self.extensions, $b !== false && $b !== nil ?self['$docinfo_processors?'](location) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
            contentx = $rb_times(($a = ($b = self.docinfo_processor_extensions['$[]'](location)).$map, $a.$$p = (TMP_15 = function(candidate){var self = TMP_15.$$s || this;
if (candidate == null) candidate = nil;
            return candidate.$process_method()['$[]'](self)}, TMP_15.$$s = self, TMP_15), $a).call($b).$compact(), $scope.get('EOL'));
            content = (function() {if (content !== false && content !== nil) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      Opal.defs(self, '$next_block', function(reader, parent, attributes, options) {
        ...
        in_list = (parent['$is_a?']($scope.get('List')));
        block = nil;
        style = nil;
        explicit_style = nil;
          ...
          if (text_only !== false && text_only !== nil) {
            ...
            if ((($c = ($d = ($e = ($scope.get('LAYOUT_BREAK_LINES')['$has_key?'](first_char)), $e !== false && $e !== nil ?$rb_ge(this_line.$length(), 3) : $e), $d !== false && $d !== nil ?((function() {if ((($e = $scope.get('Compliance').$markdown_syntax()) !== nil && (!$e.$$is_boolean || $e == true))) {
              ...
              if ((($c = (default_attrs = extension.$config()['$[]']("default_attrs"))) !== nil && (!$c.$$is_boolean || $c == true))) {
                ($c = ($d = default_attrs).$each, $c.$$p = (TMP_1 = function(k, v){var self = TMP_1.$$s || this, $a, $b, $c;
if (k == null) k = nil;if (v == null) v = nil;
                return ($a = k, $b = attributes, ((($c = $b['$[]']($a)) !== false && $c !== nil) ? $c : $b['$[]=']($a, v)))}, TMP_1.$$s = self, TMP_1), $c).call($d)};
          ...
          if ((($c = (match = $scope.get('CalloutListRx').$match(this_line))) !== nil && (!$c.$$is_boolean || $c == true))) {
            ...
            reader.$unshift_line(this_line);
            expected_index = 1;
            while ((($e = ($f = reader['$has_more_lines?'](), $f !== false && $f !== nil ?(match = $scope.get('CalloutListRx').$match(reader.$peek_line())) : $f)) !== nil && (!$e.$$is_boolean || $e == true))) {
            ...
            if ((($c = ($e = attributes['$[]']("style")['$!'](), $e !== false && $e !== nil ?block.$attributes()['$[]']("style")['$!']() : $e)) !== nil && (!$c.$$is_boolean || $c == true))) {
              ...
              if ((($c = marker['$start_with?'](".")) !== nil && (!$c.$$is_boolean || $c == true))) {
                ...
                style = ($c = ($e = $scope.get('ORDERED_LIST_STYLES')).$detect, $c.$$p = (TMP_2 = function(s){var self = TMP_2.$$s || this;
if (s == null) s = nil;
                return $scope.get('OrderedListMarkerRxMap')['$[]'](s)['$=~'](marker)}, TMP_2.$$s = self, TMP_2), $c).call($e);
          ...
          if ((($c = ($f = style['$==']("normal")['$!'](), $f !== false && $f !== nil ?$scope.get('LiteralParagraphRx')['$=~'](this_line) : $f)) !== nil && (!$c.$$is_boolean || $c == true))) {
            reader.$unshift_line(this_line);
            lines = ($c = ($f = reader).$read_lines_until, $c.$$p = (TMP_3 = function(line){var self = TMP_3.$$s || this, $a, $b, $c;
if (line == null) line = nil;
            return ((($a = ((($b = break_at_list !== false && break_at_list !== nil) ? $scope.get('AnyListRx')['$=~'](line) : $b))) !== false && $a !== nil) ? $a : (($b = $scope.get('Compliance').$block_terminates_paragraph(), $b !== false && $b !== nil ?(((($c = self['$is_delimited_block?'](line)) !== false && $c !== nil) ? $c : $scope.get('BlockAttributeLineRx')['$=~'](line))) : $b)))}, TMP_3.$$s = self, TMP_3), $c).call($f, $hash2(["break_on_blank_lines", "break_on_list_continuation", "preserve_last_line"], {"break_on_blank_lines": true, "break_on_list_continuation": true, "preserve_last_line": true}));
            ...
            reader.$unshift_line(this_line);
            lines = ($c = ($g = reader).$read_lines_until, $c.$$p = (TMP_4 = function(line){var self = TMP_4.$$s || this, $a, $b, $c;
if (line == null) line = nil;
            return ((($a = ((($b = break_at_list !== false && break_at_list !== nil) ? $scope.get('AnyListRx')['$=~'](line) : $b))) !== false && $a !== nil) ? $a : (($b = $scope.get('Compliance').$block_terminates_paragraph(), $b !== false && $b !== nil ?(((($c = self['$is_delimited_block?'](line)) !== false && $c !== nil) ? $c : $scope.get('BlockAttributeLineRx')['$=~'](line))) : $b)))}, TMP_4.$$s = self, TMP_4), $c).call($g, $hash2(["break_on_blank_lines", "break_on_list_continuation", "preserve_last_line", "skip_line_comments"], {"break_on_blank_lines": true, "break_on_list_continuation": true, "preserve_last_line": true, "skip_line_comments": true}));
            if ((($c = lines['$empty?']()) !== nil && (!$c.$$is_boolean || $c == true))) {
              reader.$advance();
              return nil;};
            self.$catalog_inline_anchors(lines.$join($scope.get('EOL')), document);
            first_line = lines['$[]'](0);
            if ((($c = ($h = text_only['$!'](), $h !== false && $h !== nil ?(admonition_match = $scope.get('AdmonitionParagraphRx').$match(first_line)) : $h)) !== nil && (!$c.$$is_boolean || $c == true))) {
            ...
            } else if ((($c = ($h = ($i = text_only['$!'](), $i !== false && $i !== nil ?$scope.get('Compliance').$markdown_syntax() : $i), $h !== false && $h !== nil ?first_line['$start_with?']("> ") : $h)) !== nil && (!$c.$$is_boolean || $c == true))) {
              ($c = ($h = lines)['$map!'], $c.$$p = (TMP_5 = function(line){var self = TMP_5.$$s || this, $a;
if (line == null) line = nil;
              if (line['$=='](">")) {
              ...
              if ((($c = lines['$[]'](-1)['$start_with?']("-- ")) !== nil && (!$c.$$is_boolean || $c == true))) {
                ...
                while ((($i = lines['$[]'](-1)['$empty?']()) !== nil && (!$i.$$is_boolean || $i == true))) {
                lines.$pop()};
                } else {
            ...
            } else if ((($c = ($i = ($j = ($k = ($l = text_only['$!'](), $l !== false && $l !== nil ?$rb_gt(lines.$size(), 1) : $l), $k !== false && $k !== nil ?first_line['$start_with?']("\"") : $k), $j !== false && $j !== nil ?lines['$[]'](-1)['$start_with?']("-- ") : $j), $i !== false && $i !== nil ?lines['$[]'](-2)['$end_with?']("\"") : $i)) !== nil && (!$c.$$is_boolean || $c == true))) {
              ...
              if ((($c = (($i = style['$==']("normal")) ? (((($j = ((first_char = lines['$[]'](0).$chr()))['$=='](" ")) !== false && $j !== nil) ? $j : first_char['$==']($scope.get('TAB')))) : $i)) !== nil && (!$c.$$is_boolean || $c == true))) {
                first_line = lines['$[]'](0);
                first_line_shifted = first_line.$lstrip();
                indent = $rb_minus(self.$line_length(first_line), self.$line_length(first_line_shifted));
                lines['$[]='](0, first_line_shifted);
                ($c = ($i = lines.$size()).$times, $c.$$p = (TMP_6 = function(i){var self = TMP_6.$$s || this;
if (i == null) i = nil;
                if ($rb_gt(i, 0)) {
                    return lines['$[]='](i, lines['$[]'](i)['$[]']($range(indent, -1, false)))
                    } else {
                    return nil
                  }}, TMP_6.$$s = self, TMP_6), $c).call($i);};
        ...
        if ((($b = ($c = block['$!'](), $c !== false && $c !== nil ?block_context : $c)) !== nil && (!$b.$$is_boolean || $b == true))) {
          ...
          return nil;}else if ("example"['$===']($case)) {block = self.$build_block(block_context, "compound", terminator, parent, reader, attributes)}else if ("listing"['$===']($case) || "fenced_code"['$===']($case) || "source"['$===']($case)) {if (block_context['$==']("fenced_code")) {
            ...
            if ((($b = (($c = language !== false && language !== nil) ? ((language = language.$strip()))['$empty?']()['$!']() : $c)) !== nil && (!$b.$$is_boolean || $b == true))) {
              attributes['$[]=']("language", language);
              if ((($b = (($c = linenums !== false && linenums !== nil) ? linenums.$strip()['$empty?']()['$!']() : $c)) !== nil && (!$b.$$is_boolean || $b == true))) {
                attributes['$[]=']("linenums", "")};
            ...
            if ((($b = attributes['$has_key?']("language")) !== nil && (!$b.$$is_boolean || $b == true))) {
            } else if ((($b = (default_language = document.$attributes()['$[]']("source-language"))) !== nil && (!$b.$$is_boolean || $b == true))) {
              attributes['$[]=']("language", default_language)};};
...
if (k == null) k = nil;if (v == null) v = nil;
            ...
            if ((($b = (($j = block !== false && block !== nil) ? content_model['$==']("skip")['$!']() : $j)) !== nil && (!$b.$$is_boolean || $b == true))) {
              } else {
              attributes.$clear();
              return nil;
            };
        ...
        if (block !== false && block !== nil) {
          ...
          if (block.$context()['$==']("image")) {
            ...
            ($a = "alt", $b = attributes, ((($j = $b['$[]']($a)) !== false && $j !== nil) ? $j : $b['$[]=']($a, Opal.get('File').$basename(resolved_target, Opal.get('File').$extname(resolved_target)).$tr("_-", " "))));
          ...
          if ((($a = (block_id = (($b = block, ((($j = $b.$id()) !== false && $j !== nil) ? $j : $b['$id='](attributes['$[]']("id"))))))) !== nil && (!$a.$$is_boolean || $a == true))) {
      ...
      Opal.defs(self, '$build_block', function(block_context, content_model, terminator, parent, reader, attributes, options) {
        ...
        if ((($a = terminator['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          if (parse_as_content_model['$==']("verbatim")) {
            ...
            lines = ($a = ($b = reader).$read_lines_until, $a.$$p = (TMP_8 = function(line){var self = TMP_8.$$s || this, $a, $b;
if (line == null) line = nil;
            return ($a = $scope.get('Compliance').$block_terminates_paragraph(), $a !== false && $a !== nil ?(((($b = self['$is_delimited_block?'](line)) !== false && $b !== nil) ? $b : $scope.get('BlockAttributeLineRx')['$=~'](line))) : $a)}, TMP_8.$$s = self, TMP_8), $a).call($b, $hash2(["break_on_blank_lines", "break_on_list_continuation", "preserve_last_line", "skip_line_comments", "skip_processing"], {"break_on_blank_lines": true, "break_on_list_continuation": true, "preserve_last_line": true, "skip_line_comments": true, "skip_processing": skip_processing}));
          };
          block_reader = nil;
        ...
        if (content_model['$==']("skip")) {
          attributes.$clear();
          return lines;};
        if ((($a = (($c = content_model['$==']("verbatim")) ? (indent = attributes['$[]']("indent")) : $c)) !== nil && (!$a.$$is_boolean || $a == true))) {
          self['$reset_block_indent!'](lines, indent.$to_i())};
        if ((($a = (extension = options['$[]']("extension"))) !== nil && (!$a.$$is_boolean || $a == true))) {
          attributes.$delete("style");
          if ((($a = (block = extension.$process_method()['$[]'](parent, ((($c = block_reader) !== false && $c !== nil) ? $c : ($scope.get('Reader').$new(lines))), attributes.$dup()))) !== nil && (!$a.$$is_boolean || $a == true))) {
            attributes.$replace(block.$attributes());
            if ((($a = (($c = block.$content_model()['$==']("compound")) ? ((lines = block.$lines()))['$nil_or_empty?']()['$!']() : $c)) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        if ((($a = ($c = (attributes['$has_key?']("title")), $c !== false && $c !== nil ?(block.$document()['$attr?']("" + (block.$context()) + "-caption")) : $c)) !== nil && (!$a.$$is_boolean || $a == true))) {
          (($a = [attributes.$delete("title")]), $c = block, $c['$title='].apply($c, $a), $a[$a.length-1]);
      ...
      Opal.defs(self, '$catalog_callouts', function(text, document) {
        ...
        if ((($a = text['$include?']("<")) !== nil && (!$a.$$is_boolean || $a == true))) {
          ($a = ($b = text).$scan, $a.$$p = (TMP_9 = function(){var self = TMP_9.$$s || this, $a, m = nil;
            if ($gvars["~"] == null) $gvars["~"] = nil;

          m = $gvars["~"];
            if ((($a = m['$[]'](0).$chr()['$==']("\\")['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
              document.$callouts().$register(m['$[]'](2))};
            return found = true;}, TMP_9.$$s = self, TMP_9), $a).call($b, $scope.get('CalloutQuickScanRx'))};
        return found;
      });
      ...
      Opal.defs(self, '$catalog_inline_anchors', function(text, document) {
        ...
        if ((($a = text['$include?']("[")) !== nil && (!$a.$$is_boolean || $a == true))) {
          ($a = ($b = text).$scan, $a.$$p = (TMP_10 = function(){var self = TMP_10.$$s || this, $a, m = nil, id = nil, reftext = nil;
            if ($gvars["~"] == null) $gvars["~"] = nil;
          ...
          m = $gvars["~"];
            ...
            return document.$register("ids", [id, reftext]);}, TMP_10.$$s = self, TMP_10), $a).call($b, $scope.get('InlineAnchorRx'))};
        return nil;
      });
      ...
      Opal.defs(self, '$next_labeled_list', function(reader, match, parent) {
        ...
        while ((($b = ($c = reader['$has_more_lines?'](), $c !== false && $c !== nil ?(match = sibling_pattern.$match(reader.$peek_line())) : $c)) !== nil && (!$b.$$is_boolean || $b == true))) {
      ...
      Opal.defs(self, '$read_lines_for_list_item', function(reader, list_type, sibling_trait, has_text) {
        ...
        if ((($b = (match = self['$is_delimited_block?'](this_line, true))) !== nil && (!$b.$$is_boolean || $b == true))) {
          ...
          if ((($b = $scope.get('LiteralParagraphRx')['$=~'](this_line)) !== nil && (!$b.$$is_boolean || $b == true))) {
            reader.$unshift_line(this_line);
            buffer.$concat(($b = ($c = reader).$read_lines_until, $b.$$p = (TMP_11 = function(line){var self = TMP_11.$$s || this, $a;
if (line == null) line = nil;
            return (($a = list_type['$==']("dlist")) ? self['$is_sibling_list_item?'](line, list_type, sibling_trait) : $a)}, TMP_11.$$s = self, TMP_11), $b).call($c, $hash2(["preserve_last_line", "break_on_blank_lines", "break_on_list_continuation"], {"preserve_last_line": true, "break_on_blank_lines": true, "break_on_list_continuation": true})));
            continuation = "inactive";
            ...
            }; return nil; })())).$detect, $d.$$p = (TMP_12 = function(ctx){var self = TMP_12.$$s || this;
if (ctx == null) ctx = nil;
            return $scope.get('ListRxMap')['$[]'](ctx)['$=~'](this_line)}, TMP_12.$$s = self, TMP_12), $d).call($e)) !== nil && (!$b.$$is_boolean || $b == true))) {
          ...
          if (this_line['$==']($scope.get('LIST_CONTINUATION'))) {
            ...
            if ((($b = self['$is_sibling_list_item?'](this_line, list_type, sibling_trait)) !== nil && (!$b.$$is_boolean || $b == true))) {
              break;
            } else if ((($b = nested_list_type = ($d = ($f = $scope.get('NESTABLE_LIST_CONTEXTS')).$detect, $d.$$p = (TMP_13 = function(ctx){var self = TMP_13.$$s || this;
if (ctx == null) ctx = nil;
            return $scope.get('ListRxMap')['$[]'](ctx)['$=~'](this_line)}, TMP_13.$$s = self, TMP_13), $d).call($f)) !== nil && (!$b.$$is_boolean || $b == true))) {
              buffer['$<<'](this_line);
              within_nested_list = true;
              if ((($b = (($d = nested_list_type['$==']("dlist")) ? $gvars["~"]['$[]'](3)['$nil_or_empty?']() : $d)) !== nil && (!$b.$$is_boolean || $b == true))) {
                has_text = false};
              ...
              reader.$unshift_line(this_line);
              buffer.$concat(($b = ($d = reader).$read_lines_until, $b.$$p = (TMP_14 = function(line){var self = TMP_14.$$s || this, $a;
if (line == null) line = nil;
              return (($a = list_type['$==']("dlist")) ? self['$is_sibling_list_item?'](line, list_type, sibling_trait) : $a)}, TMP_14.$$s = self, TMP_14), $b).call($d, $hash2(["preserve_last_line", "break_on_blank_lines", "break_on_list_continuation"], {"preserve_last_line": true, "break_on_blank_lines": true, "break_on_list_continuation": true})));
              } else {
              break;
            }
            } else {
          ...
          if ((($b = nested_list_type = ($g = ($h = ((function() {if (within_nested_list !== false && within_nested_list !== nil) {
            ...
            return $scope.get('NESTABLE_LIST_CONTEXTS')
          }; return nil; })())).$detect, $g.$$p = (TMP_15 = function(ctx){var self = TMP_15.$$s || this;
if (ctx == null) ctx = nil;
          return $scope.get('ListRxMap')['$[]'](ctx)['$=~'](this_line)}, TMP_15.$$s = self, TMP_15), $g).call($h)) !== nil && (!$b.$$is_boolean || $b == true))) {
            within_nested_list = true;
        ...
        if ((($a = ($b = reader['$has_more_lines?'](), $b !== false && $b !== nil ?reader['$next_line_empty?']()['$!']() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          if ((($a = author_metadata['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            ...
            if (document !== false && document !== nil) {
              ($a = ($b = author_metadata).$each, $a.$$p = (TMP_16 = function(key, val){var self = TMP_16.$$s || this, $a;
if (key == null) key = nil;if (val == null) val = nil;
          ...
          if ((($a = ($c = reader['$has_more_lines?'](), $c !== false && $c !== nil ?reader['$next_line_empty?']()['$!']() : $c)) !== nil && (!$a.$$is_boolean || $a == true))) {
            ...
            if ((($a = (match = $scope.get('RevisionInfoLineRx').$match(rev_line))) !== nil && (!$a.$$is_boolean || $a == true))) {
              ...
              if ((($a = match['$[]'](1)['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
                } else {
                rev_metadata['$[]=']("revnumber", match['$[]'](1).$rstrip())
              };
              if ((($a = match['$[]'](3)['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
                } else {
          ...
          if ((($a = rev_metadata['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            ...
            if (document !== false && document !== nil) {
              ($a = ($c = rev_metadata).$each, $a.$$p = (TMP_17 = function(key, val){var self = TMP_17.$$s || this, $a;
if (key == null) key = nil;if (val == null) val = nil;
              if ((($a = document.$attributes()['$has_key?'](key)) !== nil && (!$a.$$is_boolean || $a == true))) {
                  return nil
                  } else {
      ...
      Opal.defs(self, '$process_authors', function(author_line, names_only, multiple) {
        ...
        author_entries = (function() {if (multiple !== false && multiple !== nil) {
          return ($a = ($b = (author_line.$split(";"))).$map, $a.$$p = (TMP_18 = function(line){var self = TMP_18.$$s || this;
if (line == null) line = nil;
          return line.$strip()}, TMP_18.$$s = self, TMP_18), $a).call($b)
          } else {
          return [author_line]
        }; return nil; })();
        ($a = ($c = author_entries).$each_with_index, $a.$$p = (TMP_19 = function(author_entry, idx){var self = TMP_19.$$s || this, $a, $b, TMP_20, $c, TMP_21, $d, TMP_22, key_map = nil, segments = nil, match = nil, fname = nil, mname = nil, lname = nil;
if (author_entry == null) author_entry = nil;if (idx == null) idx = nil;
        if ((($a = author_entry['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          if ((($a = idx['$zero?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            ($a = ($b = keys).$each, $a.$$p = (TMP_20 = function(key){var self = TMP_20.$$s || this;
if (key == null) key = nil;
            return key_map['$[]='](key.$to_sym(), key)}, TMP_20.$$s = self, TMP_20), $a).call($b)
            } else {
            ($a = ($c = keys).$each, $a.$$p = (TMP_21 = function(key){var self = TMP_21.$$s || this;
if (key == null) key = nil;
            return key_map['$[]='](key.$to_sym(), "" + (key) + "_" + ($rb_plus(idx, 1)))}, TMP_21.$$s = self, TMP_21), $a).call($c)
          };
          segments = nil;
...
if (key == null) key = nil;
      ...
      Opal.defs(self, '$resolve_ordered_list_marker', function(marker, ordinal, validate, reader) {
        ...
        number_style = ($a = ($b = $scope.get('ORDERED_LIST_STYLES')).$detect, $a.$$p = (TMP_23 = function(s){var self = TMP_23.$$s || this;
if (s == null) s = nil;
        return $scope.get('OrderedListMarkerRxMap')['$[]'](s)['$=~'](marker)}, TMP_23.$$s = self, TMP_23), $a).call($b);
        expected = actual = nil;
      ...
      Opal.defs(self, '$next_table', function(table_reader, parent, attributes) {
        ...
        if ((($a = attributes['$has_key?']("cols")) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        if ((($a = explicit_col_specs['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          ($a = ($b = table.$columns()).$each, $a.$$p = (TMP_24 = function(c){var self = TMP_24.$$s || this;
if (c == null) c = nil;
          return c.$assign_width(0, even_width)}, TMP_24.$$s = self, TMP_24), $a).call($b);};
      ...
      Opal.defs(self, '$parse_col_specs', function(records) {
        ...
        if ((($a = $scope.get('DigitsRx')['$=~'](records)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return ($a = ($b = Opal.get('Array')).$new, $a.$$p = (TMP_25 = function(){var self = TMP_25.$$s || this;

          return $hash2(["width"], {"width": 1})}, TMP_25.$$s = self, TMP_25), $a).call($b, records.$to_i())};
        specs = [];
        ($a = ($c = records.$split(",")).$each, $a.$$p = (TMP_26 = function(record){var self = TMP_26.$$s || this, $a, $b, TMP_27, m = nil, spec = nil, colspec = nil, rowspec = nil, repeat = nil;
if (record == null) record = nil;
        if ((($a = (m = $scope.get('ColumnSpecRx').$match(record))) !== nil && (!$a.$$is_boolean || $a == true))) {
            spec = $hash2([], {});
            ...
            spec['$[]=']("width", (function() {if ((($a = m['$[]'](3)['$nil?']()['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
              return m['$[]'](3).$to_i()
              } else {
              return 1
            }; return nil; })());
            ...
            repeat = (function() {if ((($a = m['$[]'](1)['$nil?']()['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
              return m['$[]'](1).$to_i()
              } else {
              return 1
            }; return nil; })();
            return ($a = ($b = (1)).$upto, $a.$$p = (TMP_27 = function(){var self = TMP_27.$$s || this;

            return specs['$<<'](spec.$dup())}, TMP_27.$$s = self, TMP_27), $a).call($b, repeat);
            } else {
            return nil
          }}, TMP_26.$$s = self, TMP_26), $a).call($c);
        return specs;
      });
      ...
      Opal.defs(self, '$parse_style_attribute', function(attributes, reader) {
        ...
        if ((($a = ($b = (($c = raw_style !== false && raw_style !== nil) ? raw_style['$include?'](" ")['$!']() : $c), $b !== false && $b !== nil ?$scope.get('Compliance').$shorthand_property_syntax() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          collector = [];
          parsed = $hash2([], {});
          save_current = ($a = ($b = self).$lambda, $a.$$p = (TMP_28 = function(){var self = TMP_28.$$s || this, $a, $b, $c, $case = nil;
          ...
          ($a = ($c = raw_style).$each_char, $a.$$p = (TMP_29 = function(c){var self = TMP_29.$$s || this, $a, $b, $c, $case = nil;
if (c == null) c = nil;
          ...
          if (type['$==']("style")) {
            ...
            if ((($a = parsed['$has_key?']("option")) !== nil && (!$a.$$is_boolean || $a == true))) {
              ($a = ($d = ((options = parsed['$[]']("option")))).$each, $a.$$p = (TMP_30 = function(option){var self = TMP_30.$$s || this;
if (option == null) option = nil;
              return attributes['$[]=']("" + (option) + "-option", "")}, TMP_30.$$s = self, TMP_30), $a).call($d);
      ...
      Opal.defs(self, '$reset_block_indent!', function(lines, indent) {
        ...
        if ((($a = ((($b = indent['$!']()) !== false && $b !== nil) ? $b : lines['$empty?']())) !== nil && (!$a.$$is_boolean || $a == true))) {
          return nil};
        tab_detected = false;
        tab_expansion = "    ";
        offsets = ($a = ($b = lines).$map, $a.$$p = (TMP_31 = function(line){var self = TMP_31.$$s || this, $a, flush_line = nil, offset = nil;
if (line == null) line = nil;
        if ((($a = line.$chr().$lstrip()['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            } else {
            return ($breaker.$v = [], $breaker)
          };
          if ((($a = line['$include?']($scope.get('TAB'))) !== nil && (!$a.$$is_boolean || $a == true))) {
            tab_detected = true;
            line = line.$gsub($scope.get('TAB_PATTERN'), tab_expansion);};
          if ((($a = ((flush_line = line.$lstrip()))['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            return nil
          } else if (((offset = $rb_minus(line.$length(), flush_line.$length())))['$=='](0)) {
            return ($breaker.$v = [], $breaker)
            } else {
            return offset
          };}, TMP_31.$$s = self, TMP_31), $a).call($b);
        if ((($a = ((($c = offsets['$empty?']()) !== false && $c !== nil) ? $c : ((offsets = offsets.$compact()))['$empty?']())) !== nil && (!$a.$$is_boolean || $a == true))) {
        } else if ($rb_gt((offset = offsets.$min()), 0)) {
          ($a = ($c = lines)['$map!'], $a.$$p = (TMP_32 = function(line){var self = TMP_32.$$s || this;
if (line == null) line = nil;
          if (tab_detected !== false && tab_detected !== nil) {
              line = line.$gsub($scope.get('TAB_PATTERN'), tab_expansion)};
            return line['$[]']($range(offset, -1, false)).$to_s();}, TMP_32.$$s = self, TMP_32), $a).call($c)};
        if ($rb_gt(indent, 0)) {
          padding = $rb_times(" ", indent);
          ($a = ($d = lines)['$map!'], $a.$$p = (TMP_33 = function(line){var self = TMP_33.$$s || this;
if (line == null) line = nil;
          return "" + (padding) + (line)}, TMP_33.$$s = self, TMP_33), $a).call($d);};
        return nil;
      });
      ...
      return (Opal.defs(self, '$roman_numeral_to_int', function(value) {
        ...
        result = 0;
        ($a = ($b = ($range(0, $rb_minus(value.$length(), 1), false))).$each, $a.$$p = (TMP_34 = function(i){var self = TMP_34.$$s || this, $a, $b, digit = nil;
if (i == null) i = nil;
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$system_path = function(target, start, jail, opts) {
        ...
        warned = false;
        ($a = ($b = target_segments).$each, $a.$$p = (TMP_1 = function(segment){var self = TMP_1.$$s || this, $a;
if (segment == null) segment = nil;
        if (segment['$==']($scope.get('DOT_DOT'))) {
            if (jail !== false && jail !== nil) {
              ...
              } else if ((($a = recover['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
      ...
      def.$web_path = function(target, start) {
        ...
        if ((($a = ((($b = start['$nil_or_empty?']()) !== false && $b !== nil) ? $b : (self['$is_web_root?'](target)))) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          if ((($a = ($b = (target['$include?'](":")), $b !== false && $b !== nil ?$scope.get('UriSniffRx')['$=~'](target) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
            uri_prefix = $gvars["~"]['$[]'](0);
...
if (line == null) line = nil;
      ...
      def.$read_lines_until = TMP_4 = function(options) {
        var $a, $b, $c, $d, $e, self = this, $iter = TMP_4.$$p, $yield = $iter || nil, result = nil, restore_process_lines = nil, terminator = nil, break_on_blank_lines = nil, break_on_list_continuation = nil, skip_line_comments = nil, line_read = nil, line_restored = nil, complete = nil, line = nil;
        ...
        if (complete !== false && complete !== nil) {
          ...
          if ((($b = options['$[]']("preserve_last_line")) !== nil && (!$b.$$is_boolean || $b == true))) {
            ...
            line_restored = true;};
        } else if ((($b = ($c = (($d = skip_line_comments !== false && skip_line_comments !== nil) ? line['$start_with?']("//") : $d), $c !== false && $c !== nil ?$scope.get('CommentLineRx')['$=~'](line) : $c)) !== nil && (!$b.$$is_boolean || $b == true))) {
          } else {
          result['$<<'](line);
          line_read = true;
        };};
    ...
    (function($base, $super) {
      ...
      def.$prepare_lines = TMP_6 = function(data, opts) {var $zuper = $slice.call(arguments, 0);
        var $a, $b, $c, self = this, $iter = TMP_6.$$p, $yield = $iter || nil, result = nil, front_matter = nil, first = nil, last = nil, indent = nil;
        ...
        if ((($a = opts.$fetch("condense", true)) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          result.$pop()};};
        if ((($a = (indent = opts.$fetch("indent", nil))) !== nil && (!$a.$$is_boolean || $a == true))) {
          $scope.get('Parser')['$reset_block_indent!'](result, indent.$to_i())};
        return result;
      };
...
if (candidate == null) candidate = nil;
        return candidate.$instance()['$handles?'](target)}, TMP_12.$$s = self, TMP_12), $c).call($d)) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          } else if ((($a = ($b = target['$include?'](":"), $b !== false && $b !== nil ?$scope.get('UriSniffRx')['$=~'](target) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (f == null) f = nil;
      ...
      def.$resolve_expr_val = function(str) {
        ...
        if (type['$==']("string")) {
          ...
          val = nil
        } else if ((($a = val.$strip()['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          val = " "
        } else if (val['$==']("true")) {
          val = true
        } else if (val['$==']("false")) {
...
if (f == null) f = nil;
      ...
      def.$pygments_stylesheet_name = function(style) {
        ...
        ((($a = style) !== false && $a !== nil) ? $a : style = $scope.get('DEFAULT_PYGMENTS_STYLE'));
...
if (f == null) f = nil;
      ...
      return (def.$load_pygments = function() {
        ...
        if ((($a = (Opal.Object.$$scope.Pygments == null ? nil : 'constant')) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          $scope.get('Helpers').$require_library("pygments", "pygments.rb")
        };
        return $hash2([], {});
      }, nil) && 'load_pygments';
    })(self, null)
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$initialize = TMP_1 = function(parent, attributes) {
        ...
        if ((($a = self.document.$attributes()['$has_key?']("pagewidth")) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (c == null) c = nil;
        ...
        if ((($a = (($c = $rb_gt(num_body_rows, 0)) ? attributes['$has_key?']("footer-option") : $c)) !== nil && (!$a.$$is_boolean || $a == true))) {
    ...
    (function($base, $super) {
      ...
      return (def.$assign_width = function(total_width, even_width) {
        ...
        if ((($a = self.$parent().$attributes()['$has_key?']("tableabswidth")) !== nil && (!$a.$$is_boolean || $a == true))) {
    ...
    (function($base, $super) {
      ...
      def.$initialize = TMP_6 = function(column, text, attributes, cursor) {
        ...
        if (attributes !== false && attributes !== nil) {
          ...
          if ((($a = attributes['$has_key?']("style")) !== nil && (!$a.$$is_boolean || $a == true))) {
            self.style = attributes['$[]']("style")};
...
if (p == null) p = nil;
    ...
    (function($base, $super) {
      ...
      def.$initialize = function(reader, table, attributes) {
        ...
        self.delimiter = (function() {if ((($a = ($b = (($c = self.format['$==']("psv")) ? (attributes['$has_key?']("separator"))['$!']() : $c), $b !== false && $b !== nil ?table.$document()['$nested?']() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return "!"
          } else {
      ...
      def.$close_cell = function(eol) {
        ...
        if (self.format['$==']("psv")) {
          ...
          if ((($a = cell_spec['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        ($a = ($b = (1)).$upto, $a.$$p = (TMP_9 = function(i){var self = TMP_9.$$s || this, $a, $b, $c, TMP_10, $d, $e, column = nil, extra_cols = nil, cell = nil;
...
if (i == null) i = nil;
        if (self.col_count['$=='](-1)) {
            self.table.$columns()['$<<']((column = (($scope.get('Table')).$$scope.get('Column')).$new(self.table, $rb_minus($rb_plus(self.current_row.$size(), i), 1))));
            if ((($a = ($b = (($c = cell_spec !== false && cell_spec !== nil) ? (cell_spec['$has_key?']("colspan")) : $c), $b !== false && $b !== nil ?$rb_gt((extra_cols = $rb_minus(cell_spec['$[]']("colspan").$to_i(), 1)), 0) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
              ($a = ($b = extra_cols).$times, $a.$$p = (TMP_10 = function(j){var self = TMP_10.$$s || this;
                if (self.table == null) self.table = nil;
                if (self.current_row == null) self.current_row = nil;
if (j == null) j = nil;
              return self.table.$columns()['$<<']((($scope.get('Table')).$$scope.get('Column')).$new(self.table, $rb_minus($rb_plus($rb_plus(self.current_row.$size(), i), j), 1)))}, TMP_10.$$s = self, TMP_10), $a).call($b)};
            } else {
...
if (key == null) key = nil;
    ...
    Opal.cdecl($scope, 'UnorderedListRx', (new RegExp("^" + $scope.get('CG_BLANK') + "*(-|\\*{1,5})" + $scope.get('CG_BLANK') + "+(.*)$")));
    ...
    (function(self) {
      ...
      self.$$proto.$load = function(input, options) {
        var $a, $b, $c, TMP_2, TMP_3, $d, TMP_4, self = this, timings = nil, attributes = nil, attrs = nil, capture_1 = nil, original_attrs = nil, lines = nil, input_path = nil, input_mtime = nil, docdate = nil, doctime = nil, doc = nil, e = nil;
...
if (key == null) key = nil;
          ...
          if ((($a = Opal.get('File')['$==='](input)) !== nil && (!$a.$$is_boolean || $a == true))) {
            ...
            attributes['$[]=']("docname", Opal.get('File').$basename(input_path, (Opal.get('File').$extname(input_path))));
      ...
      self.$$proto.$convert = function(input, options) {
        ...
        if (write_to_same_dir !== false && write_to_same_dir !== nil) {
          outfile = Opal.get('File').$join(outdir, "" + (doc.$attributes()['$[]']("docname")) + (doc.$attributes()['$[]']("outfilesuffix")));
        ...
        if (outfile !== false && outfile !== nil) {
          ...
          if ((($a = ($b = ($c = ($d = ($e = stream_output['$!'](), $e !== false && $e !== nil ?$rb_lt(doc.$safe(), (($scope.get('SafeMode')).$$scope.get('SECURE'))) : $e), $d !== false && $d !== nil ?(doc['$attr?']("basebackend-html")) : $d), $c !== false && $c !== nil ?(doc['$attr?']("linkcss")) : $c), $b !== false && $b !== nil ?(doc['$attr?']("copycss")) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
            copy_asciidoctor_stylesheet = $scope.get('DEFAULT_STYLESHEET_KEYS')['$include?'](stylesheet = (doc.$attr("stylesheet")));
...
if (f == null) f = nil;
  ...
  self.$require("asciidoctor/core_ext/match_data");
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        (function(self) {
          ...
          self.$$proto.$extend_dsl = self.$$proto.$use_dsl;
          return self.$$proto.$include_dsl = self.$$proto.$use_dsl;
        })(self.$singleton_class());
...
args = $slice.call(arguments, 0);
      ...
      (function($base) {
        ...
        Opal.defn(self, '$process', TMP_3 = function(args) {
      ...
      (function($base) {
        ...
        Opal.defn(self, '$contexts', function(value) {
          var self = this;
        ...
        Opal.defn(self, '$positional_attributes', function(value) {
          var self = this;
...
if (word == null) word = nil;
      ...
      (function(self) {
        ...
        self.$$proto.$next_auto_id = function() {
          var $a, self = this;
        ...
        self.$$proto.$unregister_all = function() {
          var self = this;

          return self.groups = $hash2([], {});
        };
        self.$$proto.$resolve_class = function(object) {
          var $a, self = this;
