  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      def.$restore_passthroughs = function(text) {
        ...
        pass = self.passthroughs['$[]']($gvars["~"]['$[]'](1).$to_i());
          ...
          if (($a = (type = pass['$[]']("type"))) !== false && $a !== nil) {
            return $scope.Inline.$new(self, "quoted", subbed_text, $hash2(["type", "attributes"], {"type": type, "attributes": pass['$[]']("attributes")})).$render()
            } else {
            return subbed_text
      ...
      def.$sub_macros = function(source) {
        var $a, $b, $c, TMP_20, TMP_22, $d, TMP_24, $e, $f, TMP_26, $g, TMP_28, TMP_29, $h, TMP_30, $i, $j, TMP_31, TMP_32, $k, TMP_33, self = this, found = nil, found_colon = nil, use_link_attrs = nil, experimental = nil, result = nil, extensions = nil;
        if (self.document == null) self.document = nil;
        ...
        if (experimental !== false && experimental !== nil) {
          ...
          if (($a = ($c = found['$[]']("macroish"), $c !== false && $c !== nil ?result['$include?']("menu:") : $c)) !== false && $a !== nil) {
            ...
            m = $gvars["~"];
              ...
              return $scope.Inline.$new(self, "menu", nil, $hash2(["attributes"], {"attributes": $hash2(["menu", "submenus", "menuitem"], {"menu": menu, "submenus": submenus, "menuitem": menuitem})})).$render();}, TMP_22._s = self, TMP_22), $a).call($c, $scope.MenuInlineMacroRx)};
          if (($a = ($d = result['$include?']("\""), $d !== false && $d !== nil ?result['$include?']("&gt;") : $d)) !== false && $a !== nil) {
            ...
            m = $gvars["~"];
              ...
              menuitem = submenus.$pop();
              return $scope.Inline.$new(self, "menu", nil, $hash2(["attributes"], {"attributes": $hash2(["menu", "submenus", "menuitem"], {"menu": menu, "submenus": submenus, "menuitem": menuitem})})).$render();}, TMP_24._s = self, TMP_24), $a).call($d, $scope.MenuInlineRx)};};
        ...
        if (($a = ($f = found['$[]']("macroish"), $f !== false && $f !== nil ?(((($g = result['$include?']("image:")) !== false && $g !== nil) ? $g : result['$include?']("icon:"))) : $f)) !== false && $a !== nil) {
          ...
          m = $gvars["~"];
            ...
            return $scope.Inline.$new(self, "image", nil, $hash2(["type", "target", "attributes"], {"type": type, "target": target, "attributes": attrs})).$render();}, TMP_28._s = self, TMP_28), $a).call($f, $scope.ImageInlineMacroRx)};
        ...
        if (($a = (($h = found_colon !== false && found_colon !== nil) ? (result['$include?']("://")) : $h)) !== false && $a !== nil) {
          ...
          m = $gvars["~"];
            ...
            return "" + (prefix) + ($scope.Inline.$new(self, "anchor", text, $hash2(["type", "target", "attributes"], {"type": "link", "target": target, "attributes": attrs})).$render()) + (suffix);}, TMP_30._s = self, TMP_30), $a).call($h, $scope.LinkInlineRx)};
        if (($a = ((($i = ($j = found['$[]']("macroish"), $j !== false && $j !== nil ?(result['$include?']("link:")) : $j)) !== false && $i !== nil) ? $i : (result['$include?']("mailto:")))) !== false && $a !== nil) {
          ...
          m = $gvars["~"];
            ...
            return $scope.Inline.$new(self, "anchor", text, $hash2(["type", "target", "attributes"], {"type": "link", "target": target, "attributes": attrs})).$render();}, TMP_31._s = self, TMP_31), $a).call($i, $scope.LinkInlineMacroRx)};
        if (($a = result['$include?']("@")) !== false && $a !== nil) {
          ...
          m = $gvars["~"];
            ...
            self.document.$register("links", target);
            return $scope.Inline.$new(self, "anchor", address, $hash2(["type", "target"], {"type": "link", "target": target})).$render();}, TMP_32._s = self, TMP_32), $a).call($j, $scope.EmailInlineMacroRx)};
        if (($a = ($k = found['$[]']("macroish_short_form"), $k !== false && $k !== nil ?result['$include?']("footnote") : $k)) !== false && $a !== nil) {
          ...
          m = $gvars["~"];
            ...
            return $scope.Inline.$new(self, "footnote", text, $hash2(["attributes", "id", "target", "type"], {"attributes": $hash2(["index"], {"index": index}), "id": id, "target": target, "type": type})).$render();}, TMP_33._s = self, TMP_33), $a).call($k, $scope.FootnoteInlineMacroRx)};
      ...
      def.$sub_inline_anchors = function(text, found) {
        ...
        if (($a = ($b = (((($c = ($d = found, ($d === nil || $d === false))) !== false && $c !== nil) ? $c : found['$[]']("square_bracket"))), $b !== false && $b !== nil ?text['$include?']("[[[") : $b)) !== false && $a !== nil) {
          ...
          m = $gvars["~"];
            if (($a = m['$[]'](0)['$start_with?']("\\")) !== false && $a !== nil) {
              return m['$[]'](0)['$[]']($range(1, -1, false));};
            id = reftext = m['$[]'](1);
            return $scope.Inline.$new(self, "anchor", reftext, $hash2(["type", "target"], {"type": "bibref", "target": id})).$render();}, TMP_35._s = self, TMP_35), $a).call($b, $scope.InlineBiblioAnchorRx)};
        if (($a = ((($c = (($d = (((($e = ($f = found, ($f === nil || $f === false))) !== false && $e !== nil) ? $e : found['$[]']("square_bracket"))), $d !== false && $d !== nil ?text['$include?']("[[") : $d))) !== false && $c !== nil) ? $c : (($d = (((($e = ($f = found, ($f === nil || $f === false))) !== false && $e !== nil) ? $e : found['$[]']("macroish"))), $d !== false && $d !== nil ?text['$include?']("anchor:") : $d)))) !== false && $a !== nil) {
          ...
          m = $gvars["~"];
            ...
            return $scope.Inline.$new(self, "anchor", reftext, $hash2(["type", "target"], {"type": "ref", "target": id})).$render();}, TMP_36._s = self, TMP_36), $a).call($c, $scope.InlineAnchorRx)};
        return text;
      };
      ...
      def.$sub_inline_xrefs = function(text, found) {
        ...
        if (($a = ((($b = (((($c = ($d = found, ($d === nil || $d === false))) !== false && $c !== nil) ? $c : found['$[]']("macroish")))) !== false && $b !== nil) ? $b : text['$include?']("&lt;&lt;"))) !== false && $a !== nil) {
          ...
          m = $gvars["~"];
            ...
            return $scope.Inline.$new(self, "anchor", reftext, $hash2(["type", "target", "attributes"], {"type": "xref", "target": target, "attributes": $hash2(["path", "fragment", "refid"], {"path": path, "fragment": fragment, "refid": refid})})).$render();}, TMP_38._s = self, TMP_38), $a).call($b, $scope.XrefInlineMacroRx)};
        return text;
      };
      ...
      def.$sub_callouts = function(text) {
        ...
        m = $gvars["~"];
          if (m['$[]'](1)['$==']("\\")) {
            return m['$[]'](0).$sub("\\", "");};
          return $scope.Inline.$new(self, "callout", m['$[]'](3), $hash2(["id"], {"id": self.document.$callouts().$read_next_id()})).$render();}, TMP_40._s = self, TMP_40), $a).call($b, $scope.CalloutRenderRx);
      };
      ...
      def.$sub_post_replacements = function(text) {
        ...
        if (($a = ((($b = (self.document.$attributes()['$has_key?']("hardbreaks"))) !== false && $b !== nil) ? $b : (self.attributes['$has_key?']("hardbreaks-option")))) !== false && $a !== nil) {
          ...
          return $scope.Inline.$new(self, "break", line.$rstrip().$chomp($scope.LINE_BREAK), $hash2(["type"], {"type": "line"})).$render()}, TMP_41._s = self, TMP_41), $a).call($b).$push(last)['$*']($scope.EOL);
        } else if (($a = text['$include?']("+")) !== false && $a !== nil) {
          return ($a = ($c = text).$gsub, $a._p = (TMP_42 = function(){var self = TMP_42._s || this;
          return $scope.Inline.$new(self, "break", $gvars["~"]['$[]'](1), $hash2(["type"], {"type": "line"})).$render()}, TMP_42._s = self, TMP_42), $a).call($c, $scope.LineBreakRx)
          } else {
          return text
        };
      };
      ...
      def.$transform_quoted_text = function(match, type, scope) {
        var $a, $b, self = this, unescaped_attrs = nil, attributes = nil, id = nil;
        unescaped_attrs = nil;
        if (($a = match['$[]'](0)['$start_with?']("\\")) !== false && $a !== nil) {
          if (($a = (($b = scope['$==']("constrained")) ? match['$[]'](2) : $b)) !== false && $a !== nil) {
            unescaped_attrs = "[" + (match['$[]'](2)) + "]"
            } else {
            return match['$[]'](0)['$[]']($range(1, -1, false))
          }};
        if (scope['$==']("constrained")) {
          if (($a = ($b = unescaped_attrs, ($b === nil || $b === false))) !== false && $a !== nil) {
            ...
            return "" + (unescaped_attrs) + ($scope.Inline.$new(self, "quoted", match['$[]'](3), $hash2(["type"], {"type": type})).$render())
          }
          } else {
      ...
      def.$highlight_source = function(source, sub_callouts, highlighter) {
        ...
        $case = highlighter;if ("coderay"['$===']($case)) {result = ((($a = $opal.Object._scope.CodeRay) == null ? $opal.cm('CodeRay') : $a))._scope.Duo['$[]'](self.$attr("language", "text").$to_sym(), "html", $hash2(["css", "line_numbers", "line_number_anchors"], {"css": self.document.$attributes().$fetch("coderay-css", "class").$to_sym(), "line_numbers": (linenums_mode = ((function() {if (($a = self['$attr?']("linenums")) !== false && $a !== nil) {
          ...
          if (($a = self.document.$attributes().$fetch("pygments-css", "class")['$==']("class")) === false || $a === nil) {
            opts['$[]=']("noclasses", true)};
          if (($a = self['$attr?']("linenums")) !== false && $a !== nil) {
            if ((opts['$[]=']("linenos", self.document.$attributes().$fetch("pygments-linenums-mode", "table")))['$==']("table")) {
...
if (line == null) line = nil;
          if (($a = reached_code) === false || $a === nil) {
            ...
            if (($a = (conums = callout_marks.$delete(lineno))) !== false && $a !== nil) {
              ...
              if (conums.$size()['$=='](1)) {
                return "" + (line) + ($scope.Inline.$new(self, "callout", conums['$[]'](0), $hash2(["id"], {"id": self.document.$callouts().$read_next_id()})).$render()) + (tail)
                } else {
                conums_markup = ($a = ($b = conums).$map, $a._p = (TMP_49 = function(conum){var self = TMP_49._s || this;
                  if (self.document == null) self.document = nil;
if (conum == null) conum = nil;
                return $scope.Inline.$new(self, "callout", conum, $hash2(["id"], {"id": self.document.$callouts().$read_next_id()})).$render()}, TMP_49._s = self, TMP_49), $a).call($b)['$*'](" ");
...
(function($opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.document = def.attributes = def.template_name = def.blocks = def.subs = def.title = def.subbed_title = def.caption = def.context = def.next_section_index = def.next_section_number = nil;
...
(function($opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      $opal.cdecl($scope, 'DEFAULT_CONTENT_MODEL', (($a = $opal.Object._scope.Hash) == null ? $opal.cm('Hash') : $a).$new("simple").$merge($hash2(["audio", "image", "listing", "literal", "math", "open", "page_break", "pass", "ruler", "video"], {"audio": "empty", "image": "empty", "listing": "verbatim", "literal": "verbatim", "math": "raw", "open": "compound", "page_break": "empty", "pass": "raw", "ruler": "empty", "video": "empty"})));
      ...
      def.$initialize = TMP_1 = function(parent, context, opts) {
        ...
        self.attributes = ((($a = opts['$[]']("attributes")) !== false && $a !== nil) ? $a : $hash2([], {}));
...
(function($opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      var def = $Document._proto, $scope = $Document._scope, TMP_1, TMP_9, TMP_14;
      def.parent_document = def.attribute_overrides = def.safe = def.attributes = def.base_dir = def.extensions = def.reader = def.callouts = def.counters = def.references = def.options = def._doctype = def._backend = def.header = def.blocks = def.attributes_modified = def.id = def.original_attributes = def.renderer = nil;
      ...
      def.$initialize = TMP_1 = function(data, options) {
        var $a, $b, $c, TMP_2, TMP_3, $e, $f, TMP_4, $g, TMP_5, $h, $i, TMP_6, $j, $k, TMP_7, self = this, $iter = TMP_1._p, $yield = $iter || nil, initialize_extensions = nil, overrides = nil, safe_mode = nil, safe_mode_name = nil, now = nil, registry = nil, ext_registry = nil, ext_block = nil;
        if (data == null) {
          data = []
        }
        if (options == null) {
        ...
        if (($a = options['$[]']("parent")) !== false && $a !== nil) {
          ...
          self.attribute_overrides.$delete("doctype");
          ...
          if (($a = key['$start_with?']("!")) !== false && $a !== nil) {
              ...
              key = key.$chop();
              value = nil;};
            return overrides['$[]='](key.$downcase(), value);}, TMP_3._s = self, TMP_3), $a).call($c);
          self.attribute_overrides = overrides;
          self.safe = nil;
          self.renderer = nil;
        ...
        if (($a = self.parent_document) === false || $a === nil) {
          if (($a = ($e = ($f = self.safe, ($f === nil || $f === false)), $e !== false && $e !== nil ?($f = (safe_mode = options['$[]']("safe")), ($f === nil || $f === false)) : $e)) !== false && $a !== nil) {
        ...
        ($a = "header_footer", $e = options, ((($f = $e['$[]']($a)) !== false && $f !== nil) ? $f : $e['$[]=']($a, false)));
        self.attributes['$[]=']("encoding", "UTF-8");
        self.attributes['$[]=']("sectids", "");
        if (($a = options['$[]']("header_footer")) === false || $a === nil) {
...
if (l == null) l = nil;
        ...
        self.attribute_overrides['$[]=']("embedded", (function() {if (($a = options['$[]']("header_footer")) !== false && $a !== nil) {
          return nil
          } else {
          return ""
        }; return nil; })());
        ($a = "max-include-depth", $f = self.attribute_overrides, ((($g = $f['$[]']($a)) !== false && $g !== nil) ? $g : $f['$[]=']($a, 64)));
        if (($a = ($f = self.attribute_overrides['$[]']("allow-uri-read")['$nil?'](), ($f === nil || $f === false))) === false || $a === nil) {
          self.attribute_overrides['$[]=']("allow-uri-read", nil)};
        self.attribute_overrides['$[]=']("user-home", $scope.USER_HOME);
        if (($a = ($f = options['$[]']("base_dir"), ($f === nil || $f === false))) !== false && $a !== nil) {
          if (($a = self.attribute_overrides['$[]']("docdir")) !== false && $a !== nil) {
            self.base_dir = self.attribute_overrides['$[]=']("docdir", (($a = $opal.Object._scope.File) == null ? $opal.cm('File') : $a).$expand_path(self.attribute_overrides['$[]']("docdir")))
            } else {
            self.base_dir = self.attribute_overrides['$[]=']("docdir", (($a = $opal.Object._scope.File) == null ? $opal.cm('File') : $a).$expand_path((($a = $opal.Object._scope.Dir) == null ? $opal.cm('Dir') : $a).$pwd()))
          }
          } else {
          self.base_dir = self.attribute_overrides['$[]=']("docdir", (($a = $opal.Object._scope.File) == null ? $opal.cm('File') : $a).$expand_path(options['$[]']("base_dir")))
        };
        if (($a = (value = options['$[]']("backend"))) !== false && $a !== nil) {
          self.attribute_overrides['$[]=']("backend", "" + (value))};
        if (($a = (value = options['$[]']("doctype"))) !== false && $a !== nil) {
          self.attribute_overrides['$[]=']("doctype", "" + (value))};
        if (self.safe['$>='](($scope.SafeMode)._scope.SERVER)) {
          ($a = "copycss", $f = self.attribute_overrides, ((($g = $f['$[]']($a)) !== false && $g !== nil) ? $g : $f['$[]=']($a, nil)));
          ($a = "source-highlighter", $f = self.attribute_overrides, ((($g = $f['$[]']($a)) !== false && $g !== nil) ? $g : $f['$[]=']($a, nil)));
          ($a = "backend", $f = self.attribute_overrides, ((($g = $f['$[]']($a)) !== false && $g !== nil) ? $g : $f['$[]=']($a, $scope.DEFAULT_BACKEND)));
          if (($a = ($f = ($g = self.parent_document, ($g === nil || $g === false)), $f !== false && $f !== nil ?self.attribute_overrides['$has_key?']("docfile") : $f)) !== false && $a !== nil) {
          ...
          if (self.safe['$>='](($scope.SafeMode)._scope.SECURE)) {
            ...
            ($a = "icons", $f = self.attribute_overrides, ((($g = $f['$[]']($a)) !== false && $g !== nil) ? $g : $f['$[]=']($a, nil)));};};
        ($a = ($f = self.attribute_overrides).$delete_if, $a._p = (TMP_5 = function(key, val){var self = TMP_5._s || this, $a, $b, $c, verdict = nil;
          if (self.attributes == null) self.attributes = nil;
if (key == null) key = nil;if (val == null) val = nil;
        ...
        if (($a = ($g = self.parent_document, ($g === nil || $g === false))) !== false && $a !== nil) {
          ($a = "backend", $g = self.attributes, ((($h = $g['$[]']($a)) !== false && $h !== nil) ? $h : $g['$[]=']($a, $scope.DEFAULT_BACKEND)));
          ($a = "doctype", $g = self.attributes, ((($h = $g['$[]']($a)) !== false && $h !== nil) ? $h : $g['$[]=']($a, $scope.DEFAULT_DOCTYPE)));
          self.$update_backend_attributes();
          now = $scope.Time.$new();
          ($a = "localdate", $g = self.attributes, ((($h = $g['$[]']($a)) !== false && $h !== nil) ? $h : $g['$[]=']($a, now.$strftime("%Y-%m-%d"))));
          ($a = "localtime", $g = self.attributes, ((($h = $g['$[]']($a)) !== false && $h !== nil) ? $h : $g['$[]=']($a, now.$strftime("%H:%M:%S %Z"))));
          ($a = "localdatetime", $g = self.attributes, ((($h = $g['$[]']($a)) !== false && $h !== nil) ? $h : $g['$[]=']($a, "" + (self.attributes['$[]']("localdate")) + " " + (self.attributes['$[]']("localtime")))));
          ($a = "docdate", $g = self.attributes, ((($h = $g['$[]']($a)) !== false && $h !== nil) ? $h : $g['$[]=']($a, self.attributes['$[]']("localdate"))));
          ($a = "doctime", $g = self.attributes, ((($h = $g['$[]']($a)) !== false && $h !== nil) ? $h : $g['$[]=']($a, self.attributes['$[]']("localtime"))));
          ($a = "docdatetime", $g = self.attributes, ((($h = $g['$[]']($a)) !== false && $h !== nil) ? $h : $g['$[]=']($a, self.attributes['$[]']("localdatetime"))));
          ($a = "stylesdir", $g = self.attributes, ((($h = $g['$[]']($a)) !== false && $h !== nil) ? $h : $g['$[]=']($a, ".")));
          ($a = "iconsdir", $g = self.attributes, ((($h = $g['$[]']($a)) !== false && $h !== nil) ? $h : $g['$[]=']($a, $scope.File.$join(self.attributes.$fetch("imagesdir", "./images"), "icons"))));
          self.extensions = (function() {if (initialize_extensions !== false && initialize_extensions !== nil) {
            ...
            } else if (($a = ($g = (ext_block = options['$[]']("extensions")), $g !== false && $g !== nil ?(ext_block['$is_a?']((($h = $opal.Object._scope.Proc) == null ? $opal.cm('Proc') : $h))) : $g)) !== false && $a !== nil) {
          ...
          if (($a = ($h = self.extensions, $h !== false && $h !== nil ?self.extensions['$preprocessors?']() : $h)) !== false && $a !== nil) {
            ($a = ($h = self.extensions.$preprocessors()).$each, $a._p = (TMP_6 = function(ext){var self = TMP_6._s || this, $a;
              if (self.reader == null) self.reader = nil;
if (ext == null) ext = nil;
            return self.reader = ((($a = ext.$process_method()['$[]'](self, self.reader)) !== false && $a !== nil) ? $a : self.reader)}, TMP_6._s = self, TMP_6), $a).call($h)};
          } else {
          self.reader = $scope.Reader.$new(data, options['$[]']("cursor"))
        };
        $scope.Parser.$parse(self.reader, self, $hash2(["header_only"], {"header_only": ($a = ($i = options['$[]']("parse_header_only"), ($i === nil || $i === false)), ($a === nil || $a === false))}));
        self.callouts.$rewind();
        if (($a = ($i = ($j = self.extensions, $j !== false && $j !== nil ?($k = self.parent_document, ($k === nil || $k === false)) : $j), $i !== false && $i !== nil ?self.extensions['$treeprocessors?']() : $i)) !== false && $a !== nil) {
          return ($a = ($i = self.extensions.$treeprocessors()).$each, $a._p = (TMP_7 = function(ext){var self = TMP_7._s || this;if (ext == null) ext = nil;
          return ext.$process_method()['$[]'](self)}, TMP_7._s = self, TMP_7), $a).call($i)
          } else {
          return nil
        };
      };
      ...
      def.$counter = function(name, seed) {
        ...
        if (($a = ($b = (attr_is_seed = ($c = ((attr_val = self.attributes['$[]'](name)))['$nil_or_empty?'](), ($c === nil || $c === false))), $b !== false && $b !== nil ?self.counters['$has_key?'](name) : $b)) !== false && $a !== nil) {
      ...
      def.$doctype = function() {
        var $a, self = this;
        return ((($a = self._doctype) !== false && $a !== nil) ? $a : self._doctype = self.attributes['$[]']("doctype"));
      };

      def.$backend = function() {
        var $a, self = this;
        return ((($a = self._backend) !== false && $a !== nil) ? $a : self._backend = self.attributes['$[]']("backend"));
      };
      ...
      def.$save_attributes = function() {
        ...
        if (($a = ((($b = self.attributes['$has_key?']("doctitle")) !== false && $b !== nil) ? $b : ($c = (val = self.$doctitle()), ($c === nil || $c === false)))) === false || $a === nil) {
...
if (name == null) name = nil;
      ...
      def.$playback_attributes = function(block_attributes) {
        var $a, $b, TMP_12, self = this, entries = nil;
        if (($a = (entries = block_attributes['$[]']("attribute_entries"))) !== false && $a !== nil) {
          return ($a = ($b = entries).$each, $a._p = (TMP_12 = function(entry){var self = TMP_12._s || this, $a;
            if (self.attributes == null) self.attributes = nil;
if (entry == null) entry = nil;
      ...
      def.$update_backend_attributes = function() {
        ...
        basebackend = backend.$sub($scope.TrailingDigitsRx, "");
      ...
      def.$render = function(opts) {
        ...
        if (($a = ($b = self.extensions, $b !== false && $b !== nil ?($c = self.parent_document, ($c === nil || $c === false)) : $b)) !== false && $a !== nil) {
          if (($a = self.extensions['$postprocessors?']()) !== false && $a !== nil) {
            ($a = ($b = self.extensions.$postprocessors()).$each, $a._p = (TMP_13 = function(ext){var self = TMP_13._s || this;if (ext == null) ext = nil;
...
(function($opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$render = TMP_2 = function() {var $zuper = $slice.call(arguments, 0);
        ...
        if (self.context['$==']("colist")) {
          ...
          return $opal.find_super_dispatcher(self, 'render', TMP_2, $iter).apply(self, $zuper)
        };
      };
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      $opal.defs(self, '$initialize_section', function(reader, parent, attributes) {
        var $a, $b, $c, self = this, document = nil, sect_id = nil, sect_reftext = nil, sect_title = nil, sect_level = nil, _ = nil, section = nil, id = nil;
        if (attributes == null) {
          attributes = $hash2([], {})
        }
        document = parent.$document();
...
(function($opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$initialize = function(view, backend) {
        var self = this;
        self.view = view;
      ...
      def.$render = function(node, locals) {
        var $a, $b, $c, $d, self = this, tmpl = nil, $case = nil, output = nil;
        if (node == null) {
        ...
        tmpl = self.$template();
        $case = tmpl;if ("invoke_result"['$===']($case)) {return self.$result(node)}else if ("invoke_result_document"['$===']($case)) {output = self.$result(node)}else if ("content"['$===']($case)) {output = node.$content()}else {output = tmpl.$result(node.$get_binding(self))};
      ...
      def.$compact = function(str) {
        var self = this;
        return str.$gsub($scope.BlankLineRx, "").$gsub($scope.LINE_FEED_ENTITY, $scope.EOL);
      };
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$initialize = function(options) {
        var $a, $b, TMP_1, $c, TMP_2, $d, TMP_3, $e, TMP_4, self = this, backend = nil, $case = nil, template_dirs = nil, template_cache = nil, view_opts = nil, eruby = nil, path_resolver = nil, engine = nil;
        if (options == null) {
          options = $hash2([], {})
        }
        ...
        if (($a = (($b = $opal.Object._scope.RUBY_ENGINE_OPAL) == null ? $opal.cm('RUBY_ENGINE_OPAL') : $b)) !== false && $a !== nil) {
          ...
          ($a = ($b = (($c = $opal.Object._scope.Template) == null ? $opal.cm('Template') : $c).$instance_variable_get("@_cache")).$each, $a._p = (TMP_1 = function(path, tmpl){var self = TMP_1._s || this, $a;
            if (self.views == null) self.views = nil;
if (path == null) path = nil;if (tmpl == null) tmpl = nil;
          return self.views['$[]='](((($a = $opal.Object._scope.File) == null ? $opal.cm('File') : $a).$basename(path)), tmpl)}, TMP_1._s = self, TMP_1), $a).call($b);
          return nil;};
        $case = backend;if ("html5"['$===']($case) || "docbook45"['$===']($case) || "docbook5"['$===']($case)) {;
        ;
...
if (tc == null) tc = nil;
        if (($a = tc.$to_s().$downcase()['$include?']("::"['$+'](backend)['$+']("::"))) !== false && $a !== nil) {
            ...
            if (view_backend['$=='](backend)) {
              return self.views['$[]='](view_name, tc.$new(view_name, backend))
              } else {
              return nil
            };
            } else {
        ...
        if (($a = (template_dirs = options.$delete("template_dirs"))) !== false && $a !== nil) {
          ...
          return ($a = ($e = template_dirs).$each, $a._p = (TMP_4 = function(template_dir){var self = TMP_4._s || this, $a, $b, TMP_5, $c, $d, TMP_7, $e, template_glob = nil, helpers = nil, scan_result = nil;
...
if (template_dir == null) template_dir = nil;
          template_dir = path_resolver.$system_path(template_dir, nil);
            ...
            helpers = nil;
            scan_result = $hash2([], {});
            ($a = ($b = ($c = ($d = (($e = $opal.Object._scope.Dir) == null ? $opal.cm('Dir') : $e).$glob((($e = $opal.Object._scope.File) == null ? $opal.cm('File') : $e).$join(template_dir, template_glob))).$select, $c._p = (TMP_7 = function(f){var self = TMP_7._s || this, $a;if (f == null) f = nil;
            return (($a = $opal.Object._scope.File) == null ? $opal.cm('File') : $a)['$file?'](f)}, TMP_7._s = self, TMP_7), $c).call($d)).$each, $a._p = (TMP_5 = function(template){var self = TMP_5._s || this, $a, $b, TMP_6, basename = nil, name_parts = nil, view_name = nil, ext_name = nil, opts = nil;
              if (self.cache == null) self.cache = nil;
              if (self.views == null) self.views = nil;
if (template == null) template = nil;
            basename = (($a = $opal.Object._scope.File) == null ? $opal.cm('File') : $a).$basename(template);
              ...
              if (ext_name['$==']("slim")) {
                if (($a = ($opal.Object._scope.Slim == null ? nil : 'constant')) === false || $a === nil) {
                  $scope.Helpers.$require_library("slim")}
              } else if (ext_name['$==']("erb")) {
                if (($a = eruby) === false || $a === nil) {
                  eruby = self.$load_eruby(options['$[]']("eruby"))}};
              if (($a = (($b = $opal.Object._scope.Tilt) == null ? $opal.cm('Tilt') : $b)['$registered?'](ext_name)) === false || $a === nil) {
                return nil;};
              opts = view_opts['$[]'](ext_name.$to_sym());
              if (($a = self.cache) !== false && $a !== nil) {
                return self.views['$[]='](view_name, scan_result['$[]='](view_name, ($a = ($b = self.cache).$fetch, $a._p = (TMP_6 = function(){var self = TMP_6._s || this, $a;
                return (($a = $opal.Object._scope.Tilt) == null ? $opal.cm('Tilt') : $a).$new(template, nil, opts)}, TMP_6._s = self, TMP_6), $a).call($b, "view", template)))
                } else {
                return self.views['$[]='](view_name, (($a = $opal.Object._scope.Tilt) == null ? $opal.cm('Tilt') : $a).$new(template, nil, opts))
      ...
      def.$render = function(view, object, locals) {
        var $a, self = this, view_impl = nil;
        if (locals == null) {
          locals = $hash2([], {})
        }
        if (($a = (view_impl = self.views['$[]'](view))) === false || $a === nil) {
          self.$raise("Couldn't find a view in @views for " + (view))};
        if (($a = self.chomp_result) !== false && $a !== nil) {
          return view_impl.$render(object, locals).$chomp()
          } else {
          return view_impl.$render(object, locals)
        };
      };
      ...
      def.$load_eruby = function(name) {
        ...
        if (($a = ((($b = name['$nil?']()) !== false && $b !== nil) ? $b : ($c = ["erb", "erubis"]['$include?'](name), ($c === nil || $c === false)))) !== false && $a !== nil) {
          name = "erb"};
        if (name['$==']("erb")) {
          $scope.Helpers.$require_library("erb");
...
(function($opal) {
  var $a, $b, TMP_1, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice;
  $opal.add_stubs(['$new', '$append', '$===', '$append=', '$*', '$compact', '$role', '$title?', '$title', '$each', '$text', '$nil?', '$text?', '$blocks?', '$content', '$items', '$attr?', '$chomp', '$attr', '$option?', '$last', '$==', '$join']);
    ...
    output_buffer.$append("\n<li>");
      ...
      if (($a = answer['$nil?']()) === false || $a === nil) {
        ...
        if (($a = answer['$blocks?']()) !== false && $a !== nil) {
          output_buffer.$append("\n");
          output_buffer['$append=']((answer.$content()));
          output_buffer.$append("");};};
...
(function($opal) {
  ...
  return ($a = ($b = $scope.Template).$new, $a._p = (TMP_1 = function(output_buffer){var self = TMP_1._s || this, $a, $b, $c, TMP_2, TMP_3, $d, TMP_4, $e, $f, TMP_8;
    if (self.id == null) self.id = nil;
...
if (output_buffer == null) output_buffer = nil;
  output_buffer.$append("");
    ...
    if (($a = (self.$attr("rowcount"))['$zero?']()) === false || $a === nil) {
      ...
      output_buffer.$append("\n</colgroup>");
      ($a = ($d = ($e = ($f = ["head", "foot", "body"]).$select, $e._p = (TMP_8 = function(tsec){var self = TMP_8._s || this, $a;
        if (self.rows == null) self.rows = nil;
if (tsec == null) tsec = nil;
      return ($a = self.rows['$[]'](tsec)['$empty?'](), ($a === nil || $a === false))}, TMP_8._s = self, TMP_8), $e).call($f)).$each, $a._p = (TMP_4 = function(tsec){var self = TMP_4._s || this, $a, $b, TMP_5;
        if (self.rows == null) self.rows = nil;
if (tsec == null) tsec = nil;
      output_buffer.$append("\n<t");
        ...
        output_buffer.$append("\n<tr>");
          ($a = ($b = row).$each, $a._p = (TMP_6 = function(cell){var self = TMP_6._s || this, $a, $b, TMP_7, cell_content = nil, $case = nil, cell_css_style = nil, cell_tag_name = nil;
            if (self.document == null) self.document = nil;
if (cell == null) cell = nil;
          if (tsec['$==']("head")) {
            ...
            output_buffer.$append("\n<");
            output_buffer['$append='](((cell_tag_name = ((function() {if (($a = ((($b = tsec['$==']("head")) !== false && $b !== nil) ? $b : cell.$style()['$==']("header"))) !== false && $a !== nil) {
              return "th"
              } else {
              return "td"
            }; return nil; })()))));
            ...
            if (tsec['$==']("head")) {
              ...
              output_buffer['$append=']((cell_content));
              output_buffer.$append("</pre></div>");}else {($a = ($b = cell_content).$each, $a._p = (TMP_7 = function(text){var self = TMP_7._s || this;if (text == null) text = nil;
              output_buffer.$append("<p class=\"tableblock\">");
                output_buffer['$append=']((text));
                return output_buffer.$append("</p>");}, TMP_7._s = self, TMP_7), $a).call($b)}
            };
            output_buffer.$append("</");
            output_buffer['$append=']((cell_tag_name));
...
(function($opal) {
  ...
  return (function($base) {
    ...
    $opal.cdecl($scope, 'LAYOUT_BREAK_LINES', $hash2(["'", "-", "*", "_", "<"], {"'": "ruler", "-": "ruler", "*": "ruler", "_": "ruler", "<": "page_break"}));
    ...
    $opal.cdecl($scope, 'CalloutRenderRx', (new RegExp("(?:(?:\\/\\/|#|;;) ?)?(\\\\)?&lt;!?(--|)(\\d+)\\2&gt;(?=(?: ?\\\\?&lt;!?\\2\\d+\\2&gt;)*" + $scope.CC_EOL + ")")));
    ...
    $opal.defs(self, '$load', function(input, options) {
      var $a, $b, $c, $d, TMP_2, TMP_3, TMP_4, $e, self = this, monitor = nil, start = nil, attrs = nil, capture_1 = nil, original_attrs = nil, lines = nil, input_mtime = nil, input_path = nil, docdate = nil, doctime = nil, read_time = nil, doc = nil, parse_time = nil;
      if (options == null) {
        options = $hash2([], {})
      }
      if (($a = (monitor = options['$[]']("monitor"))) !== false && $a !== nil) {
      ...
      if (($a = ((($b = attrs['$is_a?']((($c = $opal.Object._scope.Hash) == null ? $opal.cm('Hash') : $c))) !== false && $b !== nil) ? $b : (($c = (($d = $opal.Object._scope.RUBY_ENGINE_JRUBY) == null ? $opal.cm('RUBY_ENGINE_JRUBY') : $d), $c !== false && $c !== nil ?attrs['$is_a?']((((($d = $opal.Object._scope.Java) == null ? $opal.cm('Java') : $d))._scope.JavaUtil)._scope.Map) : $c)))) === false || $a === nil) {
        if (($a = attrs['$is_a?']((($b = $opal.Object._scope.Array) == null ? $opal.cm('Array') : $b))) !== false && $a !== nil) {
          attrs = options['$[]=']("attributes", ($a = ($b = attrs).$inject, $a._p = (TMP_2 = function(accum, entry){var self = TMP_2._s || this, $a, k = nil, v = nil;if (accum == null) accum = nil;if (entry == null) entry = nil;
          ...
          attrs = options['$[]=']("attributes", ($a = ($c = attrs.$split($scope.NULL)).$inject, $a._p = (TMP_3 = function(accum, entry){var self = TMP_3._s || this, $a, k = nil, v = nil;if (accum == null) accum = nil;if (entry == null) entry = nil;
          $a = $opal.to_ary(entry.$split("=", 2)), k = ($a[0] == null ? nil : $a[0]), v = ($a[1] == null ? nil : $a[1]);
            accum['$[]='](k, ((($a = v) !== false && $a !== nil) ? $a : ""));
    ...
    $opal.defs(self, '$render', function(input, options) {
      ...
      if (to_file !== false && to_file !== nil) {
        ...
        if (stream_output !== false && stream_output !== nil) {
          ...
          ($a = ($b = (($c = $opal.Object._scope.File) == null ? $opal.cm('File') : $c)).$open, $a._p = (TMP_5 = function(file){var self = TMP_5._s || this;if (file == null) file = nil;
          return file.$write(output)}, TMP_5._s = self, TMP_5), $a).call($b, to_file, "w");
        ...
        if (($a = ($c = ($d = ($e = ($f = ($g = stream_output, ($g === nil || $g === false)), $f !== false && $f !== nil ?doc.$safe()['$<'](($scope.SafeMode)._scope.SECURE) : $f), $e !== false && $e !== nil ?(doc['$attr?']("basebackend-html")) : $e), $d !== false && $d !== nil ?(doc['$attr?']("linkcss")) : $d), $c !== false && $c !== nil ?(doc['$attr?']("copycss")) : $c)) !== false && $a !== nil) {
          ...
          copy_user_stylesheet = ($a = ($c = copy_asciidoctor_stylesheet, ($c === nil || $c === false)), $a !== false && $a !== nil ?($c = stylesheet['$nil_or_empty?'](), ($c === nil || $c === false)) : $a);
          ...
          if (($a = ((($c = ((($d = ((($e = copy_asciidoctor_stylesheet) !== false && $e !== nil) ? $e : copy_user_stylesheet)) !== false && $d !== nil) ? $d : copy_coderay_stylesheet)) !== false && $c !== nil) ? $c : copy_pygments_stylesheet)) !== false && $a !== nil) {
            ...
            if (copy_asciidoctor_stylesheet !== false && copy_asciidoctor_stylesheet !== nil) {
              ($a = ($c = (($d = $opal.Object._scope.File) == null ? $opal.cm('File') : $d)).$open, $a._p = (TMP_6 = function(f){var self = TMP_6._s || this;if (f == null) f = nil;
              return f.$write($scope.HTML5.$default_asciidoctor_stylesheet())}, TMP_6._s = self, TMP_6), $a).call($c, (($d = $opal.Object._scope.File) == null ? $opal.cm('File') : $d).$join(stylesoutdir, $scope.DEFAULT_STYLESHEET_NAME), "w")};
            if (copy_user_stylesheet !== false && copy_user_stylesheet !== nil) {
              ...
              if (($a = ((($d = stylesheet_src['$=='](stylesheet_dst)) !== false && $d !== nil) ? $d : ((stylesheet_content = doc.$read_asset(stylesheet_src)))['$nil?']())) === false || $a === nil) {
                ($a = ($d = (($e = $opal.Object._scope.File) == null ? $opal.cm('File') : $e)).$open, $a._p = (TMP_7 = function(f){var self = TMP_7._s || this;if (f == null) f = nil;
                return f.$write(stylesheet_content)}, TMP_7._s = self, TMP_7), $a).call($d, stylesheet_dst, "w")};};
            if (copy_coderay_stylesheet !== false && copy_coderay_stylesheet !== nil) {
              ($a = ($e = (($f = $opal.Object._scope.File) == null ? $opal.cm('File') : $f)).$open, $a._p = (TMP_8 = function(f){var self = TMP_8._s || this;if (f == null) f = nil;
              return f.$write($scope.HTML5.$default_coderay_stylesheet())}, TMP_8._s = self, TMP_8), $a).call($e, (($f = $opal.Object._scope.File) == null ? $opal.cm('File') : $f).$join(stylesoutdir, "asciidoctor-coderay.css"), "w")};
            if (copy_pygments_stylesheet !== false && copy_pygments_stylesheet !== nil) {
              ($a = ($f = (($g = $opal.Object._scope.File) == null ? $opal.cm('File') : $g)).$open, $a._p = (TMP_9 = function(f){var self = TMP_9._s || this;if (f == null) f = nil;
              return f.$write($scope.HTML5.$pygments_stylesheet(doc.$attr("pygments-style")))}, TMP_9._s = self, TMP_9), $a).call($f, (($g = $opal.Object._scope.File) == null ? $opal.cm('File') : $g).$join(stylesoutdir, "asciidoctor-pygments.css"), "w")};};};
        return doc;
        } else {
        return output
      };
