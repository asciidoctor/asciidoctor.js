...
(function($opal) {
  ...
  return (function($base) {
    ...
    $opal.cdecl($scope, 'VERSION', "1.5.0-preview.6")
...
(function($opal) {
  ...
  return (function($base, $super) {
    ...
    if ((($a = self['$respond_to?']("chr")) !== nil && (!$a._isBoolean || $a == true))) {
      return nil
      } else {
...
if (it == null) it = nil;
              ...
              id = id.$sub($scope.DoubleQuotedRx, (function() {if ((($a = (($b = $opal.Object._scope.RUBY_ENGINE_OPAL) == null ? $opal.cm('RUBY_ENGINE_OPAL') : $b)) !== nil && (!$a._isBoolean || $a == true))) {
                return "$2"
                } else {
                return "\\2"
              }; return nil; })());
              if (reftext !== false && reftext !== nil) {
                reftext = reftext.$sub($scope.DoubleQuotedMultiRx, (function() {if ((($a = (($b = $opal.Object._scope.RUBY_ENGINE_OPAL) == null ? $opal.cm('RUBY_ENGINE_OPAL') : $b)) !== nil && (!$a._isBoolean || $a == true))) {
                  return "$2"
                  } else {
                  return "\\2"
                }; return nil; })())};
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$generate_data_uri = function(target_image, asset_dir_key) {
        ...
        if ((($a = $scope.File['$readable?'](image_path)['$!']()) !== nil && (!$a._isBoolean || $a == true))) {
          self.$warn("asciidoctor: WARNING: image to embed not found or not readable: " + (image_path));
          return "data:" + (mimetype) + ":base64,";};
        bindata = nil;
        if ((($a = $scope.IO['$respond_to?']("binread")) !== nil && (!$a._isBoolean || $a == true))) {
          bindata = $scope.IO.$binread(image_path)
          } else {
          bindata = ($a = ($b = $scope.File).$open, $a._p = (TMP_1 = function(file){var self = TMP_1._s || this;
if (file == null) file = nil;
      ...
      def.$read_asset = function(path, warn_on_failure) {
        ...
        if ((($a = $scope.File['$readable?'](path)) !== nil && (!$a._isBoolean || $a == true))) {
...
(function($opal) {
  ...
  (function($base) {
    ...
    $opal.cdecl($scope, 'NULL', (function() {if ((($a = (($b = $opal.Object._scope.RUBY_ENGINE_OPAL) == null ? $opal.cm('RUBY_ENGINE_OPAL') : $b)) !== nil && (!$a._isBoolean || $a == true))) {
      return (0).$chr()
      } else {
      return "\x00"
    }; return nil; })());
...
if (key == null) key = nil;
    ...
    if ((($a = (($c = $opal.Object._scope.RUBY_ENGINE_OPAL) == null ? $opal.cm('RUBY_ENGINE_OPAL') : $c)) !== nil && (!$a._isBoolean || $a == true))) {
    ...
    $opal.cdecl($scope, 'PassInlineLiteralRx', /(^|[^`\w])(?:\[([^\]]+?)\])?(\\?`([^`\s]|[^`\s].*?\S)`)(?![`\w])/m);

    $opal.cdecl($scope, 'PassInlineMacroRx', /\\?(?:(\+{3}|\${2})(.*?)\1|pass:([a-z,]*)\[(.*?[^\\])\])/m);

    $opal.cdecl($scope, 'XrefInlineMacroRx', /\\?(?:&lt;&lt;([\w":].*?)&gt;&gt;|xref:([\w":].*?)\[(.*?)\])/m);

    $opal.cdecl($scope, 'LineBreakRx', (function() {if ((($a = (($c = $opal.Object._scope.RUBY_ENGINE_OPAL) == null ? $opal.cm('RUBY_ENGINE_OPAL') : $c)) !== nil && (!$a._isBoolean || $a == true))) {
      return /^(.*?)[ \\t]\\+$/m;
      } else {
      return /^(.*)[[:blank:]]\+$/
    }; return nil; })());
    ...
    $opal.cdecl($scope, 'UnicodeCharScanRx', (function() {if ((($a = $scope.FORCE_UNICODE_LINE_LENGTH) !== nil && (!$a._isBoolean || $a == true))) {
      return ($scope.Regexp.$new(".", false, "u"))
      } else {
      return nil
    }; return nil; })());
    ...
    $opal.cdecl($scope, 'QUOTE_SUBS', [["strong", "unconstrained", /\\?(?:\[([^\]]+?)\])?\*\*(.+?)\*\*/m], ["strong", "constrained", /(^|[^\w;:}])(?:\[([^\]]+?)\])?\*(\S|\S.*?\S)\*(?=\W|$)/m], ["double", "constrained", /(^|[^\w;:}])(?:\[([^\]]+?)\])?``(\S|\S.*?\S)''(?=\W|$)/m], ["emphasis", "constrained", /(^|[^\w;:}])(?:\[([^\]]+?)\])?'(\S|\S.*?\S)'(?=\W|$)/m], ["single", "constrained", /(^|[^\w;:}])(?:\[([^\]]+?)\])?`(\S|\S.*?\S)'(?=\W|$)/m], ["monospaced", "unconstrained", /\\?(?:\[([^\]]+?)\])?\+\+(.+?)\+\+/m], ["monospaced", "constrained", /(^|[^\w;:}])(?:\[([^\]]+?)\])?\+(\S|\S.*?\S)\+(?=\W|$)/m], ["emphasis", "unconstrained", /\\?(?:\[([^\]]+?)\])?__(.+?)__/m], ["emphasis", "constrained", /(^|[^\w;:}])(?:\[([^\]]+?)\])?_(\S|\S.*?\S)_(?=\W|$)/m], ["none", "unconstrained", /\\?(?:\[([^\]]+?)\])?##(.+?)##/m], ["none", "constrained", /(^|[^\w;:}])(?:\[([^\]]+?)\])?#(\S|\S.*?\S)#(?=\W|$)/m], ["superscript", "unconstrained", /\\?(?:\[([^\]]+?)\])?\^(.+?)\^/m], ["subscript", "unconstrained", /\\?(?:\[([^\]]+?)\])?~(.+?)~/m]]);
