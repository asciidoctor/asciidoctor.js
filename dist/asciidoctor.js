...
/* Generated by Opal 0.5.5 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $module = $opal.module, $gvars = $opal.gvars, $range = $opal.range;
  return (function($base) {
    var self = $module($base, 'Asciidoctor');
    ...
    (function($base) {
      ...
      $opal.defs(self, '$encode_uri', function(str) {
        ...
        return ($a = ($b = str).$gsub, $a._p = (TMP_1 = function(){var self = TMP_1._s || this, $a, $b, TMP_2;
        return ($a = ($b = $gvars["&"].$each_byte()).$map, $a._p = (TMP_2 = function(c){var self = TMP_2._s || this;if (c == null) c = nil;
          return self.$sprintf("%%%02X", c)}, TMP_2._s = self, TMP_2), $a).call($b).$join()}, TMP_1._s = self, TMP_1), $a).call($b, $scope.REGEXP['$[]']("uri_encode_chars"));
      });
  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      def.$sub_replacements = function(text) {
        var $a, $b, TMP_10, self = this, result = nil;
        result = text.$dup();
        ($a = ($b = $scope.REPLACEMENTS).$each, $a._p = (TMP_10 = function(pattern, replacement, restore){var self = TMP_10._s || this, $a, $b, TMP_11;if (pattern == null) pattern = nil;if (replacement == null) replacement = nil;if (restore == null) restore = nil;
        return result = ($a = ($b = result).$gsub, $a._p = (TMP_11 = function(){var self = TMP_11._s || this, $a, m = nil, matched = nil, $case = nil;
          m = $gvars["~"];
            matched = $gvars["&"];
            if (($a = matched['$include?']("\\")) !== false && $a !== nil) {
              return matched.$tr("\\", "")
              } else {
            ...
            };}, TMP_11._s = self, TMP_11), $a).call($b, pattern)}, TMP_10._s = self, TMP_10), $a).call($b);
        return result;
      };

      def.$sub_attributes = function(data, opts) {
        var $a, $b, TMP_12, self = this, string_data = nil, lines = nil, result = nil;
        if (opts == null) {
          opts = $hash2([], {})
        }
        ...
        result = [];
        ($a = ($b = lines).$each, $a._p = (TMP_12 = function(line){var self = TMP_12._s || this, $a, $b, TMP_13, $c, $d, reject = nil, reject_if_empty = nil;if (line == null) line = nil;
        reject = false;
          reject_if_empty = false;
          if (($a = line['$include?']("{")) !== false && $a !== nil) {
            line = ($a = ($b = line).$gsub, $a._p = (TMP_13 = function(){var self = TMP_13._s || this, $a, $b, TMP_14, $c, TMP_15, m = nil, directive = nil, offset = nil, expr = nil, $case = nil, args = nil, _ = nil, value = nil, val = nil, key = nil;
              if (self.document == null) self.document = nil;
              ...
              if (($a = ((($b = m['$[]'](1)['$==']("\\")) !== false && $b !== nil) ? $b : m['$[]'](4)['$==']("\\"))) !== false && $a !== nil) {
                ...
                if (($a = value['$nil?']()) !== false && $a !== nil) {
                  if (self.document.$attributes().$fetch("attribute-undefined", $scope.Compliance.$attribute_undefined())['$==']("drop-line")) {
                    ($a = ($b = $scope.Debug).$debug, $a._p = (TMP_14 = function(){var self = TMP_14._s || this;
                    return "Undefining attribute: " + (self.$key()) + ", line marked for removal"}, TMP_14._s = self, TMP_14), $a).call($b);
                    reject = true;
                ...
                return (function() {$case = (((($a = opts['$[]']("attribute_missing")) !== false && $a !== nil) ? $a : self.document.$attributes().$fetch("attribute-missing", $scope.Compliance.$attribute_missing())));if ("skip"['$===']($case)) {return m['$[]'](0)}else if ("drop-line"['$===']($case)) {($a = ($c = $scope.Debug).$debug, $a._p = (TMP_15 = function(){var self = TMP_15._s || this;
                return "Missing attribute: " + (key) + ", line marked for removal"}, TMP_15._s = self, TMP_15), $a).call($c);
                reject = true;
                return ($breaker.$v = "", $breaker);}else {reject_if_empty = true;
                return "";}})()
              };}, TMP_13._s = self, TMP_13), $a).call($b, $scope.REGEXP['$[]']("attr_ref"))};
      ...
      def.$sub_macros = function(source) {
        var $a, $b, $c, TMP_16, TMP_18, $d, TMP_19, $e, $f, TMP_20, $g, TMP_22, TMP_23, $h, TMP_24, $i, $j, TMP_25, TMP_26, $k, TMP_27, self = this, found = nil, use_link_attrs = nil, experimental = nil, result = nil, extensions = nil;
        if (self.document == null) self.document = nil;
        ...
        if (experimental !== false && experimental !== nil) {
          if (($a = ($b = found['$[]']("macroish_short_form"), $b !== false && $b !== nil ?(((($c = result['$include?']("kbd:")) !== false && $c !== nil) ? $c : result['$include?']("btn:"))) : $b)) !== false && $a !== nil) {
            result = ($a = ($b = result).$gsub, $a._p = (TMP_16 = function(){var self = TMP_16._s || this, $a, $b, TMP_17, m = nil, captured = nil, keys = nil, label = nil;
            m = $gvars["~"];
              ...
              if (($a = captured['$start_with?']("kbd")) !== false && $a !== nil) {
                ...
                if (keys['$==']("+")) {
                  ...
                  keys = ($a = ($b = keys.$split($scope.REGEXP['$[]']("kbd_delim"))).$inject, $a._p = (TMP_17 = function(c, key){var self = TMP_17._s || this, $a;if (c == null) c = nil;if (key == null) key = nil;
                  if (($a = key['$end_with?']("++")) !== false && $a !== nil) {
                    ...
                    return c;}, TMP_17._s = self, TMP_17), $a).call($b, [])
                };
                ...
                return nil
              };}, TMP_16._s = self, TMP_16), $a).call($b, $scope.REGEXP['$[]']("kbd_btn_macro"))};
          if (($a = ($c = found['$[]']("macroish"), $c !== false && $c !== nil ?result['$include?']("menu:") : $c)) !== false && $a !== nil) {
            result = ($a = ($c = result).$gsub, $a._p = (TMP_18 = function(){var self = TMP_18._s || this, $a, $b, m = nil, captured = nil, menu = nil, items = nil, submenus = nil, menuitem = nil, delim = nil;
            m = $gvars["~"];
              if (($a = ((captured = m['$[]'](0)))['$start_with?']("\\")) !== false && $a !== nil) {
                return captured['$[]']($range(1, -1, false));};
              menu = m['$[]'](1);
              ...
              return $scope.Inline.$new(self, "menu", nil, $hash2(["attributes"], {"attributes": $hash2(["menu", "submenus", "menuitem"], {"menu": menu, "submenus": submenus, "menuitem": menuitem})})).$render();}, TMP_18._s = self, TMP_18), $a).call($c, $scope.REGEXP['$[]']("menu_macro"))};
          if (($a = ($d = result['$include?']("\""), $d !== false && $d !== nil ?result['$include?']("&gt;") : $d)) !== false && $a !== nil) {
            result = ($a = ($d = result).$gsub, $a._p = (TMP_19 = function(){var self = TMP_19._s || this, $a, $b, $c, m = nil, captured = nil, input = nil, menu = nil, submenus = nil, menuitem = nil;
            m = $gvars["~"];
              if (($a = ((captured = m['$[]'](0)))['$start_with?']("\\")) !== false && $a !== nil) {
                return captured['$[]']($range(1, -1, false));};
              input = m['$[]'](1);
              ...
              menuitem = submenus.$pop();
              return $scope.Inline.$new(self, "menu", nil, $hash2(["attributes"], {"attributes": $hash2(["menu", "submenus", "menuitem"], {"menu": menu, "submenus": submenus, "menuitem": menuitem})})).$render();}, TMP_19._s = self, TMP_19), $a).call($d, $scope.REGEXP['$[]']("menu_inline_macro"))};};
        if (($a = ($e = ($f = (extensions = self.document.$extensions()), $f !== false && $f !== nil ?extensions['$inline_macros?']() : $f), $e !== false && $e !== nil ?found['$[]']("macroish") : $e)) !== false && $a !== nil) {
          ($a = ($e = extensions.$load_inline_macro_processors(self.document)).$each, $a._p = (TMP_20 = function(processor){var self = TMP_20._s || this, $a, $b, TMP_21;if (processor == null) processor = nil;
          return result = ($a = ($b = result).$gsub, $a._p = (TMP_21 = function(){var self = TMP_21._s || this, $a, m = nil, target = nil, attributes = nil, posattrs = nil;
            m = $gvars["~"];
              if (($a = m['$[]'](0)['$start_with?']("\\")) !== false && $a !== nil) {
                return m['$[]'](0)['$[]']($range(1, -1, false));};
              target = m['$[]'](1);
              ...
              return processor.$process(self, target, attributes);}, TMP_21._s = self, TMP_21), $a).call($b, processor.$regexp())}, TMP_20._s = self, TMP_20), $a).call($e)};
        if (($a = ($f = found['$[]']("macroish"), $f !== false && $f !== nil ?(((($g = result['$include?']("image:")) !== false && $g !== nil) ? $g : result['$include?']("icon:"))) : $f)) !== false && $a !== nil) {
          result = ($a = ($f = result).$gsub, $a._p = (TMP_22 = function(){var self = TMP_22._s || this, $a, $b, m = nil, raw_attrs = nil, type = nil, posattrs = nil, target = nil, attrs = nil;
            if (self.document == null) self.document = nil;
          ...
          m = $gvars["~"];
            ...
            return $scope.Inline.$new(self, "image", nil, $hash2(["type", "target", "attributes"], {"type": type, "target": target, "attributes": attrs})).$render();}, TMP_22._s = self, TMP_22), $a).call($f, $scope.REGEXP['$[]']("image_macro"))};
        if (($a = ((($g = found['$[]']("macroish_short_form")) !== false && $g !== nil) ? $g : found['$[]']("round_bracket"))) !== false && $a !== nil) {
          result = ($a = ($g = result).$gsub, $a._p = (TMP_23 = function(){var self = TMP_23._s || this, $a, $b, m = nil, num_brackets = nil, text_in_brackets = nil, macro_name = nil, terms = nil, text = nil;
            if (self.document == null) self.document = nil;
          ...
          m = $gvars["~"];
            ...
            };}, TMP_23._s = self, TMP_23), $a).call($g, $scope.REGEXP['$[]']("indexterm_macro"))};
        if (($a = result['$include?']("://")) !== false && $a !== nil) {
          result = ($a = ($h = result).$gsub, $a._p = (TMP_24 = function(){var self = TMP_24._s || this, $a, $b, $c, m = nil, prefix = nil, target = nil, suffix = nil, attrs = nil, text = nil;
            if (self.document == null) self.document = nil;
          ...
          m = $gvars["~"];
            ...
            return "" + (prefix) + ($scope.Inline.$new(self, "anchor", text, $hash2(["type", "target", "attributes"], {"type": "link", "target": target, "attributes": attrs})).$render()) + (suffix);}, TMP_24._s = self, TMP_24), $a).call($h, $scope.REGEXP['$[]']("link_inline"))};
        if (($a = ((($i = ($j = found['$[]']("macroish"), $j !== false && $j !== nil ?(result['$include?']("link:")) : $j)) !== false && $i !== nil) ? $i : (result['$include?']("mailto:")))) !== false && $a !== nil) {
          result = ($a = ($i = result).$gsub, $a._p = (TMP_25 = function(){var self = TMP_25._s || this, $a, $b, $c, m = nil, raw_target = nil, mailto = nil, target = nil, attrs = nil, text = nil;
            if (self.document == null) self.document = nil;
          ...
          m = $gvars["~"];
            ...
            return $scope.Inline.$new(self, "anchor", text, $hash2(["type", "target", "attributes"], {"type": "link", "target": target, "attributes": attrs})).$render();}, TMP_25._s = self, TMP_25), $a).call($i, $scope.REGEXP['$[]']("link_macro"))};
        if (($a = result['$include?']("@")) !== false && $a !== nil) {
          result = ($a = ($j = result).$gsub, $a._p = (TMP_26 = function(){var self = TMP_26._s || this, m = nil, address = nil, $case = nil, target = nil;
            if (self.document == null) self.document = nil;
          ...
          m = $gvars["~"];
            ...
            self.document.$register("links", target);
            return $scope.Inline.$new(self, "anchor", address, $hash2(["type", "target"], {"type": "link", "target": target})).$render();}, TMP_26._s = self, TMP_26), $a).call($j, $scope.REGEXP['$[]']("email_inline"))};
        if (($a = ($k = found['$[]']("macroish_short_form"), $k !== false && $k !== nil ?result['$include?']("footnote") : $k)) !== false && $a !== nil) {
          result = ($a = ($k = result).$gsub, $a._p = (TMP_27 = function(){var self = TMP_27._s || this, $a, $b, TMP_28, m = nil, id = nil, text = nil, index = nil, type = nil, target = nil, footnote = nil;
            if (self.document == null) self.document = nil;
          ...
          m = $gvars["~"];
            ...
            if (m['$[]'](1)['$==']("footnote")) {
              ...
              if (($a = ($b = text['$nil?'](), ($b === nil || $b === false))) !== false && $a !== nil) {
                ...
                footnote = ($a = ($b = self.document.$references()['$[]']("footnotes")).$find, $a._p = (TMP_28 = function(fn){var self = TMP_28._s || this;if (fn == null) fn = nil;
                return fn.$id()['$=='](id)}, TMP_28._s = self, TMP_28), $a).call($b);
                target = id;
                id = nil;
            ...
            return $scope.Inline.$new(self, "footnote", text, $hash2(["attributes", "id", "target", "type"], {"attributes": $hash2(["index"], {"index": index}), "id": id, "target": target, "type": type})).$render();}, TMP_27._s = self, TMP_27), $a).call($k, $scope.REGEXP['$[]']("footnote_macro"))};
        return self.$sub_inline_xrefs(self.$sub_inline_anchors(result, found), found);
      };

      def.$sub_inline_anchors = function(text, found) {
        var $a, $b, $c, TMP_29, $d, $e, TMP_30, self = this;
        if (found == null) {
          found = nil
        }
        if (($a = ($b = (((($c = found['$nil?']()) !== false && $c !== nil) ? $c : found['$[]']("square_bracket"))), $b !== false && $b !== nil ?text['$include?']("[[[") : $b)) !== false && $a !== nil) {
          text = ($a = ($b = text).$gsub, $a._p = (TMP_29 = function(){var self = TMP_29._s || this, $a, m = nil, id = nil, reftext = nil;
          m = $gvars["~"];
            if (($a = m['$[]'](0)['$start_with?']("\\")) !== false && $a !== nil) {
              return m['$[]'](0)['$[]']($range(1, -1, false));};
            id = reftext = m['$[]'](1);
            return $scope.Inline.$new(self, "anchor", reftext, $hash2(["type", "target"], {"type": "bibref", "target": id})).$render();}, TMP_29._s = self, TMP_29), $a).call($b, $scope.REGEXP['$[]']("biblio_macro"))};
        if (($a = ((($c = (($d = (((($e = found['$nil?']()) !== false && $e !== nil) ? $e : found['$[]']("square_bracket"))), $d !== false && $d !== nil ?text['$include?']("[[") : $d))) !== false && $c !== nil) ? $c : (($d = (((($e = found['$nil?']()) !== false && $e !== nil) ? $e : found['$[]']("macroish"))), $d !== false && $d !== nil ?text['$include?']("anchor:") : $d)))) !== false && $a !== nil) {
          text = ($a = ($c = text).$gsub, $a._p = (TMP_30 = function(){var self = TMP_30._s || this, $a, $b, TMP_31, m = nil, id = nil, reftext = nil;
            if (self.document == null) self.document = nil;
          ...
          m = $gvars["~"];
            ...
            if (($a = self.document.$references()['$[]']("ids")['$has_key?'](id)) === false || $a === nil) {
              ($a = ($b = $scope.Debug).$debug, $a._p = (TMP_31 = function(){var self = TMP_31._s || this;
              return "Missing reference for anchor " + (id)}, TMP_31._s = self, TMP_31), $a).call($b)};
            return $scope.Inline.$new(self, "anchor", reftext, $hash2(["type", "target"], {"type": "ref", "target": id})).$render();}, TMP_30._s = self, TMP_30), $a).call($c, $scope.REGEXP['$[]']("anchor_macro"))};
        return text;
      };

      def.$sub_inline_xrefs = function(text, found) {
        var $a, $b, $c, TMP_32, self = this;
        if (found == null) {
          found = nil
        }
        if (($a = ((($b = (((($c = found['$nil?']()) !== false && $c !== nil) ? $c : found['$[]']("macroish")))) !== false && $b !== nil) ? $b : text['$include?']("&lt;&lt;"))) !== false && $a !== nil) {
          text = ($a = ($b = text).$gsub, $a._p = (TMP_32 = function(){var self = TMP_32._s || this, $a, $b, $c, m = nil, id = nil, reftext = nil, path = nil, fragment = nil, refid = nil, target = nil;
            if (self.document == null) self.document = nil;

          m = $gvars["~"];
            if (($a = m['$[]'](0)['$start_with?']("\\")) !== false && $a !== nil) {
              return m['$[]'](0)['$[]']($range(1, -1, false));};
            if (($a = ((($b = m['$[]'](1)['$nil?']()) !== false && $b !== nil) ? $b : (($c = $scope.RUBY_ENGINE_OPAL, $c !== false && $c !== nil ?m['$[]'](1).$to_s()['$==']("") : $c)))) !== false && $a !== nil) {
              id = m['$[]'](2);
              ...
              id = id.$sub($scope.REGEXP['$[]']("dbl_quoted"), (function() {if (($a = $scope.RUBY_ENGINE_OPAL) !== false && $a !== nil) {
                return "$2"
                } else {
                return "2"
              }; return nil; })());
              if (($a = reftext['$nil?']()) === false || $a === nil) {
                reftext = reftext.$sub($scope.REGEXP['$[]']("m_dbl_quoted"), (function() {if (($a = $scope.RUBY_ENGINE_OPAL) !== false && $a !== nil) {
                  return "$2"
                  } else {
                  return "2"
                }; return nil; })())};
            ...
            return $scope.Inline.$new(self, "anchor", reftext, $hash2(["type", "target", "attributes"], {"type": "xref", "target": target, "attributes": $hash2(["path", "fragment", "refid"], {"path": path, "fragment": fragment, "refid": refid})})).$render();}, TMP_32._s = self, TMP_32), $a).call($b, $scope.REGEXP['$[]']("xref_macro"))};
        return text;
      };

      def.$sub_callouts = function(text) {
        var $a, $b, TMP_33, self = this;
        return ($a = ($b = text).$gsub, $a._p = (TMP_33 = function(){var self = TMP_33._s || this, m = nil;
          if (self.document == null) self.document = nil;

        m = $gvars["~"];
          if (m['$[]'](1)['$==']("\\")) {
            return m['$[]'](0).$sub("\\", "");};
          return $scope.Inline.$new(self, "callout", m['$[]'](3), $hash2(["id"], {"id": self.document.$callouts().$read_next_id()})).$render();}, TMP_33._s = self, TMP_33), $a).call($b, $scope.REGEXP['$[]']("callout_render"));
      };

      def.$sub_post_replacements = function(text) {
        var $a, $b, TMP_34, $c, TMP_35, self = this, lines = nil, last = nil;
        if (self.document == null) self.document = nil;
        ...
        if (($a = ((($b = (self.document.$attributes()['$has_key?']("hardbreaks"))) !== false && $b !== nil) ? $b : (self.attributes['$has_key?']("hardbreaks-option")))) !== false && $a !== nil) {
          ...
          if (lines.$size()['$=='](1)) {
            return text};
          last = lines.$pop();
          return ($a = ($b = lines).$map, $a._p = (TMP_34 = function(line){var self = TMP_34._s || this;if (line == null) line = nil;
          return $scope.Inline.$new(self, "break", line.$rstrip().$chomp($scope.LINE_BREAK), $hash2(["type"], {"type": "line"})).$render()}, TMP_34._s = self, TMP_34), $a).call($b).$push(last)['$*']($scope.EOL);
          } else {
          return ($a = ($c = text).$gsub, $a._p = (TMP_35 = function(){var self = TMP_35._s || this;
          return $scope.Inline.$new(self, "break", $gvars["~"]['$[]'](1), $hash2(["type"], {"type": "line"})).$render()}, TMP_35._s = self, TMP_35), $a).call($c, $scope.REGEXP['$[]']("line_break"))
        };
      };
      ...
      def.$split_simple_csv = function(str) {
        var $a, $b, TMP_36, $c, self = this, values = nil, current = nil, quote_open = nil;
        if (($a = str['$empty?']()) !== false && $a !== nil) {
          values = []
          ...
          current = [];
          quote_open = false;
          ($a = ($b = str).$each_char, $a._p = (TMP_36 = function(c){var self = TMP_36._s || this, $a, $case = nil;if (c == null) c = nil;
          return (function() {$case = c;if (","['$===']($case)) {if (quote_open !== false && quote_open !== nil) {
              return current.$push(c)
              } else {
              values['$<<'](current.$join().$strip());
              return current = [];
            }}else if ("\""['$===']($case)) {return quote_open = ($a = quote_open, ($a === nil || $a === false))}else {return current.$push(c)}})()}, TMP_36._s = self, TMP_36), $a).call($b);
          values['$<<'](current.$join().$strip());
          } else {
      ...
      def.$resolve_subs = function(subs, type, defaults, subject) {
        var $a, $b, TMP_37, self = this, candidates = nil, modification_group = nil, resolved = nil, invalid = nil;
        if (type == null) {
          type = "block"
        }
        if (defaults == null) {
        ...
        ($a = ($b = subs.$split(",")).$each, $a._p = (TMP_37 = function(val){var self = TMP_37._s || this, $a, $b, $c, key = nil, first = nil, operation = nil, resolved_keys = nil, resolved_key = nil, $case = nil;if (val == null) val = nil;
        key = val.$strip();
      ...
      def.$highlight_source = function(source, sub_callouts, highlighter) {
        var $a, $b, TMP_38, $c, $d, TMP_40, self = this, callout_marks = nil, lineno = nil, callout_on_last = nil, last = nil, linenums_mode = nil, $case = nil, result = nil, lexer = nil, opts = nil, reached_code = nil;
        if (self.document == null) self.document = nil;
        if (self.passthroughs == null) self.passthroughs = nil;
        ...
        if (sub_callouts !== false && sub_callouts !== nil) {
          last = -1;
          source = ($a = ($b = source.$split($scope.LINE_SPLIT)).$map, $a._p = (TMP_38 = function(line){var self = TMP_38._s || this, $a, $b, TMP_39;if (line == null) line = nil;
          lineno = lineno['$+'](1);
            return ($a = ($b = line).$gsub, $a._p = (TMP_39 = function(){var self = TMP_39._s || this, $a, $b, $c, m = nil;
            m = $gvars["~"];
              if (m['$[]'](1)['$==']("\\")) {
                return m['$[]'](0).$sub("\\", "")
                } else {
                ...
                last = lineno;
                return nil;
              };}, TMP_39._s = self, TMP_39), $a).call($b, $scope.REGEXP['$[]']("callout_scan"));}, TMP_38._s = self, TMP_38), $a).call($b)['$*']($scope.EOL);
        ...
        if (($a = ((($c = ($d = sub_callouts, ($d === nil || $d === false))) !== false && $c !== nil) ? $c : callout_marks['$empty?']())) !== false && $a !== nil) {
          ...
          return ($a = ($c = result.$split($scope.LINE_SPLIT)).$map, $a._p = (TMP_40 = function(line){var self = TMP_40._s || this, $a, $b, $c, TMP_41, conums = nil, tail = nil, pos = nil, conums_markup = nil;
            if (self.document == null) self.document = nil;
          ...
          if (($a = reached_code) === false || $a === nil) {
            ...
            if (($a = (conums = callout_marks.$delete(lineno))) !== false && $a !== nil) {
              ...
              if (conums.$size()['$=='](1)) {
                ...
                conums_markup = ($a = ($b = conums).$map, $a._p = (TMP_41 = function(conum){var self = TMP_41._s || this;
                  if (self.document == null) self.document = nil;
if (conum == null) conum = nil;
                return $scope.Inline.$new(self, "callout", conum, $hash2(["id"], {"id": self.document.$callouts().$read_next_id()})).$render()}, TMP_41._s = self, TMP_41), $a).call($b)['$*'](" ");
                return "" + (line) + (conums_markup) + (tail);
              };
              } else {
              return line
            };}, TMP_40._s = self, TMP_40), $a).call($c)['$*']($scope.EOL);
        };
      };

      def.$lock_in_subs = function() {
        var $a, $b, $c, $d, $e, TMP_42, self = this, default_subs = nil, $case = nil, custom_subs = nil, highlighter = nil;
        ...
        if (($a = ($b = ($c = ($d = (($e = self.context['$==']("listing")) ? self.style['$==']("source") : $e), $d !== false && $d !== nil ?(self.document['$basebackend?']("html")) : $d), $c !== false && $c !== nil ?(((($d = ((highlighter = self.document.$attributes()['$[]']("source-highlighter")))['$==']("coderay")) !== false && $d !== nil) ? $d : highlighter['$==']("pygments"))) : $c), $b !== false && $b !== nil ?(self['$attr?']("language")) : $b)) !== false && $a !== nil) {
          return self.subs = ($a = ($b = self.subs).$map, $a._p = (TMP_42 = function(sub){var self = TMP_42._s || this;if (sub == null) sub = nil;
...
(function($opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      var def = $Block._proto, $scope = $Block._scope, TMP_1, TMP_4;
      ...
      def.$initialize = TMP_1 = function(parent, context, opts) {
        var $a, $b, TMP_2, $c, TMP_3, self = this, $iter = TMP_1._p, $yield = $iter || nil, raw_source = nil;
        if (opts == null) {
          opts = $hash2([], {})
        }
        TMP_1._p = null;
        ...
        if (($a = raw_source['$nil?']()) !== false && $a !== nil) {
          ...
          if (($a = $scope.FORCE_ENCODING) !== false && $a !== nil) {
            return self.lines = ($a = ($b = raw_source.$each_line()).$map, $a._p = (TMP_2 = function(line){var self = TMP_2._s || this, $a;if (line == null) line = nil;
            return "" + (line.$rstrip().$force_encoding(((($a = $opal.Object._scope.Encoding) == null ? $opal.cm('Encoding') : $a))._scope.UTF_8))}, TMP_2._s = self, TMP_2), $a).call($b)
            } else {
            return self.lines = ($a = ($c = raw_source.$each_line()).$map, $a._p = (TMP_3 = function(line){var self = TMP_3._s || this;if (line == null) line = nil;
            return line.$rstrip()}, TMP_3._s = self, TMP_3), $a).call($c)
          }
          } else {
      ...
      def.$content = TMP_4 = function() {var $zuper = $slice.call(arguments, 0);
        var $a, $b, $c, $d, self = this, $iter = TMP_4._p, $yield = $iter || nil, $case = nil, result = nil, first = nil, last = nil;
        TMP_4._p = null;
        return (function() {$case = self.content_model;if ("compound"['$===']($case)) {return $opal.find_super_dispatcher(self, 'content', TMP_4, $iter).apply(self, $zuper)}else if ("simple"['$===']($case)) {return self.$apply_subs(self.lines.$join($scope.EOL), self.subs)}else if ("verbatim"['$===']($case) || "raw"['$===']($case)) {result = self.$apply_subs(self.lines, self.subs);
        if (result.$size()['$<'](2)) {
...
(function($opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      var def = $Reader._proto, $scope = $Reader._scope, TMP_8;
      ...
      def.$prepare_lines = function(data, opts) {
        ...
        if (($a = data['$is_a?']((($b = $opal.Object._scope.String) == null ? $opal.cm('String') : $b))) !== false && $a !== nil) {
          if (($a = opts['$[]']("normalize")) !== false && $a !== nil) {
            if (($a = $scope.FORCE_ENCODING) !== false && $a !== nil) {
              return ($a = ($b = data.$each_line()).$map, $a._p = (TMP_1 = function(line){var self = TMP_1._s || this, $a;if (line == null) line = nil;
              return "" + (line.$rstrip().$force_encoding(((($a = $opal.Object._scope.Encoding) == null ? $opal.cm('Encoding') : $a))._scope.UTF_8))}, TMP_1._s = self, TMP_1), $a).call($b)
              } else {
              return ($a = ($c = data.$each_line()).$map, $a._p = (TMP_2 = function(line){var self = TMP_2._s || this;if (line == null) line = nil;
              return line.$rstrip()}, TMP_2._s = self, TMP_2), $a).call($c)
            }
            } else {
          ...
          if (($a = $scope.FORCE_ENCODING) !== false && $a !== nil) {
            return ($a = ($d = data).$map, $a._p = (TMP_3 = function(line){var self = TMP_3._s || this, $a;if (line == null) line = nil;
            return "" + (line.$rstrip().$force_encoding(((($a = $opal.Object._scope.Encoding) == null ? $opal.cm('Encoding') : $a))._scope.UTF_8))}, TMP_3._s = self, TMP_3), $a).call($d)
            } else {
      ...
      def.$peek_lines = function(num, direct) {
        var $a, $b, TMP_5, $c, TMP_6, self = this, old_look_ahead = nil, result = nil;
        if (num == null) {
          num = 1
        }
        if (direct == null) {
        ...
        result = [];
        ($a = ($b = ($range(1, num, false))).$each, $a._p = (TMP_5 = function(){var self = TMP_5._s || this, $a, line = nil;
        ...
        if (($a = result['$empty?']()) === false || $a === nil) {
          ($a = ($c = result).$reverse_each, $a._p = (TMP_6 = function(line){var self = TMP_6._s || this;if (line == null) line = nil;
          return self.$unshift(line)}, TMP_6._s = self, TMP_6), $a).call($c);
      ...
      def.$unshift_lines = function(lines_to_restore) {
        var $a, $b, TMP_7, self = this;
        ($a = ($b = lines_to_restore).$reverse_each, $a._p = (TMP_7 = function(line){var self = TMP_7._s || this;if (line == null) line = nil;
        return self.$unshift(line)}, TMP_7._s = self, TMP_7), $a).call($b);
        return nil;
      };
      ...
      def.$read_lines_until = TMP_8 = function(options) {
        var $a, $b, $c, $d, $e, self = this, $iter = TMP_8._p, $yield = $iter || nil, result = nil, restore_process_lines = nil, has_block = nil, terminator = nil, break_on_blank_lines = nil, break_on_list_continuation = nil, skip_line_comments = nil, line_read = nil, line_restored = nil, complete = nil, line = nil;
        if (options == null) {
          options = $hash2([], {})
        }
        TMP_8._p = null;
    ...
    (function($base, $super) {
      ...
      var def = $PreprocessorReader._proto, $scope = $PreprocessorReader._scope, TMP_9, TMP_10, TMP_11, TMP_24;
      ...
      def.$initialize = TMP_9 = function(document, data, cursor) {
        var $a, $b, $c, self = this, $iter = TMP_9._p, $yield = $iter || nil, include_depth_default = nil;
        if (data == null) {
          data = nil
        }
        if (cursor == null) {
        ...
        $opal.find_super_dispatcher(self, 'initialize', TMP_9, null).apply(self, [data, cursor, $hash2(["normalize"], {"normalize": true})]);
      ...
      def.$prepare_lines = TMP_10 = function(data, opts) {var $zuper = $slice.call(arguments, 0);
        var $a, $b, $c, $d, self = this, $iter = TMP_10._p, $yield = $iter || nil, result = nil, front_matter = nil, first = nil, last = nil, indent = nil;
        if (opts == null) {
          opts = $hash2([], {})
        }
        TMP_10._p = null;
        result = $opal.find_super_dispatcher(self, 'prepare_lines', TMP_10, $iter).apply(self, $zuper);
      ...
      def.$peek_line = TMP_11 = function(direct) {var $zuper = $slice.call(arguments, 0);
        var $a, self = this, $iter = TMP_11._p, $yield = $iter || nil, line = nil;
        if (direct == null) {
          direct = false
        }
        TMP_11._p = null;
        if (($a = (line = $opal.find_super_dispatcher(self, 'peek_line', TMP_11, $iter).apply(self, $zuper))) !== false && $a !== nil) {
          return line
      ...
      def.$preprocess_conditional_inclusion = function(directive, target, delimiter, text) {
        var $a, $b, $c, $d, TMP_12, TMP_13, $e, TMP_14, TMP_15, $f, $g, self = this, stack_size = nil, pair = nil, skip = nil, $case = nil, expr_match = nil, lhs = nil, op = nil, rhs = nil, conditional_line = nil;
        ...
        if (($a = self.skipping) === false || $a === nil) {
          $case = directive;if ("ifdef"['$===']($case)) {$case = delimiter;if (nil['$===']($case)) {skip = ($a = self.document.$attributes()['$has_key?'](target), ($a === nil || $a === false))}else if (","['$===']($case)) {skip = ($a = ($b = ($c = target.$split(",")).$detect, $b._p = (TMP_12 = function(name){var self = TMP_12._s || this;
            if (self.document == null) self.document = nil;
if (name == null) name = nil;
          return self.document.$attributes()['$has_key?'](name)}, TMP_12._s = self, TMP_12), $b).call($c), ($a === nil || $a === false))}else if ("+"['$===']($case)) {skip = ($a = ($b = target.$split("+")).$detect, $a._p = (TMP_13 = function(name){var self = TMP_13._s || this, $a;
            if (self.document == null) self.document = nil;
if (name == null) name = nil;
          return ($a = self.document.$attributes()['$has_key?'](name), ($a === nil || $a === false))}, TMP_13._s = self, TMP_13), $a).call($b)}}else if ("ifndef"['$===']($case)) {$case = delimiter;if (nil['$===']($case)) {skip = self.document.$attributes()['$has_key?'](target)}else if (","['$===']($case)) {skip = ($a = ($d = ($e = target.$split(",")).$detect, $d._p = (TMP_14 = function(name){var self = TMP_14._s || this, $a;
            if (self.document == null) self.document = nil;
if (name == null) name = nil;
          return ($a = self.document.$attributes()['$has_key?'](name), ($a === nil || $a === false))}, TMP_14._s = self, TMP_14), $d).call($e), ($a === nil || $a === false))}else if ("+"['$===']($case)) {skip = ($a = ($d = target.$split("+")).$detect, $a._p = (TMP_15 = function(name){var self = TMP_15._s || this;
            if (self.document == null) self.document = nil;
if (name == null) name = nil;
          return self.document.$attributes()['$has_key?'](name)}, TMP_15._s = self, TMP_15), $a).call($d)}}else if ("ifeval"['$===']($case)) {if (($a = ((($f = ($g = target['$empty?'](), ($g === nil || $g === false))) !== false && $f !== nil) ? $f : ($g = (expr_match = text.$strip().$match($scope.REGEXP['$[]']("eval_expr"))), ($g === nil || $g === false)))) !== false && $a !== nil) {
            return false};
      ...
      def.$preprocess_include = function(target, raw_attributes) {
        var $a, $b, $c, $d, TMP_16, TMP_17, TMP_18, $e, TMP_20, $f, TMP_23, self = this, processor = nil, abs_maxdepth = nil, target_type = nil, include_file = nil, path = nil, inc_lines = nil, tags = nil, attributes = nil, selected = nil, inc_line_offset = nil, inc_lineno = nil, active_tag = nil, tags_found = nil, missing_tags = nil;
        ...
        } else if (($a = ($b = self['$include_processors?'](), $b !== false && $b !== nil ?(processor = ($c = ($d = self.include_processors).$find, $c._p = (TMP_16 = function(candidate){var self = TMP_16._s || this;if (candidate == null) candidate = nil;
        return candidate['$handles?'](target)}, TMP_16._s = self, TMP_16), $c).call($d)) : $b)) !== false && $a !== nil) {
          self.$advance();
          ...
          if (($a = ($b = raw_attributes['$empty?'](), ($b === nil || $b === false))) !== false && $a !== nil) {
            ...
            if (($a = attributes['$has_key?']("lines")) !== false && $a !== nil) {
              inc_lines = [];
              ($a = ($b = attributes['$[]']("lines").$split($scope.REGEXP['$[]']("ssv_or_csv_delim"))).$each, $a._p = (TMP_17 = function(linedef){var self = TMP_17._s || this, $a, $b, $c, from = nil, to = nil;if (linedef == null) linedef = nil;
          ...
          if (($a = ($c = inc_lines['$nil?'](), ($c === nil || $c === false))) !== false && $a !== nil) {
            if (($a = ($c = inc_lines['$empty?'](), ($c === nil || $c === false))) !== false && $a !== nil) {
              ...
              inc_lineno = 0;
              try {
              ($a = ($c = self).$open, $a._p = (TMP_18 = function(f){var self = TMP_18._s || this, $a, $b, TMP_19;if (f == null) f = nil;
                return ($a = ($b = f).$each_line, $a._p = (TMP_19 = function(l){var self = TMP_19._s || this, $a, $b, take = nil;if (l == null) l = nil;
                  inc_lineno = inc_lineno['$+'](1);
                    ...
                    };}, TMP_19._s = self, TMP_19), $a).call($b)}, TMP_18._s = self, TMP_18), $a).call($c, include_file, "r")
              } catch ($err) {if (true) {
            ...
            if (($a = ($e = tags['$empty?'](), ($e === nil || $e === false))) !== false && $a !== nil) {
              ...
              try {
              ($a = ($e = self).$open, $a._p = (TMP_20 = function(f){var self = TMP_20._s || this, $a, $b, TMP_21;if (f == null) f = nil;
                return ($a = ($b = f).$each_line, $a._p = (TMP_21 = function(l){var self = TMP_21._s || this, $a, $b, TMP_22;if (l == null) l = nil;
                  inc_lineno = inc_lineno['$+'](1);
                    if (($a = $scope.FORCE_ENCODING) !== false && $a !== nil) {
                    ...
                    if (($a = ($b = active_tag['$nil?'](), ($b === nil || $b === false))) !== false && $a !== nil) {
                      ...
                      return ($a = ($b = tags).$each, $a._p = (TMP_22 = function(tag){var self = TMP_22._s || this, $a;if (tag == null) tag = nil;
                    ...
                    };}, TMP_21._s = self, TMP_21), $a).call($b)}, TMP_20._s = self, TMP_20), $a).call($e, include_file, "r")
              } catch ($err) {if (true) {
                self.$warn("asciidoctor: WARNING: " + (self.$line_info()) + ": include " + (target_type) + " not readable: " + (include_file));
                self.$advance();
                return true;
            ...
            try {
            self.$advance();
              self.$push_include(($a = ($f = self).$open, $a._p = (TMP_23 = function(f){var self = TMP_23._s || this;if (f == null) f = nil;
              return f.$read()}, TMP_23._s = self, TMP_23), $a).call($f, include_file, "r"), include_file, path, 1, attributes);
            } catch ($err) {if (true) {
              self.$warn("asciidoctor: WARNING: " + (self.$line_info()) + ": include " + (target_type) + " not readable: " + (include_file));
              self.$advance();
              return true;
      ...
      def.$shift = TMP_24 = function() {var $zuper = $slice.call(arguments, 0);
        var $a, self = this, $iter = TMP_24._p, $yield = $iter || nil;
        TMP_24._p = null;
        if (($a = self.unescape_next_line) !== false && $a !== nil) {
          self.unescape_next_line = false;
          return $opal.find_super_dispatcher(self, 'shift', TMP_24, $iter).apply(self, $zuper)['$[]']($range(1, -1, false));
          } else {
          return $opal.find_super_dispatcher(self, 'shift', TMP_24, $iter).apply(self, $zuper)
        };
      };
      ...
      return (def.$to_s = function() {
        ...
        return "" + (self.$class().$name()) + " [path: " + (self.path) + ", line #: " + (self.lineno) + ", include depth: " + (self.include_stack.$size()) + ", include stack: [" + (($a = ($b = self.include_stack).$map, $a._p = (TMP_25 = function(inc){var self = TMP_25._s || this;if (inc == null) inc = nil;
        return inc.$to_s()}, TMP_25._s = self, TMP_25), $a).call($b).$join(", ")) + "]]";
      }, nil);
    })(self, $scope.Reader);
...
(function($opal) {
  ...
  return (function($base) {
    ...
    $opal.cdecl($scope, 'USER_HOME', (function() {if ($scope.RUBY_VERSION['$>=']("1.9")) {
      return (($a = $opal.Object._scope.Dir) == null ? $opal.cm('Dir') : $a).$home()
      } else {
      return $scope.ENV['$[]']("HOME")
    }; return nil; })());

    $opal.cdecl($scope, 'FORCE_ENCODING', ($a = ($b = ($c = $scope.RUBY_ENGINE_OPAL, ($c === nil || $c === false)), $b !== false && $b !== nil ?$scope.RUBY_VERSION['$>=']("1.9") : $b), $a !== false && $a !== nil ?($b = (($c = $opal.Object._scope.Encoding) == null ? $opal.cm('Encoding') : $c).$default_external()['$=='](((($c = $opal.Object._scope.Encoding) == null ? $opal.cm('Encoding') : $c))._scope.UTF_8), ($b === nil || $b === false)) : $a));

    $opal.cdecl($scope, 'FORCE_UNICODE_LINE_LENGTH', $scope.RUBY_VERSION['$<']("1.9"));
    ...
    $opal.cdecl($scope, 'PASS_PLACEHOLDER', $hash2(["start", "end", "match", "match_syn"], {"start": (function() {if (($a = $scope.RUBY_ENGINE_OPAL) !== false && $a !== nil) {
      return (150).$chr()
      } else {
      return "u0096"
    }; return nil; })(), "end": (function() {if (($a = $scope.RUBY_ENGINE_OPAL) !== false && $a !== nil) {
      return (151).$chr()
      } else {
      return "u0097"
    ...
    $opal.defs(self, '$load', function(input, options) {
      ...
      if (($a = ((($b = attrs['$is_a?']((($c = $opal.Object._scope.Hash) == null ? $opal.cm('Hash') : $c))) !== false && $b !== nil) ? $b : (($c = $scope.RUBY_ENGINE_JRUBY, $c !== false && $c !== nil ?attrs['$is_a?']((((($d = $opal.Object._scope.Java) == null ? $opal.cm('Java') : $d))._scope.JavaUtil)._scope.Map) : $c)))) === false || $a === nil) {
