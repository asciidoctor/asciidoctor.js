(function(a){function L(c,a){return"number"===typeof c&&"number"===typeof a?c+a:c["$+"](a)}function D(c,a){return"number"===typeof c&&"number"===typeof a?c<a:c["$<"](a)}function M(c,a){return"number"===typeof c&&"number"===typeof a?c-a:c["$-"](a)}var c=a.nil,B=a.module,z=a.klass,x=a.hash2,N=a.range,fa=a.hash;a.add_stubs("$[]= $config $nil_or_empty? $name $grep $constants $include $const_get $extend $attr_reader $merge $class $update $raise $new $create_block $=== $has_more_lines? $next_block $dup $<< $each $define_method $send $insert $call $attr_accessor $[] $option $to_set $flatten $resolve_regexp $== $attr $method $register $arity $instance_exec $to_proc $activate $+ $values $groups $add_document_processor $! $any? $select $add_syntax_processor $to_sym $include? $private $tr $to_s $join $map $upcase $chr $split $instance_variable_get $instance_variable_set $resolve_args $freeze $process_block_given? $source_location $class_for_name $< $update_config $unshift $as_symbol $name= $pop $size $> $- $fill $-@ $next_auto_id $generate_name $length $empty? $const_defined?".split(" "));
return function(ea){(function(C){C=B(C,"Extensions");var g=C.$$scope;(function(d,$super){function f(){}var b=f=z(d,$super,"Processor",f),k=b.$$scope,l,t,p,h,g,r,u,v,A,q;b.$$proto.config=c;(function(b){var d,h,k;a.defn(b,"$config",d=function(){var a;null==this.config&&(this.config=c);return!1!==(a=this.config)&&a!==c&&null!=a?a:this.config=x([],{})},d.$$arity=0);a.defn(b,"$option",h=function(c,a){return this.$config()["$[]="](c,a)},h.$$arity=2);a.defn(b,"$use_dsl",k=function(){var a;return(a=this.$name()["$nil_or_empty?"]())===
...
h?h.$dup():x([],{})),!1!==l&&l!==c&&null!=l)a["$<<"](l);return a},u.$$arity=-3);return(v=(A=[["create_paragraph","create_block","paragraph"],["create_open_block","create_block","open"],["create_example_block","create_block","example"],["create_pass_block","create_block","pass"],["create_listing_block","create_block","listing"],["create_literal_block","create_block","literal"],["create_anchor","create_inline","anchor"]]).$each,v.$$p=(q=function(b,h,d){var k=q.$$s||this,p,l;null==b&&(b=c);null==h&&
(h=c);null==d&&(d=c);return(p=k.$define_method,p.$$p=(l=function(c){var b=l.$$s||this,k,p=arguments.length;k=p-0;0>k&&(k=0);k=Array(k);for(var f=0;f<p;f++)k[f-0]=arguments[f];return b.$send.apply(b,[h].concat(a.to_a(k.$dup().$insert(1,d))))},l.$$s=k,l.$$arity=-1,l),p).call(k,b)},q.$$s=b,q.$$arity=3,q),v).call(A)})(g.base,null);(function(d){d=B(d,"ProcessorDsl");var g,f,b;a.defn(d,"$option",g=function(a,c){return this.$config()["$[]="](a,c)},g.$$arity=2);a.defn(d,"$process",f=function(b){var d,t,p=
...
return h="content_model",f=this.config,!1!==(l=f["$[]"](h))&&l!==c&&null!=l?l:f["$[]="](h,"attributes")},k.$$arity=-1);return(a.defn(b,"$process",l=function(c,b,d){return this.$raise(a.get("NotImplementedError"))},l.$$arity=3),c)&&"process"})(g.base,g.get("Processor"));(function(d){d=B(d,"MacroProcessorDsl");var g=d.$$scope,f,b,k,l;d.$include(g.get("ProcessorDsl"));a.defn(d,"$named",f=function(a){var b;return(b=g.get("Processor")["$==="](this))===c||null==b||b.$$is_boolean&&1!=b?this.$option("name",
...
(function(d,$super){function f(){}var b=f=z(d,$super,"Group",f),k;(function(b){var d=b.$$scope,f;return(a.defn(b,"$register",f=function(a){null==a&&(a=c);return d.get("Extensions").$register(a,this)},f.$$arity=-1),c)&&"register"})(a.get_singleton_class(b));return(a.defn(b,"$activate",k=function(c){return this.$raise(a.get("NotImplementedError"))},k.$$arity=1),c)&&"activate"})(g.base,null);(function(d,$super){function f(){}var b=f=z(d,$super,"Registry",f),k=b.$$proto,g=b.$$scope,t,p,h,B,r,u,v,A,q,
y,O,E,C,P,F,Q,R,G,S,T,U,H,V,W,X,I,Y,Z,aa,ba,J,K,ca,da;k.groups=k.preprocessor_extensions=k.treeprocessor_extensions=k.postprocessor_extensions=k.include_processor_extensions=k.docinfo_processor_extensions=k.block_extensions=k.block_macro_extensions=k.inline_macro_extensions=c;b.$attr_reader("document");b.$attr_reader("groups");a.defn(b,"$initialize",t=function(a){null==a&&(a=x([],{}));this.groups=a;return this.document=this.block_extensions=this.block_macro_extensions=this.inline_macro_extensions=
...
-1;return this.auto_id=L(this.auto_id,1)},b.$$arity=0);a.defn(d,"$groups",k=function(){var a;null==this.groups&&(this.groups=c);return!1!==(a=this.groups)&&a!==c&&null!=a?a:this.groups=x([],{})},k.$$arity=0);a.defn(d,"$build_registry",l=function(a){var b,d=l.$$p||c;null==a&&(a=c);l.$$p=null;return d!==c?(!1!==(b=a)&&b!==c&&null!=b?b:a=this.$generate_name(),g.get("Registry").$new(fa(a,d))):g.get("Registry").$new()},l.$$arity=-1);a.defn(d,"$register",t=function(b){var d,f,g=t.$$p||c,k=c,h=c,l=h=c,l=
