...
Tree processor::
Processes the {url-jsdoc}/#document[Asciidoctor.Document (AST)] once parsing is complete.
...
Each registered class is instantiated when the {url-jsdoc}/#document[Asciidoctor.Document] is created.
