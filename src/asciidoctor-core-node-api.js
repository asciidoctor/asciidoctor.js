/* global Opal, Asciidoctor, toHash, prepareOptions */
const fs = require('fs')
          ...
          try {
            ...
            if (cache[targetPath]) {
              ...
              if (includeLinesAttr && includeLinesAttr !== Opal.nil) {
                ...
                const [selectedLines] = doc.reader['$select_include_tags'](content, includeTagsAttr)
                content = selectedLines.join('')
              }
                      ...
                      if (resolvedAbsoluteIncludePath.includes(ATTR_REF_HEAD)) {
                        ...
                        if (attrs.includes(ATTR_REF_HEAD) || attrs.includes('leveloffset=')) {
                          ...
                          if (includeLinesAttr && includeLinesAttr !== Opal.nil) {
                            ...
                            const [selectedLines] = doc.reader['$select_include_tags'](includeContent, includeTagsAttr)
                            includeContent = selectedLines.join('')
                          } else {
