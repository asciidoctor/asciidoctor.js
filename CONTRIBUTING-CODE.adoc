...
build/::
* *asciidoctor-core.js* -- core + extensions API
* *asciidoctor-docbook.js* -- DocBook (4.5 and 5) converters
* *asciidoctor.js* -- core + extensions API + Opal +
  _(DocBook isn't the main target of webapp. For this reason, we choose to keep it separate.)_

build/npm/::
* *asciidoctor.js* -- core + extensions API (will automatically load the DocBook converters)
* *asciidoctor-docbook.js* -- DocBook (4.5 and 5) converters
