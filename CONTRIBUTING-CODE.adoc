...
* {uri-jdk8}[Java SE Development Kit 8] to run the tests suite against Nashorn
...
For instance to build against Asciidoctor (Ruby) v1.5.8 use:

 $ ASCIIDOCTOR_CORE_VERSION=v1.5.8 npm run build
