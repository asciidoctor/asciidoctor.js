function notSupported (name) {
  return function () {
    throw new Error(`node:fs ${name}() is not supported in browser environments`)
  }
}
...
const fs = {
  readFileSync, writeFileSync, copyFileSync, unlinkSync, mkdtempSync, mkdirSync, rmSync,
  existsSync, statSync, readdirSync, constants,
}
export default fs