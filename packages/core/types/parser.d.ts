export class Parser {
     ...
     */
    static parse(reader: Reader, document: import("./document.js").Document, options?: {
        header_only?: boolean;
    }): Promise<import("./document.js").Document>;
    /**
     ...
     */
    static parseDocumentHeader(reader: Reader, document: import("./document.js").Document, headerOnly?: boolean): Promise<any>;
    /**
     ...
     */
    static parseManpageHeader(reader: Reader, document: import("./document.js").Document, blockAttributes: any, headerOnly?: boolean): Promise<void>;
    /**
     ...
     */
    static nextSection(reader: Reader, parent: import("./document.js").Document | Section, attributes?: any): Promise<[Section | null, any]>;
    /**
     ...
     */
    static parseSectionTitle(reader: Reader, document: import("./document.js").Document, sectId?: string | null): Promise<[string | null, string | null, string, number, boolean]>;
    /**
     ...
     */
    static parseHeaderMetadata(reader: Reader, document?: import("./document.js").Document | null, retrieve?: boolean): Promise<any | null>;
    /**
     ...
     */
    static storeAttribute(name: string, value: string, doc?: import("./document.js").Document | null, attrs?: any | null, opts?: any): [string, string | null];
    /**
